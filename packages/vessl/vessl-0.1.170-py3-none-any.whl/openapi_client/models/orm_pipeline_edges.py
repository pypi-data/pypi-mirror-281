...
class OrmPipelineEdges(object):
    ...
    def __init__(self, created_by=None, executions=None, organization=None, project=None, specs=None, triggers=None, volume=None, local_vars_configuration=None):  # noqa: E501
