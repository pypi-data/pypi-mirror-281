...
class OrmRunSpecEdges(object):
    ...
    def __init__(self, cluster=None, image=None, organization=None, pipeline_step_specs=None, project=None, resource_spec_preset=None, run_executions=None, local_vars_configuration=None):  # noqa: E501
