...
class V1ServeRevisionServiceForm(object):
    ...
    def __init__(self, autoscaling=None, auxiliary=None, expose=None, healthcheck=None, monitoring=None, serverless=None, local_vars_configuration=None):  # noqa: E501
