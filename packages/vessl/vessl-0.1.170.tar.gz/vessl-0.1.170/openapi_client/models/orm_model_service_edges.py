...
class OrmModelServiceEdges(object):
    ...
    def __init__(self, access_token=None, created_by=None, gateway=None, kernel_cluster=None, last_updated_by=None, organization=None, revisions=None, rollouts=None, local_vars_configuration=None):  # noqa: E501
