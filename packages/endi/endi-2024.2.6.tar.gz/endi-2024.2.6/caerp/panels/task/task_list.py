...
class TaskListPanel:
    ...
    def _invoice_columns(self):
        ...
        result.append(Column("N° facture", "official_number", "col_text"))
        if self.is_admin_view:
            result.append(Column("Enseigne", "company", "col_text"))
        result.append(Column("Émise le", "date", "col_date"))
        ...
        if not self.tva_on_margin_display:
            result.append(Column("HT", "ht", "col_number"))
            result.append(Column("TVA", "tva", "col_number"))
        result.append(Column("TTC", "ttc", "col_number"))
        result.append(Column("Paiement", "payment", "col_text"))
        result.append(Column("Fichiers attachés", "col_text"))
        return result
    ...
    def _estimation_columns(self):
        ...
        if self.is_admin_view:
            result.append(Column("Enseigne", "company", "col_text"))
        result.append(Column("Émis le", "date", "col_date"))
