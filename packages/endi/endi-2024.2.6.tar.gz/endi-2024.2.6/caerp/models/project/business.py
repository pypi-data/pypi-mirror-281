...
class Business(BusinessMetricsMixin, Node):
    ...
    def gen_invoices(self, request, user, payment_deadlines=None):
        ...
        """
        return self._caerp_service.gen_invoices(request, self, user, payment_deadlines)
    ...
    def is_visible(self):
        ...
        :rtype: bool
        """
        return self._caerp_service.is_complex_project_type(self)
    ...
    def populate_progress_invoicing_plan(self, plan):
        ...
        """
        return self._caerp_service.populate_progress_invoicing_plan(self, plan)
