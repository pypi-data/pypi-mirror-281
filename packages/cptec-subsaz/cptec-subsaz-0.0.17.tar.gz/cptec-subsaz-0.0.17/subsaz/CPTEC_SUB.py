...
class model(object):
    ...
    def __init__(self):
        ...
        """ 
            ...
            * Variables : Para habilitar novas váriaveis adicionar o nome da variavel e (ensemble_mean ou calibrated)
            * Products  : Define os nome, num de figuras e steps dos dias para cada produto
            * Fields    : Define os nome, sigla e descricao para cada campo
    ...
    def __getrange__(self):
        ...
        """ 
            Função para criar um Xarray com informações que serão consumidas do servidor self.dict['server']['ftp'] e
            as opcoes definidas pelo usuario atraves do comando load
