...
from scipy.ndimage import zoom, binary_erosion, gaussian_filter as gf, median_filter
...
# from .misc import chunking
from .reg_algs import mrtv_reg_v4, cost_norm, cost_abs
    ...
    aut_xns3d_cfg["auto_reg_cfg"] = {
        ...
        "data": {
            ...
            "roi": (
                ...
                if aut_xns3d_cfg["aut_xns3d_pars"]["use_opt_reg_roi"]
                else aut_xns3d_cfg["aut_xns3d_pars"]["rec_roi"]
            ),
        },
        "file": {
