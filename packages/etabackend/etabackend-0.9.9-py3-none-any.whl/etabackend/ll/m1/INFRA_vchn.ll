...
define dso_local i32 @circular_buf_get(%struct.circular_buf_t* %0, i64* %1, i1 %2) #1 {
...
15:                                               ; preds = %12
  %16 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
...
24:                                               ; preds = %15
  ...
  %28 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
...
36:                                               ; preds = %24
  %37 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
  %38 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %37, i32 0, i32 2
  %39 = load i64, i64* %38, align 8
  %40 = add nsw i64 %39, 1
  %41 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
  %42 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %41, i32 0, i32 3
  %43 = load i64, i64* %42, align 8
  %44 = srem i64 %40, %43
  %45 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
...
; Function Attrs: alwaysinline nounwind
define dso_local i1 @circular_buf_empty(%struct.circular_buf_t* %0) #0 {
...
; Function Attrs: alwaysinline nounwind
define dso_local i1 @circular_buf_full(%struct.circular_buf_t* %0) #0 {
  %2 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %0, i32 0, i32 1
  %3 = load i64, i64* %2, align 8
  %4 = add nsw i64 %3, 1
...
37:                                               ; preds = %5
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str, i64 0, i64 0))
...
40:                                               ; preds = %10
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0))
...
51:                                               ; preds = %43
  %52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.2, i64 0, i64 0))
...
62:                                               ; preds = %54
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.3, i64 0, i64 0))
...
136:                                              ; preds = %123
  %137 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i64 0, i64 0))
...
define dso_local i32 @VCHN_put(%struct.VCHN_t* %0, i64 %1, i8 %2) #1 {
  ...
  %37 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
  ...
  %43 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
...
50:                                               ; preds = %3
  ...
  %65 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %72 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %79 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
89:                                               ; preds = %85
  ...
  %106 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
121:                                              ; preds = %89
  %122 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %128 = load i64, i64* %127, align 8
  %129 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %135 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %142 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %148 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %155 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
161:                                              ; preds = %89
  %162 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %169 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %175 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %182 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %188 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %195 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
203:                                              ; preds = %85
  %204 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
  ...
  store %struct.circular_buf_t* %209, %struct.circular_buf_t** %4, align 8
  store i32 -1, i32* %5, align 4
  %210 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
  %211 = icmp ne %struct.circular_buf_t* %210, null
  br i1 %211, label %212, label %217

212:                                              ; preds = %203
  %213 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
  %214 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %213, i32 0, i32 1
  store i64 0, i64* %214, align 8
  %215 = load %struct.circular_buf_t*, %struct.circular_buf_t** %4, align 8
...
219:                                              ; preds = %3
  %220 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
  ...
  %227 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
...
235:                                              ; preds = %219
  ...
  %250 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %257 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
...
306:                                              ; preds = %274
  %307 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %314 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %320 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %327 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %333 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %340 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
...
346:                                              ; preds = %274
  %347 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %354 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %360 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %367 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %373 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
  ...
  %380 = load %struct.VCHN_t*, %struct.VCHN_t** %6, align 8
...
390:                                              ; preds = %219
  %391 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
...
408:                                              ; preds = %390
  %409 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
  ...
  %418 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5, i64 0, i64 0), i64 %417)
...
423:                                              ; preds = %390
  %424 = load %struct.VCHN_t*, %struct.VCHN_t** %26, align 8
  %425 = getelementptr inbounds %struct.VCHN_t, %struct.VCHN_t* %424, i32 0, i32 3
  %426 = load %struct.circular_buf_t*, %struct.circular_buf_t** %425, align 8
  %427 = load i32, i32* %29, align 4
  %428 = sext i32 %427 to i64
  %429 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %426, i64 %428
  %430 = load i64, i64* %27, align 8
  store %struct.circular_buf_t* %429, %struct.circular_buf_t** %14, align 8
  store i64 %430, i64* %15, align 8
  store i32 -1, i32* %16, align 4
  %431 = load %struct.circular_buf_t*, %struct.circular_buf_t** %14, align 8
  %432 = icmp ne %struct.circular_buf_t* %431, null
  br i1 %432, label %433, label %471

433:                                              ; preds = %423
  %434 = load i64, i64* %15, align 8
  %435 = load %struct.circular_buf_t*, %struct.circular_buf_t** %14, align 8
  %436 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %435, i32 0, i32 0
  %437 = load i64*, i64** %436, align 8
  %438 = load %struct.circular_buf_t*, %struct.circular_buf_t** %14, align 8
...
51:                                               ; preds = %3
  ...
  %53 = zext i8 %52 to i32
  %54 = load %struct.VCHN_t*, %struct.VCHN_t** %25, align 8
...
61:                                               ; preds = %51
  %62 = load %struct.VCHN_t*, %struct.VCHN_t** %25, align 8
...
75:                                               ; preds = %61
  ...
  %88 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %95 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %102 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
...
112:                                              ; preds = %108
  ...
  %129 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  %130 = getelementptr inbounds %struct.VCHN_t, %struct.VCHN_t* %129, i32 0, i32 0
  %131 = load i64*, i64** %130, align 8
  ...
  %136 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
...
144:                                              ; preds = %112
  %145 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %152 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %158 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %165 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %171 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %178 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
...
184:                                              ; preds = %112
  %185 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %192 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %198 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %205 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %211 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
  ...
  %218 = load %struct.VCHN_t*, %struct.VCHN_t** %4, align 8
...
227:                                              ; preds = %61
  %228 = load %struct.VCHN_t*, %struct.VCHN_t** %25, align 8
  ...
  store %struct.circular_buf_t* %233, %struct.circular_buf_t** %12, align 8
  store i64* %33, i64** %13, align 8
  store i8 1, i8* %14, align 1
  store i32 -1, i32* %15, align 4
  %234 = load %struct.circular_buf_t*, %struct.circular_buf_t** %12, align 8
...
239:                                              ; preds = %236
  %240 = load %struct.circular_buf_t*, %struct.circular_buf_t** %12, align 8
...
248:                                              ; preds = %239
  %249 = load %struct.circular_buf_t*, %struct.circular_buf_t** %12, align 8
  %250 = getelementptr inbounds %struct.circular_buf_t, %struct.circular_buf_t* %249, i32 0, i32 0
  %251 = load i64*, i64** %250, align 8
  %252 = load %struct.circular_buf_t*, %struct.circular_buf_t** %12, align 8
...
272:                                              ; preds = %227, %236, %239, %271
  ...
  %274 = load %struct.VCHN_t*, %struct.VCHN_t** %25, align 8
  %275 = load i64, i64* %33, align 8
  %276 = load i8, i8* %29, align 1
  %277 = load i8, i8* %30, align 1
  store %struct.VCHN_t* %274, %struct.VCHN_t** %17, align 8
  store i64 %275, i64* %18, align 8
  store i8 %276, i8* %19, align 1
  store i8 %277, i8* %20, align 1
  %278 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %287 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %294 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %300 = load i8, i8* %20, align 1
  %301 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
311:                                              ; preds = %307
  ...
  %328 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %335 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
343:                                              ; preds = %311
  %344 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %351 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %357 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %364 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %370 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %377 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
383:                                              ; preds = %311
  %384 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %391 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %397 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %404 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %410 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
  ...
  %417 = load %struct.VCHN_t*, %struct.VCHN_t** %17, align 8
...
attributes #0 = { alwaysinline nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="non-leaf" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { alwaysinline "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="non-leaf" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon" "unsafe-fp-math"="false" "use-soft-float"="false" }
