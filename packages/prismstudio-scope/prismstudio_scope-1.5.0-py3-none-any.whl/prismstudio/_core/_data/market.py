...
class open(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> open_prc = ps.market.open(adjustment='all', package='Prism Market')
        >>> open_df = ps.get_data([open_prc], 'KOSPI 200 Index', startdate='2015-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> open_df
...
class close(_PrismMarketComponent):
    ...
    --------
        ...
        >>> close_df = ps.get_data([close], 'KOSPI 200 Index', startdate='2015-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> close_df
...
class high(_PrismMarketComponent):
    ...
    --------
        ...
        >>> high_df = ps.get_data([high], 'KOSPI 200 Index', startdate='2015-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> high_df
...
class low(_PrismMarketComponent):
    ...
    --------
        ...
        >>> low_df = ps.get_data([low], 'KOSPI 200 Index', startdate='2015-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> low_df
...
class vwap(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> vwap = ps.market.ask(adjustment=True, package='CIQ Market')
...
class totalreturnindex(_PrismMarketComponent):
    ...
    --------
        ...
        >>> tri_df = ps.get_data([tri], 'KOSPI 200 Index', startdate='2019-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> tri_df
    """
    @_validate_args
    def __init__(
...
class dividend(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> dividend = ps.market.dividend(package='MI Integrated Market')
        >>> dividend _df = ps.get_data([dividend], 'KOSPI 200 Index', startdate='2019-01-01', enddate='2020-12-31', shownid=['ticker'])
        >>> dividend _df
