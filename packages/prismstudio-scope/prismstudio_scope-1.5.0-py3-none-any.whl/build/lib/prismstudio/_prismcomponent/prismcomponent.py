...
class _PrismComponent(_AbstractPrismComponent, ABC):
    ...
    @samples_operation
    @operation
    def samples_pct_change(self, n: int, positive_denominator: bool = False):
        """
        ...
        --------
            ...
            >>> close_result = close.samples_pct_change(n=1)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date     value  Ticker
    ...
    def samples_shift(self, n: int):
        ...
        --------
            ...
            >>> close_result = close.samples_shift(n=2)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date  value  Ticker
    ...
    def samples_diff(self, n: int):
        ...
        --------
            ...
            >>> log_close = close.samples_diff(5)
            >>> log_close.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date   value  Ticker
    ...
    @samples_operation
    @operation
    def samples_max(self, n: int, min_samples: int = 1, weights: list = None):
        """
    ...
    @samples_operation
    @operation
    def samples_min(self, n: int, min_samples: int = 1, weights: list = None):
        """
        ...
        --------
            ...
            >>> close_result = close.samples_min(n=2)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date  value  Ticker
    ...
    @samples_operation
    @operation
    def samples_mean(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_mean(n=5)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date   value  Ticker
    ...
    @samples_operation
    @operation
    def samples_ewma(self, n: int, min_samples: int = 1):
        r"""
    ...
    @samples_operation
    @operation
    def samples_ewmstd(self, n: int, min_samples: int = 1):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_ewma(n=5)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date      value  Ticker
    ...
    @samples_operation
    @operation
    def samples_ewmvar(self, n: int, min_samples: int = 1):
        r"""
    ...
    @samples_operation
    @operation
    def samples_median(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_median(n=3)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date  value  Ticker
            0         2586086  2010-01-04  46.88     AFL
            1         2586086  2010-01-05  47.57     AFL
    ...
    @samples_operation
    @operation
    def samples_sum(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_sum(n=2)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date  value  Ticker
    ...
    @samples_operation
    @operation
    def samples_std(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_std(n=5)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date     value  Ticker
    ...
    @samples_operation
    @operation
    def samples_var(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_var(n=5)
            TODO
        """
        if (weights is not None) and (len(weights) != n):
            raise PrismValueError("Number of weights should equal to n")
    ...
    @samples_operation
    @operation
    def samples_z_score(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_z_score(n=5)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date      value  Ticker
    ...
    @samples_operation
    @operation
    def samples_skew(self, n: int, min_samples: int = 1, weights: list = None):
        r"""
        ...
        --------
            ...
            >>> close_result = close.samples_skew(n=5)
            >>> close_result.get_data(universe='S&P 500', startdate='2010-01-01', enddate='2015-12-31', shownid=['ticker'])
                    listingid        date     value  Ticker
    ...
    @_validate_args
    @operation
    def periods_count(self, period: str):
        """"""
        ...

    @_validate_args
    @operation
    def periods_z_score(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_max(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_min(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_mean(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_std(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_var(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_skew(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_median(self, period: str, min_samples: int = 1):
        """"""
        ...

    @_validate_args
    @operation
    def periods_sum(self, period: str, min_samples: int = 1):
        """"""
        ...
