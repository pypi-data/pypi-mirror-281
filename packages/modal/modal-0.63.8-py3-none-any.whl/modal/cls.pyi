...
class _Obj:
    ...
    _instance_service_function: modal.functions._Function

    def __init__(
        self,
        user_cls: type,
        output_mgr: typing.Union[modal._output.OutputManager, None],
        class_service_function: modal.functions._Function,
...
class Obj:
    ...
    _local_obj: typing.Any
    _local_obj_constr: typing.Union[typing.Callable[[], typing.Any], None]
    _instance_service_function: modal.functions.Function

    def __init__(
        self,
        user_cls: type,
        output_mgr: typing.Union[modal._output.OutputManager, None],
        class_service_function: modal.functions.Function,
...
class _Cls(modal.object._Object):
    ...
    _class_service_function: modal.functions._Function
...
class Cls(modal.object.Object):
    _user_cls: typing.Union[type, None]
    _class_service_function: modal.functions.Function
