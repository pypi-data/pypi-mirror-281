...
class InspectorScan(ContainerScan):
    ...
    def create_asset(self, dat: Optional[InspectorRecord] = None) -> Asset:
        ...
        :param Optional[dict] dat: Data row from an Inspector Record, defaults to None
    ...
    def create_vuln(self, dat: Optional[InspectorRecord] = None) -> Vulnerability:
        """
        Create a vulnerability from an Inspector Record

        :param Optional[dict] dat: Data row an Inspector Record, defaults to None
