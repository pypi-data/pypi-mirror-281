...
macro(_ov_find_intel_cpu_dependencies)
    ...
    if(_OV_ENABLE_CPU_ACL)
        set(_ov_in_install_tree "${PACKAGE_PREFIX_DIR}/openvino/libs")
        if(_ov_in_install_tree)
            set_and_check(ARM_COMPUTE_LIB_DIR "${PACKAGE_PREFIX_DIR}/openvino/libs")
...
macro(_ov_find_intel_gpu_dependencies)
    ...
    if(_OV_ENABLE_ONEDNN_FOR_GPU AND NOT TARGET onednn_gpu_tgt)
        ...
        if(_ov_in_install_tree)
            ...
            set_and_check(onednn_gpu_lib_root "${PACKAGE_PREFIX_DIR}/openvino/libs")
            if(WIN32)
