...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, pulp_created=None, hidden=False, base_url=None, content_guard=None, name=None, pulp_last_updated=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
