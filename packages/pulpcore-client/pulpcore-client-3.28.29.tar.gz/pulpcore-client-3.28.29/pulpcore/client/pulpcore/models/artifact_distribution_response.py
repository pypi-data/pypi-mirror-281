...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, pulp_labels=None, hidden=False, base_path=None, pulp_href=None, content_guard=None, base_url=None, local_vars_configuration=None):  # noqa: E501
