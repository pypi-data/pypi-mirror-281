...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, pulp_last_updated=None, pulp_href=None, name=None, pulp_labels=None, hidden=False, base_url=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
