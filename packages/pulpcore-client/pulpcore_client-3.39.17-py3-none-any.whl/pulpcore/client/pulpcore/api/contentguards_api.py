...
class ContentguardsApi(object):
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param str pulp_type: Pulp type  * `core.rbac` - core.rbac * `core.content_redirect` - core.content_redirect * `core.header` - core.header * `certguard.rhsm` - certguard.rhsm * `certguard.x509` - certguard.x509
        :param list[str] pulp_type__in: Multiple values may be separated by commas.  * `core.rbac` - core.rbac * `core.content_redirect` - core.content_redirect * `core.header` - core.header * `certguard.rhsm` - certguard.rhsm * `certguard.x509` - certguard.x509
        :param str q:
