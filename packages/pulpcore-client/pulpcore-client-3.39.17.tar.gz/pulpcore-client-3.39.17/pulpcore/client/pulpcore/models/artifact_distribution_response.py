...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, content_guard=None, pulp_href=None, pulp_created=None, hidden=False, base_path=None, base_url=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
