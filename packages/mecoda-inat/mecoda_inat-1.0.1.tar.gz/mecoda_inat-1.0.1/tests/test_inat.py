...
# Retrieve project data using a valid project ID
def test_retrieve_project_data_using_valid_id(requests_mock):
    project_id = 80406
    expected_result = [
        Project(id=80406, title="Bugs", created_at=datetime.datetime(2020, 1, 1))
    ]
    requests_mock.get(
        f"{BASE_URL}/projects/{project_id}.json",
        json={"id": 80406, "title": "Bugs", "created_at": "2020-01-01T00:00:00Z"},
    )
    result = get_project(project_id)
    assert result[0].id == expected_result[0].id
    assert result[0].title == expected_result[0].title
    assert result[0].created_at.year == expected_result[0].created_at.year


def test_handle_non_existent_project_id_gracefully(requests_mock, capsys):
    project_id = 11
    requests_mock.get(
        f"{BASE_URL}/projects/{project_id}.json",
...
def test_retrieve_real_project_data():
    project_id = 80406
    result = get_project(project_id)
    assert result[0].id == 80406
    assert result[0].title == "Bugs in Flight"
    assert result[0].user_id == 304494
...
def test_get_obs_by_id_returns_observations_data(
    ...
    expected_result = [
        Observation(
            ...
            photos=[
                Photo(
                    id=1975,
                    large_url=f"{API_PATH}/attachments/local_photos/files/2947/large/rissoella_verruculosa.JPG?1468246242",
                    medium_url=f"{API_PATH}/attachments/local_photos/files/2947/medium/rissoella_verruculosa.JPG?1468246242",
                    small_url=f"{API_PATH}/attachments/local_photos/files/2947/small/rissoella_verruculosa.JPG?1468246242",
                ),
                Photo(
                    id=2075,
                    large_url=f"{API_PATH}/attachments/local_photos/files/2947/large/rissoella_verruculosa.JPG?1468246242",
    ...
    requests_mock.get(
        f"{API_PATH}/observations?id=2084&per_page=200",
        json={
            "total_results": 1,
            "page": 1,
            "per_page": 30,
...
def test_get_obs_from_query_returns_observations_data_when_less_than_pagination(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?q=%22quercus%20quercus%22&per_page=200",
        json={
            "total_results": 147,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_returns_observations_data_when_more_than_pagination(
    ...
    requests_mock.get(
        f'{API_PATH}/observations?q="quercus quercus"&per_page=200',
        json={
            "total_results": 250,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f'{API_PATH}/observations?q="quercus quercus"&per_page=200&page=2',
        json={
            "total_results": 250,
            "page": 2,
            "per_page": 200,
    ...
    requests_mock.get(
        f'{API_PATH}/observations?q="quercus quercus"&per_page=200&page=100',
        json=[],
    )
...
def test_get_obs_from_user_returns_observations_data(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?user_login=zolople&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f"{API_PATH}/observations?user_login=zolople&per_page=200&page=2",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_project_returns_observations_data(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?project_id=20&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_from_taxon_returns_info_with_pagination(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?iconic_taxa=Fungi&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f"{API_PATH}/observations?iconic_taxa=Fungi&per_page=200&page=2",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f"{API_PATH}/observations?iconic_taxa=Fungi&per_page=200&page=3",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_from_place_id_returns_obs(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?place_id=1011&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f"{API_PATH}/observations?place_id=1011&per_page=200&page=2",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
    ...
    requests_mock.get(
        f"{API_PATH}/observations?place_id=1011&per_page=200&page=3",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_from_combined_arguments(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?user_login=zolople&iconic_taxa=Mollusca&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_from_three_combined_arguments(
    ...
    requests_mock.get(
        f'{API_PATH}/observations?project_id=45&place_id=3&q="quercus quercus"&per_page=200',
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_obs_from_year_returns_obs(
    ...
    requests_mock.get(
        f"{API_PATH}/observations?year=2018&per_page=200",
        json={
            "total_results": 900,
            "page": 1,
            "per_page": 200,
...
def test_get_dwc() -> None:
    observations = [
        Observation(id=223504590),
        Observation(id=223504591),
        Observation(id=223504592),
    ]
    ...
    assert result["institutionCode"].iloc[0] == "INaturalist"


def test_get_dwc_from_query() -> None:
    result = get_dwc_from_query(
        user_id=16651,  # xasalva
        taxon_id=47170,  # filo chordata
        # place_id=55,  # spain
        start_on="2024-06-01",
        ends_on="2024-06-18",
    )
