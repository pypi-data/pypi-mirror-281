"""Routines to run simulations generated by the user"""
...
def runExperiment(pmodule,datadir):
    """Multiprocessing wrapper to launch asynchronous jobs"""
...
class ExperimentRunner():
    """Logic to find experiments and run them using multiprocessing"""
    ...
    def setMaxProcesses(self,numProcs):
        """Maximum number of processes that the runner can spawn"""
        self.numprocesses = numProcs
        
    def setDataDirectory(self,datadir):
        """Set datadirectory to save simulation results"""
