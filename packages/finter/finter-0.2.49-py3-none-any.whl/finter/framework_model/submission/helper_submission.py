...
@timer
def submit_model(model_info, output_directory, docker_submit):
    """
    ...
    """
    try:
        res = finter.SubmissionApi(get_api_client()).submission_create(model_info, output_directory, docker_submit)
        return res
