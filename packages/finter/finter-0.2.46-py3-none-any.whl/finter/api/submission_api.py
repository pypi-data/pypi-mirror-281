...
class SubmissionApi(object):
    ...
    def submission_create(self, model_info, model_dir, docker_submit, **kwargs):  # noqa: E501
        """submission_create  # noqa: E501

        Finter submission  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submission_create(model_info, model_dir, docker_submit, async_req=True)
        >>> result = thread.get()
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if kwargs.get('async_req'):
                return self.submission_create_with_http_info(model_info, model_zip_file, docker_submit, **kwargs)  # noqa: E501
            else:
                (data) = self.submission_create_with_http_info(model_info, model_zip_file, docker_submit, **kwargs)  # noqa: E501
                return data

    def submission_create_with_http_info(self, model_info, model_zip_file, docker_submit, **kwargs):  # noqa: E501
        """submission_create  # noqa: E501

        Finter submission  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submission_create_with_http_info(model_info, model_zip_file, docker_submit, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['model_info', 'model_zip_file', 'docker_submit']  # noqa: E501
