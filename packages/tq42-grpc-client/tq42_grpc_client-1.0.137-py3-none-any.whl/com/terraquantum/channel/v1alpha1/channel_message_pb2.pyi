...
class ChannelMessage(_message.Message):
    __slots__ = ("timestamp", "sequential_message_id", "acknowledge_data", "ask_data", "tell_data")
    ...
    ask_data: Ask
    tell_data: Tell
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., sequential_message_id: _Optional[int] = ..., acknowledge_data: _Optional[_Union[DataAcknowledge, _Mapping]] = ..., ask_data: _Optional[_Union[Ask, _Mapping]] = ..., tell_data: _Optional[_Union[Tell, _Mapping]] = ...) -> None: ...
