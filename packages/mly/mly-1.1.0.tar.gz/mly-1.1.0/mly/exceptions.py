...
def check_dates(dates):
    ...
    elif len(dates)==2 and all(list(isinstance(date,(float,int)) for date in dates)):
        pass

    elif len(dates)>2 or len(dates)==2 and all(list(not isinstance(date,(float,int)) for date in dates)):
