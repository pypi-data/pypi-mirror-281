        ...
        if res:
            ...
            try:
                if inspect.iscoroutinefunction(handler_method):
                    ...
                    if options.common_cache_enable:
                        data = await async_common_cache(handler_method, options.common_cache_ex, **params_dict)
                    else:
                    ...
                    if options.common_cache_enable:
                        func = lambda: common_cache(handler_method, options.common_cache_ex, **params_dict)
                    else:
