...
class SecurityfindingsSecurityFindingResource(BaseModel):
    """
    ...
    expected_fix_date: Optional[StrictStr] = None
    ...
    installation_path: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["activities", "cvss", "cvss_vector", "description", "discovered_at", "expected_fix_date", "external_vuln_id", "fixed_in", "id", "image_build_digest", "image_build_repo", "image_build_tag", "installation_path", "nvd_link", "package_distro", "package_ecosystem", "package_name", "package_version", "published_at", "resolution", "scanner_name", "severity", "status", "workspace_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecurityfindingsSecurityFindingResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecurityfindingsSecurityFindingResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "expected_fix_date": obj.get("expected_fix_date"),
            ...
            "installation_path": obj.get("installation_path"),
