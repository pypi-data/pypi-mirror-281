...
class TestSecurityfindingsSecurityFindingResource(unittest.TestCase):
    """SecurityfindingsSecurityFindingResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecurityfindingsSecurityFindingResource:
        """Test SecurityfindingsSecurityFindingResource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecurityfindingsSecurityFindingResource`
        """
        model = SecurityfindingsSecurityFindingResource()
        if include_optional:
            return SecurityfindingsSecurityFindingResource(
    ...
    def testSecurityfindingsSecurityFindingResource(self):
        """Test SecurityfindingsSecurityFindingResource"""
