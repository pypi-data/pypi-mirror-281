...
class SecurityfindingsSecurityFindingDetailedActivityResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "account_name", "activity", "comment", "comment_id", "comment_parent_id", "created_at", "new_status", "old_status", "organization_id", "organization_name", "resolution", "workspace_id", "workspace_name"]
