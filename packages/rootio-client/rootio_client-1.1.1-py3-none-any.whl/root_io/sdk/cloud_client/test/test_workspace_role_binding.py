...
class TestWorkspaceRoleBinding(unittest.TestCase):
    """WorkspaceRoleBinding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceRoleBinding:
        """Test WorkspaceRoleBinding
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceRoleBinding`
        """
    ...
    def testWorkspaceRoleBinding(self):
        """Test WorkspaceRoleBinding"""
