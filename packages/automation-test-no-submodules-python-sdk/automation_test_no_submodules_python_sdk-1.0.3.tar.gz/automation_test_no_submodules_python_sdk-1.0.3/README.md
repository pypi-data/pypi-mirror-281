...
[![PyPI](https://img.shields.io/badge/PyPI-v1.0.3-blue)](https://pypi.org/project/automation-test-no-submodules-python-sdk/1.0.3)
...
```sh
pip install automation-test-no-submodules-python-sdk==1.0.3
```
