...
from collibra_protect_api_partner.models.standard_error_response import StandardErrorResponse  # noqa: E501
...
class TestStandardErrorResponse(unittest.TestCase):
    ...
    def testStandardErrorResponse(self):
        ...
        # model = collibra_protect_api_partner.models.standard_error_response.StandardErrorResponse()  # noqa: E501
        pass
