...
from collibra_protect_api_partner.models.row_filter import RowFilter  # noqa: E501
...
class TestRowFilter(unittest.TestCase):
    ...
    def testRowFilter(self):
        ...
        # model = collibra_protect_api_partner.models.row_filter.RowFilter()  # noqa: E501
        pass
