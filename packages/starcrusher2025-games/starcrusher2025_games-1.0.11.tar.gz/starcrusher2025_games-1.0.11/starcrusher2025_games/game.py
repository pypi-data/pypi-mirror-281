...
try:
    ...
    from update.requests import notify_user_if_update_available
...
class Game:
    def __init__(self):
        ...
        self.menu = Menu(self._window, self.menu_config)
        self.menu.set_game_instance(self)
        self.ingame_menu = InGameMenu(self._window, self.menu_config)
