...
You can add additional game objects to your game by creating instances of `GameObject` and adding them to the game:

```python
from starcrusher2025_games.configs.GameObject import GameObject

obj1 = GameObject(start_pos=(100, 100), size=(50, 50), speed=3, color=(255, 0, 0))
obj2 = GameObject(start_pos=(200, 200), size=(75, 75), speed=2, color=(0, 255, 0))
