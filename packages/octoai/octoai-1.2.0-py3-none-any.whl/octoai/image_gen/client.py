    ...
    def generate_controlnet_sd15(
        ...
        *,
        ...
        controlnet : typing.Optional[str]
            [Not supported on SD3] ControlNet to be used during image generation.

        controlnet_conditioning_scale : typing.Optional[float]
            [Not supported on SD3] How strong the effect of the controlnet should be.

        controlnet_early_stop : typing.Optional[float]
            [Not supported on SD3] If provided, indicates fraction of steps at which to stop applying controlnet. This can be used to sometimes generate better outputs.

        controlnet_image : typing.Optional[str]
            [Not supported on SD3] Controlnet image encoded in b64 string for guiding image generation. Required for controlnet engines.

        controlnet_preprocess : typing.Optional[bool]
            [Not supported on SD3] Whether to apply automatic ControlNet preprocessing.
