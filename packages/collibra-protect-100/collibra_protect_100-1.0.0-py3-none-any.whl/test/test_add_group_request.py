...
from collibra_protect.models.add_group_request import AddGroupRequest  # noqa: E501
...
class TestAddGroupRequest(unittest.TestCase):
    ...
    def testAddGroupRequest(self):
        ...
        # model = collibra_protect.models.add_group_request.AddGroupRequest()  # noqa: E501
        pass
