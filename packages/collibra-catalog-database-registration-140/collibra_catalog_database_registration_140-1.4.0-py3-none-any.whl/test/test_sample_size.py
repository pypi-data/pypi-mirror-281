...
from collibra_catalog_database_registration.models.sample_size import SampleSize  # noqa: E501
from collibra_catalog_database_registration.rest import ApiException


class TestSampleSize(unittest.TestCase):
    """SampleSize unit test stubs"""
    ...
    def testSampleSize(self):
        ...
        # model = collibra_catalog_database_registration.models.sample_size.SampleSize()  # noqa: E501
        pass
