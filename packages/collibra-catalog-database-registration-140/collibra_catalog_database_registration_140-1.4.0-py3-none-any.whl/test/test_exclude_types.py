...
from collibra_catalog_database_registration.models.exclude_types import ExcludeTypes  # noqa: E501
from collibra_catalog_database_registration.rest import ApiException


class TestExcludeTypes(unittest.TestCase):
    """ExcludeTypes unit test stubs"""
    ...
    def testExcludeTypes(self):
        ...
        # model = collibra_catalog_database_registration.models.exclude_types.ExcludeTypes()  # noqa: E501
        pass
