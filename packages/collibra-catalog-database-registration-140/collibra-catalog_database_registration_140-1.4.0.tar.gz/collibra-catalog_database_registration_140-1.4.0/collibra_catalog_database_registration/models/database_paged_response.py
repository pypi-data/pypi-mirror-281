...
class DatabasePagedResponse(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """DatabasePagedResponse - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this DatabasePagedResponse.  # noqa: E501

        The list of results.  # noqa: E501

        :return: The results of this DatabasePagedResponse.  # noqa: E501
        :rtype: list[Database]
        """
    ...
    def results(self, results):
        """Sets the results of this DatabasePagedResponse.

        The list of results.  # noqa: E501

        :param results: The results of this DatabasePagedResponse.  # noqa: E501
        :type: list[Database]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatabasePagedResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatabasePagedResponse):
            return False
