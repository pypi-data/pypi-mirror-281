...
class ChangeProfilingConfigurationRequest(object):
    ...
    def __init__(self, profiling_type=None, sample_size=None, run_after_metadata_synchronization=None, exclude_types=None):  # noqa: E501
        """ChangeProfilingConfigurationRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def profiling_type(self):
        """Gets the profiling_type of this ChangeProfilingConfigurationRequest.  # noqa: E501
        ...
        :return: The profiling_type of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def profiling_type(self, profiling_type):
        """Sets the profiling_type of this ChangeProfilingConfigurationRequest.

        - **full**: Select to profile and classify based on all synchronized metadata. - **sample**: Select to profile and classify based on a sample of the synchronized metadata.   When you select Partial scan, you can define the maximum number of rows that you want to use for profiling and classification (as *sampleSize*). By default, the maximum number of rows is 20000.   # noqa: E501

        :param profiling_type: The profiling_type of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :type: str
        """
    ...
    def sample_size(self):
        """Gets the sample_size of this ChangeProfilingConfigurationRequest.  # noqa: E501

        If *profilingType* is defined as *sample*, this attribute defines how many rows are used for profiling. The minimum value is 100.  # noqa: E501

        :return: The sample_size of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def sample_size(self, sample_size):
        """Sets the sample_size of this ChangeProfilingConfigurationRequest.

        If *profilingType* is defined as *sample*, this attribute defines how many rows are used for profiling. The minimum value is 100.  # noqa: E501

        :param sample_size: The sample_size of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :type: int
        """
    ...
    def run_after_metadata_synchronization(self):
        """Gets the run_after_metadata_synchronization of this ChangeProfilingConfigurationRequest.  # noqa: E501
        ...
        :return: The run_after_metadata_synchronization of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_after_metadata_synchronization(self, run_after_metadata_synchronization):
        """Sets the run_after_metadata_synchronization of this ChangeProfilingConfigurationRequest.

        If set to *true*, it will automatically create a data profile and classify columns every time the metadata synchronization process of one or more schemas finishes.  This may take a long time. You can also add a schedule to profile and classify at regular intervals.   # noqa: E501

        :param run_after_metadata_synchronization: The run_after_metadata_synchronization of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :type: bool
        """
    ...
    def exclude_types(self):
        """Gets the exclude_types of this ChangeProfilingConfigurationRequest.  # noqa: E501


        :return: The exclude_types of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :rtype: ExcludeTypes
        """
    ...
    def exclude_types(self, exclude_types):
        """Sets the exclude_types of this ChangeProfilingConfigurationRequest.


        :param exclude_types: The exclude_types of this ChangeProfilingConfigurationRequest.  # noqa: E501
        :type: ExcludeTypes
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChangeProfilingConfigurationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeProfilingConfigurationRequest):
            return False
