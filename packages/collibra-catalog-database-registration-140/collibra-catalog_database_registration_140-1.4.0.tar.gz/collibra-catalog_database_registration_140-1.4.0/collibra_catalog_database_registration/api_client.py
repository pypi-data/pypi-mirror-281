...
import collibra_catalog_database_registration.models
from collibra_catalog_database_registration import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(collibra_catalog_database_registration.models, klass)
