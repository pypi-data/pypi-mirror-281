...
def paper_2_analysis( directory, output_directory, file_data, data ):
    ...
    for i in sample_mask:
        ...
        features_2 = features[specimen_mask, feature_names.index( "DSC_Cryst" )]
    ...
    for i in sample_mask:
        ...
        features_2 = features[specimen_mask, feature_names.index( "DSC_Cryst_PP" )]
...
def sandbox( directory, output_directory, file_data, data, first_derivative_data, second_derivative_data ):
    ...
    perform_identify_anomalies = True

    perform_paper_2_analysis = False
