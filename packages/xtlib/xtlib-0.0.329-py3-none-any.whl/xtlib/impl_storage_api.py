...
class ImplStorageApi():
    ...
    # COMMAND
    def download(self, store_path, local_path, share, workspace, experiment, job, run, feedback, snapshot, azcopy, show_output=True):
    ...
    # COMMAND
    def upload(self, local_path, store_path, share, workspace, experiment, job, run, feedback, azcopy, show_output=True):
