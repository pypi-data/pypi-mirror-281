...
class ImplStorage(ImplBase):
    ...
    def upload(self, local_path, store_path, share, workspace, experiment, job, run, feedback, azcopy):
        self.impl_storage_api.upload(local_path, store_path, share, workspace, experiment, job, run, feedback, azcopy, show_output=True)
    ...
    def download(self, store_path, local_path, share, workspace, experiment, job, run, feedback, snapshot, azcopy):
        self.impl_storage_api.download(store_path, local_path, share, workspace, experiment, job, run, feedback, snapshot, azcopy, show_output=True)
