...
files_to_download = {
                    ...
                    'pbe.pth': 'https://raw.githubusercontent.com/sxm13/GCNEnergy/main/pth/best_pbe/pbe-atom.pth',
                    'pbe.pkl': 'https://raw.githubusercontent.com/sxm13/GCNEnergy/main/pth/best_pbe/normalizer-pbe.pkl',
                    'bandgap.pth': 'https://raw.githubusercontent.com/sxm13/GCNEnergy/main/pth/best_bandgap/bandgap.pth',
                    'bandgap.pkl': 'https://raw.githubusercontent.com/sxm13/GCNEnergy/main/pth/best_bandgap/normalizer-bandgap.pkl'
                    }
...
def Energy(cif_file):
    ...
    try:
        ...
        checkpoint = torch.load(bandgap_model_name, map_location=torch.device(device))
        x = checkpoint['model_args']
        atom_fea_len = x['atom_fea_len']
        h_fea_len = x['h_fea_len']
        n_conv = x['n_conv']
