...
class WhatsApp:
    ...
    def send_cta_url(
        ...
        """
        Sends a call to action URL message to the specified phone number using the WhatsApp Cloud API.
        ...
        Args:
            ...
            body (str): The body text of the message.
            header (str, optional): The header text to include above the message. Defaults to None.
