...
# Původní credentials pro oogle workspace
...
# přidaná inicializace klienta BigQuery
...
client = bigquery.Client(credentials=credentials, project='data-poc-424211')
...
class Projects:
    ...
    def __init__(self, client: object):
        ...
        :param client: údaje, které slouží k authenizaci v rámci BigQuery
        """
        self.projects = self._get_projects(client)
    ...
    def _get_projects(self, client: object) -> pd.DataFrame:
