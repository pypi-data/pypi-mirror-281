...
class SimpleLLMP:
    ...
    def setup(self, api_key: str, model_version: str = "gpt-4"):
        """
        Setup by inputting an API key and model version.
        
        :param api_key: Your OpenAI API key.
        :param model_version: The model version to use (default is "gpt-4").
        """
    ...
    def generate(self, prompt: str, max_tokens: int = 150, temperature: float = 0.7) -> str:
        """
        Takes in a prompt and returns a string response from the API, with optional parameters for max tokens and temperature.
        
        :param prompt: The prompt to send to the API.
        :param max_tokens: The maximum number of tokens in the response (default is 150).
        :param temperature: The sampling temperature (default is 0.7).
        ...
        try:
            # Include only the provided prompt in the request
    ...
    def fine_tune_model(self, training_file_path: str) -> str:
        ...
        try:
            ...
            fine_tune_response = openai.FineTune.create(training_file=file_id, model=self.model_version)
