    ...
    def fine_tune_model(self, training_file_path: str) -> str:
        ...
        try:
            ...
            with open(training_file_path, 'rb') as f:
                response = self.client.File.create(file=f, purpose='fine-tune')
            file_id = response['id']
            
            # Create a fine-tune job
            fine_tune_response = self.client.FineTune.create(training_file=file_id, model=self.model_version)
