...
class RotationBuilder:
    ...
    def __process_non_dot_follow_up_skill(
        ...
        se_tracker.add_to_status_effects(application_time, skill, SkillModifier(), targets)
    ...
    def __process_all_dots(self, last_event_time):
        ...
        for target, all_follow_up_dot_skills in self._q_dot_skills.items():
            for follow_up_dot_skill in all_follow_up_dot_skills:
                base_dot_times = self.__get_base_dot_timings(target, follow_up_dot_skill)
    ...
    def __process_skill(
        ...
        se_tracker.add_to_status_effects(application_time, skill, skill_modifier, targets)
    ...
    def get_cast_periods(self, speed_status_effects_timeline):
        ...
        while len(q) > 0:
            ...
            se_tracker.add_to_status_effects(t, skill, skill_modifier, targets=(SimConsts.DEFAULT_TARGET))
            job_resource_tracker.add_resource(t, skill, skill_modifier)
        res.sort()
        return res
