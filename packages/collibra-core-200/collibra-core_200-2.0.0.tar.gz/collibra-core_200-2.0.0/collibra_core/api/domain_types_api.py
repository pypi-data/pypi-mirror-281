...
class DomainTypesApi(object):
    ...
    def find_sub_domain_types(self, domain_type_id, domain_type_id, **kwargs):  # noqa: E501
        """Returns sub domain types matching the given search criteria.  # noqa: E501

        Returns sub domain types matching the given search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_sub_domain_types(domain_type_id, domain_type_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.find_sub_domain_types_with_http_info(domain_type_id, domain_type_id, **kwargs)  # noqa: E501
        else:
            (data) = self.find_sub_domain_types_with_http_info(domain_type_id, domain_type_id, **kwargs)  # noqa: E501
            return data

    def find_sub_domain_types_with_http_info(self, domain_type_id, domain_type_id, **kwargs):  # noqa: E501
        """Returns sub domain types matching the given search criteria.  # noqa: E501

        Returns sub domain types matching the given search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_sub_domain_types_with_http_info(domain_type_id, domain_type_id, async_req=True)
        >>> result = thread.get()
