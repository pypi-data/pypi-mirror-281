...
class TimescaleDbReader(AbstractReader):
    ...
    def get_closer_attributes_values(self, attributes, columns=[], time_bound=None, n=1):
        """
        ...
        """
        data = {}
        time_bound = datetime.datetime.now() if time_bound is None else time_bound
