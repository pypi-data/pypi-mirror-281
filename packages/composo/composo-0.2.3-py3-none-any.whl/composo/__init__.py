...
class Composo:
	PERMITTED_RESTART_RATE=3;disable=_B;api_key=_A;auto_bump=_B;version=_A;development_mode=_B;first_link=_E;launch_checks_passed=_A;attempted_start_times=[]
	@staticmethod
	...
	def __call__(self,func):
		...
		def wrapper(*args,**kwargs):
			...
			if not self.launch_checks_passed or self.disable:return func(*args,**kwargs)
		return wrapper
