...
if __name__ == '__main__':
    lng = 128.543
    lat = 37.065
    result1 = Translate.gcj02_to_bd09(lng, lat)
    result2 = Translate.bd09_to_gcj02(lng, lat)
    result3 = Translate.wgs84_to_gcj02(lng, lat)
    result4 = Translate.gcj02_to_wgs84(lng, lat)
    result5 = Translate.bd09_to_wgs84(lng, lat)
    result6 = Translate.wgs84_to_bd09(lng, lat)
