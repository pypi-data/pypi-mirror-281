...
from udo.hljs import get_language, guess_file_traits
from udo.core.shim.paginator_base import EmojiSettings
from udo.core.work.types import ContextA

# Version detection
if discord.version_info >= (2, 0, 0):
    from udo.core.shim.paginator_200 import PaginatorEmbedInterface, PaginatorInterface
else:
    from udo.core.shim.paginator_170 import PaginatorEmbedInterface, PaginatorInterface
