...
class MiscApi(object):
    ...
    def api_serverversion(self, body, **kwargs):  # noqa: E501
        ...
        :param LegacyVersionRequest body: Request must specify a `client_id`. To retrieve your `client_id`, you can do the following: (1) submit a dummy job to Bacalhau (or use one you created before), (2) run `bacalhau describe <job-id>` and fetch the `ClientID` field. (required)
    ...
    def api_serverversion_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LegacyVersionResponse',  # noqa: E501
