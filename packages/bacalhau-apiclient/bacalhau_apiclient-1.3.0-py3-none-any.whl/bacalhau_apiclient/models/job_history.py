...
class JobHistory(object):
    ...
    def __init__(self, comment=None, execution_id=None, execution_state=None, job_id=None, job_state=None, new_revision=None, node_id=None, time=None, type=None):  # noqa: E501
