...
class Spec(object):
    ...
    def __init__(self, annotations=None, deal=None, do_not_track=None, docker=None, engine=None, engine_spec=None, inputs=None, network=None, node_selectors=None, outputs=None, publisher=None, publisher_spec=None, resources=None, timeout=None, wasm=None):  # noqa: E501
