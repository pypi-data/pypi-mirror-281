...
class ConsoleSamlApi(object):
    ...
    def change_certificate(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.change_certificate(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.change_certificate_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.change_certificate_with_http_info(**kwargs)  # noqa: E501
            return data

    def change_certificate_with_http_info(self, **kwargs):  # noqa: E501
        """Changes the certificate to be used with SAML  # noqa: E501

        Replaces the currently used certificate with the one uploaded in PEM format. The PEM file must be unencrypted (no password) and contain both the certificate and the private key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_certificate_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def delete_certificate(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_certificate_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def delete_certificate_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/samlconsole/certificate', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_file1(self, **kwargs):  # noqa: E501
        """Download the saml.xml configuration file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file1(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_file1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_file1_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_file1_with_http_info(self, **kwargs):  # noqa: E501
        """Download the saml.xml configuration file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file1_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def upload_file(self, body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, **kwargs):  # noqa: E501
        """Update the saml.xml configuration by uploading a new file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_file(body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_file_with_http_info(body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_file_with_http_info(body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, **kwargs)  # noqa: E501
            return data

    def upload_file_with_http_info(self, body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, **kwargs):  # noqa: E501
        """Update the saml.xml configuration by uploading a new file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_file_with_http_info(body_parts, content_disposition, entity, fields, headers, media_type, message_body_workers, parameterized_headers, parent, providers, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body_parts', 'content_disposition', 'entity', 'fields', 'headers', 'media_type', 'message_body_workers', 'parameterized_headers', 'parent', 'providers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body_parts' not in params or
            ...
            raise ValueError("Missing the required parameter `body_parts` when calling `upload_file`")  # noqa: E501
        ...
        if ('content_disposition' not in params or
            ...
            raise ValueError("Missing the required parameter `content_disposition` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'entity' is set
        if ('entity' not in params or
                params['entity'] is None):
            raise ValueError("Missing the required parameter `entity` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'fields' is set
        if ('fields' not in params or
                params['fields'] is None):
            raise ValueError("Missing the required parameter `fields` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'headers' is set
        if ('headers' not in params or
                params['headers'] is None):
            raise ValueError("Missing the required parameter `headers` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'media_type' is set
        if ('media_type' not in params or
                params['media_type'] is None):
            raise ValueError("Missing the required parameter `media_type` when calling `upload_file`")  # noqa: E501
        ...
        if ('message_body_workers' not in params or
            ...
            raise ValueError("Missing the required parameter `message_body_workers` when calling `upload_file`")  # noqa: E501
        ...
        if ('parameterized_headers' not in params or
            ...
            raise ValueError("Missing the required parameter `parameterized_headers` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'parent' is set
        if ('parent' not in params or
                params['parent'] is None):
            raise ValueError("Missing the required parameter `parent` when calling `upload_file`")  # noqa: E501
        # verify the required parameter 'providers' is set
        if ('providers' not in params or
                params['providers'] is None):
            raise ValueError("Missing the required parameter `providers` when calling `upload_file`")  # noqa: E501
