...
from collibra_management_console.models.backup_model import BackupModel  # noqa: E501
...
class TestBackupModel(unittest.TestCase):
    ...
    def testBackupModel(self):
        ...
        # model = collibra_management_console.models.backup_model.BackupModel()  # noqa: E501
        pass
