...
from collibra_management_console.models.content_disposition import ContentDisposition  # noqa: E501
...
class TestContentDisposition(unittest.TestCase):
    ...
    def testContentDisposition(self):
        ...
        # model = collibra_management_console.models.content_disposition.ContentDisposition()  # noqa: E501
        pass
