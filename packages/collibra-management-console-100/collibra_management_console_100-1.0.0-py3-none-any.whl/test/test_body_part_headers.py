...
from collibra_management_console.models.body_part_headers import BodyPartHeaders  # noqa: E501
...
class TestBodyPartHeaders(unittest.TestCase):
    ...
    def testBodyPartHeaders(self):
        ...
        # model = collibra_management_console.models.body_part_headers.BodyPartHeaders()  # noqa: E501
        pass
