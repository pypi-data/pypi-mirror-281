...
from collibra_management_console.models.node_configuration import NodeConfiguration  # noqa: E501
...
class TestNodeConfiguration(unittest.TestCase):
    ...
    def testNodeConfiguration(self):
        ...
        # model = collibra_management_console.models.node_configuration.NodeConfiguration()  # noqa: E501
        pass
