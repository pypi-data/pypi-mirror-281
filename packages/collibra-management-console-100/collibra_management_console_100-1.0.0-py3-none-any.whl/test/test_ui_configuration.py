...
from collibra_management_console.models.ui_configuration import UiConfiguration  # noqa: E501
...
class TestUiConfiguration(unittest.TestCase):
    ...
    def testUiConfiguration(self):
        ...
        # model = collibra_management_console.models.ui_configuration.UiConfiguration()  # noqa: E501
        pass
