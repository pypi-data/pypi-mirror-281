...
class TemplateRegistry:
    ...
    def _build_cache_key(self, template_name: str, template_dir: str, package_name: str) -> str:
    ...
    def _load_template(
        ...
        if package_name is not None:
            loader = j2.PackageLoader(package_name=package_name, package_path=template_dir)
        else:
