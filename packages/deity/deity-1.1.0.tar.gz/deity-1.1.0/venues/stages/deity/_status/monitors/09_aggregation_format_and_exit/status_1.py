...
'''
	python3 /deity/venues/stages/deity/_status/status.proc.py "_status/monitors/9_aggregation_format_and_exit/status_1.py"
	python3 /deity/venues/stages/deity/_status/status.proc.py "9_aggregation_format_and_exit/status_1.py"
