...
def main ():
	...
	status_path = os.environ.get ("deity___status_path")
	status_relative_path = os.environ.get ("deity___status_relative_path")
	host = os.environ.get ("deity___harbor_host")
	port = int (os.environ.get ("deity___harbor_port"))
