...
from paracopy import _, __byte_unit_length__, __locale__
from paracopy.src.model.destination import Device, Hub
from paracopy.src.model.source import Source
from paracopy.src.services.copy import CopyPartitionWorker
from paracopy.src.services.destination import DestinationsService
from paracopy.src.services.settings import SettingsService
from paracopy.src.services.source import SourceService
from paracopy.src.services.usb import (
    ComputeOccupiedSpaceWorker,
    UsbMonitorService,
    UsbSizeService,
)
from paracopy.src.view.utils.banners import error_banner, success_banner
from paracopy.src.view.utils.progress import TimerProgressBar
...
class CopyView(ft.Container):
    ...
    def __init__(self) -> None:
        ...
        self.occupied_space_button = ft.ElevatedButton(
            ...
            tooltip=_(
                "Computes the occupied space for each destination currently connected.",
            ),
