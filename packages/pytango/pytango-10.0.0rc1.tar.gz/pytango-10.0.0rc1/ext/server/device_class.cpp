...
void export_device_class()
{
    ...
    class_<CppDeviceClass, std::shared_ptr<CppDeviceClassWrap>, boost::noncopyable>("DeviceClass",
    ...
    ;
    implicitly_convertible<std::shared_ptr<CppDeviceClassWrap>, std::shared_ptr<CppDeviceClass> >();
}
