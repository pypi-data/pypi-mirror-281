...
namespace PyDeviceImpl
{
    ...
    inline dict get_version_info_dict(Tango::DeviceImpl &self)
    {
        dict result;
                                 ...
                                 str &name)
    {
        ...
        if ("state" != name_lower) {
            Tango::Except::throw_exception(
                ...
                "state attribute.", "DeviceImpl::push_alarm_event");
        }
        SAFE_PUSH(self, attr, name)
                                   ...
                                   str &name)
    {
        ...
        if ("state" != name_lower && "status" != name_lower)
        {
            Tango::Except::throw_exception(
                ...
                "state and status attributes.", "DeviceImpl::push_archive_event");
        }
        SAFE_PUSH(self, attr, name)
        attr.set_value_flag(false);
                           ...
                           object &filt_vals)
    {
        ...
        if ("state" != name_lower && "status" != name_lower)
        {
            Tango::Except::throw_exception(
                ...
                "state and status attributes.", "DeviceImpl::push_event");
        }
     ...
     * data ready event
     * **********************************/
    inline void push_data_ready_event(Tango::DeviceImpl &self, const str &name, long ctr)
    {
        SAFE_PUSH(self, attr, name)
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(set_alarm_event_overload,
                                       Tango::DeviceImpl::set_alarm_event, 2, 3)
...
void export_device_impl()
{
    ...
    class_<Tango::DeviceImpl, std::shared_ptr<DeviceImplWrap>, boost::noncopyable>("DeviceImpl",
    ...
    ;
    implicitly_convertible<std::shared_ptr<DeviceImplWrap>, std::shared_ptr<Tango::DeviceImpl> >();
    ...
    class_<Tango::Device_4Impl, std::shared_ptr<Device_4ImplWrap>,
    ...
    implicitly_convertible<std::shared_ptr<Device_4ImplWrap>, std::shared_ptr<Tango::Device_4Impl> >();

    class_<Tango::Device_5Impl, std::shared_ptr<Device_5ImplWrap>,
    ...
    implicitly_convertible<std::shared_ptr<Device_5ImplWrap>, std::shared_ptr<Tango::Device_5Impl> >();

    class_<Tango::Device_6Impl, std::shared_ptr<Device_6ImplWrap>,
           bases<Tango::Device_5Impl>,
           boost::noncopyable>
           ("Device_6Impl",
            init<CppDeviceClass *, const char *,
                 boost::python::optional<const char *, Tango::DevState, const char *> >())
        .def("init_device", pure_virtual(&Tango::Device_6Impl::init_device))
        .def("server_init_hook", &Tango::Device_6Impl::server_init_hook,
             &Device_6ImplWrap::default_server_init_hook)
        .def("delete_device", &Tango::Device_6Impl::delete_device,
            &Device_6ImplWrap::default_delete_device)
        ...
        .def("dev_state", &Tango::Device_6Impl::dev_state,
            &Device_6ImplWrap::default_dev_state)
        .def("dev_status", &Tango::Device_6Impl::dev_status,
            &Device_6ImplWrap::default_dev_status)
        .def("signal_handler", &Tango::Device_6Impl::signal_handler,
            &Device_6ImplWrap::default_signal_handler);
    implicitly_convertible<std::shared_ptr<Device_6ImplWrap>, std::shared_ptr<Tango::Device_6Impl> >();
