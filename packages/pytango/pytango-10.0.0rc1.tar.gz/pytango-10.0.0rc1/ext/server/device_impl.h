...
public:
    ...
    PyDeviceImplBase(PyObject *self):the_self(self){
        Py_INCREF(the_self);
    };
...
class Device_XImplWrap : public TangoDeviceImpl,
                         public PyDeviceImplBase,
                         public boost::python::wrapper<TangoDeviceImpl>
{
public:
    /**
     * Constructor
     ...
     * @param[in] status
     */
    Device_XImplWrap(PyObject *_self, CppDeviceClass *cl, const char *name,
     ...
     * Destructor
     */
    virtual ~Device_XImplWrap(){delete_device();};
    ...
    {
        CALL_DEVICE_METHOD(TangoDeviceImpl, server_init_hook)
    };
    ...
    */
    ...
    {
        CALL_DEVICE_METHOD(TangoDeviceImpl, always_executed_hook)
    };
...
public:
    ...
    Device_3ImplWrap(PyObject *_self, CppDeviceClass *cl, const char *name,
                     const char *_desc = "A Tango device",
                     Tango::DevState sta = Tango::UNKNOWN,
                     const char *status = Tango::StatusNotSet)
...
public:
    ...
    Device_4ImplWrap(PyObject *_self, CppDeviceClass *cl, const char *name,
                     const char *_desc = "A Tango device",
                     Tango::DevState sta = Tango::UNKNOWN,
                     const char *status = Tango::StatusNotSet)
        :Device_XImplWrap(_self, cl, name, _desc, sta, status) {};
...
public:
    ...
    Device_5ImplWrap(PyObject *_self, CppDeviceClass *cl, const char *name,
                     const char *_desc = "A Tango device",
                     Tango::DevState sta = Tango::UNKNOWN,
                     const char *status = Tango::StatusNotSet)
        :Device_XImplWrap(_self, cl, name, _desc, sta, status) {};
...
public:
    ...
    Device_6ImplWrap(PyObject *_self, CppDeviceClass *cl, const char *name,
                     const char *_desc = "A Tango device",
                     Tango::DevState sta = Tango::UNKNOWN,
                     const char *status = Tango::StatusNotSet)
        :Device_XImplWrap(_self, cl, name, _desc, sta, status) {};
