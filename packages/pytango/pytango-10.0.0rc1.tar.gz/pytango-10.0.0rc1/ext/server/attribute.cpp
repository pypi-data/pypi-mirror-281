...
namespace PyAttribute
{
            ...
            bool isImage)
    {
        ...
        data_buffer = fast_python_to_tango_buffer_numpy<tangoTypeConst>(
    ...
    inline void fire_alarm_event(Tango::Attribute &self, object &data)
    {
        bopy::extract<Tango::DevFailed> except_convert(data);
        if (except_convert.check()) {
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(set_alarm_event_overloads,
                                       Tango::Attribute::set_alarm_event, 1, 2);
...
void export_attribute()
{
    ...
    class_<Tango::Attribute>("Attribute", no_init)
        ...
        .def("set_alarm_event", &Tango::Attribute::set_alarm_event,
            set_alarm_event_overloads())
