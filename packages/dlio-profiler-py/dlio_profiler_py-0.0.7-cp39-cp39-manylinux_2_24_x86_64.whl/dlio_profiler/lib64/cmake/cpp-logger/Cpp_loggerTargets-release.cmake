...
set_target_properties(cpp-logger::cpp-logger PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libcpp-logger.so.1.0.0"
  IMPORTED_SONAME_RELEASE "libcpp-logger.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS cpp-logger::cpp-logger )
list(APPEND _IMPORT_CHECK_FILES_FOR_cpp-logger::cpp-logger "${_IMPORT_PREFIX}/lib64/libcpp-logger.so.1.0.0" )
