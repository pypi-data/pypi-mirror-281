...
class JobDetails(BaseModel):
    ...
    __properties = ["id", "category", "key", "created", "started", "finished", "finishedSuccessful", "jobNotificationUids", "additionalInfo", "computeTime", "createdByUser", "childrenIds", "states", "spec"]
