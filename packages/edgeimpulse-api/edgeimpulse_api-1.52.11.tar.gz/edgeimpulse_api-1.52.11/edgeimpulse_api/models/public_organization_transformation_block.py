...
class PublicOrganizationTransformationBlock(BaseModel):
    ...
    __properties = ["id", "ownerOrganizationId", "ownerOrganizationName", "name", "created", "lastUpdated", "description", "operatesOn", "allowExtraCliArguments", "parameters", "parametersUI", "repositoryUrl", "showInDataSources", "showInCreateTransformationJob"]
