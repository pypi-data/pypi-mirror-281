...
class PltCommandArgIds:
    '''The identifiers for PLT command argument type.'''
    
    @classmethod
    @property
    def NUMERICAL(cls) -> PltCommandArgIds:
        '''The numerical type.'''
        ...
    
    @classmethod
    @property
    def STRING(cls) -> PltCommandArgIds:
        '''The string type.'''
        ...
    
    @classmethod
    @property
    def BYTE(cls) -> PltCommandArgIds:
        '''The byte type.'''
        ...
    
    @classmethod
    @property
    def FLAG_BYTE(cls) -> PltCommandArgIds:
        '''The flag byte type.'''
        ...
