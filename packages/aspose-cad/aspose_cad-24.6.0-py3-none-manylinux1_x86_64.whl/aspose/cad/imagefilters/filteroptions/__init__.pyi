...
class DeconvolutionFilterOptions(FilterOptionsBase):
    ...
    def grayscale(self) -> bool:
        '''Gets a value indicating whether this :py:class:`aspose.cad.imagefilters.filteroptions.DeconvolutionFilterOptions` is grayscale.
        Return grayscale mode or RGB mode.'''
        ...
    
    @grayscale.setter
    def grayscale(self, value : bool):
        '''Sets a value indicating whether this :py:class:`aspose.cad.imagefilters.filteroptions.DeconvolutionFilterOptions` is grayscale.
        Return grayscale mode or RGB mode.'''
        ...
