...
class Auth_MS365: # Classe de autenticação de usuários no Microsoft 365
    def __init__(self, client_id, client_secret, tenant_id, grupo, timeout=60, log_file='auth_ms365.log'):
...
class API: # Classe para interação com APIs Rest (especialmente Sienge)
