...
def pp(opt, fastq,log_out):
    ...
    print(cmd)
    os.system(cmd)
    print('fastp time: ' + str(time.time() - t))
    ...
    if os.path.exists(opt['index'] + '/Bisulfite_Genome' ) :
        ...
        print('create bismark index')
        cmd = 'bismark_genome_preparation --bowtie2 ' + opt['index']
        print(cmd)
        os.system(cmd)
        print('bismark_genome_preparation time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('bismark1 time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('bismark3 time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('bismark4 time: ' + str(time.time() - t))
    ...
    t = time.time()
    os.system(cmd)
    print('samtools merge time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('samtools view time: ' + str(time.time() - t))

    print('filtSam')
    t = time.time()
    filtSam(fastq + '.sorted.sam', fastq + '.sam')
    print('filtSam time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('pairtools parse time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('pairtools restrict time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('pairtools select time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('pairtools sort time: ' + str(time.time() - t))
    ...
    print('pairtools dedup time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('gunzip time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('cooler cload time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('gzip time: ' + str(time.time() - t))
    ...
    # print(cmd)
    # os.system(cmd)
    # print('hicCorrectMatrix time: ' + str(time.time() - t))
    ...
    print(cmd)
    os.system(cmd)
    print('cooler zoomify time: ' + str(time.time() - t))
