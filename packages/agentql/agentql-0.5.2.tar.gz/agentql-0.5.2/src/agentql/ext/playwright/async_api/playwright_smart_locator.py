...
async def _get_by_ai(self, query: str, include_aria_hidden: bool = False) -> Union[Locator, None]:
...
"""
    ...
    response = await query_agentql_server(query, accessibility_tree, 300, page.url)
