...
class PlaywrightPage(Page, PageProtocol[Locator]):
    ...
    def _accessibility_tree(self) -> dict:
        try:
            accessibility_tree = get_page_accessibility_tree(self)
            process_iframes(self, accessibility_tree)
    ...
    def _prepare_accessibility_tree(self, include_aria_hidden: bool) -> dict:
        self._original_html = self.content()
    ...
    def wait_for_page_ready_state(self, wait_for_network_idle: bool = True):
        ...
        self._add_event_listeners_for_page_monitor(self)
        ...
        self._remove_event_listeners_for_page_monitor(self)
