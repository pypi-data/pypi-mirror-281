...
class text_core_function:
    def __init__(self, password=1, mode='str', encoding='gbk', length_ran=False, out_of_place=True, ratio=1, output_mod=False):  # gbk编码省空间
...
if __name__ == "__main__":
    with open("../版权.txt", 'r', encoding='utf8') as f:
        text = f.read()
    a = text_core_function(encoding='gbk')
    a.init_emb_func("Bque.jpg", text[ : 2300])
    a.test_info()
