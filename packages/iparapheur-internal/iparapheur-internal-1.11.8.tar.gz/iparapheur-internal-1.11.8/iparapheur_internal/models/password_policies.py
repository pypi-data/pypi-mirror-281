...
class PasswordPolicies(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["minLength", "maxLength", "notUsername", "notEmail", "specialCharsMinCount", "uppercaseCharsMinCount", "lowercaseCharsMinCount", "digitsMinCount"]
