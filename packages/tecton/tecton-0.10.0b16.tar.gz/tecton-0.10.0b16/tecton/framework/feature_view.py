...
class MaterializedFeatureView(FeatureView):
    ...
    def test_run(
        ...
        **mock_inputs: Union[pandas.DataFrame, pyspark_dataframe.DataFrame],
        ...
        with conf._temporary_set("TECTON_VALIDATION_MODE", ValidationMode.SKIP.value), conf._temporary_set(
            "TECTON_REQUIRE_SCHEMA", True
        ):
            return self.run(
                start_time=start_time,
                end_time=end_time,
        ...
        *,
        ...
        if conf.get_bool("TECTON_REQUIRE_SCHEMA"):
            if schema is None and features is None:
                raise errors.SchemaRequired(name)
