...
class FaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: ISSG, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
...
class GlobalFaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    def get_abstract_state_index(self, arg0: State) -> int:
        ...
...
class StateSpace:
    ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: ISSG, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[StateSpace]:
        ...
