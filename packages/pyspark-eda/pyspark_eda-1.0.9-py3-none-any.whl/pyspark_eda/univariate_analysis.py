...
def get_univariate_analysis(df, print_graphs=0, id_list=None):
    ...
    numerical_summary_df = spark.createDataFrame(spark.sql.emptyRDD(), schema=numerical_summary_schema)
    categorical_summary_df = spark.createDataFrame(spark.sql.emptyRDD(), schema=categorical_summary_schema)
