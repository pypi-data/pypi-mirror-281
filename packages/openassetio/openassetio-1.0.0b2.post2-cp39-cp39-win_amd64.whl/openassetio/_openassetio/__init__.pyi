...
from . import trait
from . import utils
__all__ = ['Context', 'EntityReference', 'access', 'betaMajorVersion', 'betaMinorVersion', 'constants', 'errors', 'hostApi', 'log', 'majorVersion', 'managerApi', 'minorVersion', 'patchVersion', 'pluginSystem', 'trait', 'utils', 'versionString']
class Context:
...
class EntityReference:
    ...
    def toString(self) -> str:
        ...
def betaMajorVersion() -> int:
    ...
def betaMinorVersion() -> int:
    ...
