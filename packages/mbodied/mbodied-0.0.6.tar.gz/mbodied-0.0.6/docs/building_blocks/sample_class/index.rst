...
The Sample class is a base model for serializing, recording, and manipulating arbitrary data. It is designed to be extensible, flexible, and strongly typed. By wrapping your observation or action objects in the `Sample <https://github.com/MbodiAI/mbodied/blob/main/mbodied/base/sample.py>`_ class, you'll be able to convert to and from the following with ease:
...
See `sample.py <https://github.com/MbodiAI/mbodied/blob/main/mbodied/base/sample.py>`_ for more details.