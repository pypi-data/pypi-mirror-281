...
from mbodied.agents.backends import AnthropicBackend, OpenAIBackend
...
class Agent:
    ...
    Attributes:
        ...
        remote_actor (Union[OpenAIBackend, AnthropicBackend, GradioClient]): The remote actor to interact with.
