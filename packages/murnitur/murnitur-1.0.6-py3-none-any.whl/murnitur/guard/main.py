...
class Response:
    def __init__(self, text: str, triggered: bool) -> None:
        self.text = text
...
class Guard:
    ...
    def shield(
        ...
        try:
                ...
                for rule in ruleset["rules"]:
                    ...
                    if metric in ("pii", "input_pii"):
                        ...
                        if check_pii(pii_value, operator, rule_value):
                            ...
                            return Response(pii_value, False)
                        ...
                        if detect_tone(tone_value, operator, rule_value):
                            ...
                            return Response(tone_value, False)
                        ...
                        if detect_injection(
                            ...
                            return Response(input_value, False)
            ...
            return Response(payload.get("output", ""), False)
