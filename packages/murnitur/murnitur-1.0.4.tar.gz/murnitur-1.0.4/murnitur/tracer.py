...
def setup_tracing(application_name, environment, tracer, otlp_headers, disable_batch):
    """
        ...
        if not TRACER_SET:
            ...
            resource = Resource(
                attributes={
                    ...
                    TELEMETRY_SDK_NAME: "murnix-trace",
                }
            )
            ...
            os.environ["OTEL_EXPORTER_OTLP_ENDPOINT"] = "https://middleware.murnitur.ai"
