...
{
    "distutils": {
        "name": "nimble.calculate.distance",
        "sources": [
            "nimble\\calculate\\distance.py"
        ]
    },
    "module_name": "nimble.calculate.distance"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nimble__calculate__distance
#define __PYX_HAVE_API__nimble__calculate__distance
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "nimble.calculate.distance" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nimble.calculate.distance"
extern int __pyx_module_is_main_nimble__calculate__distance;
int __pyx_module_is_main_nimble__calculate__distance = 0;

/* Implementation of "nimble.calculate.distance" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_nimble__calculate__distance) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nimble.calculate.distance")) {
      if (unlikely((PyDict_SetItemString(modules, "nimble.calculate.distance", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "nimble/calculate/distance.py":2
 * 
 * ##########################################################################             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nimble.calculate.distance", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nimble.calculate.distance");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
