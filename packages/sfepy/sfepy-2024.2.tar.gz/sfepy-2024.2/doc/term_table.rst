...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`the.ela <multi_physics-thermo_elasticity>`
   * - ev_biot_stress
   ...
   * - dw_convect
     ...
     - :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`
   * - dw_convect_v_grad_s
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio <multi_physics-biot>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`
   ...
   * - dw_div_grad
     ...
     - :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto <navier_stokes-stokes>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`
   * - dw_dot
     ...
     - :ref:`aco <acoustics-acoustics3d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`hyd <quantum-hydrogen>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`wel <quantum-well>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bor <quantum-boron>`, :ref:`osc <quantum-oscillator>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`aco <acoustics-acoustics>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`bal <large_deformation-balloon>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`
   * - ev_integrate
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`sin <diffusion-sinbc>`, :ref:`cub <diffusion-cube>`, :ref:`hyd <quantum-hydrogen>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`wel <quantum-well>`, :ref:`poi <diffusion-poisson>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`bor <quantum-boron>`, :ref:`osc <quantum-oscillator>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`aco <acoustics-acoustics>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio <multi_physics-biot>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`mul.poi.con <linear_elasticity-multi_point_constraints>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`mul.nod.lcb <linear_elasticity-multi_node_lcbcs>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`tru.bri <linear_elasticity-truss_bridge>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sto <navier_stokes-stokes>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`
   * - ev_surface_moment
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`bur.2D <dg-burgers_2D>`
   * - dw_volume_nvf
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`hyp <large_deformation-hyperelastic>`, :ref:`act.fib <large_deformation-active_fibres>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`
   * - dw_tl_he_neohook_ad
