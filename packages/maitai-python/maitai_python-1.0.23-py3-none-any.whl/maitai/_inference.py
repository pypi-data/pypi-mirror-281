...
class Inference(MaitaiClient):
    ...
    def infer(cls, session_id, reference_id, action_type, application_ref_name, completion_params: ChatCompletionParams, apply_corrections: bool, evaluation_enabled: bool, evaluate_callback: EvaluateCallback = None,
        ...
        chat_request: ChatCompletionRequest = cls.create_inference_request(application_ref_name, session_id, reference_id, action_type, apply_corrections, evaluation_enabled, completion_params, evaluate_callback)
    ...
    def create_chat_storage_request(cls, session_id, reference_id, action_type, application_ref_name, completion_params: ChatCompletionParams, chat_completion_response: Optional[ChatCompletionResponse],
        ...
        inference_request = cls.create_inference_request(application_ref_name, session_id, reference_id, action_type, False, False, completion_params, None)
        if final_chunk:
