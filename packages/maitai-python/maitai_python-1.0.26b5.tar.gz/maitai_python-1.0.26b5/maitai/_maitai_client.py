...
class MaitaiClient:
    ...
    @classmethod
    def create_inference_request(cls, application_ref_name, session_id, reference_id, action_type, apply_corrections, evaluation_enabled, completion_params: ChatCompletionParams, callback):
