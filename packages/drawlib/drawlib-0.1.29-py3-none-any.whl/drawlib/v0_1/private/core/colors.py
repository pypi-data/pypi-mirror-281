...
class ColorsBase:
    """Base class for color-related classes, providing common attributes and utilities."""
    ...
    def get_rgba_from_hexcode(hexcode: str, alpha: Optional[float] = None) -> Tuple[int, int, int, float]:
        ...
        try:
            ...
            raise ValueError("Converting hex color code failed. Please check hex format.")
