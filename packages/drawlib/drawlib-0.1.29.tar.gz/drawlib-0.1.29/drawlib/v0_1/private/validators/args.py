        ...
        # save
            ...
            if value is not None:
                ...
                if format not in supported_formats:
                    raise ValueError(f'Save format supports only {supported_formats}. But "{format}" is provided.')
...
def validate_shape_args(args: Dict[str, Any], argnames_accept_none: List[str] = []) -> None:
