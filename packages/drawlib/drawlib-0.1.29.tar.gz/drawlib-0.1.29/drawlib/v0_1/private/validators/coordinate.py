...
def validate_path_points(
    ...
    Args:
        arg_name (str): Name of the argument or attribute being validated.
        value (List[Union[Tuple[float, float], Tuple[Tuple[float, float], Tuple[float, float]], Tuple[Tuple[float, float], Tuple[float, float], Tuple[float, float]]]]): List of path points to validate.
