...
class Theme:
    ...
    def apply_custom_theme(
        ...
        Args:
            ...
            named_styles (List[Tuple[str, Theme.ThemeStyles]], optional): A list of named theme styles.
            ...
            theme_colors (List[Tuple[str, Union[Tuple[int, int, int], Tuple[int, int, int, float]]]], optional):
                A list of theme colors. Each tuple contains a name and a color in the format (R, G, B) or (R, G, B, A). Defaults to [].
