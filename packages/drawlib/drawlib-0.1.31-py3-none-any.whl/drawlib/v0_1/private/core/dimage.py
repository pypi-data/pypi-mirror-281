...
class Dimage:
    ...
    def alpha(self, alpha: float) -> Dimage:
        ...
        Args:
            alpha (float): The alpha value to apply to the image, where 0.0 is fully transparent and 1.0 is fully opaque.
    ...
    def colorize(
        ...
        Args:
            from_black_to (Union[Tuple[int, int, int], Tuple[int, int, int, float]]): The color to map black to.
            from_white_to (Union[Tuple[int, int, int], Tuple[int, int, int, float]]): The color to map white to.
            from_mid_to (Union[Tuple[int, int, int], Tuple[int, int, int, float], None]): The color to map mid-tone to. If None, mid-tones are mapped automatically.
    ...
    def remove_margin(
        ...
        Args:
            margin_color (Union[None, str, Tuple[int, int, int]]): The color of the margin to remove. If None, removes transparent margins.
