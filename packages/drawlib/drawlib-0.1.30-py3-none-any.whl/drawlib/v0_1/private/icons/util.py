...
def icon(
    ...
    Args:
        ...
        angle (Union[int, float], optional): The rotation angle of the icon, ranging from 0.0 to 360.0. Defaults to 0.0.
        style (Union[IconStyle, str, None], optional): The style of the icon, including alignment and other properties. Defaults to None.
