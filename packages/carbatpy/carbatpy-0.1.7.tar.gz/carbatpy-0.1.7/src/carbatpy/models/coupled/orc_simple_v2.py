...
class OrganicRankineCycle:
    ...
    def calc_orc(self,  verbose=False):
        ...
        if evaporator.warning<100:
            self.evaluation[evaporator.name]=[evaporator.dt_min,
                                              evaporator.dt_mean,
                                              evaporator.q_dot,
                                              evaporator.warning]
        else:
        ...
        if condenser_env.warning<100:
            self.evaluation[condenser_env.name]=[condenser_env.dt_min,
                                          condenser_env.dt_mean,
                                          condenser_env.q_dot,
                                          condenser_env.warning]
        else:
        ...
        if condenser.warning<100:
            self.evaluation[condenser.name]=[condenser.dt_min,
                                              condenser.dt_mean,
                                              condenser.q_dot,
                                              condenser.warning]
        else:
        ...
        self.evaluation["Power"] = np.abs(power + power_pump)
