...
_UNIFFI_CALLBACK_INTERFACE_MESSAGE_HANDLER_METHOD0 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,_UniffiRustBuffer,_UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
...
class AgentDefinition:
    ...
    is_leader: "bool"
    def __init__(self, *, id: "typing.Optional[str]" = _DEFAULT, name: "str", position: "str", responsibilities: "typing.List[str]", instructions: "typing.List[str]", is_leader: "bool"):
        if id is _DEFAULT:
            self.id = ""
        else:
            self.id = id
    ...
    def __str__(self):
        return "AgentDefinition(id={}, name={}, position={}, responsibilities={}, instructions={}, is_leader={})".format(self.id, self.name, self.position, self.responsibilities, self.instructions, self.is_leader)
...
class _UniffiConverterTypeAgentDefinition(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return AgentDefinition(
            ...
            is_leader=_UniffiConverterBool.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterBool.check_lower(value.is_leader)
    ...
    def write(value, buf):
        ...
        _UniffiConverterBool.write(value.is_leader, buf)
