...
class ProductionWellPerformance(ApplicationAbstract):
    ...
    def init_parameters(self):
        ...
        reservoir_unit = self.unit.from_units[0].from_units[0]
    ...
    def calculate_dp_top_esp(self):
        ...
        for flow in self.inputs['flow']:
            ...
            u['temperature_ambient'] = self.inputs['soil_temperature']
            u['direction'] = 'down'
    ...
    def calculate_pump_head(self):
        """Function to calculate ESP pump head"""
        u = dict()
        x = []
    ...
    def calculate_pbh_res(self):
        ...
        self.inputs['reservoir_pressure'] = p_res
