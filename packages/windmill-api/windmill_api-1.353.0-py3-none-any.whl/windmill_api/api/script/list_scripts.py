...
def _get_kwargs(
    ...
    *,
    ...
    hide_without_main: Union[Unset, None, bool] = UNSET,
    ...
    params["hide_without_main"] = hide_without_main
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        hide_without_main (Union[Unset, None, bool]):
    ...
    kwargs = _get_kwargs(
        ...
        hide_without_main=hide_without_main,
