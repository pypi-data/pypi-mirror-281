...
setup(
    name='gcardenas_db',
    version='0.6',  # Actualiza la versión aquí
    packages=find_packages(),
    description='Optimización del proceso de carga de datos con procesamiento paralelo',
    long_description="""
    ...
    url='https://github.com/tu_usuario/gcardenas_db',
)
