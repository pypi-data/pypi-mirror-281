...
@dataclass
class ReleaseLink:
    album_key: InitVar[str]
    band_key: InitVar[str]
    release_key: str = field(init=False)

    def __post_init__(self, album_key: str, band_key: str):
        self.release_key = create_key(album_key, band_key)
...
class AlbumProfile:
    ...
    def __post_init__(self, profile_html):
        ...
        self.releases = list(map(lambda n: ReleaseLink(album_key, n.band_key), self.bands))
