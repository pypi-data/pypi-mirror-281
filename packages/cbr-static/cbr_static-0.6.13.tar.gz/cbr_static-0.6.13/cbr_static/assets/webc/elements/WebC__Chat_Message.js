...
export default class WebC__Chat_Message extends Web_Component {
    ...
    edit_message () {
        ...
        text_area.style.width = ($(message_area).width() /1.7 )+ 'px'
        window.aaaa = message_area
    }
    ...
    html() {
        let source = `${this.platform} | ${this.provider} | ${this.model} | ${this.type}`
