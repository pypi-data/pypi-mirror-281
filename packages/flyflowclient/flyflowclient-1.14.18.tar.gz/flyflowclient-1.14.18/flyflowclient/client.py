...
class Flyflow:
    ...
    def upsert_agent(self, name, system_prompt=None, initial_message=None, voice_id=None, llm_model=None, webhook=None, tools=None, filler_words=None, filler_words_whitelist=None, actions=None, voicemail_number=None, chunking=None, endpointing=None, voice_optimization=None, smart_endpointing_threshold=None, multilingual=False):
        payload = {
            'name': name,
