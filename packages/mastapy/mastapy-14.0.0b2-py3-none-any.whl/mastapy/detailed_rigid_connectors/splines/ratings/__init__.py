...
if __tc:
    from mastapy._private.detailed_rigid_connectors.splines.ratings._1469 import (
        AGMA6123SplineHalfRating,
    )
    from mastapy._private.detailed_rigid_connectors.splines.ratings._1470 import (
    ...
    __import_structure = {
        "_private.detailed_rigid_connectors.splines.ratings._1469": [
            "AGMA6123SplineHalfRating"
        ],
        "_private.detailed_rigid_connectors.splines.ratings._1470": [
            "AGMA6123SplineJointRating"
        ],
