...
class PointsWithWorstResults(_0.APIBase):
    ...
    def coefficient_of_friction(
        self: "Self",
    ) -> "_882.CylindricalGearMeshLoadedContactPoint":
    ...
    @property
    def max_pressure(self: "Self") -> "_882.CylindricalGearMeshLoadedContactPoint":
        """mastapy._private.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def max_shear_stress(self: "Self") -> "_882.CylindricalGearMeshLoadedContactPoint":
        """mastapy._private.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def sliding_velocity(self: "Self") -> "_882.CylindricalGearMeshLoadedContactPoint":
        """mastapy._private.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
