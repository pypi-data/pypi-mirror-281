...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.analysis import _1261, _1260, _1254
...
class CylindricalGearMeshLoadDistributionAnalysis(
    ...
    @property
    def cylindrical_mesh_load_case(self: "Self") -> "_907.CylindricalMeshLoadCase":
    ...
    def gear_a_in_mesh(
        self: "Self",
    ) -> "_855.CylindricalMeshedGearLoadDistributionAnalysis":
    ...
    @property
    def mesh_micro_geometry(self: "Self") -> "_1130.CylindricalGearMeshMicroGeometry":
    ...
    def load_distribution_analyses_at_single_rotation(
        self: "Self",
    ) -> "List[_884.CylindricalMeshLoadDistributionAtRotation]":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_855.CylindricalMeshedGearLoadDistributionAnalysis]":
