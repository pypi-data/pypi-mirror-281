...
class _Cast_CylindricalGearMeshLoadedContactLine:
    ...
    def gear_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_866.GearMeshLoadedContactLine":
        return self.__parent__._cast(_866.GearMeshLoadedContactLine)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshLoadedContactLine(_866.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    def loaded_contact_strip_end_points(
        self: "Self",
    ) -> "List[_882.CylindricalGearMeshLoadedContactPoint]":
