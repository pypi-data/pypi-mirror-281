...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _872, _866
...
class _Cast_GearMeshLoadDistributionAtRotation:
    ...
    def cylindrical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_884.CylindricalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.cylindrical import _884

        return self.__parent__._cast(_884.CylindricalMeshLoadDistributionAtRotation)

    @property
    def conical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_894.ConicalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.conical import _894

        return self.__parent__._cast(_894.ConicalMeshLoadDistributionAtRotation)
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    def gear_a_in_mesh(
        self: "Self",
    ) -> "_872.MeshedGearLoadDistributionAnalysisAtRotation":
    ...
    @property
    def loaded_contact_lines(self: "Self") -> "List[_866.GearMeshLoadedContactLine]":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_872.MeshedGearLoadDistributionAnalysisAtRotation]":
