...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _860, _853
...
class _Cast_GearFilletNodeStressResultsRow:
    ...
    def cylindrical_gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_853.CylindricalGearFilletNodeStressResultsRow":
        from mastapy._private.gears.ltca import _853

        return self.__parent__._cast(_853.CylindricalGearFilletNodeStressResultsRow)
