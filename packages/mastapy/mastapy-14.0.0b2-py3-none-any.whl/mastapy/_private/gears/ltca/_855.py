...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.cylindrical import _1249, _1248, _1247, _1246
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def worst_contact_charts(
        self: "Self",
    ) -> "_1249.CylindricalGearWorstLTCAContactCharts":
    ...
    def worst_contact_charts_as_text_files(
        self: "Self",
    ) -> "_1248.CylindricalGearWorstLTCAContactChartDataAsTextFile":
    ...
    @property
    def contact_charts(self: "Self") -> "List[_1247.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: "Self",
    ) -> "List[_1246.CylindricalGearLTCAContactChartDataAsTextFile]":
    ...
    def contact_patch_as_text(
        self: "Self",
        result_type: "_850.ContactResultType",
