...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _848, _851
...
class _Cast_GearFilletNodeStressResults:
    ...
    def conical_gear_fillet_stress_results(
        self: "CastSelf",
    ) -> "_848.ConicalGearFilletStressResults":
        from mastapy._private.gears.ltca import _848

        return self.__parent__._cast(_848.ConicalGearFilletStressResults)

    @property
    def cylindrical_gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_851.CylindricalGearFilletNodeStressResults":
        from mastapy._private.gears.ltca import _851

        return self.__parent__._cast(_851.CylindricalGearFilletNodeStressResults)
