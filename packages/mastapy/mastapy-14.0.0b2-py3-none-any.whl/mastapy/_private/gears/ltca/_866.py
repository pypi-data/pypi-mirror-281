...
class _Cast_GearMeshLoadedContactLine:
    ...
    def cylindrical_gear_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_881.CylindricalGearMeshLoadedContactLine":
        from mastapy._private.gears.ltca.cylindrical import _881

        return self.__parent__._cast(_881.CylindricalGearMeshLoadedContactLine)

    @property
    def conical_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_895.ConicalMeshLoadedContactLine":
        from mastapy._private.gears.ltca.conical import _895

        return self.__parent__._cast(_895.ConicalMeshLoadedContactLine)
...
class GearMeshLoadedContactLine(_0.APIBase):
    ...
    def loaded_contact_strip_end_points(
        self: "Self",
    ) -> "List[_867.GearMeshLoadedContactPoint]":
