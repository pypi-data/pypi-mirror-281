...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _860, _852
...
class _Cast_GearFilletNodeStressResultsColumn:
    ...
    def cylindrical_gear_fillet_node_stress_results_column(
        self: "CastSelf",
    ) -> "_852.CylindricalGearFilletNodeStressResultsColumn":
        from mastapy._private.gears.ltca import _852

        return self.__parent__._cast(_852.CylindricalGearFilletNodeStressResultsColumn)
...
class GearFilletNodeStressResultsColumn(_0.APIBase):
    ...
    @property
    def node_results(self: "Self") -> "List[_860.GearFilletNodeStressResults]":
