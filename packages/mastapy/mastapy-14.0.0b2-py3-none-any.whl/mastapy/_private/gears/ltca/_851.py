...
class _Cast_CylindricalGearFilletNodeStressResults:
    ...
    def gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_860.GearFilletNodeStressResults":
        return self.__parent__._cast(_860.GearFilletNodeStressResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFilletNodeStressResults(_860.GearFilletNodeStressResults):
    """CylindricalGearFilletNodeStressResults
