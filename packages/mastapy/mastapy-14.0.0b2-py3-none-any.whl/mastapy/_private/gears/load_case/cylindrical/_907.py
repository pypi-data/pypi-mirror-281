...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _333, _334
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalMeshLoadCase(_898.MeshLoadCase):
    """CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self: "Self") -> "_334.CylindricalMisalignmentDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._334", "CylindricalMisalignmentDataSource"
        )(value)

    @misalignment_source.setter
    @enforce_parameter_types
    def misalignment_source(
        self: "Self", value: "_334.CylindricalMisalignmentDataSource"
    ) -> None:
