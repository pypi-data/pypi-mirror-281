...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearFlankMicroGeometry(_581.FlankMicroGeometry):
    """ConicalGearFlankMicroGeometry
    ...
    @property
    def bias(self: "Self") -> "_1210.ConicalGearBiasModification":
    ...
    @property
    def lead_relief(self: "Self") -> "_1212.ConicalGearLeadModification":
    ...
    @property
    def profile_relief(self: "Self") -> "_1213.ConicalGearProfileModification":
    ...
    @property
    def gear_design(self: "Self") -> "_1192.ConicalGearDesign":
