...
class _Cast_SingleCylindricalGearTriangularEndModification:
    ...
    def linear_cylindrical_gear_triangular_end_modification(
        self: "CastSelf",
    ) -> "_1151.LinearCylindricalGearTriangularEndModification":
    ...
    def parabolic_cylindrical_gear_triangular_end_modification(
        self: "CastSelf",
    ) -> "_1159.ParabolicCylindricalGearTriangularEndModification":
...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    @property
    def profile_evaluation(self: "Self") -> "_1055.CylindricalGearProfileMeasurement":
    ...
    @property
    def profile_start(self: "Self") -> "_1055.CylindricalGearProfileMeasurement":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
