...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1058, _1071, _1042
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetMicroGeometry(_1269.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def coefficient_of_friction_method_for_ltca(
        ...
        temp = self.wrapped.CoefficientOfFrictionMethodForLTCA
    ...
    @property
    def cylindrical_gear_set_design(self: "Self") -> "_1058.CylindricalGearSetDesign":
    ...
    def cylindrical_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1130.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: "Self", gear_set_design: "_1058.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy._private.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: "Self", gear_set_design: "_1071.CylindricalPlanetaryGearSetDesign"
    ) -> "_1269.GearSetImplementationDetail":
        """mastapy._private.gears.analysis.GearSetImplementationDetail
