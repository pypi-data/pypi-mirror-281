...
class _Cast_ProfileReliefWithDeviation:
    ...
    @property
    def relief_with_deviation(self: "CastSelf") -> "_1165.ReliefWithDeviation":
        return self.__parent__._cast(_1165.ReliefWithDeviation)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ProfileReliefWithDeviation(_1165.ReliefWithDeviation):
    """ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self: "Self") -> "_1055.CylindricalGearProfileMeasurement":
