...
class CylindricalGearMicroGeometrySettings(
    _1633.IndependentReportablePropertiesBase["CylindricalGearMicroGeometrySettings"]
):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    def flank_side_with_zero_face_width(self: "Self") -> "_582.FlankSide":
    ...
    def flank_side_with_zero_face_width(self: "Self", value: "_582.FlankSide") -> None:
