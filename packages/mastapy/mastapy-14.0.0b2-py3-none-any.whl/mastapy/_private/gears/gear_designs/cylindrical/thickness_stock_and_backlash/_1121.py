...
class FinishStockSpecification(
    _1099.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: "Self", value: "_1122.FinishStockType"
    ) -> None:
    ...
    def normal(
        self: "Self",
    ) -> "_1115.TolerancedValueSpecification[FinishStockSpecification]":
