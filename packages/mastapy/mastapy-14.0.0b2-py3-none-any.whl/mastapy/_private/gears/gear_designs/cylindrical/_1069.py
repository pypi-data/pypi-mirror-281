...
class CylindricalMeshedGearFlank(_0.APIBase):
    ...
    def arc_of_approach(self: "Self") -> "float":
        ...
        """
        temp = self.wrapped.ArcOfApproach
    ...
    @property
    def specific_sliding_chart(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @property
    def working_pitch(self: "Self") -> "_1055.CylindricalGearProfileMeasurement":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
