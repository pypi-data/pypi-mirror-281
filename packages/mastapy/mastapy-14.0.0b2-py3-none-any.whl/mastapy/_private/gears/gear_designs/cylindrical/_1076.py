...
class _Cast_FinishToothThicknessDesignSpecification:
    ...
    def tooth_thickness_specification_base(
        self: "CastSelf",
    ) -> "_1118.ToothThicknessSpecificationBase":
        return self.__parent__._cast(_1118.ToothThicknessSpecificationBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FinishToothThicknessDesignSpecification(_1118.ToothThicknessSpecificationBase):
    """FinishToothThicknessDesignSpecification
