...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1023
...
class _Cast_RelativeValuesSpecification:
    ...
    @property
    def backlash_specification(self: "CastSelf") -> "_1023.BacklashSpecification":
        from mastapy._private.gears.gear_designs.cylindrical import _1023

        return self.__parent__._cast(_1023.BacklashSpecification)

    @property
    def finish_stock_specification(
        self: "CastSelf",
    ) -> "_1121.FinishStockSpecification":
        from mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash import (
            _1121,
        )

        return self.__parent__._cast(_1121.FinishStockSpecification)
