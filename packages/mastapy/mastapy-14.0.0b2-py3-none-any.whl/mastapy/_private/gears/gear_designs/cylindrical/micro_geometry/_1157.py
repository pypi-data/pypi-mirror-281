...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    def contact_results(self: "Self", value: "_850.ContactResultType") -> None:
    ...
    @property
    def gear_option(self: "Self") -> "_1144.DrawDefiningGearOrBoth":
    ...
    @gear_option.setter
    @enforce_parameter_types
    def gear_option(self: "Self", value: "_1144.DrawDefiningGearOrBoth") -> None:
