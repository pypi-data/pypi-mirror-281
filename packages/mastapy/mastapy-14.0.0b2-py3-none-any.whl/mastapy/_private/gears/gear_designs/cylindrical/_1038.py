...
class _Cast_CylindricalGearBasicRack:
    ...
    def cylindrical_gear_abstract_rack(
        self: "CastSelf",
    ) -> "_1036.CylindricalGearAbstractRack":
        return self.__parent__._cast(_1036.CylindricalGearAbstractRack)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearBasicRack(_1036.CylindricalGearAbstractRack):
    """CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self: "Self") -> "_1024.BasicRackProfiles":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1024", "BasicRackProfiles"
        )(value)

    @basic_rack_profile.setter
    @enforce_parameter_types
    def basic_rack_profile(self: "Self", value: "_1024.BasicRackProfiles") -> None:
    ...
    def proportional_method_for_tip_clearance(
        self: "Self",
    ) -> "_1113.TipAlterationCoefficientMethod":
    ...
    @enforce_parameter_types
    def proportional_method_for_tip_clearance(
        self: "Self", value: "_1113.TipAlterationCoefficientMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TipAlterationCoefficientMethod",
