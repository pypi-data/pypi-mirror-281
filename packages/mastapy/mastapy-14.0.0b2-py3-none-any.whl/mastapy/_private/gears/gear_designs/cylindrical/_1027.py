...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1028, _1029
...
class _Cast_CrossedAxisCylindricalGearPair:
    ...
    def crossed_axis_cylindrical_gear_pair_line_contact(
        self: "CastSelf",
    ) -> "_1028.CrossedAxisCylindricalGearPairLineContact":
        from mastapy._private.gears.gear_designs.cylindrical import _1028

        return self.__parent__._cast(_1028.CrossedAxisCylindricalGearPairLineContact)
    ...
    def crossed_axis_cylindrical_gear_pair_point_contact(
        ...
        return self.__parent__._cast(_1029.CrossedAxisCylindricalGearPairPointContact)
...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self: "Self") -> "_755.CylindricalCutterSimulatableGear":
