...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1067, _1070
...
class _Cast_TolerancedValueSpecification:
    ...
    def relative_measurement_view_model(
        self: "CastSelf",
    ) -> "_1098.RelativeMeasurementViewModel":
        return self.__parent__._cast(_1098.RelativeMeasurementViewModel)

    @property
    def cylindrical_mesh_angular_backlash(
        self: "CastSelf",
    ) -> "_1067.CylindricalMeshAngularBacklash":
        from mastapy._private.gears.gear_designs.cylindrical import _1067

        return self.__parent__._cast(_1067.CylindricalMeshAngularBacklash)

    @property
    def cylindrical_mesh_linear_backlash_specification(
        self: "CastSelf",
    ) -> "_1070.CylindricalMeshLinearBacklashSpecification":
        from mastapy._private.gears.gear_designs.cylindrical import _1070

        return self.__parent__._cast(_1070.CylindricalMeshLinearBacklashSpecification)

    @property
    def nominal_value_specification(
        self: "CastSelf",
    ) -> "_1123.NominalValueSpecification":
        from mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash import (
            _1123,
        )

        return self.__parent__._cast(_1123.NominalValueSpecification)

    @property
    def no_value_specification(self: "CastSelf") -> "_1124.NoValueSpecification":
        from mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash import (
            _1124,
        )

        return self.__parent__._cast(_1124.NoValueSpecification)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TolerancedValueSpecification(_1098.RelativeMeasurementViewModel[T]):
    """TolerancedValueSpecification
