...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.worm import _981, _982
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetDesign(_974.GearSetDesign):
    """WormGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_981.WormGearDesign]":
    ...
    @property
    def worm_meshes(self: "Self") -> "List[_982.WormGearMeshDesign]":
