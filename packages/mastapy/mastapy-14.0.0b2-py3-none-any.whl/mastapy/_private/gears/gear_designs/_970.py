...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1888
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignConstraintsCollection(_1879.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: "Self",
    ) -> "List[_1888.DeletableCollectionMember[_968.DesignConstraint]]":
