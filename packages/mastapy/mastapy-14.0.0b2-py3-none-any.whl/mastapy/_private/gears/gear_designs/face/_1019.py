...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetDesign(_974.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: "Self") -> "_1021.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: "Self") -> "_1018.FaceGearPinionDesign":
    ...
    @property
    def gears(self: "Self") -> "List[_1013.FaceGearDesign]":
    ...
    @property
    def face_gears(self: "Self") -> "List[_1013.FaceGearDesign]":
        """List[mastapy._private.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: "Self") -> "List[_1015.FaceGearMeshDesign]":
