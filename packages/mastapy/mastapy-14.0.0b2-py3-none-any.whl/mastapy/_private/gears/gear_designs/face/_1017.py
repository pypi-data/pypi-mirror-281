...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMicroGeometry(_1259.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: "Self") -> "_1013.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: "Self") -> "_1133.CylindricalGearMicroGeometryBase":
