...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1020, _1015, _1017
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshMicroGeometry(_1263.GearMeshImplementationDetail):
    """FaceGearMeshMicroGeometry
    ...
    @property
    def face_gear_set_micro_geometry(self: "Self") -> "_1020.FaceGearSetMicroGeometry":
    ...
    @property
    def face_mesh(self: "Self") -> "_1015.FaceGearMeshDesign":
    ...
    @property
    def face_gear_micro_geometries(self: "Self") -> "List[_1017.FaceGearMicroGeometry]":
