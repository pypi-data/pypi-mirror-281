...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel_diff import _989, _990
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetDesign(_1220.BevelGearSetDesign):
    """StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_989.StraightBevelDiffGearDesign]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_990.StraightBevelDiffGearMeshDesign]":
