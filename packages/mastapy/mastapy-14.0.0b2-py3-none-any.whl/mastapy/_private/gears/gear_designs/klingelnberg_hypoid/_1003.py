...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.klingelnberg_hypoid import _1001, _1002
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: "Self") -> "List[_1001.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_conical_meshes(
        self: "Self",
    ) -> "List[_1002.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
