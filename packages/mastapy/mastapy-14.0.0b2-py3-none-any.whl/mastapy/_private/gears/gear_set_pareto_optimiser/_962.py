...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetParetoOptimiser(_935.GearSetParetoOptimiser):
    """SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_995.SpiralBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_995.SpiralBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_995.SpiralBevelGearSetDesign]":
        """List[mastapy._private.gears.gear_designs.spiral_bevel.SpiralBevelGearSetDesign]
