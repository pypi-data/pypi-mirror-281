...
from mastapy._private.gears.gear_set_pareto_optimiser import _927, _940
...
class _Cast_MicroGeometryDesignSpaceSearchChartInformation:
    ...
    @property
    def chart_info_base(self: "CastSelf") -> "_927.ChartInfoBase":
        return self.__parent__._cast(_927.ChartInfoBase)
...
class MicroGeometryDesignSpaceSearchChartInformation(
    ...
    @property
    def optimiser(self: "Self") -> "_939.MicroGeometryDesignSpaceSearch":
