...
from mastapy._private.gears.gear_set_pareto_optimiser import _929, _934
...
class _Cast_GearSetParetoOptimiser:
    ...
    @property
    def design_space_search_base(self: "CastSelf") -> "_929.DesignSpaceSearchBase":
        return self.__parent__._cast(_929.DesignSpaceSearchBase)
...
class GearSetParetoOptimiser(
    _929.DesignSpaceSearchBase[
        _365.AbstractGearSetRating, _934.GearSetOptimiserCandidate
    ]
):
    """GearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_974.GearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_974.GearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_974.GearSetDesign]":
        """List[mastapy._private.gears.gear_designs.GearSetDesign]
