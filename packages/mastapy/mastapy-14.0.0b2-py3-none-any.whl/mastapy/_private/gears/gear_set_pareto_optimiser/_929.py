...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1595, _1592, _1587
...
class _Cast_DesignSpaceSearchBase:
    ...
    def cylindrical_gear_set_pareto_optimiser(
        self: "CastSelf",
    ) -> "_928.CylindricalGearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _928

        return self.__parent__._cast(_928.CylindricalGearSetParetoOptimiser)

    @property
    def face_gear_set_pareto_optimiser(
        self: "CastSelf",
    ) -> "_931.FaceGearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _931

        return self.__parent__._cast(_931.FaceGearSetParetoOptimiser)

    @property
    def gear_set_pareto_optimiser(self: "CastSelf") -> "_935.GearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _935

        return self.__parent__._cast(_935.GearSetParetoOptimiser)

    @property
    def hypoid_gear_set_pareto_optimiser(
        self: "CastSelf",
    ) -> "_936.HypoidGearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _936

        return self.__parent__._cast(_936.HypoidGearSetParetoOptimiser)

    @property
    def micro_geometry_design_space_search(
        self: "CastSelf",
    ) -> "_939.MicroGeometryDesignSpaceSearch":
        from mastapy._private.gears.gear_set_pareto_optimiser import _939

        return self.__parent__._cast(_939.MicroGeometryDesignSpaceSearch)

    @property
    def micro_geometry_gear_set_design_space_search(
        self: "CastSelf",
    ) -> "_943.MicroGeometryGearSetDesignSpaceSearch":
        from mastapy._private.gears.gear_set_pareto_optimiser import _943

        return self.__parent__._cast(_943.MicroGeometryGearSetDesignSpaceSearch)

    @property
    def spiral_bevel_gear_set_pareto_optimiser(
        self: "CastSelf",
    ) -> "_962.SpiralBevelGearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _962

        return self.__parent__._cast(_962.SpiralBevelGearSetParetoOptimiser)

    @property
    def straight_bevel_gear_set_pareto_optimiser(
        self: "CastSelf",
    ) -> "_963.StraightBevelGearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _963

        return self.__parent__._cast(_963.StraightBevelGearSetParetoOptimiser)
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @enforce_parameter_types
    def display_candidates(self: "Self", value: "_926.CandidateDisplayChoice") -> None:
    ...
    @property
    def remove_candidates_with(self: "Self") -> "_938.LargerOrSmaller":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_set_pareto_optimiser._938", "LargerOrSmaller"
        )(value)

    @remove_candidates_with.setter
    @enforce_parameter_types
    def remove_candidates_with(self: "Self", value: "_938.LargerOrSmaller") -> None:
    ...
    def chart_details(
        self: "Self",
    ) -> "List[_927.ChartInfoBase[TAnalysis, TCandidate]]":
    ...
    @property
    def filters(self: "Self") -> "List[_1592.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: "Self") -> "List[_1587.InputSetter[TAnalysis]]":
    ...
    def optimisation_targets(
        self: "Self",
    ) -> "List[_946.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: "Self",
    ) -> "List[_961.ReasonsForInvalidDesigns]":
