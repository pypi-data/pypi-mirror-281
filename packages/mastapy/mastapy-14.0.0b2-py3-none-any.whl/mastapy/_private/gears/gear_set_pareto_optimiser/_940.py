...
class _Cast_MicroGeometryDesignSpaceSearchCandidate:
    ...
    def design_space_search_candidate_base(
        self: "CastSelf",
    ) -> "_930.DesignSpaceSearchCandidateBase":
        pass

        return self.__parent__._cast(_930.DesignSpaceSearchCandidateBase)
...
class MicroGeometryDesignSpaceSearchCandidate(
    ...
    @property
    def candidate(self: "Self") -> "_883.CylindricalGearSetLoadDistributionAnalysis":
    ...
    @property
    def candidate_for_slider(self: "Self") -> "_1139.CylindricalGearSetMicroGeometry":
