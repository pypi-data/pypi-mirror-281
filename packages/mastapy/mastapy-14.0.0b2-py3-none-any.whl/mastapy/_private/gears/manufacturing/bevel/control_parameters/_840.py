...
class _Cast_ConicalGearManufacturingControlParameters:
    ...
    def conical_manufacturing_sgm_control_parameters(
        self: "CastSelf",
    ) -> "_841.ConicalManufacturingSGMControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _841

        return self.__parent__._cast(_841.ConicalManufacturingSGMControlParameters)

    @property
    def conical_manufacturing_sgt_control_parameters(
        self: "CastSelf",
    ) -> "_842.ConicalManufacturingSGTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _842

        return self.__parent__._cast(_842.ConicalManufacturingSGTControlParameters)

    @property
    def conical_manufacturing_smt_control_parameters(
        self: "CastSelf",
    ) -> "_843.ConicalManufacturingSMTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _843

        return self.__parent__._cast(_843.ConicalManufacturingSMTControlParameters)
