...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.control_parameters import _840
...
class _Cast_ConicalMeshFlankManufacturingConfig:
    ...
    def conical_mesh_flank_micro_geometry_config(
        self: "CastSelf",
    ) -> "_805.ConicalMeshFlankMicroGeometryConfig":
        return self.__parent__._cast(_805.ConicalMeshFlankMicroGeometryConfig)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalMeshFlankManufacturingConfig(_805.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    def control_parameters(
        self: "Self",
    ) -> "_840.ConicalGearManufacturingControlParameters":
    ...
    def specified_phoenix_style_machine_settings(
        self: "Self",
    ) -> "_846.BasicConicalGearMachineSettingsGenerated":
