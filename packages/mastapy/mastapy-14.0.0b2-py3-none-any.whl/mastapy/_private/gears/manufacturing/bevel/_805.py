...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _804, _806
...
class _Cast_ConicalMeshFlankMicroGeometryConfig:
    ...
    def conical_mesh_flank_manufacturing_config(
        ...
        from mastapy._private.gears.manufacturing.bevel import _804

        return self.__parent__._cast(_804.ConicalMeshFlankManufacturingConfig)
    ...
    def conical_mesh_flank_nurbs_micro_geometry_config(
        ...
        return self.__parent__._cast(_806.ConicalMeshFlankNURBSMicroGeometryConfig)
