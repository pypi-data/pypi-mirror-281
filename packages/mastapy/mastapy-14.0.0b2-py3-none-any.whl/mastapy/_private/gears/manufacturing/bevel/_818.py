...
from mastapy._private.gears.manufacturing.bevel import _795
...
class _Cast_EaseOffBasedTCA:
    ...
    @property
    def abstract_tca(self: "CastSelf") -> "_795.AbstractTCA":
        return self.__parent__._cast(_795.AbstractTCA)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class EaseOffBasedTCA(_795.AbstractTCA):
    """EaseOffBasedTCA
