...
from mastapy._private.gears.gear_designs.conical import _1195, _1196
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _799, _808
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalSetManufacturingConfig(_816.ConicalSetMicroGeometryConfigBase):
    """ConicalSetManufacturingConfig
    ...
    def gear_manufacturing_configurations(
        self: "Self",
    ) -> "List[_799.ConicalGearManufacturingConfig]":
    ...
    @property
    def meshes(self: "Self") -> "List[_808.ConicalMeshManufacturingConfig]":
