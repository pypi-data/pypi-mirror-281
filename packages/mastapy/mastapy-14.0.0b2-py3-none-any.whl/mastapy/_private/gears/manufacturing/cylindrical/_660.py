...
class _Cast_ProfileModificationSegment:
    ...
    @property
    def modification_segment(self: "CastSelf") -> "_659.ModificationSegment":
        return self.__parent__._cast(_659.ModificationSegment)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ProfileModificationSegment(_659.ModificationSegment):
    """ProfileModificationSegment
