...
from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _754
...
class _Cast_RackSimulationCalculator:
    ...
    @property
    def cutter_simulation_calc(self: "CastSelf") -> "_754.CutterSimulationCalc":
        return self.__parent__._cast(_754.CutterSimulationCalc)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RackSimulationCalculator(_754.CutterSimulationCalc):
    """RackSimulationCalculator
