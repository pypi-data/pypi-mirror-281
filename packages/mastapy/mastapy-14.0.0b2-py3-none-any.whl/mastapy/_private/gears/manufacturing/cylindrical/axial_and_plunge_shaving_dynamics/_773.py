...
class _Cast_AxialShaverRedressing:
    ...
    @property
    def shaver_redressing(self: "CastSelf") -> "_787.ShaverRedressing":
        return self.__parent__._cast(_787.ShaverRedressing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialShaverRedressing(_787.ShaverRedressing[_774.ConventionalShavingDynamics]):
    """AxialShaverRedressing
