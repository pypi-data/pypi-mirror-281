...
class _Cast_ProcessSimulationInput:
    ...
    def hobbing_process_simulation_input(
        self: "CastSelf",
    ) -> "_695.HobbingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _695,
        )

        return self.__parent__._cast(_695.HobbingProcessSimulationInput)

    @property
    def worm_grinding_process_simulation_input(
        self: "CastSelf",
    ) -> "_722.WormGrindingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _722,
        )

        return self.__parent__._cast(_722.WormGrindingProcessSimulationInput)
...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def analysis_setting(self: "Self") -> "_682.AnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new._682",
            "AnalysisMethod",
        )(value)

    @analysis_setting.setter
    @enforce_parameter_types
    def analysis_setting(self: "Self", value: "_682.AnalysisMethod") -> None:
    ...
    def centre_distance_offset_specification_method(
        self: "Self",
    ) -> "_686.CentreDistanceOffsetMethod":
    ...
    @enforce_parameter_types
    def centre_distance_offset_specification_method(
        self: "Self", value: "_686.CentreDistanceOffsetMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod",
    ...
    @property
    def cutter_head_slide_error(self: "Self") -> "_687.CutterHeadSlideError":
    ...
    @property
    def cutter_mounting_error(self: "Self") -> "_713.RackMountingError":
    ...
    @property
    def gear_mounting_error(self: "Self") -> "_688.GearMountingError":
