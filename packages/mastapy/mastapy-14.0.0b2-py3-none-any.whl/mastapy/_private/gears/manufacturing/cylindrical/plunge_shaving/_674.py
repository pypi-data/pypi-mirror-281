...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _666
...
class _Cast_PlungeShaverOutputs:
    ...
    @property
    def real_plunge_shaver_outputs(self: "CastSelf") -> "_677.RealPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _677

        return self.__parent__._cast(_677.RealPlungeShaverOutputs)

    @property
    def virtual_plunge_shaver_outputs(
        self: "CastSelf",
    ) -> "_680.VirtualPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _680

        return self.__parent__._cast(_680.VirtualPlungeShaverOutputs)
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    def chart(self: "Self", value: "_666.ChartType") -> None:
    ...
    @enforce_parameter_types
    def selected_flank(self: "Self", value: "_650.Flank") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def calculation_details(self: "Self") -> "_672.PlungeShaverGeneration":
