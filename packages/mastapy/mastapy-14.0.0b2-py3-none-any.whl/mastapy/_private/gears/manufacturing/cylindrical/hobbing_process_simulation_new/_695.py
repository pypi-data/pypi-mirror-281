...
class _Cast_HobbingProcessSimulationInput:
    ...
    @property
    def process_simulation_input(self: "CastSelf") -> "_708.ProcessSimulationInput":
        return self.__parent__._cast(_708.ProcessSimulationInput)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobbingProcessSimulationInput(_708.ProcessSimulationInput):
    """HobbingProcessSimulationInput
    ...
    def process_method(self: "Self", value: "_681.ActiveProcessMethod") -> None:
    ...
    @property
    def hob_manufacture_error(self: "Self") -> "_699.HobManufactureError":
    ...
    @property
    def hob_resharpening_error(self: "Self") -> "_700.HobResharpeningError":
