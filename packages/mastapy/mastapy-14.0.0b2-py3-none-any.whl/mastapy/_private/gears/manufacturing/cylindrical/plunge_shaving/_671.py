...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self: "Self") -> "_343.Hand":
    ...
    @shaver_hand.setter
    @enforce_parameter_types
    def shaver_hand(self: "Self", value: "_343.Hand") -> None:
    ...
    @property
    def input_gear_geometry(self: "Self") -> "_755.CylindricalCutterSimulatableGear":
