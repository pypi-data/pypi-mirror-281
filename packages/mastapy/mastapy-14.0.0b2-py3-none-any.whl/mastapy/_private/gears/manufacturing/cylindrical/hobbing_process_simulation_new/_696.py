...
class _Cast_HobbingProcessSimulationNew:
    ...
    @property
    def process_simulation_new(self: "CastSelf") -> "_709.ProcessSimulationNew":
        return self.__parent__._cast(_709.ProcessSimulationNew)
...
class HobbingProcessSimulationNew(
    _709.ProcessSimulationNew[_695.HobbingProcessSimulationInput]
):
    """HobbingProcessSimulationNew
