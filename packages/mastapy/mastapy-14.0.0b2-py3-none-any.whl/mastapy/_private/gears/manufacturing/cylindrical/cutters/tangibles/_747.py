...
from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _746
...
class _Cast_CylindricalGearFormedWheelGrinderTangible:
    ...
    @property
    def cutter_shape_definition(self: "CastSelf") -> "_746.CutterShapeDefinition":
        return self.__parent__._cast(_746.CutterShapeDefinition)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFormedWheelGrinderTangible(_746.CutterShapeDefinition):
    """CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self: "Self") -> "_730.CylindricalGearFormGrindingWheel":
