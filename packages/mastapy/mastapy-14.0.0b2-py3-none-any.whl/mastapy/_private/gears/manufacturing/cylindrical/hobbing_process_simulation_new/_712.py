...
class _Cast_RackManufactureError:
    ...
    @property
    def hob_manufacture_error(self: "CastSelf") -> "_699.HobManufactureError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _699,
        )

        return self.__parent__._cast(_699.HobManufactureError)
    ...
    def worm_grinder_manufacture_error(
        ...
        return self.__parent__._cast(_714.WormGrinderManufactureError)
