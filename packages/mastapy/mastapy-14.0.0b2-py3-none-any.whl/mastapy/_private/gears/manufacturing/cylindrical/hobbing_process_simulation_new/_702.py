...
class _Cast_MountingError:
    ...
    @property
    def gear_mounting_error(self: "CastSelf") -> "_688.GearMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _688,
        )

        return self.__parent__._cast(_688.GearMountingError)

    @property
    def rack_mounting_error(self: "CastSelf") -> "_713.RackMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _713,
        )

        return self.__parent__._cast(_713.RackMountingError)
