...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.agma_gleason_conical import _1230
...
class _Cast_AccuracyGrades:
    ...
    @property
    def agma20151_accuracy_grades(self: "CastSelf") -> "_1171.AGMA20151AccuracyGrades":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1171,
        )

        return self.__parent__._cast(_1171.AGMA20151AccuracyGrades)
    ...
    def cylindrical_accuracy_grades(
        ...
        return self.__parent__._cast(_1176.CylindricalAccuracyGrades)

    @property
    def iso1328_accuracy_grades(self: "CastSelf") -> "_1182.ISO1328AccuracyGrades":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1182,
        )

        return self.__parent__._cast(_1182.ISO1328AccuracyGrades)

    @property
    def agma_gleason_conical_accuracy_grades(
        self: "CastSelf",
    ) -> "_1230.AGMAGleasonConicalAccuracyGrades":
        from mastapy._private.gears.gear_designs.agma_gleason_conical import _1230

        return self.__parent__._cast(_1230.AGMAGleasonConicalAccuracyGrades)
