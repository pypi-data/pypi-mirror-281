...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.zerol_bevel import _381, _380
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetRating(_567.BevelGearSetRating):
    """ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_gear_ratings(self: "Self") -> "List[_381.ZerolBevelGearRating]":
    ...
    @property
    def zerol_bevel_mesh_ratings(self: "Self") -> "List[_380.ZerolBevelGearMeshRating]":
