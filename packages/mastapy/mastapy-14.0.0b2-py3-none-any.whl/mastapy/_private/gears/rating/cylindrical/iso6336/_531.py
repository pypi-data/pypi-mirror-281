...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _487, _492, _493, _470, _478
    from mastapy._private.gears.gear_designs.cylindrical import _1105
    from mastapy._private.gears.rating.cylindrical.iso6336 import _525, _530, _523, _527
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def scuffing_temperature_method(
        self: "Self",
    ) -> "_1105.ScuffingTemperatureMethodsISO":
    ...
    def sorted_micro_pitting_results(
        self: "Self",
    ) -> "_470.CylindricalGearMicroPittingResults":
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_530.ISO6336AbstractMetalGearSingleFlankRating]":
