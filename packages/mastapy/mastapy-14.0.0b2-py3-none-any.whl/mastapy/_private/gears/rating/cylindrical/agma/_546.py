...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1057, _1104
    from mastapy._private.gears.rating.cylindrical.agma import _548, _545
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMA2101MeshSingleFlankRating(_478.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    def scuffing_temperature_method(
        self: "Self",
    ) -> "_1104.ScuffingTemperatureMethodsAGMA":
    ...
    def thermal_reduction_factor_factors_and_exponents(
        self: "Self",
    ) -> "_548.ThermalReductionFactorFactorsAndExponents":
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_545.AGMA2101GearSingleFlankRating]":
