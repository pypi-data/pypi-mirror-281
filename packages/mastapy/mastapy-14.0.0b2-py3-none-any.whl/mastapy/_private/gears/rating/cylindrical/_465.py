...
from mastapy._private.gears.rating.cylindrical import _492, _493
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _354, _325
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDesignAndRatingSettingsItem(_1879.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def agma_quality_grade_type(self: "Self") -> "_354.QualityGradeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._354", "QualityGradeTypes"
        )(value)

    @agma_quality_grade_type.setter
    @enforce_parameter_types
    def agma_quality_grade_type(self: "Self", value: "_354.QualityGradeTypes") -> None:
    ...
    @property
    def agma_tolerances_standard(self: "Self") -> "_325.AGMAToleranceStandard":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._325", "AGMAToleranceStandard"
        )(value)

    @agma_tolerances_standard.setter
    @enforce_parameter_types
    def agma_tolerances_standard(
        self: "Self", value: "_325.AGMAToleranceStandard"
    ) -> None:
    ...
    def chosen_tooth_thickness_for_bending_strength(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._498", "ToothThicknesses"
        )(value)

    @chosen_tooth_thickness_for_bending_strength.setter
    @enforce_parameter_types
    def chosen_tooth_thickness_for_bending_strength(
        self: "Self", value: "_498.ToothThicknesses"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def dynamic_factor_method(self: "Self") -> "_483.DynamicFactorMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._483", "DynamicFactorMethods"
        )(value)

    @dynamic_factor_method.setter
    @enforce_parameter_types
    def dynamic_factor_method(self: "Self", value: "_483.DynamicFactorMethods") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def film_thickness_equation_for_scuffing(self: "Self") -> "_494.ScuffingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._494", "ScuffingMethods"
        )(value)

    @film_thickness_equation_for_scuffing.setter
    @enforce_parameter_types
    def film_thickness_equation_for_scuffing(
        self: "Self", value: "_494.ScuffingMethods"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def gear_blank_factor_calculation_option(
        self: "Self",
    ) -> "_484.GearBlankFactorCalculationOptions":
    ...
    @enforce_parameter_types
    def gear_blank_factor_calculation_option(
        self: "Self", value: "_484.GearBlankFactorCalculationOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.GearBlankFactorCalculationOptions",
    ...
    def iso_tolerances_standard(
        self: "Self",
        value: "Union[_344.ISOToleranceStandard, Tuple[_344.ISOToleranceStandard, bool]]",
    ) -> None:
    ...
    @property
    def micropitting_rating_method(self: "Self") -> "_487.MicropittingRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._487", "MicropittingRatingMethod"
        )(value)

    @micropitting_rating_method.setter
    @enforce_parameter_types
    def micropitting_rating_method(
        self: "Self", value: "_487.MicropittingRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def permissible_bending_stress_method(self: "Self") -> "_490.RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._490", "RatingMethod"
        )(value)

    @permissible_bending_stress_method.setter
    @enforce_parameter_types
    def permissible_bending_stress_method(
        self: "Self", value: "_490.RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def rating_method(self: "Self", value: "_262.CylindricalGearRatingMethods") -> None:
    ...
    @enforce_parameter_types
    def scuffing_rating_method_flash_temperature_method(
        self: "Self", value: "_492.ScuffingFlashTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def scuffing_rating_method_integral_temperature_method(
        self: "Self", value: "_493.ScuffingIntegralTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def tip_relief_in_scuffing_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._497", "TipReliefScuffingOptions"
        )(value)

    @tip_relief_in_scuffing_calculation.setter
    @enforce_parameter_types
    def tip_relief_in_scuffing_calculation(
        self: "Self", value: "_497.TipReliefScuffingOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tolerance_rounding_system(self: "Self") -> "_1654.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.units_and_measurements._1654", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(
        self: "Self", value: "_1654.MeasurementSystem"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def vdi_rating_geometry_calculation_method(
        self: "Self",
        value: "Union[_262.CylindricalGearRatingMethods, Tuple[_262.CylindricalGearRatingMethods, bool]]",
    ) -> None:
        wrapper_type = (
