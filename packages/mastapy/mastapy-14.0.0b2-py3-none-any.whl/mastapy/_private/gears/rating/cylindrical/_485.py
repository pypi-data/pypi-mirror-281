...
class _Cast_ISOScuffingResultsRow:
    ...
    @property
    def scuffing_results_row(self: "CastSelf") -> "_495.ScuffingResultsRow":
        return self.__parent__._cast(_495.ScuffingResultsRow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISOScuffingResultsRow(_495.ScuffingResultsRow):
    """ISOScuffingResultsRow
