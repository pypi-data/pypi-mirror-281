...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _514, _515
...
T = TypeVar("T", bound="_515.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    def results(self: "Self") -> "_514.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: "Self",
    ) -> "_514.SafetyFactorOptimisationResults[T]":
        """mastapy._private.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
