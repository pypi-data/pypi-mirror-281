...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _519, _520, _526, _528
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO63362006GearSingleFlankRating(_530.ISO6336AbstractMetalGearSingleFlankRating):
    """ISO63362006GearSingleFlankRating
    ...
    def tooth_fatigue_fracture_results(
        self: "Self",
    ) -> "_519.CylindricalGearToothFatigueFractureResults":
    ...
    def tooth_fatigue_fracture_results_according_to_french_proposal(
        self: "Self",
    ) -> "_520.CylindricalGearToothFatigueFractureResultsN1457":
