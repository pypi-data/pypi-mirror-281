...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _467, _468
...
class _Cast_GearFlankRating:
    ...
    def cylindrical_gear_flank_duty_cycle_rating(
        self: "CastSelf",
    ) -> "_467.CylindricalGearFlankDutyCycleRating":
        from mastapy._private.gears.rating.cylindrical import _467

        return self.__parent__._cast(_467.CylindricalGearFlankDutyCycleRating)

    @property
    def cylindrical_gear_flank_rating(
        self: "CastSelf",
    ) -> "_468.CylindricalGearFlankRating":
        from mastapy._private.gears.rating.cylindrical import _468

        return self.__parent__._cast(_468.CylindricalGearFlankRating)
