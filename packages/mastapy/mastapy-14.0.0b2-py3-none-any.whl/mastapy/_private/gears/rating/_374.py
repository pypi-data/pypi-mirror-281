...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _371, _372
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetRating(_365.AbstractGearSetRating):
    """GearSetRating
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_371.GearMeshRating]":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_372.GearRating]":
