...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _370, _375
    ...
    from mastapy._private.gears.rating.cylindrical.din3990 import _544
    from mastapy._private.gears.rating.cylindrical.agma import _546
...
class _Cast_MeshSingleFlankRating:
    ...
    def klingelnberg_conical_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_425.KlingelnbergConicalMeshSingleFlankRating":
        from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _425

        return self.__parent__._cast(_425.KlingelnbergConicalMeshSingleFlankRating)

    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_429.KlingelnbergCycloPalloidHypoidMeshSingleFlankRating":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_430.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating":
    ...
    def metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_501.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _501
    ...
    def plastic_gear_vdi2736_abstract_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_503.PlasticGearVDI2736AbstractMeshSingleFlankRating":
    ...
    def plastic_plastic_vdi2736_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_505.PlasticPlasticVDI2736MeshSingleFlankRating":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _505

        return self.__parent__._cast(_505.PlasticPlasticVDI2736MeshSingleFlankRating)
    ...
    def iso63362006_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_525.ISO63362006MeshSingleFlankRating":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _525

        return self.__parent__._cast(_525.ISO63362006MeshSingleFlankRating)
    ...
    def din3990_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_544.DIN3990MeshSingleFlankRating":
        from mastapy._private.gears.rating.cylindrical.din3990 import _544

        return self.__parent__._cast(_544.DIN3990MeshSingleFlankRating)

    @property
    def agma2101_mesh_single_flank_rating(
        self: "CastSelf",
    ) -> "_546.AGMA2101MeshSingleFlankRating":
        from mastapy._private.gears.rating.cylindrical.agma import _546

        return self.__parent__._cast(_546.AGMA2101MeshSingleFlankRating)
...
class MeshSingleFlankRating(_0.APIBase):
    ...
    @property
    def efficiency_rating_method(self: "Self") -> "_370.GearMeshEfficiencyRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._370", "GearMeshEfficiencyRatingMethod"
        )(value)
    ...
    @property
    def gear_single_flank_ratings(self: "Self") -> "List[_375.GearSingleFlankRating]":
