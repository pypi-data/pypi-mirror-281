...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _399, _400
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergHypoidVirtualCylindricalGear(_397.KlingelnbergVirtualCylindricalGear):
    """KlingelnbergHypoidVirtualCylindricalGear
