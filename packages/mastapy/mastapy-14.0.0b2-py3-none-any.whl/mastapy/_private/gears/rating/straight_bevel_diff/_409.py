...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _412, _410
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshRating(_550.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: "Self") -> "List[_412.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: "Self") -> "List[_412.StraightBevelDiffMeshedGearRating]":
        """List[mastapy._private.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
    ...
    def straight_bevel_diff_gear_ratings(
        self: "Self",
    ) -> "List[_410.StraightBevelDiffGearRating]":
