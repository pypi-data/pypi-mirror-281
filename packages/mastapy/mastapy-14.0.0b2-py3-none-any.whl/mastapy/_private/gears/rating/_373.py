...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _368, _376
    from mastapy._private.gears.rating.worm import _386
    from mastapy._private.gears.rating.face import _460
    from mastapy._private.gears.rating.cylindrical import _474, _491
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetDutyCycleRating(_365.AbstractGearSetRating):
    """GearSetDutyCycleRating
    ...
    @property
    def gear_set_design(self: "Self") -> "_974.GearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_368.GearDutyCycleRating]":
    ...
    @property
    def gear_duty_cycle_ratings(self: "Self") -> "List[_368.GearDutyCycleRating]":
        """List[mastapy._private.gears.rating.GearDutyCycleRating]
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_376.MeshDutyCycleRating]":
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self: "Self") -> "List[_376.MeshDutyCycleRating]":
        """List[mastapy._private.gears.rating.MeshDutyCycleRating]
