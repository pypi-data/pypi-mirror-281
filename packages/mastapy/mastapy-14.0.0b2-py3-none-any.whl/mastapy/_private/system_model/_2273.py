...
T = TypeVar("T", bound="_2498.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: "Self") -> "_1537.AlignmentAxis":
    ...
    def alignment_axis(self: "Self", value: "_1537.AlignmentAxis") -> None:
    ...
    @property
    def axial_offset(self: "Self") -> "_2274.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2274", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2274.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
