...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMesh(_2366.GearMesh):
    """FaceGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1015.FaceGearMeshDesign":
    ...
    @property
    def face_gear_mesh_design(self: "Self") -> "_1015.FaceGearMeshDesign":
        """mastapy._private.gears.gear_designs.face.FaceGearMeshDesign
