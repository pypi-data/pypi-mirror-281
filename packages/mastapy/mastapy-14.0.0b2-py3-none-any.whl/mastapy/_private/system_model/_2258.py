...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignSettings(_0.APIBase, _1632.IHaveAllSettings):
    """DesignSettings
    ...
    @property
    def bearing_settings(self: "Self") -> "_1933.BearingSettingsItem":
    ...
    @property
    def design_constraints_settings(self: "Self") -> "_970.DesignConstraintsCollection":
    ...
    @property
    def materials_settings(self: "Self") -> "_284.MaterialsSettingsItem":
