...
class ConceptGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6716.ConceptGearSetCriticalSpeedAnalysis]":
    ...
    def concept_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6848.ConceptGearCompoundCriticalSpeedAnalysis]":
    ...
    def concept_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6849.ConceptGearMeshCompoundCriticalSpeedAnalysis]":
