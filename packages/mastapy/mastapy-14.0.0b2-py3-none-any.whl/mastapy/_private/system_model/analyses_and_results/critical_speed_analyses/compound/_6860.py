...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundCriticalSpeedAnalysis(_6829.BeltDriveCompoundCriticalSpeedAnalysis):
    """CVTCompoundCriticalSpeedAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6729.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6729.CVTCriticalSpeedAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.CVTCriticalSpeedAnalysis]
