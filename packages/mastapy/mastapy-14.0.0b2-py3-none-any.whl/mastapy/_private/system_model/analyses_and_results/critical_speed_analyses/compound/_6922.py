...
class SpiralBevelGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6791.SpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6920.SpiralBevelGearCompoundCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6921.SpiralBevelGearMeshCompoundCriticalSpeedAnalysis]":
