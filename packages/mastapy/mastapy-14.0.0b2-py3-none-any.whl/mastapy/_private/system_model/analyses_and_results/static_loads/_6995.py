...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetLoadCase(_7042.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_6991.ConicalGearLoadCase]":
    ...
    @property
    def conical_gears_load_case(self: "Self") -> "List[_6991.ConicalGearLoadCase]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.ConicalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_6993.ConicalGearMeshLoadCase]":
    ...
    @property
    def conical_meshes_load_case(self: "Self") -> "List[_6993.ConicalGearMeshLoadCase]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.ConicalGearMeshLoadCase]
