...
from mastapy._private.utility_gui import _1899
...
class _Cast_PointLoadInputOptions:
    ...
    @property
    def column_input_options(self: "CastSelf") -> "_1899.ColumnInputOptions":
        return self.__parent__._cast(_1899.ColumnInputOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadInputOptions(_1899.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    def axis(self: "Self", value: "_1538.Axis") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self: "Self") -> "_7137.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7137",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7137.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2527.PointLoad") -> None:
        wrapper_type = (
