...
class _Cast_ElectricMachineHarmonicLoadImportOptionsBase:
    ...
    def electric_machine_harmonic_load_flux_import_options(
        ...
        return self.__parent__._cast(_7026.ElectricMachineHarmonicLoadFluxImportOptions)

    @property
    def electric_machine_harmonic_load_jmag_import_options(
        self: "CastSelf",
    ) -> "_7028.ElectricMachineHarmonicLoadJMAGImportOptions":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7028,
        )

        return self.__parent__._cast(_7028.ElectricMachineHarmonicLoadJMAGImportOptions)
