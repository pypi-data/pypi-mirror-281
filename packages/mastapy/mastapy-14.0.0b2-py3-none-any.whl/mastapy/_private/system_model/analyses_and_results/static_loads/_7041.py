...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetHarmonicLoadData(_1426.HarmonicLoadDataBase):
    """GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self: "Self") -> "_7040.GearMeshTEOrderType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7040",
            "GearMeshTEOrderType",
        )(value)
    ...
    def gear_mesh_te_order_type(
        self: "Self", value: "_7040.GearMeshTEOrderType"
    ) -> None:
