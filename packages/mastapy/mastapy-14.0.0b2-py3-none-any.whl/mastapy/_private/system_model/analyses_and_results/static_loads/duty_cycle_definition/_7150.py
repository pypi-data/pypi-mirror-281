...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: "Self", value: "_7140.DestinationDesignState"
    ) -> None:
    ...
    @property
    def force_chart(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def import_type(self: "Self") -> "_7055.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7055",
            "ImportType",
        )(value)

    @import_type.setter
    @enforce_parameter_types
    def import_type(self: "Self", value: "_7055.ImportType") -> None:
    ...
    @property
    def moment_chart(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def speed_chart(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def torque_chart(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def design_state_options(self: "Self") -> "_7139.DesignStateOptions":
    ...
    @property
    def gear_ratio_options(self: "Self") -> "_7142.GearRatioInputOptions":
    ...
    @property
    def load_case_name_inputs(self: "Self") -> "_7143.LoadCaseNameOptions":
    ...
    @property
    def time_step_input(self: "Self") -> "_7151.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: "Self",
    ) -> "List[_7138.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    def file_inputs(self: "Self") -> "List[_7145.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    def force_inputs(self: "Self") -> "List[_7141.ForceInputOptions]":
    ...
    @property
    def moment_inputs(self: "Self") -> "List[_7144.MomentInputOptions]":
    ...
    @property
    def speed_inputs(self: "Self") -> "List[_7149.SpeedInputOptions]":
    ...
    @property
    def torque_inputs(self: "Self") -> "List[_7152.TorqueInputOptions]":
    ...
    @property
    def columns(self: "Self") -> "List[_1867.ColumnTitle]":
