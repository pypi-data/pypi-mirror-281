...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: "Self") -> "_5506.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5506",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_5506.AnalysisTypes") -> None:
    ...
    @property
    def bearing_element_orbit_model(self: "Self") -> "_5508.BearingElementOrbitModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5508",
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5508.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5569.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5569",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5569.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2528.PowerLoad"
    ) -> None:
        wrapper_type = (
    ...
    def static_load_case_used_to_set_initial_speeds(
        ...
        """ListWithSelectedItem[str]"""
        temp = self.wrapped.StaticLoadCaseUsedToSetInitialSpeeds
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5570.InertiaAdjustedLoadCaseResultsToCreate":
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5570.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def use_static_load_case_to_set_initial_speeds(self: "Self") -> "bool":
        """bool"""
        temp = self.wrapped.UseStaticLoadCaseToSetInitialSpeeds
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5656.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4745.FrequencyResponseAnalysisOptions":
    ...
    @property
    def run_up_analysis_options(self: "Self") -> "_5586.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: "Self") -> "_5619.SplineDampingOptions":
        """mastapy._private.system_model.analyses_and_results.mbd_analyses.SplineDampingOptions

        Note:
            This property is readonly.
        """
        temp = self.wrapped.SplineDampingOptions
