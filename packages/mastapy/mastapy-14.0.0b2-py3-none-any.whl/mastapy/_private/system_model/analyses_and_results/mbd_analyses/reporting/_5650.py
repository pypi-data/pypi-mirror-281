...
class _Cast_AbstractMeasuredDynamicResponseAtTime:
    ...
    def dynamic_force_result_at_time(
        self: "CastSelf",
    ) -> "_5651.DynamicForceResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5651,
        )

        return self.__parent__._cast(_5651.DynamicForceResultAtTime)

    @property
    def dynamic_torque_result_at_time(
        self: "CastSelf",
    ) -> "_5653.DynamicTorqueResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5653,
        )

        return self.__parent__._cast(_5653.DynamicTorqueResultAtTime)
