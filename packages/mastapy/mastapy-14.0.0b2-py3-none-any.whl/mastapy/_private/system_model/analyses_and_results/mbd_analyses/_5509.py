...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingMultibodyDynamicsAnalysis(_5539.ConnectorMultibodyDynamicsAnalysis):
    """BearingMultibodyDynamicsAnalysis
    ...
    def element_orbital_position(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ElementOrbitalPosition
    ...
    def element_orbital_velocity(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ElementOrbitalVelocity
    ...
    def element_passing_frequency(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ElementPassingFrequency
    ...
    @property
    def peak_dynamic_force(self: "Self") -> "_5652.DynamicForceVector3DResult":
