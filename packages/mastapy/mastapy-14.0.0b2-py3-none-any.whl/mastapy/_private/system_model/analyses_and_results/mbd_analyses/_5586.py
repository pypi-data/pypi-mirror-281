...
class _Cast_MBDRunUpAnalysisOptions:
    ...
    @property
    def abstract_analysis_options(self: "CastSelf") -> "_7701.AbstractAnalysisOptions":
        return self.__parent__._cast(_7701.AbstractAnalysisOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MBDRunUpAnalysisOptions(_7701.AbstractAnalysisOptions[_6952.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def initial_speed_for_run_up(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.InitialSpeedForRunUp
    ...
    def initial_speed_for_run_up(self: "Self", value: "float") -> None:
        self.wrapped.InitialSpeedForRunUp = float(value) if value is not None else 0.0

    @property
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5572.InputVelocityForRunUpProcessingType":
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5572.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    def run_up_driving_mode(self: "Self") -> "_5609.RunUpDrivingMode":
    ...
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5609.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @property
    def run_up_speed_profile(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition

        Note:
            This property is readonly.
        """
        temp = self.wrapped.RunUpSpeedProfile
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5614.ShapeOfInitialAccelerationPeriodForRunUp":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5614",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5614.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
