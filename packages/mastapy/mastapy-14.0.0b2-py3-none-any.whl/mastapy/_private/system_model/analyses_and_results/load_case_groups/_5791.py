...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5795.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5795.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5795.GenericClutchEngagementStatus[_2395.ClutchConnection]
):
    """ClutchEngagementStatus
