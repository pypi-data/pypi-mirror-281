...
class _Cast_PartStaticLoadCaseGroup:
    ...
    def abstract_assembly_static_load_case_group(
        self: "CastSelf",
    ) -> "_5802.AbstractAssemblyStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5802,
        )

        return self.__parent__._cast(_5802.AbstractAssemblyStaticLoadCaseGroup)

    @property
    def component_static_load_case_group(
        self: "CastSelf",
    ) -> "_5803.ComponentStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5803,
        )

        return self.__parent__._cast(_5803.ComponentStaticLoadCaseGroup)

    @property
    def gear_set_static_load_case_group(
        self: "CastSelf",
    ) -> "_5806.GearSetStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5806,
        )

        return self.__parent__._cast(_5806.GearSetStaticLoadCaseGroup)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartStaticLoadCaseGroup(_5805.DesignEntityStaticLoadCaseGroup):
    """PartStaticLoadCaseGroup
    ...
    @property
    def part_load_cases(self: "Self") -> "List[_7077.PartLoadCase]":
