...
class _Cast_DutyCycle:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5790.AbstractStaticLoadCaseGroup":
        return self.__parent__._cast(_5790.AbstractStaticLoadCaseGroup)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DutyCycle(_5790.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5797.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: "Self") -> "_7150.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_6951.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5797.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_6951.StaticLoadCase") -> None:
        """Method does not return.
