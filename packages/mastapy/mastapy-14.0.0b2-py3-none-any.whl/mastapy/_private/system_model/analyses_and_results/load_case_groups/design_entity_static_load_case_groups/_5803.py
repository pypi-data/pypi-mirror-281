...
TReal = TypeVar("TReal", bound="_2498.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6984.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5807.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
