...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6462
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalPlanetGearDynamicAnalysis(_6462.CylindricalGearDynamicAnalysis):
    """CylindricalPlanetGearDynamicAnalysis
