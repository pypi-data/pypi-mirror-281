...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCompoundDynamicAnalysis(_6672.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6492.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6492.MassDiscDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]
