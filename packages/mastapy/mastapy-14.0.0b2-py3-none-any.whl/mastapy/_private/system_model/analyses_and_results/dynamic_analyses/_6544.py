...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetDynamicAnalysis(_6477.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6542.WormGearDynamicAnalysis]":
    ...
    def worm_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6542.WormGearDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.WormGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6543.WormGearMeshDynamicAnalysis]":
