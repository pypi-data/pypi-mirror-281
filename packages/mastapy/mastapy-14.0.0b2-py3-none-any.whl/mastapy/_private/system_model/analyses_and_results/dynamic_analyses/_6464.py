...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetDynamicAnalysis(_6477.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    def gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6462.CylindricalGearDynamicAnalysis]":
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6463.CylindricalGearMeshDynamicAnalysis]":
