...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6524
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearDynamicAnalysis(_6524.StraightBevelDiffGearDynamicAnalysis):
    """StraightBevelSunGearDynamicAnalysis
