...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetCompoundDynamicAnalysis(_6608.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6595.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6596.CylindricalGearMeshCompoundDynamicAnalysis]":
