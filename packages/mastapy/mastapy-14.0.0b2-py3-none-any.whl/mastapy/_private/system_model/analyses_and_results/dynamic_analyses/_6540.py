...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6541
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassDynamicAnalysis(_6541.VirtualComponentDynamicAnalysis):
    """UnbalancedMassDynamicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7129.UnbalancedMassLoadCase":
