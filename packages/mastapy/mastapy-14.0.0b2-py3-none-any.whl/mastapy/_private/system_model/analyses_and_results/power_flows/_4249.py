...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetPowerFlow(_4153.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4248.StraightBevelDiffGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4247.StraightBevelDiffGearMeshPowerFlow]":
