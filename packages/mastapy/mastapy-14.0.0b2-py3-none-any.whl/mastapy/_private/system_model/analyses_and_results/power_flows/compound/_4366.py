...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingCompoundPowerFlow(_4311.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4235.RollingRingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4235.RollingRingPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.RollingRingPowerFlow]
