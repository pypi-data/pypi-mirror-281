...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetCompoundPowerFlow(_4290.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4271.ZerolBevelGearSetPowerFlow]":
    ...
    def zerol_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4400.ZerolBevelGearCompoundPowerFlow]":
    ...
    def zerol_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4401.ZerolBevelGearMeshCompoundPowerFlow]":
