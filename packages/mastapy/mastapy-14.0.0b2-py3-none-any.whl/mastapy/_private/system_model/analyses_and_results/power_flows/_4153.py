...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetPowerFlow(_4141.AGMAGleasonConicalGearSetPowerFlow):
    """BevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4152.BevelGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4151.BevelGearMeshPowerFlow]":
    ...
    @property
    def bevel_meshes_power_flow(self: "Self") -> "List[_4151.BevelGearMeshPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
