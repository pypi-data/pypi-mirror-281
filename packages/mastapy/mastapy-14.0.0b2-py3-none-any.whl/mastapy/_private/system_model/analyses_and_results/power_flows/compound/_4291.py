...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundPowerFlow(_4297.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4155.BoltPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4155.BoltPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.BoltPowerFlow]
