...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingCompoundPowerFlow(_4309.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2638.ConceptCoupling":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4163.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4163.ConceptCouplingPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
