...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetPowerFlow(_4198.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_387.WormGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_387.WormGearSetRating":
        """mastapy._private.gears.rating.worm.WormGearSetRating
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4267.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: "Self") -> "List[_4267.WormGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4266.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: "Self") -> "List[_4266.WormGearMeshPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
