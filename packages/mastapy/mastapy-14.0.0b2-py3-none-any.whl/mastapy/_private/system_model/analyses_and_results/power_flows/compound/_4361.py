...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadCompoundPowerFlow(_4396.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4229.PowerLoadPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.PowerLoadPowerFlow]
