...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetCompoundPowerFlow(_4372.SpecialisedAssemblyCompoundPowerFlow):
    """GearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self: "Self") -> "_373.GearSetDutyCycleRating":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4198.GearSetPowerFlow]":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4198.GearSetPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.GearSetPowerFlow]
