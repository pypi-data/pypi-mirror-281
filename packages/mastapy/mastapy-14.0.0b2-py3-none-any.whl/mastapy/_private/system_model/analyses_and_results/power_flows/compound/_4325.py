...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCompoundPowerFlow(_4330.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4190.FaceGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4190.FaceGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
