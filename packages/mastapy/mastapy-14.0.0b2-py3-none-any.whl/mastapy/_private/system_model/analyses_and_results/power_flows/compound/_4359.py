...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierCompoundPowerFlow(_4351.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4225.PlanetCarrierPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4225.PlanetCarrierPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
