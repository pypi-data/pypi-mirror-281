...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundPowerFlow(_4282.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4176.CVTPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4176.CVTPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.CVTPowerFlow]
