...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetPowerFlow(_4153.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4147.BevelDifferentialGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4146.BevelDifferentialGearMeshPowerFlow]":
