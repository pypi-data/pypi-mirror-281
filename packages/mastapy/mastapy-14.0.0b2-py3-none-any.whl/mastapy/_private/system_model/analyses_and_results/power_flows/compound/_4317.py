...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscCompoundPowerFlow(_4273.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4181.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4181.CycloidalDiscPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
