...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1607, _1608
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentSystemDeflection(_2870.PartSystemDeflection):
    """ComponentSystemDeflection
    ...
    @property
    def connected_components_forces_in_lcs(self: "Self") -> "List[_1607.ForceResults]":
    ...
    @property
    def connected_components_forces_in_wcs(self: "Self") -> "List[_1607.ForceResults]":
        """List[mastapy._private.math_utility.measured_vectors.ForceResults]
    ...
    @property
    def node_results(self: "Self") -> "List[_1608.NodeResults]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4160.ComponentPowerFlow":
