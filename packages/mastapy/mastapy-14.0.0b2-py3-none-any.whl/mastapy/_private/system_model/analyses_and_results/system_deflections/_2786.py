...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSystemDeflection(_2791.BevelGearSystemDeflection):
    """BevelDifferentialGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_566.BevelGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_6969.BevelDifferentialGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4147.BevelDifferentialGearPowerFlow":
