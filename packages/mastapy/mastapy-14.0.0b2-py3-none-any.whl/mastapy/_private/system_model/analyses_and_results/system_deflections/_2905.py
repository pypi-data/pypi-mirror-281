...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2900
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearSystemDeflection(_2900.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4254.StraightBevelSunGearPowerFlow":
