...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetSystemDeflection(_2843.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4191.FaceGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2839.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_2839.FaceGearSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
