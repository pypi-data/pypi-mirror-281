...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshSystemDeflection(_2842.GearMeshSystemDeflection):
    """WormGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_384.WormGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_384.WormGearMeshRating":
        """mastapy._private.gears.rating.worm.WormGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4266.WormGearMeshPowerFlow":
