...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundSystemDeflection(_2997.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gear_set_rating(self: "Self") -> "_386.WormGearSetDutyCycleRating":
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3063.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3064.WormGearMeshCompoundSystemDeflection]":
