...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingAssemblySystemDeflection(_2891.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4233.RollingRingAssemblyPowerFlow":
