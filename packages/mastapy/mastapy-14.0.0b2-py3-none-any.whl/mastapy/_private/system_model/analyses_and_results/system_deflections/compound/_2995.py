...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearCompoundSystemDeflection(_3016.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: "Self") -> "_368.GearDutyCycleRating":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2844.GearSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2844.GearSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.GearSystemDeflection]
