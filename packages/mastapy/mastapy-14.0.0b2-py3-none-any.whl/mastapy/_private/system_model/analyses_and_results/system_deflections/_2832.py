...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self: "Self") -> "_2831.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    def right_flank(self: "Self") -> "_2831.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    def compression_side_fillet_results(
        self: "Self",
    ) -> "List[_868.GearRootFilletStressResults]":
    ...
    def flanks(
        self: "Self",
    ) -> "List[_2831.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    def both_flanks(self: "Self") -> "_2831.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
