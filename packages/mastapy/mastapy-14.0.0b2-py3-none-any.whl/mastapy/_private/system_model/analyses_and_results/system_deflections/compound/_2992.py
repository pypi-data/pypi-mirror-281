...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundSystemDeflection(_2997.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2838.FaceGearSetSystemDeflection]":
    ...
    def face_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2990.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2991.FaceGearMeshCompoundSystemDeflection]":
