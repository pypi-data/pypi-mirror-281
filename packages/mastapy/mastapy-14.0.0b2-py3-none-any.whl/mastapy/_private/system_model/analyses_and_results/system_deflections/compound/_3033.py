...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundSystemDeflection(_2943.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def duty_cycle_efficiency_results(
        self: "Self",
    ) -> "_2988.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2885.RootAssemblySystemDeflection]":
    ...
    def peak_to_peak_transmission_error_chart(
        self: "Self",
        mesh_duty_cycles: "List[_1131.CylindricalGearMeshMicroGeometryDutyCycle]",
        header: "str",
        x_axis_title: "str",
        y_axis_title: "str",
