...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearMeshSystemDeflection(_2789.BevelGearMeshSystemDeflection):
    """SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_413.SpiralBevelGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_413.SpiralBevelGearMeshRating":
        """mastapy._private.gears.rating.spiral_bevel.SpiralBevelGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4241.SpiralBevelGearMeshPowerFlow":
