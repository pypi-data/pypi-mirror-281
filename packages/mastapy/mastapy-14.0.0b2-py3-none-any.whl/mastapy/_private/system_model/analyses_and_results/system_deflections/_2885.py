...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblySystemDeflection(_2775.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4236.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: "Self") -> "_2910.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: "Self",
    ) -> "List[_2799.ConcentricPartGroupCombinationSystemDeflectionResults]":
