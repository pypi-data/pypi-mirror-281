...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSystemDeflection(_2844.GearSystemDeflection):
    """FaceGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_459.FaceGearRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4190.FaceGearPowerFlow":
