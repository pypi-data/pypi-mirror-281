...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2890
...
class PlanetaryConnectionSystemDeflection(
    ...
    @property
    def power_flow_results(self: "Self") -> "_4223.PlanetaryConnectionPowerFlow":
