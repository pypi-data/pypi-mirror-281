...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetSystemDeflection(_2790.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_382.ZerolBevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_382.ZerolBevelGearSetRating":
        """mastapy._private.gears.rating.zerol_bevel.ZerolBevelGearSetRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4271.ZerolBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2926.ZerolBevelGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2924.ZerolBevelGearMeshSystemDeflection]":
