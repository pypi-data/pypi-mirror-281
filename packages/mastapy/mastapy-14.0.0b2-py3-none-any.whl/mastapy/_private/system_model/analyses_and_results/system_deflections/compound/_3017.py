...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundSystemDeflection(_2972.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2869.OilSealSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.OilSealSystemDeflection]
