...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: "Self") -> "_2781.BearingSystemDeflection":
    ...
    def bearing_results(
        self: "Self",
    ) -> "List[_2779.BearingDynamicResultsPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2777.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2778.BearingDynamicPostAnalysisResultWrapper]":
