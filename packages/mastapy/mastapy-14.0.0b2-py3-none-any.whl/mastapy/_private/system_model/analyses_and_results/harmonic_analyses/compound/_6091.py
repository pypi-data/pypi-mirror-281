...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundHarmonicAnalysis(_6047.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5919.OilSealHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5919.OilSealHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.OilSealHarmonicAnalysis]
