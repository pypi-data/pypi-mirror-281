...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingHarmonicAnalysis(_5846.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    def rolling_bearing_speed_results(
        self: "Self",
    ) -> "_2124.RollingBearingSpeedResults":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2781.BearingSystemDeflection":
