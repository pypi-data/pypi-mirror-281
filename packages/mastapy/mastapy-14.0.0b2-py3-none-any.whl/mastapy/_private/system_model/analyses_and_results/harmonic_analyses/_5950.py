...
class StiffnessOptionsForHarmonicAnalysis(
    _7701.AbstractAnalysisOptions[_6951.StaticLoadCase]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(
        self: "Self", value: "_5899.HarmonicAnalysisTorqueInputType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_speed_curve(self: "Self") -> "_1581.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: "Self", value: "_1581.Vector2DListAccessor") -> None:
