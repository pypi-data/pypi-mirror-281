...
from mastapy._private.system_model.part_model.acoustics import _2682
...
class _Cast_HarmonicAnalysisOptions:
    ...
    def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_7221.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
        from mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
            _7221,
        )
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def acoustic_analysis_setup(
        ...
        temp = self.wrapped.AcousticAnalysisSetup
    ...
    def acoustic_analysis_setup(
        self: "Self", value: "_2682.AcousticAnalysisSetup"
    ) -> None:
        wrapper_type = (
        ...
        self.wrapped.AcousticAnalysisSetup = value
    ...
    @property
    def response_cache_level(self: "Self") -> "_5931.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._5931",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_5931.ResponseCacheLevel") -> None:
    ...
    @property
    def excitation_selection(self: "Self") -> "_5979.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: "Self") -> "_4770.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: "Self") -> "_5950.StiffnessOptionsForHarmonicAnalysis":
