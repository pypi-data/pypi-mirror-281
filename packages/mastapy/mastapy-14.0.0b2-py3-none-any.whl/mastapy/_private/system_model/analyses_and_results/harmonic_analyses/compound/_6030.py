...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundHarmonicAnalysis(_6036.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5829.BoltHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5829.BoltHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.BoltHarmonicAnalysis]
