...
class _Cast_FEPartHarmonicAnalysisResultsPropertyAccessor:
    ...
    def harmonic_analysis_results_property_accessor(
        self: "CastSelf",
    ) -> "_5997.HarmonicAnalysisResultsPropertyAccessor":
        return self.__parent__._cast(_5997.HarmonicAnalysisResultsPropertyAccessor)
...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    @property
    def combined_orders(self: "Self") -> "_5999.ResultsForMultipleOrdersForFESurface":
    ...
    def excitations(
        self: "Self",
    ) -> "List[_5990.FEPartSingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: "Self",
    ) -> "List[_6004.ResultsForOrderIncludingSurfaces]":
