...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self: "Self") -> "_6000.ResultsForMultipleOrdersForGroups":
    ...
    def excitations(
        self: "Self",
    ) -> "List[_6009.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: "Self",
    ) -> "List[_6002.ResultsForOrderIncludingGroups]":
