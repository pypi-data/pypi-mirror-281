...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5857
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalPlanetGearHarmonicAnalysis(_5857.CylindricalGearHarmonicAnalysis):
    """CylindricalPlanetGearHarmonicAnalysis
