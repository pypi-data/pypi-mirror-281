...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentHarmonicAnalysis(_5920.PartHarmonicAnalysis):
    """ComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4708.ComponentModalAnalysis":
    ...
    @property
    def results(self: "Self") -> "_5997.HarmonicAnalysisResultsPropertyAccessor":
