...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyParametricStudyTool(_4410.AssemblyParametricStudyTool):
    """RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self: "Self") -> "_4497.ParametricStudyTool":
    ...
    def results_for_reporting(
        self: "Self",
    ) -> "_4499.ParametricStudyToolResultsForReporting":
    ...
    def root_assembly_duty_cycle_results(
        self: "Self",
    ) -> "List[_2988.DutyCycleEfficiencyResults]":
