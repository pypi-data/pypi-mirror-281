...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundParametricStudyTool(_4588.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: "Self") -> "_2001.LoadedBearingDutyCycle":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_6966.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4411.BearingParametricStudyTool]":
