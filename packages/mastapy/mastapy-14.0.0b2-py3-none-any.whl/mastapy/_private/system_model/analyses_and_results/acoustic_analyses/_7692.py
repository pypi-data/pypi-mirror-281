...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    def combine_excitations_of_same_orders(self: "Self") -> "bool":
        """bool"""
        temp = self.wrapped.CombineExcitationsOfSameOrders
    ...
    @combine_excitations_of_same_orders.setter
    @enforce_parameter_types
    def combine_excitations_of_same_orders(self: "Self", value: "bool") -> None:
        self.wrapped.CombineExcitationsOfSameOrders = (
    ...
    def number_of_frequencies_solved_for_last_run(self: "Self") -> "int":
        ...
        """
        temp = self.wrapped.NumberOfFrequenciesSolvedForLastRun
    ...
    def harmonic_analysis_frequency_options(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.HarmonicAnalysisFrequencyOptions
    ...
    def calculate_surface_sound_pressure(self: "Self") -> None:
        ...
        self.wrapped.CalculateSurfaceSoundPressure()
