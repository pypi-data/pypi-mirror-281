...
class _Cast_SingleExcitationDetails:
    ...
    def single_harmonic_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7698.SingleHarmonicExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7698,
        )

        return self.__parent__._cast(_7698.SingleHarmonicExcitationAnalysisDetail)

    @property
    def unit_force_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7699.UnitForceExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7699,
        )

        return self.__parent__._cast(_7699.UnitForceExcitationAnalysisDetail)
...
class SingleExcitationDetails(_0.APIBase):
    ...
    def number_of_frequencies(self: "Self") -> "int":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.NumberOfFrequencies
    ...
    def number_of_frequencies_to_calculate(self: "Self") -> "int":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.NumberOfFrequenciesToCalculate
