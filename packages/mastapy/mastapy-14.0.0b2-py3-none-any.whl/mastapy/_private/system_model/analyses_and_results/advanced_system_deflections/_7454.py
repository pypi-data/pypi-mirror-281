...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearAdvancedSystemDeflection(_7485.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_562.ConceptGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_6988.ConceptGearLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2805.ConceptGearSystemDeflection]":
