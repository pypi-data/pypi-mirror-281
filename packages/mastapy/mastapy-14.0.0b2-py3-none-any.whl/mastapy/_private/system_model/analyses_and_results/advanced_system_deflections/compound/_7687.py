...
class WormGearSetCompoundAdvancedSystemDeflection(
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_386.WormGearSetDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: "Self") -> "_386.WormGearSetDutyCycleRating":
        """mastapy._private.gears.rating.worm.WormGearSetDutyCycleRating
    ...
    def worm_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7685.WormGearCompoundAdvancedSystemDeflection]":
    ...
    def worm_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7686.WormGearMeshCompoundAdvancedSystemDeflection]":
