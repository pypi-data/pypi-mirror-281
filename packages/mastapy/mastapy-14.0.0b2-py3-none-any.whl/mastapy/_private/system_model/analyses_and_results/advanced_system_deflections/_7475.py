...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetAdvancedSystemDeflection(_7487.GearSetAdvancedSystemDeflection):
    """CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self: "Self") -> "_1058.CylindricalGearSetDesign":
    ...
    @property
    def micro_geometry(self: "Self") -> "_1139.CylindricalGearSetMicroGeometry":
