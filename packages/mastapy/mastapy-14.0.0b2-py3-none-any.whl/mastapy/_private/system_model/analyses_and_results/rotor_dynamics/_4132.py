...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4130.ShaftComplexShape":
        return self.__parent__._cast(_4130.ShaftComplexShape)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShape(_4130.ShaftComplexShape[_1735.Number, _1735.Number]):
    """ShaftModalComplexShape
