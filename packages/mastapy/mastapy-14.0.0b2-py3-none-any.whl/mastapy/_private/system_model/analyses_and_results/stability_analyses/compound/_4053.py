...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundStabilityAnalysis(_4058.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3918.FaceGearSetStabilityAnalysis]":
    ...
    def face_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4051.FaceGearCompoundStabilityAnalysis]":
    ...
    def face_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4052.FaceGearMeshCompoundStabilityAnalysis]":
