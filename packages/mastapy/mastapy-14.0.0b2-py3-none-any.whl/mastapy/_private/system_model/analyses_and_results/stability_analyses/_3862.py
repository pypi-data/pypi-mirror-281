...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3945
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractAssemblyStabilityAnalysis(_3945.PartStabilityAnalysis):
    """AbstractAssemblyStabilityAnalysis
