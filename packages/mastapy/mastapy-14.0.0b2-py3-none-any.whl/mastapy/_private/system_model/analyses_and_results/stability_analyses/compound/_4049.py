...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundStabilityAnalysis(_4023.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3914.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3914.DatumStabilityAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]
