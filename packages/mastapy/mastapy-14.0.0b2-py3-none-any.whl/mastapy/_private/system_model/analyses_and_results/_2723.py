...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParametricStudyToolAnalysis(_2703.SingleAnalysis):
    """ParametricStudyToolAnalysis
