...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2666, _2668
...
class SynchroniserShift(_0.APIBase):
    ...
    @enforce_parameter_types
    def final_design_state(self: "Self", value: "_5793.DesignState") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def initial_design_state(self: "Self", value: "_5793.DesignState") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_DesignState.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def cone(self: "Self") -> "_2666.SynchroniserHalf":
    ...
    @property
    def sleeve(self: "Self") -> "_2668.SynchroniserSleeve":
