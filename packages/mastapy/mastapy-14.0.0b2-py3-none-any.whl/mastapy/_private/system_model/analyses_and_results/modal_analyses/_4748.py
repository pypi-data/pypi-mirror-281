...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetModalAnalysis(_4795.SpecialisedAssemblyModalAnalysis):
    """GearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4747.GearModalAnalysis]":
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4746.GearMeshModalAnalysis]":
