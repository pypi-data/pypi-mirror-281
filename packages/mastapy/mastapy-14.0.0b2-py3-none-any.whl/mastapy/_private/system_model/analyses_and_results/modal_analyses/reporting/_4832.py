...
class _Cast_DesignEntityModalAnalysisGroupResults:
    ...
    def single_excitation_results_modal_analysis(
        self: "CastSelf",
    ) -> "_4839.SingleExcitationResultsModalAnalysis":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4839,
        )

        return self.__parent__._cast(_4839.SingleExcitationResultsModalAnalysis)

    @property
    def single_mode_results(self: "CastSelf") -> "_4840.SingleModeResults":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4840,
        )

        return self.__parent__._cast(_4840.SingleModeResults)
