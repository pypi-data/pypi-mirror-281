...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearCompoundModalAnalysis(_4845.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4700.BevelGearModalAnalysis]":
