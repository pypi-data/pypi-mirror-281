...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCompoundModalAnalysis(_4965.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4763.MassDiscModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4763.MassDiscModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.MassDiscModalAnalysis]
