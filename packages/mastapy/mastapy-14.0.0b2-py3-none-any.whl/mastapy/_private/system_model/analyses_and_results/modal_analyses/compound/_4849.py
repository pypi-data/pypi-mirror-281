...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundModalAnalysis(_4877.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4691.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4691.BearingModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]
