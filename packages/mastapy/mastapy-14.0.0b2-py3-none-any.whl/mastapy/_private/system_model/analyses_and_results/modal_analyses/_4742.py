...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetModalAnalysis(_4748.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2838.FaceGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4741.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: "Self") -> "List[_4741.FaceGearModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4740.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4740.FaceGearMeshModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
