...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FrequencyResponseAnalysisOptions(_7701.AbstractAnalysisOptions[_6950.LoadCase]):
    """FrequencyResponseAnalysisOptions
    ...
    def number_of_bearing_harmonics(self: "Self") -> "int":
        """int"""
        temp = self.wrapped.NumberOfBearingHarmonics
    ...
    def number_of_bearing_harmonics(self: "Self", value: "int") -> None:
        self.wrapped.NumberOfBearingHarmonics = int(value) if value is not None else 0
