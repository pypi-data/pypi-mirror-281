...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CouplingCompoundModalAnalysis(_4941.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4723.CouplingModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4723.CouplingModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.CouplingModalAnalysis]
