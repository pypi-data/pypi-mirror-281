...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetModalAnalysis(_4748.GearSetModalAnalysis):
    """ConicalGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4716.ConicalGearModalAnalysis]":
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4715.ConicalGearMeshModalAnalysis]":
