...
from mastapy._private.math_utility import _1541, _1573
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1580, _1566
    from mastapy._private.math_utility.measured_data_scaling import _1615
    from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
        _5882,
        _5896,
        _5943,
    )
    from mastapy._private.system_model.drawing.options import _2316, _2314
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4737.DynamicsResponse3DChartType") -> None:
    ...
    @enforce_parameter_types
    def complex_component(
        self: "Self", value: "_1541.ComplexPartDisplayOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def connected_component_type(self: "Self") -> "_5976.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5976",
    ...
    def connected_component_type(
        self: "Self", value: "_5976.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    def coordinate_system(self: "Self") -> "_4720.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4720",
    ...
    def coordinate_system(
        self: "Self", value: "_4720.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4738.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4772.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4772",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4772.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    def translation_or_rotation(self: "Self") -> "_1580.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1580", "TranslationRotation"
        )(value)

    @translation_or_rotation.setter
    @enforce_parameter_types
    def translation_or_rotation(
        self: "Self", value: "_1580.TranslationRotation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def vector_magnitude_method(self: "Self") -> "_1566.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1566", "ComplexMagnitudeMethod"
        )(value)

    @vector_magnitude_method.setter
    @enforce_parameter_types
    def vector_magnitude_method(
        self: "Self", value: "_1566.ComplexMagnitudeMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4821.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4821",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4821.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    def data_scaling(self: "Self") -> "_1615.DataScalingOptions":
    ...
    def frequency_options(
        self: "Self",
    ) -> "_5882.FrequencyOptionsForHarmonicAnalysisResults":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2316.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2314.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    def order_cuts_chart_settings(self: "Self") -> "_4774.OrderCutsChartSettings":
    ...
    def reference_speed_options(
        self: "Self",
    ) -> "_5943.SpeedOptionsForHarmonicAnalysisResults":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_5984.ResultLocationSelectionGroups":
    ...
    @property
    def selected_excitations(self: "Self") -> "_5979.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: "Self") -> "_4820.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: "Self") -> "List[_5985.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: "Self",
    ) -> "List[_1895.EnumWithBoolean[_1573.ResultOptionsFor3DVector]]":
