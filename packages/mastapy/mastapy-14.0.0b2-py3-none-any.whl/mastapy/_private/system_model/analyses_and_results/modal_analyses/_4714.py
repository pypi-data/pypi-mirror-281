...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetModalAnalysis(_4748.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4713.ConceptGearModalAnalysis]":
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4712.ConceptGearMeshModalAnalysis]":
