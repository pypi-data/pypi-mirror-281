...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundModalAnalysis(_4931.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4726.CVTPulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4726.CVTPulleyModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.CVTPulleyModalAnalysis]
