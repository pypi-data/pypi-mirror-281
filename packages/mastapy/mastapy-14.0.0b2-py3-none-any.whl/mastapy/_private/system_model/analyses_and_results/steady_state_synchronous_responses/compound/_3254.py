...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3118.CylindricalGearSetSteadyStateSynchronousResponse]":
    ...
    def cylindrical_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3252.CylindricalGearCompoundSteadyStateSynchronousResponse]":
    ...
    def cylindrical_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3253.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]":
