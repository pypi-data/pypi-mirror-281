...
class FaceGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3125.FaceGearSetSteadyStateSynchronousResponse]":
    ...
    def face_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3258.FaceGearCompoundSteadyStateSynchronousResponse]":
    ...
    def face_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3259.FaceGearMeshCompoundSteadyStateSynchronousResponse]":
