...
class WormGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3200.WormGearSetSteadyStateSynchronousResponse]":
    ...
    def worm_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3330.WormGearCompoundSteadyStateSynchronousResponse]":
    ...
    def worm_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3331.WormGearMeshCompoundSteadyStateSynchronousResponse]":
