...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: "Self") -> "_1535.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: "Self", value: "_1535.Range") -> None:
        self.wrapped.FilteringFrequencyRange = value.wrapped

    @property
    def filtering_method(self: "Self") -> "_5982.ModalContributionFilteringMethod":
    ...
    def filtering_method(
        self: "Self", value: "_5982.ModalContributionFilteringMethod"
    ) -> None:
    ...
    @property
    def frequency_range(self: "Self") -> "_1535.Range":
        """mastapy._private.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: "Self", value: "_1535.Range") -> None:
    ...
    @property
    def index_range(self: "Self") -> "_1635.IntegerRange":
    ...
    @index_range.setter
    @enforce_parameter_types
    def index_range(self: "Self", value: "_1635.IntegerRange") -> None:
        self.wrapped.IndexRange = value.wrapped

    @property
    def modes_to_display(self: "Self") -> "_5981.ModalContributionDisplayMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5981",
    ...
    def modes_to_display(
        self: "Self", value: "_5981.ModalContributionDisplayMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
