...
from mastapy._private.system_model.part_model.gears import _2582, _2581
...
class _Cast_CylindricalGearFromCAD:
    ...
    def mountable_component_from_cad(
        self: "CastSelf",
    ) -> "_2560.MountableComponentFromCAD":
        return self.__parent__._cast(_2560.MountableComponentFromCAD)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFromCAD(_2560.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2582.CylindricalGearSet") -> None:
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2581.CylindricalGear") -> None:
        wrapper_type = (
