...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSet(_2588.GearSet):
    """FaceGearSet
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1019.FaceGearSetDesign":
    ...
    @property
    def face_gears(self: "Self") -> "List[_2584.FaceGear]":
    ...
    @property
    def face_meshes(self: "Self") -> "List[_2364.FaceGearMesh]":
