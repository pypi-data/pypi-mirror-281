...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SuperchargerRotorSet(_1879.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: "Self") -> "_1917.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: "Self") -> "_2621.YVariableForImportedData":
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2621.YVariableForImportedData"
    ) -> None:
    ...
    @property
    def boost_pressure(self: "Self") -> "_2611.BoostPressureInputOptions":
    ...
    @property
    def file(self: "Self") -> "_2614.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: "Self") -> "_2612.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: "Self") -> "_2613.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: "Self") -> "_2616.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: "Self") -> "List[_2615.RotorSetMeasuredPoint]":
