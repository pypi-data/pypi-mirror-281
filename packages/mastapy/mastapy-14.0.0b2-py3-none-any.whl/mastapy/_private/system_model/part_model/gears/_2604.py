...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSet(_2576.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_987.StraightBevelGearSetDesign":
    ...
    @property
    def straight_bevel_gears(self: "Self") -> "List[_2603.StraightBevelGear]":
    ...
    @property
    def straight_bevel_meshes(self: "Self") -> "List[_2380.StraightBevelGearMesh]":
