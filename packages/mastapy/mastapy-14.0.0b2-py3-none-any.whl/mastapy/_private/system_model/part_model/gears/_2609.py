...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGear(_2575.BevelGear):
    """ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_976.ZerolBevelGearDesign":
    ...
    @property
    def zerol_bevel_gear_design(self: "Self") -> "_976.ZerolBevelGearDesign":
        """mastapy._private.gears.gear_designs.zerol_bevel.ZerolBevelGearDesign
