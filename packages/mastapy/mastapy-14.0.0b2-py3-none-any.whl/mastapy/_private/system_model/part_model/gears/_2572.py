...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSet(_2576.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1220.BevelGearSetDesign":
    ...
    @property
    def bevel_gear_set_design(self: "Self") -> "_1220.BevelGearSetDesign":
        """mastapy._private.gears.gear_designs.bevel.BevelGearSetDesign
    ...
    @property
    def bevel_gears(self: "Self") -> "List[_2575.BevelGear]":
    ...
    @property
    def bevel_meshes(self: "Self") -> "List[_2356.BevelGearMesh]":
