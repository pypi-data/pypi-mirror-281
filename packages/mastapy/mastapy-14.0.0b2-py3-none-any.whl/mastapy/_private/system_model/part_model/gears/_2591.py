...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2590, _2580, _2588
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSet(_2570.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_1011.HypoidGearSetDesign":
    ...
    @property
    def hypoid_gear_set_design(self: "Self") -> "_1011.HypoidGearSetDesign":
        """mastapy._private.gears.gear_designs.hypoid.HypoidGearSetDesign
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_2590.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_2368.HypoidGearMesh]":
