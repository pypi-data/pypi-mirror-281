...
class _Cast_OuterBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2495.BearingRaceMountingOptions":
        return self.__parent__._cast(_2495.BearingRaceMountingOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OuterBearingRaceMountingOptions(_2495.BearingRaceMountingOptions):
    """OuterBearingRaceMountingOptions
