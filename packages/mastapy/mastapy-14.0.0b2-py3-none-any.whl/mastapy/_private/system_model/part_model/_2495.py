...
from mastapy._private.bearings.bearing_results import _2016, _2017
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2512, _2523
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2512.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2512

        return self.__parent__._cast(_2512.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2523.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2523

        return self.__parent__._cast(_2523.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2016.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2017.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def mounting_sleeve_material(self: "Self") -> "_256.BearingMaterial":
