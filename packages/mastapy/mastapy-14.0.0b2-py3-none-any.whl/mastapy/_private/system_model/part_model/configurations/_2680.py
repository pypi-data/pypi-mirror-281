...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2566, _2567
...
TPart = TypeVar("TPart", bound="_2524.Part")
...
class _Cast_PartDetailSelection:
    ...
    def active_cylindrical_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2566.ActiveCylindricalGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2566

        return self.__parent__._cast(_2566.ActiveCylindricalGearSetDesignSelection)

    @property
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2567.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2567

        return self.__parent__._cast(_2567.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2673.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2673

        return self.__parent__._cast(_2673.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2675.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2675

        return self.__parent__._cast(_2675.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2678.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2678

        return self.__parent__._cast(_2678.BearingDetailSelection)
