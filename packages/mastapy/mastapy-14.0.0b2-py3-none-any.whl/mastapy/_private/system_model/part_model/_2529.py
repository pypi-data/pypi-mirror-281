...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2513.InternalClearanceTolerance":
        return self.__parent__._cast(_2513.InternalClearanceTolerance)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RadialInternalClearanceTolerance(_2513.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
