...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSettings(_1641.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self",
    ) -> "_2268.PlanetPinManufacturingErrorsCoordinateSystem":
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self", value: "_2268.PlanetPinManufacturingErrorsCoordinateSystem"
    ) -> None:
