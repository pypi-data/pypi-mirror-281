...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2681, _2683, _2686
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    def analysis_options(self: "Self") -> "_2681.AcousticAnalysisOptions":
    ...
    @property
    def cache_reporting(self: "Self") -> "_2683.AcousticAnalysisSetupCacheReporting":
        """mastapy._private.system_model.part_model.acoustics.AcousticAnalysisSetupCacheReporting

        Note:
            This property is readonly.
        """
        temp = self.wrapped.CacheReporting
    ...
    @property
    def input_surface_options(self: "Self") -> "_2686.AcousticInputSurfaceOptions":
        """mastapy._private.system_model.part_model.acoustics.AcousticInputSurfaceOptions

        Note:
            This property is readonly.
        """
        temp = self.wrapped.InputSurfaceOptions
