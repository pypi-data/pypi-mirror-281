...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2696, _2697
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2696.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2696

        return self.__parent__._cast(_2696.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2697.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2697

        return self.__parent__._cast(_2697.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    def reference_component(
        ...
        temp = self.wrapped.ReferenceComponent
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2498.Component") -> None:
        wrapper_type = (
        ...
        self.wrapped.ReferenceComponent = value
    ...
    def reference_component_type(
        ...
        temp = self.wrapped.ReferenceComponentType
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2257.DesignEntityId") -> None:
        ...
        self.wrapped.ReferenceComponentType = value

    @property
    def target_edge_length(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.TargetEdgeLength
