...
class AcousticAnalysisSetupCacheReporting(_0.APIBase):
    ...
    def estimated_memory_at_the_maximum_frequency(self: "Self") -> "str":
        ...
        """
        temp = self.wrapped.EstimatedMemoryAtTheMaximumFrequency
    ...
    def estimated_memory_at_the_minimum_frequency(self: "Self") -> "str":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.EstimatedMemoryAtTheMinimumFrequency
    ...
    def estimated_memory_for_near_field_integrals(self: "Self") -> "str":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.EstimatedMemoryForNearFieldIntegrals
    ...
    def maximum_frequency(
        ...
        self.wrapped.MaximumFrequency = value

    @property
    def minimum_frequency(self: "Self") -> "overridable.Overridable_float":
        """Overridable[float]"""
        temp = self.wrapped.MinimumFrequency
    ...
    def minimum_frequency(
        ...
        self.wrapped.MinimumFrequency = value
    ...
    def total_estimated_memory_for_near_field_integrals(self: "Self") -> "str":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.TotalEstimatedMemoryForNearFieldIntegrals
    ...
    def calculate_memory_estimate_for_near_field_integrals(self: "Self") -> None:
        """Method does not return."""
        self.wrapped.CalculateMemoryEstimateForNearFieldIntegrals()

    def calculate_memory_estimates_for_m2l_coefficients(self: "Self") -> None:
        """Method does not return."""
        self.wrapped.CalculateMemoryEstimatesForM2LCoefficients()
