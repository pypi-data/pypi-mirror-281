...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1610, _1608
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def new_result(self: "Self") -> "_1608.NodeResults":
    ...
    @property
    def original_result(self: "Self") -> "_1608.NodeResults":
        """mastapy._private.math_utility.measured_vectors.NodeResults
