...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2429, _2455
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2429.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2429

        return self.__parent__._cast(_2429.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2455.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2455

        return self.__parent__._cast(_2455.NodeGroupWithSelection)
