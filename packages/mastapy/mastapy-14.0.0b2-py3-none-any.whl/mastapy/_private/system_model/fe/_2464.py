...
from mastapy._private.nodal_analysis.fe_export_utility import _172, _173
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2458, _2459
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def default_type_of_result_to_export(
        self: "Self", value: "_172.BoundaryConditionType"
    ) -> None:
    ...
    @length_unit.setter
    @enforce_parameter_types
    def length_unit(self: "Self", value: "_1657.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def links(self: "Self") -> "List[_2458.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2459.PerNodeExportOptions]":
