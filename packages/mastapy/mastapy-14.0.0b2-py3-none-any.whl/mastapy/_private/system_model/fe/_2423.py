...
class CreateMicrophoneNormalToSurfaceOptions(_0.APIBase):
    ...
    def distance_to_surface(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.DistanceToSurface
    ...
    def distance_to_surface(self: "Self", value: "float") -> None:
        self.wrapped.DistanceToSurface = float(value) if value is not None else 0.0
    ...
    def microphone_array_to_add_to(
        ...
        temp = self.wrapped.MicrophoneArrayToAddTo
    ...
    @enforce_parameter_types
    def microphone_array_to_add_to(
        self: "Self", value: "_2519.MicrophoneArray"
    ) -> None:
        wrapper_type = (
        ...
        self.wrapped.MicrophoneArrayToAddTo = value
