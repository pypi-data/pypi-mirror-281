...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1521, _1526, _1529, _1514, _1516, _1512
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: "Self") -> "List[_1521.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: "Self", value: "List[_1521.ClampedSection]") -> None:
    ...
    @property
    def joint_geometry(self: "Self") -> "_1526.JointGeometries":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1526", "JointGeometries"
        )(value)

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: "Self", value: "_1526.JointGeometries") -> None:
    ...
    def rolled_before_or_after_heat_treatment(
        self: "Self",
    ) -> "_1529.RolledBeforeOrAfterHeatTreatment":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1529", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: "Self", value: "_1529.RolledBeforeOrAfterHeatTreatment"
    ) -> None:
    ...
    @property
    def bolt_geometry(self: "Self") -> "_1514.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: "Self") -> "_1516.BoltMaterial":
    ...
    @property
    def material_of_nut(self: "Self") -> "_1512.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: "Self") -> "_1512.BoltedJointMaterial":
        """mastapy._private.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: "Self") -> "List[_1521.ClampedSection]":
        """List[mastapy._private.bolts.ClampedSection]
