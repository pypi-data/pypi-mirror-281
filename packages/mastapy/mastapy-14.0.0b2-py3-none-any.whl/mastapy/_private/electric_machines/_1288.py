...
from mastapy._private.electric_machines import _1325
...
class _Cast_CADMagnetsForLayer:
    ...
    @property
    def magnet_design(self: "CastSelf") -> "_1325.MagnetDesign":
        return self.__parent__._cast(_1325.MagnetDesign)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CADMagnetsForLayer(_1325.MagnetDesign):
    """CADMagnetsForLayer
    ...
    @property
    def cad_magnet_details(self: "Self") -> "List[_1287.CADMagnetDetails]":
