...
from mastapy._private.electric_machines import _1340, _1337
...
class _Cast_ElectricMachineResultsViewable:
    ...
    @property
    def elmer_results_viewable(self: "CastSelf") -> "_181.ElmerResultsViewable":
        return self.__parent__._cast(_181.ElmerResultsViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineResultsViewable(_181.ElmerResultsViewable):
    """ElectricMachineResultsViewable
    ...
    @property
    def force_view_options(self: "Self") -> "_1384.ElectricMachineForceViewOptions":
    ...
    def force_view_options(
        self: "Self", value: "_1384.ElectricMachineForceViewOptions"
    ) -> None:
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: "Self", value: "_1372.ElectricMachineResults") -> None:
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: "Self") -> "List[_1895.EnumWithBoolean[_1337.RegionID]]":
