...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @property
    def on_load_results(self: "Self") -> "_1390.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: "Self") -> "_1391.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: "Self") -> "List[_1390.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: "Self",
    ) -> "List[_1391.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: "Self",
    ) -> "List[_1390.OnLoadElectricMachineResults]":
        """List[mastapy._private.electric_machines.results.OnLoadElectricMachineResults]
