...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1368
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class EfficiencyMapAnalysis(_1398.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    def field_winding_resistance(self: "Self") -> "float":
        ...
        """
        temp = self.wrapped.FieldWindingResistance
    ...
    @property
    def efficiency_map_results(self: "Self") -> "_1368.EfficiencyResults":
    ...
    @property
    def load_case(self: "Self") -> "_1397.EfficiencyMapLoadCase":
