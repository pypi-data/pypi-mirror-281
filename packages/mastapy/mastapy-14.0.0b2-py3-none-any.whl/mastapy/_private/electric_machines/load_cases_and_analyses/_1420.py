...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpeedTorqueCurveAnalysis(_1398.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1421.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: "Self") -> "List[_1387.MaximumTorqueResultsPoints]":
