...
class ElectricMachineFEAnalysis(
    _1416.SingleOperatingPointAnalysis, _1385.IHaveDynamicForceResults
):
    """ElectricMachineFEAnalysis
    ...
    @property
    def dynamic_force_results(self: "Self") -> "_1367.DynamicForceResults":
    ...
    @property
    def viewable(self: "Self") -> "_181.ElmerResultsViewable":
