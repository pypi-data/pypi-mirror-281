...
class _Cast_ElectricMachineLoadCaseBase:
    ...
    def basic_dynamic_force_load_case(
        ...
        from mastapy._private.electric_machines.load_cases_and_analyses import _1392
    ...
    @property
    def efficiency_map_load_case(self: "CastSelf") -> "_1397.EfficiencyMapLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1397

        return self.__parent__._cast(_1397.EfficiencyMapLoadCase)

    @property
    def electric_machine_load_case(self: "CastSelf") -> "_1404.ElectricMachineLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1404

        return self.__parent__._cast(_1404.ElectricMachineLoadCase)

    @property
    def electric_machine_mechanical_load_case(
        self: "CastSelf",
    ) -> "_1407.ElectricMachineMechanicalLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1407

        return self.__parent__._cast(_1407.ElectricMachineMechanicalLoadCase)
    ...
    def speed_torque_curve_load_case(
        self: "CastSelf",
    ) -> "_1421.SpeedTorqueCurveLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1421

        return self.__parent__._cast(_1421.SpeedTorqueCurveLoadCase)

    @property
    def speed_torque_load_case(self: "CastSelf") -> "_1422.SpeedTorqueLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1422

        return self.__parent__._cast(_1422.SpeedTorqueLoadCase)
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    @property
    def temperatures(self: "Self") -> "_1423.Temperatures":
    ...
    @property
    def analyses(self: "Self") -> "List[_1398.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: "Self", another_group: "_1406.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: "Self", electric_machine_analysis: "_1398.ElectricMachineAnalysis"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: "Self", setup: "_1308.ElectricMachineSetup") -> None:
        """Method does not return.
