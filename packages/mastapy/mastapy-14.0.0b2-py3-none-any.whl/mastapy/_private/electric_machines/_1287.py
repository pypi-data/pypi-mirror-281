...
class CADMagnetDetails(_0.APIBase):
    ...
    @property
    def magnetisation_direction(self: "Self") -> "_1327.MagnetisationDirection":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1327", "MagnetisationDirection"
        )(value)

    @magnetisation_direction.setter
    @enforce_parameter_types
    def magnetisation_direction(
        self: "Self", value: "_1327.MagnetisationDirection"
    ) -> None:
