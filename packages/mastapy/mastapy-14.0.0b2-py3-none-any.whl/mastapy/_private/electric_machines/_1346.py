...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1321, _1298
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorRotorMaterial(_280.Material):
    """StatorRotorMaterial
    ...
    def coefficient_specification_method(
        self: "Self",
    ) -> "_1321.IronLossCoefficientSpecificationMethod":
    ...
    @enforce_parameter_types
    def coefficient_specification_method(
        self: "Self", value: "_1321.IronLossCoefficientSpecificationMethod"
    ) -> None:
    ...
    @property
    def loss_curves(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @property
    def bh_curve_specification(self: "Self") -> "_259.BHCurveSpecification":
    ...
    @property
    def core_loss_coefficients(self: "Self") -> "_1298.CoreLossCoefficients":
