...
class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
    ...
    @property
    def permanent_magnet_rotor(self: "CastSelf") -> "_1335.PermanentMagnetRotor":
        return self.__parent__._cast(_1335.PermanentMagnetRotor)

    @property
    def rotor(self: "CastSelf") -> "_1338.Rotor":
        from mastapy._private.electric_machines import _1338

        return self.__parent__._cast(_1338.Rotor)

    @property
    def wound_field_synchronous_rotor(
        self: "CastSelf",
    ) -> "_1366.WoundFieldSynchronousRotor":
        from mastapy._private.electric_machines import _1366

        return self.__parent__._cast(_1366.WoundFieldSynchronousRotor)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1335.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    @property
    def flux_barrier_style(self: "Self") -> "_1315.FluxBarrierStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1315", "FluxBarrierStyle"
        )(value)

    @flux_barrier_style.setter
    @enforce_parameter_types
    def flux_barrier_style(self: "Self", value: "_1315.FluxBarrierStyle") -> None:
    ...
    @property
    def rotor_type(self: "Self") -> "_1341.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1341", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: "Self", value: "_1341.RotorType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def cooling_duct_layers(
        self: "Self",
    ) -> "List[_1295.CoolingDuctLayerSpecification]":
    ...
    @property
    def notch_specifications(self: "Self") -> "List[_1333.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: "Self") -> "List[_1355.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: "Self",
    ) -> "List[_1356.VShapedMagnetLayerSpecification]":
