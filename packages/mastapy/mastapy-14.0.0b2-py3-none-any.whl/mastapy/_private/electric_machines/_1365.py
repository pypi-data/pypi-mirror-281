...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1366, _1302
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WoundFieldSynchronousMachine(_1331.NonCADElectricMachineDetail):
    """WoundFieldSynchronousMachine
    ...
    @property
    def rotor(self: "Self") -> "_1366.WoundFieldSynchronousRotor":
