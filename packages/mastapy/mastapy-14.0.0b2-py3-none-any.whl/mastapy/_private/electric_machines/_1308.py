...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1354, _1301
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electromagnetic_analysis(
        self: "Self",
    ) -> "_1354.TwoDimensionalFEModelForAnalysis[_1306.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: "Self") -> "_1301.Eccentricity":
