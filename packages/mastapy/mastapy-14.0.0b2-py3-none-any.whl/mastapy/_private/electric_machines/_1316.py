...
class _Cast_HairpinConductor:
    ...
    @property
    def winding_conductor(self: "CastSelf") -> "_1357.WindingConductor":
        return self.__parent__._cast(_1357.WindingConductor)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HairpinConductor(_1357.WindingConductor):
    """HairpinConductor
