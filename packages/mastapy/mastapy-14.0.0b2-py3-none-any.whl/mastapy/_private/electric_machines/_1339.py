...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1326, _1355, _1356
...
class _Cast_RotorInternalLayerSpecification:
    ...
    def u_shaped_layer_specification(
        self: "CastSelf",
    ) -> "_1355.UShapedLayerSpecification":
        from mastapy._private.electric_machines import _1355

        return self.__parent__._cast(_1355.UShapedLayerSpecification)

    @property
    def v_shaped_magnet_layer_specification(
        self: "CastSelf",
    ) -> "_1356.VShapedMagnetLayerSpecification":
        from mastapy._private.electric_machines import _1356

        return self.__parent__._cast(_1356.VShapedMagnetLayerSpecification)
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    @property
    def magnets(self: "Self") -> "_1326.MagnetForLayer":
