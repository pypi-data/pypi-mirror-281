...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1289, _1290
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CADElectricMachineDetail(_1302.ElectricMachineDetail):
    """CADElectricMachineDetail
    ...
    @property
    def rotor(self: "Self") -> "_1289.CADRotor":
    ...
    @property
    def stator(self: "Self") -> "_1290.CADStator":
