...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SplineMaterial(_280.Material):
    """SplineMaterial
    ...
    @property
    def heat_treatment_type(self: "Self") -> "_1444.HeatTreatmentTypes":
    ...
    @enforce_parameter_types
    def heat_treatment_type(self: "Self", value: "_1444.HeatTreatmentTypes") -> None:
