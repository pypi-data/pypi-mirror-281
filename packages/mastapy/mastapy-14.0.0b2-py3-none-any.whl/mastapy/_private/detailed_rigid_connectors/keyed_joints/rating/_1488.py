...
from mastapy._private.detailed_rigid_connectors.interference_fits.rating import _1495
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints.rating import _1487
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KeywayRating(_1495.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self: "Self") -> "_1483.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: "Self") -> "List[_1487.KeywayHalfRating]":
