...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints import _1484, _1486
...
class _Cast_KeyedJointDesign:
    ...
    @property
    def interference_fit_design(self: "CastSelf") -> "_1491.InterferenceFitDesign":
        return self.__parent__._cast(_1491.InterferenceFitDesign)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KeyedJointDesign(_1491.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: "Self") -> "_1484.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.keyed_joints._1484", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: "Self", value: "_1484.KeyTypes") -> None:
    ...
    @property
    def number_of_keys(self: "Self") -> "_1486.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.keyed_joints._1486",
            "NumberOfKeys",
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: "Self", value: "_1486.NumberOfKeys") -> None:
        value = conversion.mp_to_pn_enum(
