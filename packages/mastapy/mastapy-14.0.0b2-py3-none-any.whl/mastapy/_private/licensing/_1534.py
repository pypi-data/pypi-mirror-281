...
if TYPE_CHECKING:
    ...
    from mastapy._private.licensing import _7737, _7738, _7739
...
class LicenceServer:
    ...
    @staticmethod
    @enforce_parameter_types
    def update_server_settings(server_details: "_7737.LicenceServerDetails") -> None:
    ...
    @staticmethod
    def get_server_settings() -> "_7737.LicenceServerDetails":
    ...
    @staticmethod
    def get_licensed_module_details() -> "Iterable[_7738.ModuleDetails]":
    ...
    @staticmethod
    def get_available_module_details() -> "Iterable[_7738.ModuleDetails]":
        """Iterable[mastapy._private.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    def get_requested_module_statuses() -> "Iterable[_7739.ModuleLicenceStatus]":
