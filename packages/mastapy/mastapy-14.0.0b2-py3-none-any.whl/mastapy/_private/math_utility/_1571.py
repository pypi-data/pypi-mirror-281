...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1555, _1570, _1572, _1577, _1582
...
class _Cast_RealMatrix:
    ...
    @property
    def generic_matrix(self: "CastSelf") -> "_1560.GenericMatrix":
        pass

        return self.__parent__._cast(_1560.GenericMatrix)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RealMatrix(_1560.GenericMatrix[float, "RealMatrix"]):
    """RealMatrix
