...
class TwodimensionalFunctionLookupTable(
    _1612.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1611.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1611.GriddedSurfaceAccessor") -> None:
