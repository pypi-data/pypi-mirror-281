...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1621
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1621.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1621

        return self.__parent__._cast(_1621.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_1902.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _1902

        return self.__parent__._cast(_1902.DataLoggerWithCharts)
