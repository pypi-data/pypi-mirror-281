...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self: "Self") -> "List[_1591.OptimizationVariable]":
    ...
    @property
    def target_history(self: "Self") -> "List[_1591.OptimizationVariable]":
        """List[mastapy._private.math_utility.optimisation.OptimizationVariable]
    ...
    def add_input_history(self: "Self", value: "_1591.OptimizationVariable") -> None:
    ...
    @enforce_parameter_types
    def add_target_history(self: "Self", value: "_1591.OptimizationVariable") -> None:
        """Method does not return.
