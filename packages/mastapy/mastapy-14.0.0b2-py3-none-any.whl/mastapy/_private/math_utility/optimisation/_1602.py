...
class _Cast_ReportingOptimizationInput:
    ...
    @property
    def optimization_variable(self: "CastSelf") -> "_1591.OptimizationVariable":
        from mastapy._private.math_utility.optimisation import _1591

        return self.__parent__._cast(_1591.OptimizationVariable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ReportingOptimizationInput(_1590.OptimizationInput):
    """ReportingOptimizationInput
