...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _925
...
class _Cast_ParetoOptimisationStrategyBars:
    ...
    @property
    def bar_for_pareto(self: "CastSelf") -> "_925.BarForPareto":
        from mastapy._private.gears.gear_set_pareto_optimiser import _925

        return self.__parent__._cast(_925.BarForPareto)
