...
from mastapy._private.math_utility.measured_vectors import _1605
...
class _Cast_ForceAndDisplacementResults:
    ...
    def abstract_force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1605.AbstractForceAndDisplacementResults":
        return self.__parent__._cast(_1605.AbstractForceAndDisplacementResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ForceAndDisplacementResults(_1605.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    def displacement(self: "Self") -> "_1610.VectorWithLinearAndAngularComponents":
