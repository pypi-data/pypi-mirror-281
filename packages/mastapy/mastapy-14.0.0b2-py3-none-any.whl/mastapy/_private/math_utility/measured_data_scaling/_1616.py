...
class _Cast_DataScalingReferenceValues:
    ...
    def data_scaling_reference_values_base(
        self: "CastSelf",
    ) -> "_1617.DataScalingReferenceValuesBase":
        return self.__parent__._cast(_1617.DataScalingReferenceValuesBase)
...
class DataScalingReferenceValues(
    _1617.DataScalingReferenceValuesBase, Generic[TMeasurement]
):
    """DataScalingReferenceValues
