...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1508, _1507, _1500
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: "Self") -> "_1508.RingPinsDesign":
    ...
    @property
    def disc_phases(self: "Self") -> "List[_1507.NamedDiscPhase]":
    ...
    @property
    def discs(self: "Self") -> "List[_1500.CycloidalDiscDesign]":
