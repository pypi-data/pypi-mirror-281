...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2044, _2095, _2112
...
class _Cast_LoadedAbstractSphericalRollerBearingStripLoadResults:
    ...
    def loaded_roller_strip_load_results(
        self: "CastSelf",
    ) -> "_2084.LoadedRollerStripLoadResults":
        return self.__parent__._cast(_2084.LoadedRollerStripLoadResults)
