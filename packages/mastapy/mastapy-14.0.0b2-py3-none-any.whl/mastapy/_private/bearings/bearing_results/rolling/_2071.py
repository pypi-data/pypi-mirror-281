...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2070, _2069, _2087
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedFourPointContactBallBearingRow(_2056.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    def race_results(
        self: "Self",
    ) -> "List[_2069.LoadedFourPointContactBallBearingRaceResults]":
