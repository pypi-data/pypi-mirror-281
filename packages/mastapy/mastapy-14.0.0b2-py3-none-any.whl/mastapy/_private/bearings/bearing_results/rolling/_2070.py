...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2025, _2086
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedFourPointContactBallBearingResults(_2055.LoadedBallBearingResults):
    """LoadedFourPointContactBallBearingResults
    ...
    @property
    def raceway_control(self: "Self") -> "_2025.FrictionModelForGyroscopicMoment":
