...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2082, _2086
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTaperRollerBearingResults(_2077.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
