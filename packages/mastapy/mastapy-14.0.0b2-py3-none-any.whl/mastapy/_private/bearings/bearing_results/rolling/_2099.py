...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2012, _2009, _2001
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTaperRollerBearingDutyCycle(_2076.LoadedNonBarrelRollerBearingDutyCycle):
    """LoadedTaperRollerBearingDutyCycle
