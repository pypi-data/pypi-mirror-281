...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2054, _2069
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2054.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2054

        return self.__parent__._cast(_2054.LoadedBallBearingRaceResults)
