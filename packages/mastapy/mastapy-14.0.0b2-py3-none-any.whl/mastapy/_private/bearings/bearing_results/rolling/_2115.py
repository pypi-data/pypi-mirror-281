...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2113, _2114
...
class _Cast_MaximumStaticContactStressResultsAbstract:
    ...
    def maximum_static_contact_stress(
        ...
        return self.__parent__._cast(_2113.MaximumStaticContactStress)
    ...
    def maximum_static_contact_stress_duty_cycle(
        ...
        return self.__parent__._cast(_2114.MaximumStaticContactStressDutyCycle)
