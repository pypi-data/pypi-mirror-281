...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2045, _2060, _2099
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNonBarrelRollerBearingDutyCycle(_2012.LoadedRollingBearingDutyCycle):
    """LoadedNonBarrelRollerBearingDutyCycle
