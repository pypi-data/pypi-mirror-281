...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2002, _2009, _2012
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: "Self") -> "_2183.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: "Self") -> "List[_2002.LoadedBearingResults]":
