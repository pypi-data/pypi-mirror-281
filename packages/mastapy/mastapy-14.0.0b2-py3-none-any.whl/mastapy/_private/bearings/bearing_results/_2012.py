...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1890, _1893, _1891, _1892
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedRollingBearingDutyCycle(_2009.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: "Self",
    ) -> "_1890.DutyCyclePropertySummaryForce[_1927.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1893.DutyCyclePropertySummaryStress[_1927.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_static_contact_stress_duty_cycle(
        self: "Self",
    ) -> "_2114.MaximumStaticContactStressDutyCycle":
    ...
    def maximum_truncation_summary(
        self: "Self",
    ) -> "_1891.DutyCyclePropertySummaryPercentage[_1927.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: "Self",
    ) -> "_1892.DutyCyclePropertySummarySmallAngle[_1927.BearingLoadCaseResultsLightweight]":
