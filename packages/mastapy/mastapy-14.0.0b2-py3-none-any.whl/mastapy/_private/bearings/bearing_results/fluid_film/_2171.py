...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2179, _2182
...
class _Cast_LoadedFluidFilmBearingPad:
    ...
    @property
    def loaded_tilting_journal_pad(self: "CastSelf") -> "_2179.LoadedTiltingJournalPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2179

        return self.__parent__._cast(_2179.LoadedTiltingJournalPad)

    @property
    def loaded_tilting_thrust_pad(self: "CastSelf") -> "_2182.LoadedTiltingThrustPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2182

        return self.__parent__._cast(_2182.LoadedTiltingThrustPad)
