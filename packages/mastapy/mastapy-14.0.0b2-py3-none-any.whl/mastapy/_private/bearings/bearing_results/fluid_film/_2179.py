...
from mastapy._private.bearings.bearing_results.fluid_film import _2171
...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2171.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2171.LoadedFluidFilmBearingPad)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTiltingJournalPad(_2171.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
