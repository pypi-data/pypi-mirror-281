...
class _Cast_LoadedPlainOilFedJournalBearingRow:
    ...
    def loaded_plain_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2176.LoadedPlainJournalBearingRow":
        return self.__parent__._cast(_2176.LoadedPlainJournalBearingRow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedPlainOilFedJournalBearingRow(_2176.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
