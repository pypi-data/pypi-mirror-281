...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2235, _2236
...
class _Cast_AxialFeedJournalBearing:
    ...
    def axial_groove_journal_bearing(
        self: "CastSelf",
    ) -> "_2235.AxialGrooveJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2235

        return self.__parent__._cast(_2235.AxialGrooveJournalBearing)

    @property
    def axial_hole_journal_bearing(self: "CastSelf") -> "_2236.AxialHoleJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2236

        return self.__parent__._cast(_2236.AxialHoleJournalBearing)
