...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2235, _2236, _2237
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlainOilFedJournalBearing(_2244.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self: "Self") -> "_1939.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1939", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @enforce_parameter_types
    def feed_type(self: "Self", value: "_1939.JournalOilFeedType") -> None:
    ...
    @property
    def axial_groove_oil_feed(self: "Self") -> "_2235.AxialGrooveJournalBearing":
    ...
    @property
    def axial_hole_oil_feed(self: "Self") -> "_2236.AxialHoleJournalBearing":
    ...
    def circumferential_groove_oil_feed(
        self: "Self",
    ) -> "_2237.CircumferentialFeedJournalBearing":
