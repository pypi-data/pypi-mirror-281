...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2213, _2215, _2218
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalRollerBearing(_2214.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    def permissible_axial_load_default_calculation_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results._1995",
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: "Self", value: "_1995.CylindricalRollerMaxAxialLoadMethod"
    ) -> None:
