...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2214, _2215, _2218
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialThrustNeedleRollerBearing(_2191.AxialThrustCylindricalRollerBearing):
    """AxialThrustNeedleRollerBearing
