...
from mastapy._private.bearings.tolerances import _1962, _1975, _1961
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1959, _1965, _1953
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SupportTolerance(_1961.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: "Self", value: "_1962.ITDesignation") -> None:
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: "Self", value: "_1975.SupportToleranceLocationDesignation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
