...
class _Cast_RollerBearingProfile:
    ...
    def roller_bearing_conical_profile(
        self: "CastSelf",
    ) -> "_1982.RollerBearingConicalProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1982

        return self.__parent__._cast(_1982.RollerBearingConicalProfile)

    @property
    def roller_bearing_crowned_profile(
        self: "CastSelf",
    ) -> "_1983.RollerBearingCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1983

        return self.__parent__._cast(_1983.RollerBearingCrownedProfile)

    @property
    def roller_bearing_din_lundberg_profile(
        self: "CastSelf",
    ) -> "_1984.RollerBearingDinLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1984

        return self.__parent__._cast(_1984.RollerBearingDinLundbergProfile)

    @property
    def roller_bearing_flat_profile(
        self: "CastSelf",
    ) -> "_1985.RollerBearingFlatProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1985

        return self.__parent__._cast(_1985.RollerBearingFlatProfile)

    @property
    def roller_bearing_johns_gohar_profile(
        self: "CastSelf",
    ) -> "_1986.RollerBearingJohnsGoharProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1986

        return self.__parent__._cast(_1986.RollerBearingJohnsGoharProfile)

    @property
    def roller_bearing_lundberg_profile(
        self: "CastSelf",
    ) -> "_1987.RollerBearingLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1987

        return self.__parent__._cast(_1987.RollerBearingLundbergProfile)

    @property
    def roller_bearing_tangential_crowned_profile(
        self: "CastSelf",
    ) -> "_1989.RollerBearingTangentialCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1989

        return self.__parent__._cast(_1989.RollerBearingTangentialCrownedProfile)

    @property
    def roller_bearing_user_specified_profile(
        self: "CastSelf",
    ) -> "_1990.RollerBearingUserSpecifiedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1990

        return self.__parent__._cast(_1990.RollerBearingUserSpecifiedProfile)
