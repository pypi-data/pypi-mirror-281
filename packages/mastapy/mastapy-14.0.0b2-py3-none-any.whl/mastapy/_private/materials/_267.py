...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self",
    ) -> "_270.ISO76StaticSafetyFactorLimits":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._270", "ISO76StaticSafetyFactorLimits"
        )(value)

    @bearing_iso762006_static_safety_factor_limit.setter
    @enforce_parameter_types
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self", value: "_270.ISO76StaticSafetyFactorLimits"
    ) -> None:
    ...
    @property
    def driven_machine_characteristics(self: "Self") -> "_302.WorkingCharacteristics":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._302", "WorkingCharacteristics"
        )(value)

    @driven_machine_characteristics.setter
    @enforce_parameter_types
    def driven_machine_characteristics(
        self: "Self", value: "_302.WorkingCharacteristics"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def driving_machine_characteristics(self: "Self") -> "_302.WorkingCharacteristics":
        """mastapy._private.materials.WorkingCharacteristics"""
    ...
    @property
    def gearing_type(self: "Self") -> "_266.GearingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._266", "GearingTypes"
        )(value)

    @gearing_type.setter
    @enforce_parameter_types
    def gearing_type(self: "Self", value: "_266.GearingTypes") -> None:
    ...
    @property
    def transmission_application(self: "Self") -> "_298.TransmissionApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._298", "TransmissionApplications"
        )(value)

    @transmission_application.setter
    @enforce_parameter_types
    def transmission_application(
        self: "Self", value: "_298.TransmissionApplications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def wind_turbine_standard(self: "Self") -> "_301.WindTurbineStandards":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._301", "WindTurbineStandards"
        )(value)

    @wind_turbine_standard.setter
    @enforce_parameter_types
    def wind_turbine_standard(self: "Self", value: "_301.WindTurbineStandards") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def air_properties(self: "Self") -> "_254.AirProperties":
    ...
    @property
    def vehicle_dynamics(self: "Self") -> "_300.VehicleDynamicsProperties":
