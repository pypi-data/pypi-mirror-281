...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _261, _264
...
class _Cast_FatigueSafetyFactorItemBase:
    ...
    def composite_fatigue_safety_factor_item(
        self: "CastSelf",
    ) -> "_261.CompositeFatigueSafetyFactorItem":
        from mastapy._private.materials import _261

        return self.__parent__._cast(_261.CompositeFatigueSafetyFactorItem)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FatigueSafetyFactorItemBase(_291.SafetyFactorItem):
    """FatigueSafetyFactorItemBase
