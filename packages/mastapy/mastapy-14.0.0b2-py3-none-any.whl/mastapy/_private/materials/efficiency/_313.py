...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _304, _306
...
class _Cast_ResistiveTorque:
    ...
    @property
    def combined_resistive_torque(self: "CastSelf") -> "_304.CombinedResistiveTorque":
        from mastapy._private.materials.efficiency import _304

        return self.__parent__._cast(_304.CombinedResistiveTorque)

    @property
    def independent_resistive_torque(
        self: "CastSelf",
    ) -> "_306.IndependentResistiveTorque":
        from mastapy._private.materials.efficiency import _306

        return self.__parent__._cast(_306.IndependentResistiveTorque)
