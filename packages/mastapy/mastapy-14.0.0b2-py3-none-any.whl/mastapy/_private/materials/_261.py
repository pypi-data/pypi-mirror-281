...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _265, _291
...
class _Cast_CompositeFatigueSafetyFactorItem:
    ...
    @property
    def fatigue_safety_factor_item(self: "CastSelf") -> "_264.FatigueSafetyFactorItem":
        return self.__parent__._cast(_264.FatigueSafetyFactorItem)

    @property
    def fatigue_safety_factor_item_base(
        self: "CastSelf",
    ) -> "_265.FatigueSafetyFactorItemBase":
        from mastapy._private.materials import _265

        return self.__parent__._cast(_265.FatigueSafetyFactorItemBase)

    @property
    def safety_factor_item(self: "CastSelf") -> "_291.SafetyFactorItem":
        from mastapy._private.materials import _291

        return self.__parent__._cast(_291.SafetyFactorItem)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CompositeFatigueSafetyFactorItem(_264.FatigueSafetyFactorItem):
    """CompositeFatigueSafetyFactorItem
