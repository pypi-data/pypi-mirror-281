...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _177, _184
    from mastapy._private.utility_gui import _1903
    from mastapy._private.electric_machines.results import _1371, _1383
...
class _Cast_ElmerResultsViewable:
    ...
    def electric_machine_mechanical_results_viewable(
        self: "CastSelf",
    ) -> "_1371.ElectricMachineMechanicalResultsViewable":
        from mastapy._private.electric_machines.results import _1371

        return self.__parent__._cast(_1371.ElectricMachineMechanicalResultsViewable)

    @property
    def electric_machine_results_viewable(
        self: "CastSelf",
    ) -> "_1383.ElectricMachineResultsViewable":
        from mastapy._private.electric_machines.results import _1383

        return self.__parent__._cast(_1383.ElectricMachineResultsViewable)
...
class ElmerResultsViewable(_0.APIBase):
    ...
    @enforce_parameter_types
    def degree_of_freedom(
        self: "Self", value: "_1573.ResultOptionsFor3DVector"
    ) -> None:
    ...
    @property
    def elemental_or_nodal_data(self: "Self") -> "_177.ElmerResultEntityType":
        """mastapy._private.nodal_analysis.elmer.ElmerResultEntityType"""
        temp = self.wrapped.ElementalOrNodalData
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._177", "ElmerResultEntityType"
        )(value)

    @elemental_or_nodal_data.setter
    @enforce_parameter_types
    def elemental_or_nodal_data(
        self: "Self", value: "_177.ElmerResultEntityType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.NodalAnalysis.Elmer.ElmerResultEntityType"
        )
        self.wrapped.ElementalOrNodalData = value

    @property
    def nodal_average_type(self: "Self") -> "_184.NodalAverageType":
        """mastapy._private.nodal_analysis.elmer.NodalAverageType"""
        temp = self.wrapped.NodalAverageType
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._184", "NodalAverageType"
        )(value)

    @nodal_average_type.setter
    @enforce_parameter_types
    def nodal_average_type(self: "Self", value: "_184.NodalAverageType") -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.NodalAnalysis.Elmer.NodalAverageType"
        )
        self.wrapped.NodalAverageType = value
    ...
    @result_type.setter
    @enforce_parameter_types
    def result_type(self: "Self", value: "_182.ElmerResultType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def scaling_draw_style(self: "Self") -> "_1903.ScalingDrawStyle":
