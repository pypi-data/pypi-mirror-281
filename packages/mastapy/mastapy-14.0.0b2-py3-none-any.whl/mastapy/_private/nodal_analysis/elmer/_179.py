...
from mastapy._private.nodal_analysis.elmer import _178
...
class _Cast_ElmerResultsFromElectromagneticAnalysis:
    ...
    @property
    def elmer_results(self: "CastSelf") -> "_178.ElmerResults":
        return self.__parent__._cast(_178.ElmerResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElmerResultsFromElectromagneticAnalysis(_178.ElmerResults):
    """ElmerResultsFromElectromagneticAnalysis
