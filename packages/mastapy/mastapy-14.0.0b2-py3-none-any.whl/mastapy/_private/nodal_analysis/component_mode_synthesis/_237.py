...
class CMSModel(_0.APIBase):
    ...
    def software_used_for_reduction(
        self: "Self",
    ) -> "_245.SoftwareUsedForReductionType":
    ...
    @property
    def fe_model(self: "Self") -> "_195.FEModel":
    ...
    @property
    def reduction_information(self: "Self") -> "_1625.AnalysisRunInformation":
    ...
    @property
    def reduction_options(self: "Self") -> "_239.CMSOptions":
    ...
    @property
    def element_face_groups(self: "Self") -> "List[_235.CMSElementFaceGroup]":
