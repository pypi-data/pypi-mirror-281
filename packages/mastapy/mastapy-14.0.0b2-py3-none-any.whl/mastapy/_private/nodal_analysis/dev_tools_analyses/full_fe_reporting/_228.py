...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    def class_(self: "Self", value: "_1281.MaterialPropertyClass") -> None:
    ...
    def elastic_modulus_components(
        self: "Self",
    ) -> "_217.ElasticModulusOrthotropicComponents":
    ...
    def poissons_ratio_components(
        self: "Self",
    ) -> "_230.PoissonRatioOrthotropicComponents":
    ...
    def shear_modulus_components(
        self: "Self",
    ) -> "_232.ShearModulusOrthotropicComponents":
    ...
    def thermal_expansion_coefficient_components(
        self: "Self",
    ) -> "_233.ThermalExpansionOrthotropicComponents":
