...
if TYPE_CHECKING:
    ...
    from mastapy._private.fe_tools.vis_tools_global.vis_tools_global_enums import _1276
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementPropertiesShell(_227.ElementPropertiesWithMaterial):
    """ElementPropertiesShell
    ...
    @property
    def wall_type(self: "Self") -> "_1276.ElementPropertiesShellWallType":
