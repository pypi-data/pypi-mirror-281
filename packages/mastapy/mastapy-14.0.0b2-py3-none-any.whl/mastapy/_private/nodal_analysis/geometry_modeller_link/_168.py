...
from mastapy._private.nodal_analysis.geometry_modeller_link import _159
...
class _Cast_GeometryModellerUnitlessDimension:
    ...
    def base_geometry_modeller_dimension(
        ...
        return self.__parent__._cast(_159.BaseGeometryModellerDimension)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GeometryModellerUnitlessDimension(_159.BaseGeometryModellerDimension):
    """GeometryModellerUnitlessDimension
