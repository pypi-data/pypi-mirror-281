...
class _Cast_BaseGeometryModellerDimension:
    ...
    def geometry_modeller_angle_dimension(
        ...
        return self.__parent__._cast(_160.GeometryModellerAngleDimension)
    ...
    def geometry_modeller_count_dimension(
        ...
        return self.__parent__._cast(_161.GeometryModellerCountDimension)
    ...
    def geometry_modeller_length_dimension(
        ...
        return self.__parent__._cast(_166.GeometryModellerLengthDimension)
    ...
    def geometry_modeller_unitless_dimension(
        ...
        return self.__parent__._cast(_168.GeometryModellerUnitlessDimension)
