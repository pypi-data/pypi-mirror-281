...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1831, _1832, _1792, _1805, _1826, _1835
    from mastapy._private.utility.reporting_property_framework import _1836
...
class _Cast_CustomReportPropertyItem:
    ...
    @property
    def blank_row(self: "CastSelf") -> "_1792.BlankRow":
        from mastapy._private.utility.report import _1792

        return self.__parent__._cast(_1792.BlankRow)

    @property
    def custom_report_chart_item(self: "CastSelf") -> "_1805.CustomReportChartItem":
        from mastapy._private.utility.report import _1805

        return self.__parent__._cast(_1805.CustomReportChartItem)
    ...
    @property
    def user_text_row(self: "CastSelf") -> "_1835.UserTextRow":
        from mastapy._private.utility.report import _1835

        return self.__parent__._cast(_1835.UserTextRow)
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_style(self: "Self") -> "_1831.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1831", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: "Self", value: "_1831.FontStyle") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Utility.Report.FontStyle")
        self.wrapped.FontStyle = value

    @property
    def font_weight(self: "Self") -> "_1832.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1832", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: "Self", value: "_1832.FontWeight") -> None:
    ...
    @property
    def horizontal_position(self: "Self") -> "_1836.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.reporting_property_framework._1836",
            "CellValuePosition",
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: "Self", value: "_1836.CellValuePosition") -> None:
        value = conversion.mp_to_pn_enum(
