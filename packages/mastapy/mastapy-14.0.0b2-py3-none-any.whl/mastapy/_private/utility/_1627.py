...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1640, _1626
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1640.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1626.DispatcherHelper]":
