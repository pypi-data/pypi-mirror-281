...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1890, _1891, _1892, _1893, _1894
...
TMeasurement = TypeVar("TMeasurement", bound="_1652.MeasurementBase")
T = TypeVar("T")
...
class _Cast_DutyCyclePropertySummary:
    ...
    def duty_cycle_property_summary_force(
        self: "CastSelf",
    ) -> "_1890.DutyCyclePropertySummaryForce":
        from mastapy._private.utility.property import _1890

        return self.__parent__._cast(_1890.DutyCyclePropertySummaryForce)

    @property
    def duty_cycle_property_summary_percentage(
        self: "CastSelf",
    ) -> "_1891.DutyCyclePropertySummaryPercentage":
        from mastapy._private.utility.property import _1891

        return self.__parent__._cast(_1891.DutyCyclePropertySummaryPercentage)

    @property
    def duty_cycle_property_summary_small_angle(
        self: "CastSelf",
    ) -> "_1892.DutyCyclePropertySummarySmallAngle":
        from mastapy._private.utility.property import _1892

        return self.__parent__._cast(_1892.DutyCyclePropertySummarySmallAngle)

    @property
    def duty_cycle_property_summary_stress(
        self: "CastSelf",
    ) -> "_1893.DutyCyclePropertySummaryStress":
        from mastapy._private.utility.property import _1893

        return self.__parent__._cast(_1893.DutyCyclePropertySummaryStress)

    @property
    def duty_cycle_property_summary_very_short_length(
        self: "CastSelf",
    ) -> "_1894.DutyCyclePropertySummaryVeryShortLength":
        from mastapy._private.utility.property import _1894

        return self.__parent__._cast(_1894.DutyCyclePropertySummaryVeryShortLength)
