...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1916, _1910
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_1910.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _1910

        return self.__parent__._cast(_1910.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_1916.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._1916", "SMTAxis"
        )(value)
