...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1791, _1796
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ThreeDChartDefinition(_1911.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: "Self") -> "_1791.AxisSettings":
    ...
    @property
    def x_axis_range(self: "Self") -> "_1535.Range":
    ...
    def x_axis_range(self: "Self", value: "_1535.Range") -> None:
        self.wrapped.XAxisRange = value.wrapped

    @property
    def y_axis_range(self: "Self") -> "_1535.Range":
        """mastapy._private.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: "Self", value: "_1535.Range") -> None:
        self.wrapped.YAxisRange = value.wrapped

    @property
    def z_axis_range(self: "Self") -> "_1535.Range":
        """mastapy._private.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: "Self", value: "_1535.Range") -> None:
        self.wrapped.ZAxisRange = value.wrapped

    def data_points_for_surfaces(self: "Self") -> "List[_1913.PointsForSurface]":
