...
class ListWithSelectedItem_FEPart(_2507.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2507.FEPart.TYPE

    @property
    def selected_value(self: "Self") -> "_2507.FEPart":
    ...
    @property
    def available_values(self: "Self") -> "List[_2507.FEPart]":
