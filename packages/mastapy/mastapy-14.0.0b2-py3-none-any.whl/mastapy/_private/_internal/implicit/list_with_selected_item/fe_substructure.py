...
class ListWithSelectedItem_FESubstructure(
    _2437.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2437.FESubstructure.TYPE

    @property
    def selected_value(self: "Self") -> "_2437.FESubstructure":
    ...
    @property
    def available_values(self: "Self") -> "List[_2437.FESubstructure]":
