...
class ListWithSelectedItem_Component(_2498.Component, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2498.Component.TYPE

    @property
    def selected_value(self: "Self") -> "_2498.Component":
    ...
    @property
    def available_values(self: "Self") -> "List[_2498.Component]":
