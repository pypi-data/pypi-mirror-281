...
class ListWithSelectedItem_GearSetDesign(
    _974.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSetDesign]") -> "Any":
        ...
        Returns:
            Any
        """
        return _974.GearSetDesign.TYPE

    @property
    def selected_value(self: "Self") -> "_974.GearSetDesign":
    ...
    @property
    def available_values(self: "Self") -> "List[_974.GearSetDesign]":
