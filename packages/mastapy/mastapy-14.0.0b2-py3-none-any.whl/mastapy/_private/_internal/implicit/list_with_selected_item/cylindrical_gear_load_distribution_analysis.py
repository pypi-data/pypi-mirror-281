...
class ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis(
    _879.CylindricalGearLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _879.CylindricalGearLoadDistributionAnalysis.TYPE

    @property
    def selected_value(self: "Self") -> "_879.CylindricalGearLoadDistributionAnalysis":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_879.CylindricalGearLoadDistributionAnalysis]":
