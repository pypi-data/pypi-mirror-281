...
class ListWithSelectedItem_CylindricalGear(
    _2581.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2581.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2581.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2581.CylindricalGear]":
