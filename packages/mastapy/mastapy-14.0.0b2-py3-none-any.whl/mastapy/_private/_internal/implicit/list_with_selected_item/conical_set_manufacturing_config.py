...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _814.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _814.ConicalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: "Self") -> "_814.ConicalSetManufacturingConfig":
    ...
    @property
    def available_values(self: "Self") -> "List[_814.ConicalSetManufacturingConfig]":
