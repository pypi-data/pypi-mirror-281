...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2016.RaceAxialMountingType
        """
        return _2016.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2016.RaceAxialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2016.RaceAxialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2016.RaceAxialMountingType]":
