...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_1923.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _1923.BasicStaticLoadRatingCalculationMethod
        """
        return _1923.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1923.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1923.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1923.BasicStaticLoadRatingCalculationMethod]":
