...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2267.MeshStiffnessModel
        """
        return _2267.MeshStiffnessModel
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_MeshStiffnessModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2267.MeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_2267.MeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2267.MeshStiffnessModel]":
