...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation]",
    ) -> "_5950.StiffnessOptionsForHarmonicAnalysis.StepCreation":
        ...
        Returns:
            _5950.StiffnessOptionsForHarmonicAnalysis.StepCreation
        """
        return _5950.StiffnessOptionsForHarmonicAnalysis.StepCreation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5950.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5950.StiffnessOptionsForHarmonicAnalysis.StepCreation]":
