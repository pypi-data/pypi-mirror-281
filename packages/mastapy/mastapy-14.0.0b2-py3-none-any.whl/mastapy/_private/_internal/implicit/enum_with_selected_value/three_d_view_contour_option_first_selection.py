...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection]",
    ) -> "_1872.ThreeDViewContourOptionFirstSelection":
        ...
        Returns:
            _1872.ThreeDViewContourOptionFirstSelection
        """
        return _1872.ThreeDViewContourOptionFirstSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1872.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1872.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1872.ThreeDViewContourOptionFirstSelection]":
