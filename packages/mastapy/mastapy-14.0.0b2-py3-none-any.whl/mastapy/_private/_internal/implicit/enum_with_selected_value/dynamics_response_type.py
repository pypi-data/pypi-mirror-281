...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    def wrapped_type(
        ...
        Returns:
            _4738.DynamicsResponseType
        """
        return _4738.DynamicsResponseType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DynamicsResponseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _4738.DynamicsResponseType.type_()

    @property
    def selected_value(self: "Self") -> "_4738.DynamicsResponseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_4738.DynamicsResponseType]":
