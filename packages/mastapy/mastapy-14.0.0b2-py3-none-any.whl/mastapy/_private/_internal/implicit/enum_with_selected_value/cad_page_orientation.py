...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1793.CadPageOrientation
        """
        return _1793.CadPageOrientation
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CadPageOrientation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1793.CadPageOrientation.type_()

    @property
    def selected_value(self: "Self") -> "_1793.CadPageOrientation":
    ...
    @property
    def available_values(self: "Self") -> "List[_1793.CadPageOrientation]":
