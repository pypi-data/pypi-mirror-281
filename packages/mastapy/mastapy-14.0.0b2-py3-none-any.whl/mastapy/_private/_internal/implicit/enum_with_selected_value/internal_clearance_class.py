...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1954.InternalClearanceClass
        """
        return _1954.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1954.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1954.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1954.InternalClearanceClass]":
