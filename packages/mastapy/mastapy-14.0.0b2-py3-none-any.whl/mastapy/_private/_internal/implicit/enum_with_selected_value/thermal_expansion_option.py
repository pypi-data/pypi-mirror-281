...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2465.ThermalExpansionOption
        """
        return _2465.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2465.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2465.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2465.ThermalExpansionOption]":
