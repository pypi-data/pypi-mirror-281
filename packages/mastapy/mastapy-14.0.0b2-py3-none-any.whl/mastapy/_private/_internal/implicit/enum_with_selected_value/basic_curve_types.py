...
class EnumWithSelectedValue_BasicCurveTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BasicCurveTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _323.BasicCurveTypes.type_()

    @property
    def selected_value(self: "Self") -> "_323.BasicCurveTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_323.BasicCurveTypes]":
