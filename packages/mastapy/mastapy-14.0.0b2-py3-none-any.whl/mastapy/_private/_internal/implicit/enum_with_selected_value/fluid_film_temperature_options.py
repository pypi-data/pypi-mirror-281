...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1936.FluidFilmTemperatureOptions
        """
        return _1936.FluidFilmTemperatureOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1936.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1936.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1936.FluidFilmTemperatureOptions]":
