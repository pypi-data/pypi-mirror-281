...
class EnumWithSelectedValue_Axis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "_1538.Axis":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1538.Axis.type_()

    @property
    def selected_value(self: "Self") -> "_1538.Axis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1538.Axis]":
