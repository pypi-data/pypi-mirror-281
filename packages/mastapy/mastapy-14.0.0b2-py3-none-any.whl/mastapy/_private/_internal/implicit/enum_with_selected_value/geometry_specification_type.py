...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GeometrySpecificationType]",
    ) -> "_1080.GeometrySpecificationType":
        ...
        Returns:
            _1080.GeometrySpecificationType
        """
        return _1080.GeometrySpecificationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1080.GeometrySpecificationType.type_()

    @property
    def selected_value(self: "Self") -> "_1080.GeometrySpecificationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1080.GeometrySpecificationType]":
