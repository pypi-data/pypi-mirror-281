...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_1944.RollingBearingArrangement":
        ...
        Returns:
            _1944.RollingBearingArrangement
        """
        return _1944.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1944.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_1944.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_1944.RollingBearingArrangement]":
