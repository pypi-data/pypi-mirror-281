...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LinkNodeSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2452.LinkNodeSource.type_()

    @property
    def selected_value(self: "Self") -> "_2452.LinkNodeSource":
    ...
    @property
    def available_values(self: "Self") -> "List[_2452.LinkNodeSource]":
