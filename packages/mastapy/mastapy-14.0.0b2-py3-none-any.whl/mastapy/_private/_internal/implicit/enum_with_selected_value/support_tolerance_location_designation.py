...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SupportToleranceLocationDesignation]",
    ) -> "_1975.SupportToleranceLocationDesignation":
        ...
        Returns:
            _1975.SupportToleranceLocationDesignation
        """
        return _1975.SupportToleranceLocationDesignation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1975.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: "Self") -> "_1975.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1975.SupportToleranceLocationDesignation]":
