...
class EnumWithSelectedValue_LubricantDefinition(
    ...
    def wrapped_type(
        ...
        Returns:
            _272.LubricantDefinition
        """
        return _272.LubricantDefinition
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricantDefinition]") -> "Any":
        ...
        Returns:
            Any
        """
        return _272.LubricantDefinition.type_()

    @property
    def selected_value(self: "Self") -> "_272.LubricantDefinition":
    ...
    @property
    def available_values(self: "Self") -> "List[_272.LubricantDefinition]":
