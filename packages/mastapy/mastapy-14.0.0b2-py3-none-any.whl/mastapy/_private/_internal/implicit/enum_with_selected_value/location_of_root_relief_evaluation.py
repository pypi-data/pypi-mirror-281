...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfRootReliefEvaluation]",
    ) -> "_586.LocationOfRootReliefEvaluation":
        ...
        Returns:
            _586.LocationOfRootReliefEvaluation
        """
        return _586.LocationOfRootReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _586.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_586.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_586.LocationOfRootReliefEvaluation]":
