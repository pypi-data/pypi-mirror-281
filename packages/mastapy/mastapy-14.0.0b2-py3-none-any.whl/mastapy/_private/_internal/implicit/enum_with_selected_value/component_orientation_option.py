...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2419.ComponentOrientationOption":
        ...
        Returns:
            _2419.ComponentOrientationOption
        """
        return _2419.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2419.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2419.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2419.ComponentOrientationOption]":
