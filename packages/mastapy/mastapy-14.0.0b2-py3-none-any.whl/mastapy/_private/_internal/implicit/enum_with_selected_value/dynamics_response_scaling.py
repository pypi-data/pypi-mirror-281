...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1552.DynamicsResponseScaling
        """
        return _1552.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1552.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1552.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1552.DynamicsResponseScaling]":
