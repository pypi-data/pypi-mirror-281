...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LoadCaseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1410.LoadCaseType.type_()

    @property
    def selected_value(self: "Self") -> "_1410.LoadCaseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1410.LoadCaseType]":
