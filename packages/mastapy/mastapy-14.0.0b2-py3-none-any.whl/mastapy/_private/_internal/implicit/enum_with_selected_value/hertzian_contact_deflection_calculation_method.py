...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1620.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1620.HertzianContactDeflectionCalculationMethod
        """
        return _1620.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1620.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1620.HertzianContactDeflectionCalculationMethod]":
