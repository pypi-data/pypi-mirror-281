...
class EnumWithSelectedValue_LocationOfEvaluationUpperLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationUpperLimit]",
    ) -> "_585.LocationOfEvaluationUpperLimit":
        ...
        Returns:
            _585.LocationOfEvaluationUpperLimit
        """
        return _585.LocationOfEvaluationUpperLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _585.LocationOfEvaluationUpperLimit.type_()

    @property
    def selected_value(self: "Self") -> "_585.LocationOfEvaluationUpperLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_585.LocationOfEvaluationUpperLimit]":
