...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1103.ScuffingCoefficientOfFrictionMethods
        """
        return _1103.ScuffingCoefficientOfFrictionMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1103.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1103.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1103.ScuffingCoefficientOfFrictionMethods]":
