...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods]",
    ) -> "_1217.AGMAGleasonConicalGearGeometryMethods":
        ...
        Returns:
            _1217.AGMAGleasonConicalGearGeometryMethods
        """
        return _1217.AGMAGleasonConicalGearGeometryMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1217.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1217.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1217.AGMAGleasonConicalGearGeometryMethods]":
