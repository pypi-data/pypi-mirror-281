...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1947.RollingBearingRaceType
        """
        return _1947.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1947.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_1947.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1947.RollingBearingRaceType]":
