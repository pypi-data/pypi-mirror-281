...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _344.ISOToleranceStandard
        """
        return _344.ISOToleranceStandard
    ...
    def implicit_type(cls: "Type[Overridable_ISOToleranceStandard]") -> "Any":
        ...
        Returns:
            Any
        """
        return _344.ISOToleranceStandard.type_()

    @property
    def value(self: "Self") -> "_344.ISOToleranceStandard":
    ...
    @property
    def override_value(self: "Self") -> "_344.ISOToleranceStandard":
        """mastapy._private.gears.ISOToleranceStandard
    ...
    @property
    def calculated_value(self: "Self") -> "_344.ISOToleranceStandard":
        """mastapy._private.gears.ISOToleranceStandard
