...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_CylindricalRollerMaxAxialLoadMethod]",
    ) -> "_1995.CylindricalRollerMaxAxialLoadMethod":
        ...
        Returns:
            _1995.CylindricalRollerMaxAxialLoadMethod
        """
        return _1995.CylindricalRollerMaxAxialLoadMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1995.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: "Self") -> "_1995.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: "Self") -> "_1995.CylindricalRollerMaxAxialLoadMethod":
        """mastapy._private.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_1995.CylindricalRollerMaxAxialLoadMethod":
        """mastapy._private.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
