...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2456.NodeSelectionDepthOption":
        ...
        Returns:
            _2456.NodeSelectionDepthOption
        """
        return _2456.NodeSelectionDepthOption
    ...
    def implicit_type(cls: "Type[Overridable_NodeSelectionDepthOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2456.NodeSelectionDepthOption.type_()

    @property
    def value(self: "Self") -> "_2456.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: "Self") -> "_2456.NodeSelectionDepthOption":
        """mastapy._private.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2456.NodeSelectionDepthOption":
        """mastapy._private.system_model.fe.NodeSelectionDepthOption
