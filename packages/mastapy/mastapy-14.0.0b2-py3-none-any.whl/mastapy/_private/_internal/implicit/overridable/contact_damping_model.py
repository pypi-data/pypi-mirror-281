...
from mastapy._private.math_utility.hertzian_contact import _1619
...
class Overridable_ContactDampingModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1619.ContactDampingModel
        """
        return _1619.ContactDampingModel
    ...
    def implicit_type(cls: "Type[Overridable_ContactDampingModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1619.ContactDampingModel.type_()

    @property
    def value(self: "Self") -> "_1619.ContactDampingModel":
    ...
    @property
    def override_value(self: "Self") -> "_1619.ContactDampingModel":
        """mastapy._private.math_utility.hertzian_contact.ContactDampingModel
    ...
    @property
    def calculated_value(self: "Self") -> "_1619.ContactDampingModel":
        """mastapy._private.math_utility.hertzian_contact.ContactDampingModel
