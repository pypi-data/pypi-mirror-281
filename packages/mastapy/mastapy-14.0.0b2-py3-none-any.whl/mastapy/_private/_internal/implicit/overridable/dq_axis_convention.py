...
class Overridable_DQAxisConvention(mixins.OverridableMixin, Enum):
    ...
    def implicit_type(cls: "Type[Overridable_DQAxisConvention]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1300.DQAxisConvention.type_()

    @property
    def value(self: "Self") -> "_1300.DQAxisConvention":
    ...
    @property
    def override_value(self: "Self") -> "_1300.DQAxisConvention":
        """mastapy._private.electric_machines.DQAxisConvention
    ...
    @property
    def calculated_value(self: "Self") -> "_1300.DQAxisConvention":
        """mastapy._private.electric_machines.DQAxisConvention
