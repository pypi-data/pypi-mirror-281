...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_FrictionModelForGyroscopicMoment]",
    ) -> "_2025.FrictionModelForGyroscopicMoment":
        ...
        Returns:
            _2025.FrictionModelForGyroscopicMoment
        """
        return _2025.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2025.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: "Self") -> "_2025.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: "Self") -> "_2025.FrictionModelForGyroscopicMoment":
        """mastapy._private.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: "Self") -> "_2025.FrictionModelForGyroscopicMoment":
        """mastapy._private.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
