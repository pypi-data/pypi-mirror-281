...
class Overridable_MicroGeometryModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _347.MicroGeometryModel
        """
        return _347.MicroGeometryModel
    ...
    def implicit_type(cls: "Type[Overridable_MicroGeometryModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _347.MicroGeometryModel.type_()

    @property
    def value(self: "Self") -> "_347.MicroGeometryModel":
    ...
    @property
    def override_value(self: "Self") -> "_347.MicroGeometryModel":
        """mastapy._private.gears.MicroGeometryModel
    ...
    @property
    def calculated_value(self: "Self") -> "_347.MicroGeometryModel":
        """mastapy._private.gears.MicroGeometryModel
