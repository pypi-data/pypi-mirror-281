...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _7070.MeshStiffnessSource
        """
        return _7070.MeshStiffnessSource
    ...
    def implicit_type(cls: "Type[Overridable_MeshStiffnessSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7070.MeshStiffnessSource.type_()

    @property
    def value(self: "Self") -> "_7070.MeshStiffnessSource":
    ...
    @property
    def override_value(self: "Self") -> "_7070.MeshStiffnessSource":
        """mastapy._private.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: "Self") -> "_7070.MeshStiffnessSource":
        """mastapy._private.system_model.analyses_and_results.static_loads.MeshStiffnessSource
