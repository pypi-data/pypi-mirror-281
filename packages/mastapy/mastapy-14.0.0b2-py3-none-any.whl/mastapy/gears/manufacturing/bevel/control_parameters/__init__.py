...
if __tc:
    from mastapy._private.gears.manufacturing.bevel.control_parameters._840 import (
        ConicalGearManufacturingControlParameters,
    )
    from mastapy._private.gears.manufacturing.bevel.control_parameters._841 import (
    ...
    __import_structure = {
        "_private.gears.manufacturing.bevel.control_parameters._840": [
            "ConicalGearManufacturingControlParameters"
        ],
        "_private.gears.manufacturing.bevel.control_parameters._841": [
            "ConicalManufacturingSGMControlParameters"
        ],
