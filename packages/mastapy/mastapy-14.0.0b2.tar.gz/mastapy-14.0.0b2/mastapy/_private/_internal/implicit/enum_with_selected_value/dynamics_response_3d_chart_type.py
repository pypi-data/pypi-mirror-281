...
class EnumWithSelectedValue_DynamicsResponse3DChartType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DynamicsResponse3DChartType]",
    ) -> "_4737.DynamicsResponse3DChartType":
        ...
        Returns:
            _4737.DynamicsResponse3DChartType
        """
        return _4737.DynamicsResponse3DChartType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4737.DynamicsResponse3DChartType.type_()

    @property
    def selected_value(self: "Self") -> "_4737.DynamicsResponse3DChartType":
    ...
    @property
    def available_values(self: "Self") -> "List[_4737.DynamicsResponse3DChartType]":
