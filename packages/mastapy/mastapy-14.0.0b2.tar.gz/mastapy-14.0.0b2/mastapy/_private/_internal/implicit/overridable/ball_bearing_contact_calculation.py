...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2020.BallBearingContactCalculation
        """
        return _2020.BallBearingContactCalculation
    ...
    def implicit_type(cls: "Type[Overridable_BallBearingContactCalculation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2020.BallBearingContactCalculation.type_()

    @property
    def value(self: "Self") -> "_2020.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: "Self") -> "_2020.BallBearingContactCalculation":
        """mastapy._private.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: "Self") -> "_2020.BallBearingContactCalculation":
        """mastapy._private.bearings.bearing_results.rolling.BallBearingContactCalculation
