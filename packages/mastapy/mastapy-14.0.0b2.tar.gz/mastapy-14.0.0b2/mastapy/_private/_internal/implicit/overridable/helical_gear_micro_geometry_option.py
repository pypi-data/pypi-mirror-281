...
class Overridable_HelicalGearMicroGeometryOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _521.HelicalGearMicroGeometryOption
        """
        return _521.HelicalGearMicroGeometryOption
    ...
    def implicit_type(cls: "Type[Overridable_HelicalGearMicroGeometryOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _521.HelicalGearMicroGeometryOption.type_()

    @property
    def value(self: "Self") -> "_521.HelicalGearMicroGeometryOption":
    ...
    @property
    def override_value(self: "Self") -> "_521.HelicalGearMicroGeometryOption":
        """mastapy._private.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
    ...
    @property
    def calculated_value(self: "Self") -> "_521.HelicalGearMicroGeometryOption":
        """mastapy._private.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
