...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1207.LoadDistributionFactorMethods
        """
        return _1207.LoadDistributionFactorMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1207.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1207.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1207.LoadDistributionFactorMethods]":
