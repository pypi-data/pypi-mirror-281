...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1956.BearingToleranceDefinitionOptions
        """
        return _1956.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1956.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1956.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1956.BearingToleranceDefinitionOptions]":
