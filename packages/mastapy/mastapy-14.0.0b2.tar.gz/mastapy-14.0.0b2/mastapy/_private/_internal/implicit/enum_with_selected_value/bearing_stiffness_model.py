...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5510.BearingStiffnessModel
        """
        return _5510.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5510.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5510.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5510.BearingStiffnessModel]":
