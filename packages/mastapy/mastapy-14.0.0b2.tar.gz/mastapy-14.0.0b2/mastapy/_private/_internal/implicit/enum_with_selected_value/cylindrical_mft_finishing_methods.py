...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftFinishingMethods]",
    ) -> "_646.CylindricalMftFinishingMethods":
        ...
        Returns:
            _646.CylindricalMftFinishingMethods
        """
        return _646.CylindricalMftFinishingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _646.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: "Self") -> "_646.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_646.CylindricalMftFinishingMethods]":
