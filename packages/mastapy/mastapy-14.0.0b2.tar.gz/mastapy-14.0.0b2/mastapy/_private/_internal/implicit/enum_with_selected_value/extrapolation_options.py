...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1556.ExtrapolationOptions
        """
        return _1556.ExtrapolationOptions
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ExtrapolationOptions]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1556.ExtrapolationOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1556.ExtrapolationOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1556.ExtrapolationOptions]":
