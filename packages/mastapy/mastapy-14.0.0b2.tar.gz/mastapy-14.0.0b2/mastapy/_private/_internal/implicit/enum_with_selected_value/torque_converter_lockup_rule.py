...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5636.TorqueConverterLockupRule":
        ...
        Returns:
            _5636.TorqueConverterLockupRule
        """
        return _5636.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5636.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5636.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5636.TorqueConverterLockupRule]":
