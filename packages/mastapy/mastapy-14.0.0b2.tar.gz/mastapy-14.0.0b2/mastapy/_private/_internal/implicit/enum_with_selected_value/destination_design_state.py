...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7140.DestinationDesignState
        """
        return _7140.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7140.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7140.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7140.DestinationDesignState]":
