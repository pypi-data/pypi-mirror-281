...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2653.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2653.RigidConnectorToothSpacingType
        """
        return _2653.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2653.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2653.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2653.RigidConnectorToothSpacingType]":
