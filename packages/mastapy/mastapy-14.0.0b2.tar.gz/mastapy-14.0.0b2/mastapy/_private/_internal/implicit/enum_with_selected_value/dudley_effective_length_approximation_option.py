...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1440.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1440.DudleyEffectiveLengthApproximationOption
        """
        return _1440.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1440.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1440.DudleyEffectiveLengthApproximationOption]":
