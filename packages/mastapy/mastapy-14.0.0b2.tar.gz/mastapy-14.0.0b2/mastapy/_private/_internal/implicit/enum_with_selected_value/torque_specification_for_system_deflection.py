...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7126.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7126.TorqueSpecificationForSystemDeflection
        """
        return _7126.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7126.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: "Self") -> "_7126.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7126.TorqueSpecificationForSystemDeflection]":
