...
class Overridable_BearingEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _303.BearingEfficiencyRatingMethod
        """
        return _303.BearingEfficiencyRatingMethod
    ...
    def implicit_type(cls: "Type[Overridable_BearingEfficiencyRatingMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _303.BearingEfficiencyRatingMethod.type_()

    @property
    def value(self: "Self") -> "_303.BearingEfficiencyRatingMethod":
    ...
    @property
    def override_value(self: "Self") -> "_303.BearingEfficiencyRatingMethod":
        """mastapy._private.materials.efficiency.BearingEfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_303.BearingEfficiencyRatingMethod":
        """mastapy._private.materials.efficiency.BearingEfficiencyRatingMethod
