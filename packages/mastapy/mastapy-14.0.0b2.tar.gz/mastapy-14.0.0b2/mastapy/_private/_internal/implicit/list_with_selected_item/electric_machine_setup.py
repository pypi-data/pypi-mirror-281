...
class ListWithSelectedItem_ElectricMachineSetup(
    _1308.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ElectricMachineSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1308.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: "Self") -> "_1308.ElectricMachineSetup":
    ...
    @property
    def available_values(self: "Self") -> "List[_1308.ElectricMachineSetup]":
