...
from mastapy._private.fe_tools.enums import _1281
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1281.MaterialPropertyClass
        """
        return _1281.MaterialPropertyClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1281.MaterialPropertyClass.type_()

    @property
    def selected_value(self: "Self") -> "_1281.MaterialPropertyClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1281.MaterialPropertyClass]":
