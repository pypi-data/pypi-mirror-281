...
class ListWithSelectedItem_ElectricMachineResults(
    _1372.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1372.ElectricMachineResults.TYPE

    @property
    def selected_value(self: "Self") -> "_1372.ElectricMachineResults":
    ...
    @property
    def available_values(self: "Self") -> "List[_1372.ElectricMachineResults]":
