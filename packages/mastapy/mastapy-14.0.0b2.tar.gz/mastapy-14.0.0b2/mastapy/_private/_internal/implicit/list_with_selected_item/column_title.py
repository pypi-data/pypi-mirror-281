...
class ListWithSelectedItem_ColumnTitle(
    _1867.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ColumnTitle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1867.ColumnTitle.TYPE

    @property
    def selected_value(self: "Self") -> "_1867.ColumnTitle":
    ...
    @property
    def available_values(self: "Self") -> "List[_1867.ColumnTitle]":
