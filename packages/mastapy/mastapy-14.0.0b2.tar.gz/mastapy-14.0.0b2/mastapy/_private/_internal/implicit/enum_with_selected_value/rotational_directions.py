...
class EnumWithSelectedValue_RotationalDirections(
    ...
    def wrapped_type(
        ...
        Returns:
            _1949.RotationalDirections
        """
        return _1949.RotationalDirections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RotationalDirections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1949.RotationalDirections.type_()

    @property
    def selected_value(self: "Self") -> "_1949.RotationalDirections":
    ...
    @property
    def available_values(self: "Self") -> "List[_1949.RotationalDirections]":
