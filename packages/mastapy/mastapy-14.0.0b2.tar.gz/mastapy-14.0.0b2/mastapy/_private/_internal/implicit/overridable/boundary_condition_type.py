...
from mastapy._private.nodal_analysis.fe_export_utility import _172
...
class Overridable_BoundaryConditionType(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _172.BoundaryConditionType
        """
        return _172.BoundaryConditionType
    ...
    def implicit_type(cls: "Type[Overridable_BoundaryConditionType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _172.BoundaryConditionType.type_()

    @property
    def value(self: "Self") -> "_172.BoundaryConditionType":
    ...
    @property
    def override_value(self: "Self") -> "_172.BoundaryConditionType":
        """mastapy._private.nodal_analysis.fe_export_utility.BoundaryConditionType
    ...
    @property
    def calculated_value(self: "Self") -> "_172.BoundaryConditionType":
        """mastapy._private.nodal_analysis.fe_export_utility.BoundaryConditionType
