...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2017.RaceRadialMountingType
        """
        return _2017.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2017.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2017.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2017.RaceRadialMountingType]":
