...
class ListWithSelectedItem_FESubstructureNode(
    _2439.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructureNode]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2439.FESubstructureNode.TYPE

    @property
    def selected_value(self: "Self") -> "_2439.FESubstructureNode":
    ...
    @property
    def available_values(self: "Self") -> "List[_2439.FESubstructureNode]":
