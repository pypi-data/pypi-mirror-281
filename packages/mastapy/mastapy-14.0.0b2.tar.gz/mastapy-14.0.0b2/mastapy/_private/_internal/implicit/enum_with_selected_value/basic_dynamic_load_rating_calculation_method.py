...
from mastapy._private.bearings import _1922
...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_1922.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _1922.BasicDynamicLoadRatingCalculationMethod
        """
        return _1922.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1922.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1922.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1922.BasicDynamicLoadRatingCalculationMethod]":
