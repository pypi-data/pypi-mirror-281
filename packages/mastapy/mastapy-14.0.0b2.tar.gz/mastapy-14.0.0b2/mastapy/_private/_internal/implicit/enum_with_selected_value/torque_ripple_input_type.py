...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7125.TorqueRippleInputType
        """
        return _7125.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7125.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7125.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7125.TorqueRippleInputType]":
