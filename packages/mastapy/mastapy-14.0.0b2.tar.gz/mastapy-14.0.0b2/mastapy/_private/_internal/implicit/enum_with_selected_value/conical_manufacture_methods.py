...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalManufactureMethods]",
    ) -> "_1196.ConicalManufactureMethods":
        ...
        Returns:
            _1196.ConicalManufactureMethods
        """
        return _1196.ConicalManufactureMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1196.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1196.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1196.ConicalManufactureMethods]":
