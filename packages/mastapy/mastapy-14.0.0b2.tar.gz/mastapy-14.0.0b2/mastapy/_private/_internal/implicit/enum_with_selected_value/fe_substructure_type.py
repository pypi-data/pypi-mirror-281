...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2442.FESubstructureType
        """
        return _2442.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2442.FESubstructureType.type_()

    @property
    def selected_value(self: "Self") -> "_2442.FESubstructureType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2442.FESubstructureType]":
