...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4456.DoeValueSpecificationOption":
        ...
        Returns:
            _4456.DoeValueSpecificationOption
        """
        return _4456.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4456.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4456.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4456.DoeValueSpecificationOption]":
