...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1955.BearingToleranceClass
        """
        return _1955.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1955.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1955.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1955.BearingToleranceClass]":
