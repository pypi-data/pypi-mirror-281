...
class EnumWithSelectedValue_FESubstructuringFileFormat(
    ...
    def wrapped_type(
        ...
        Returns:
            _174.FESubstructuringFileFormat
        """
        return _174.FESubstructuringFileFormat
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _174.FESubstructuringFileFormat.type_()

    @property
    def selected_value(self: "Self") -> "_174.FESubstructuringFileFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_174.FESubstructuringFileFormat]":
