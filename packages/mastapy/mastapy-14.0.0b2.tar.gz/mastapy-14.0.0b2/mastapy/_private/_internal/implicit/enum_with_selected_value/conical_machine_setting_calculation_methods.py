...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalMachineSettingCalculationMethods]",
    ) -> "_1195.ConicalMachineSettingCalculationMethods":
        ...
        Returns:
            _1195.ConicalMachineSettingCalculationMethods
        """
        return _1195.ConicalMachineSettingCalculationMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1195.ConicalMachineSettingCalculationMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1195.ConicalMachineSettingCalculationMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1195.ConicalMachineSettingCalculationMethods]":
