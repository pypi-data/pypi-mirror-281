...
class ListWithSelectedItem_StaticLoadCase(
    _6951.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6951.StaticLoadCase.TYPE

    @property
    def selected_value(self: "Self") -> "_6951.StaticLoadCase":
    ...
    @property
    def available_values(self: "Self") -> "List[_6951.StaticLoadCase]":
