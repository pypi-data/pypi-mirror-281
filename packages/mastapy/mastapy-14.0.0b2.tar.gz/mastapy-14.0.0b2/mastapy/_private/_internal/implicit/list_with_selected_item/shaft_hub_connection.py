...
class ListWithSelectedItem_ShaftHubConnection(
    _2657.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2657.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2657.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2657.ShaftHubConnection]":
