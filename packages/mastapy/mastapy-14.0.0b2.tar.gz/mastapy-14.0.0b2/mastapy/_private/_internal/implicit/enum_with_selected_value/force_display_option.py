...
from mastapy._private.electric_machines.harmonic_load_data import _1425
...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1425.ForceDisplayOption
        """
        return _1425.ForceDisplayOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ForceDisplayOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1425.ForceDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1425.ForceDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1425.ForceDisplayOption]":
