...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _332.ContactRatioRequirements
        """
        return _332.ContactRatioRequirements
    ...
    def implicit_type(cls: "Type[Overridable_ContactRatioRequirements]") -> "Any":
        ...
        Returns:
            Any
        """
        return _332.ContactRatioRequirements.type_()

    @property
    def value(self: "Self") -> "_332.ContactRatioRequirements":
    ...
    @property
    def override_value(self: "Self") -> "_332.ContactRatioRequirements":
        """mastapy._private.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: "Self") -> "_332.ContactRatioRequirements":
        """mastapy._private.gears.ContactRatioRequirements
