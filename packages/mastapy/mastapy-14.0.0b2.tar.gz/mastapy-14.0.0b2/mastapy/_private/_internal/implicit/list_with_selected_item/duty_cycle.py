...
class ListWithSelectedItem_DutyCycle(_5794.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5794.DutyCycle.TYPE

    @property
    def selected_value(self: "Self") -> "_5794.DutyCycle":
    ...
    @property
    def available_values(self: "Self") -> "List[_5794.DutyCycle]":
