...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput]",
    ) -> "_5894.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        Returns:
            _5894.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
        """
        return _5894.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5894.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5894.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":
