...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1871.ThreeDViewContourOption
        """
        return _1871.ThreeDViewContourOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1871.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: "Self") -> "_1871.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1871.ThreeDViewContourOption]":
