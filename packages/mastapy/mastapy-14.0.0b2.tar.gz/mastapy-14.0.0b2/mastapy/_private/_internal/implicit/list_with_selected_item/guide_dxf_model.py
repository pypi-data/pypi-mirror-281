...
class ListWithSelectedItem_GuideDxfModel(
    _2509.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2509.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2509.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2509.GuideDxfModel]":
