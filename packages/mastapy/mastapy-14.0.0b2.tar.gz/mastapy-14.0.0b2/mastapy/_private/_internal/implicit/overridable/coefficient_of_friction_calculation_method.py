...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _329.CoefficientOfFrictionCalculationMethod
        """
        return _329.CoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _329.CoefficientOfFrictionCalculationMethod.type_()

    @property
    def value(self: "Self") -> "_329.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: "Self") -> "_329.CoefficientOfFrictionCalculationMethod":
        """mastapy._private.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_329.CoefficientOfFrictionCalculationMethod":
        """mastapy._private.gears.CoefficientOfFrictionCalculationMethod
