...
from mastapy._private.gears.rating.cylindrical import _492
...
class EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _492.ScuffingFlashTemperatureRatingMethod
        """
        return _492.ScuffingFlashTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _492.ScuffingFlashTemperatureRatingMethod.type_()

    @property
    def selected_value(self: "Self") -> "_492.ScuffingFlashTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_492.ScuffingFlashTemperatureRatingMethod]":
