...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2162.StressConcentrationMethod":
        ...
        Returns:
            _2162.StressConcentrationMethod
        """
        return _2162.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2162.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2162.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2162.StressConcentrationMethod]":
