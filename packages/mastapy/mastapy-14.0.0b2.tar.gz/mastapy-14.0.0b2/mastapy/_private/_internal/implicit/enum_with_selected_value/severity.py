...
from mastapy._private.utility.model_validation import _1840
...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "_1840.Severity":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1840.Severity.type_()

    @property
    def selected_value(self: "Self") -> "_1840.Severity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1840.Severity]":
