...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2654.RigidConnectorTypes
        """
        return _2654.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2654.RigidConnectorTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2654.RigidConnectorTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2654.RigidConnectorTypes]":
