...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2015.LoadedBallElementPropertyType":
        ...
        Returns:
            _2015.LoadedBallElementPropertyType
        """
        return _2015.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2015.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2015.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2015.LoadedBallElementPropertyType]":
