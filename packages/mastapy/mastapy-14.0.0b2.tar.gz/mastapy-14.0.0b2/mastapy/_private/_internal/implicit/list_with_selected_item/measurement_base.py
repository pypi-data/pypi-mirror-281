...
class ListWithSelectedItem_MeasurementBase(
    _1652.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MeasurementBase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1652.MeasurementBase.TYPE

    @property
    def selected_value(self: "Self") -> "_1652.MeasurementBase":
    ...
    @property
    def available_values(self: "Self") -> "List[_1652.MeasurementBase]":
