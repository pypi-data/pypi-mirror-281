...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ToothThicknessSpecificationMethod]",
    ) -> "_1228.ToothThicknessSpecificationMethod":
        ...
        Returns:
            _1228.ToothThicknessSpecificationMethod
        """
        return _1228.ToothThicknessSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1228.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1228.ToothThicknessSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1228.ToothThicknessSpecificationMethod]":
