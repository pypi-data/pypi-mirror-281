...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2315.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2315.ExcitationAnalysisViewOption
        """
        return _2315.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2315.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2315.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2315.ExcitationAnalysisViewOption]":
