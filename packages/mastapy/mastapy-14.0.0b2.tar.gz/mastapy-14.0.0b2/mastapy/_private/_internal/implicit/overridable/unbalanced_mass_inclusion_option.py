...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2534.UnbalancedMassInclusionOption
        """
        return _2534.UnbalancedMassInclusionOption
    ...
    def implicit_type(cls: "Type[Overridable_UnbalancedMassInclusionOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2534.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: "Self") -> "_2534.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: "Self") -> "_2534.UnbalancedMassInclusionOption":
        """mastapy._private.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2534.UnbalancedMassInclusionOption":
        """mastapy._private.system_model.part_model.UnbalancedMassInclusionOption
