...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_SealLocation]") -> "_1950.SealLocation":
    ...
    def implicit_type(cls: "Type[Overridable_SealLocation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1950.SealLocation.type_()

    @property
    def value(self: "Self") -> "_1950.SealLocation":
    ...
    @property
    def override_value(self: "Self") -> "_1950.SealLocation":
        """mastapy._private.bearings.SealLocation
    ...
    @property
    def calculated_value(self: "Self") -> "_1950.SealLocation":
        """mastapy._private.bearings.SealLocation
