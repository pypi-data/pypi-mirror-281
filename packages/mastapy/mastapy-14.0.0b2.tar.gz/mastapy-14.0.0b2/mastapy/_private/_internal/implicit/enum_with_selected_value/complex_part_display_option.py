...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComplexPartDisplayOption]",
    ) -> "_1541.ComplexPartDisplayOption":
        ...
        Returns:
            _1541.ComplexPartDisplayOption
        """
        return _1541.ComplexPartDisplayOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1541.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1541.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1541.ComplexPartDisplayOption]":
