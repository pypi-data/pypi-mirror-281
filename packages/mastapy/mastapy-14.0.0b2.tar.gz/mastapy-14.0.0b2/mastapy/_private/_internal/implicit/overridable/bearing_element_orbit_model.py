...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5508.BearingElementOrbitModel":
        ...
        Returns:
            _5508.BearingElementOrbitModel
        """
        return _5508.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5508.BearingElementOrbitModel.type_()

    @property
    def value(self: "Self") -> "_5508.BearingElementOrbitModel":
    ...
    @property
    def override_value(self: "Self") -> "_5508.BearingElementOrbitModel":
        """mastapy._private.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    def calculated_value(self: "Self") -> "_5508.BearingElementOrbitModel":
        """mastapy._private.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
