...
class ListWithSelectedItem_CylindricalGearSet(
    _2582.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2582.CylindricalGearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2582.CylindricalGearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2582.CylindricalGearSet]":
