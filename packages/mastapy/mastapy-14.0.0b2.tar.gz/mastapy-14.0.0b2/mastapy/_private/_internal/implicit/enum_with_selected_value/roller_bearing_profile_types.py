...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_1943.RollerBearingProfileTypes":
        ...
        Returns:
            _1943.RollerBearingProfileTypes
        """
        return _1943.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1943.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1943.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1943.RollerBearingProfileTypes]":
