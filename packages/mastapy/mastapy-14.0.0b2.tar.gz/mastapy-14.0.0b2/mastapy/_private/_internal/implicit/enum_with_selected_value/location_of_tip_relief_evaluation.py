...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfTipReliefEvaluation]",
    ) -> "_587.LocationOfTipReliefEvaluation":
        ...
        Returns:
            _587.LocationOfTipReliefEvaluation
        """
        return _587.LocationOfTipReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _587.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_587.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_587.LocationOfTipReliefEvaluation]":
