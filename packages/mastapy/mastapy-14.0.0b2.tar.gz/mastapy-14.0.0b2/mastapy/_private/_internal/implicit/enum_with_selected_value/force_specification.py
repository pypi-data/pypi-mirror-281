...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification]",
    ) -> "_7087.PointLoadLoadCase.ForceSpecification":
        ...
        Returns:
            _7087.PointLoadLoadCase.ForceSpecification
        """
        return _7087.PointLoadLoadCase.ForceSpecification
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7087.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_7087.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7087.PointLoadLoadCase.ForceSpecification]":
