...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.scripting import _1788
...
class _Cast_DatabaseKey:
    ...
    @property
    def user_defined_property_key(self: "CastSelf") -> "_1788.UserDefinedPropertyKey":
        from mastapy._private.utility.scripting import _1788

        return self.__parent__._cast(_1788.UserDefinedPropertyKey)

    @property
    def custom_report_key(self: "CastSelf") -> "_1816.CustomReportKey":
        from mastapy._private.utility.report import _1816

        return self.__parent__._cast(_1816.CustomReportKey)

    @property
    def named_key(self: "CastSelf") -> "_1880.NamedKey":
        from mastapy._private.utility.databases import _1880

        return self.__parent__._cast(_1880.NamedKey)

    @property
    def rolling_bearing_key(self: "CastSelf") -> "_1946.RollingBearingKey":
        from mastapy._private.bearings import _1946

        return self.__parent__._cast(_1946.RollingBearingKey)
