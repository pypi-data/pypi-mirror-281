...
from mastapy._private.utility.databases import _1881, _1880
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _1879, _1874
...
TValue = TypeVar("TValue", bound="_1879.NamedDatabaseItem")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NamedDatabase(_1881.SQLDatabase[_1880.NamedKey, TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_name: "str", item: "_1879.NamedDatabaseItem"
    ) -> "_1879.NamedDatabaseItem":
    ...
    @enforce_parameter_types
    def rename(
        self: "Self", item: "_1879.NamedDatabaseItem", new_name: "str"
    ) -> "bool":
        """bool
