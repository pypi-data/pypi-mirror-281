...
class _Cast_Unit:
    ...
    @property
    def degrees_minutes_seconds(self: "CastSelf") -> "_1649.DegreesMinutesSeconds":
        from mastapy._private.utility.units_and_measurements import _1649

        return self.__parent__._cast(_1649.DegreesMinutesSeconds)

    @property
    def enum_unit(self: "CastSelf") -> "_1650.EnumUnit":
        from mastapy._private.utility.units_and_measurements import _1650

        return self.__parent__._cast(_1650.EnumUnit)

    @property
    def inverse_unit(self: "CastSelf") -> "_1651.InverseUnit":
        from mastapy._private.utility.units_and_measurements import _1651

        return self.__parent__._cast(_1651.InverseUnit)

    @property
    def safety_factor_unit(self: "CastSelf") -> "_1655.SafetyFactorUnit":
        from mastapy._private.utility.units_and_measurements import _1655

        return self.__parent__._cast(_1655.SafetyFactorUnit)

    @property
    def time_unit(self: "CastSelf") -> "_1656.TimeUnit":
        from mastapy._private.utility.units_and_measurements import _1656

        return self.__parent__._cast(_1656.TimeUnit)

    @property
    def unit_gradient(self: "CastSelf") -> "_1658.UnitGradient":
        from mastapy._private.utility.units_and_measurements import _1658

        return self.__parent__._cast(_1658.UnitGradient)
