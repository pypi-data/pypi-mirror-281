...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LengthShort(_1652.MeasurementBase):
    """LengthShort
    ...
    @property
    def inches(self: "Self") -> "_1657.Unit":
        """mastapy._private.utility.units_and_measurements.Unit
    ...
    @property
    def metres(self: "Self") -> "_1657.Unit":
        """mastapy._private.utility.units_and_measurements.Unit
    ...
    @property
    def micrometres(self: "Self") -> "_1657.Unit":
        """mastapy._private.utility.units_and_measurements.Unit
    ...
    @property
    def millimetres(self: "Self") -> "_1657.Unit":
        """mastapy._private.utility.units_and_measurements.Unit
    ...
    @property
    def thousandths_of_an_inch(self: "Self") -> "_1657.Unit":
        """mastapy._private.utility.units_and_measurements.Unit
