...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1849, _1852
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearOrderForTE(_1854.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self: "Self") -> "_1849.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._1849", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: "Self") -> "List[_1852.OrderForTE]":
