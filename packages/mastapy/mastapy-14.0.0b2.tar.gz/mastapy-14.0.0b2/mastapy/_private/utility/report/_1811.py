...
class _Cast_CustomReportItem:
    ...
    @property
    def custom_report(self: "CastSelf") -> "_1802.CustomReport":
        from mastapy._private.utility.report import _1802

        return self.__parent__._cast(_1802.CustomReport)
    ...
    @property
    def custom_report_column(self: "CastSelf") -> "_1806.CustomReportColumn":
        from mastapy._private.utility.report import _1806

        return self.__parent__._cast(_1806.CustomReportColumn)

    @property
    def custom_report_columns(self: "CastSelf") -> "_1807.CustomReportColumns":
        from mastapy._private.utility.report import _1807

        return self.__parent__._cast(_1807.CustomReportColumns)
    ...
    def custom_report_horizontal_line(
        self: "CastSelf",
    ) -> "_1809.CustomReportHorizontalLine":
        from mastapy._private.utility.report import _1809

        return self.__parent__._cast(_1809.CustomReportHorizontalLine)
    ...
    def custom_report_item_container(
        self: "CastSelf",
    ) -> "_1812.CustomReportItemContainer":
        from mastapy._private.utility.report import _1812

        return self.__parent__._cast(_1812.CustomReportItemContainer)

    @property
    def custom_report_item_container_collection(
        self: "CastSelf",
    ) -> "_1813.CustomReportItemContainerCollection":
        from mastapy._private.utility.report import _1813

        return self.__parent__._cast(_1813.CustomReportItemContainerCollection)

    @property
    def custom_report_item_container_collection_base(
        self: "CastSelf",
    ) -> "_1814.CustomReportItemContainerCollectionBase":
        from mastapy._private.utility.report import _1814

        return self.__parent__._cast(_1814.CustomReportItemContainerCollectionBase)

    @property
    def custom_report_item_container_collection_item(
        self: "CastSelf",
    ) -> "_1815.CustomReportItemContainerCollectionItem":
        from mastapy._private.utility.report import _1815

        return self.__parent__._cast(_1815.CustomReportItemContainerCollectionItem)
    ...
    @property
    def custom_report_tab(self: "CastSelf") -> "_1823.CustomReportTab":
        from mastapy._private.utility.report import _1823

        return self.__parent__._cast(_1823.CustomReportTab)

    @property
    def custom_report_tabs(self: "CastSelf") -> "_1824.CustomReportTabs":
        from mastapy._private.utility.report import _1824

        return self.__parent__._cast(_1824.CustomReportTabs)
