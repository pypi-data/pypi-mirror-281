...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @enforce_parameter_types
    def selected_version(self: "Self", value: "_1647.SystemDirectory") -> None:
        wrapper_type = (
    ...
    @property
    def current_version(self: "Self") -> "_1647.SystemDirectory":
    ...
    @property
    def version_to_copy(self: "Self") -> "_1647.SystemDirectory":
        """mastapy._private.utility.SystemDirectory
