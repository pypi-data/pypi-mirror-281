...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMesh(_2366.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self: "Self") -> "_1535.Range":
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1048.CylindricalGearMeshDesign":
    ...
    @property
    def cylindrical_gear_mesh_design(self: "Self") -> "_1048.CylindricalGearMeshDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearMeshDesign
    ...
    @property
    def cylindrical_gear_set(self: "Self") -> "_2582.CylindricalGearSet":
