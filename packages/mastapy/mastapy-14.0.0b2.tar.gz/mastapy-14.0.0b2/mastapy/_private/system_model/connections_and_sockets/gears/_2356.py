...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearMesh(_2352.AGMAGleasonConicalGearMesh):
    """BevelGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1219.BevelGearMeshDesign":
    ...
    @property
    def bevel_gear_mesh_design(self: "Self") -> "_1219.BevelGearMeshDesign":
        """mastapy._private.gears.gear_designs.bevel.BevelGearMeshDesign
