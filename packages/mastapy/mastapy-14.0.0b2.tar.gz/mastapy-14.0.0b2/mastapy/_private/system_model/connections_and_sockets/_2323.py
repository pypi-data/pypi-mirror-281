...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2324.ComponentMeasurer":
        return self.__parent__._cast(_2324.ComponentMeasurer)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentConnection(_2324.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2498.Component":
