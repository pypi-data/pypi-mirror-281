...
class _Cast_ComponentMeasurer:
    ...
    @property
    def component_connection(self: "CastSelf") -> "_2323.ComponentConnection":
        from mastapy._private.system_model.connections_and_sockets import _2323

        return self.__parent__._cast(_2323.ComponentConnection)

    @property
    def cylindrical_component_connection(
        self: "CastSelf",
    ) -> "_2328.CylindricalComponentConnection":
        from mastapy._private.system_model.connections_and_sockets import _2328

        return self.__parent__._cast(_2328.CylindricalComponentConnection)

    @property
    def datum_measurement(self: "CastSelf") -> "_2330.DatumMeasurement":
        from mastapy._private.system_model.connections_and_sockets import _2330

        return self.__parent__._cast(_2330.DatumMeasurement)
...
class ComponentMeasurer(_0.APIBase):
    ...
    @property
    def component(self: "Self") -> "_2498.Component":
