...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2286.OptimizationStep":
        return self.__parent__._cast(_2286.OptimizationStep)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearOptimizationStep(_2286.OptimizationStep):
    """CylindricalGearOptimizationStep
