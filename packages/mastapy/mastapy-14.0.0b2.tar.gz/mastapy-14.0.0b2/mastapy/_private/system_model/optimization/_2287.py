...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2286, _2279, _2282
...
TStep = TypeVar("TStep", bound="_2286.OptimizationStep")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OptimizationStrategy(_2288.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
