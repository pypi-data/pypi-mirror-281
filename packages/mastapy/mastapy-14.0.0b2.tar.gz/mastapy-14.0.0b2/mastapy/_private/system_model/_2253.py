...
from mastapy._private.materials.efficiency import _303
from mastapy._private.system_model.part_model.gears import _2568
from mastapy._private._internal.python_net import python_net_import
from mastapy._private.system_model.part_model import _2528, _2531
from mastapy._private._math.vector_3d import Vector3D
from mastapy._private.utility import _1628
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model_gui import _1898
    from mastapy._private.gears import _332, _338
    from mastapy._private.system_model import _2276, _2277, _2264, _2258, _2275, _2265
    ...
    from mastapy._private.system_model.database_access import _2317
    ...
    from mastapy._private.utility.model_validation import _1841
    ...
    from mastapy._private.gears.gear_designs.creation_options import _1184, _1186, _1187
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: "Self") -> "_1898.MASTAGUI":
    ...
    def axial_contact_ratio_requirement(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._332", "ContactRatioRequirements"
        )(value)

    @axial_contact_ratio_requirement.setter
    @enforce_parameter_types
    def axial_contact_ratio_requirement(
        self: "Self", value: "_332.ContactRatioRequirements"
    ) -> None:
    ...
    def efficiency_rating_method_for_bearings(
        self: "Self",
    ) -> "_303.BearingEfficiencyRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials.efficiency._303",
    ...
    @enforce_parameter_types
    def efficiency_rating_method_for_bearings(
        self: "Self", value: "_303.BearingEfficiencyRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: "Self", value: "_2568.ActiveGearSetDesignSelectionGroup"
    ) -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: "Self", value: "_2528.PowerLoad") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: "Self", value: "_2528.PowerLoad") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: "Self", value: "_2531.ShaftDiameterModificationDueToRollingBearingRing"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        self: "Self",
    ) -> "_2276.ThermalExpansionOptionForGroundedNodes":
    ...
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: "Self", value: "_2276.ThermalExpansionOptionForGroundedNodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
    ) -> "_2534.UnbalancedMassInclusionOption":
    ...
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: "Self", value: "_2534.UnbalancedMassInclusionOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: "Self") -> "_2277.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: "Self") -> "_1437.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: "Self") -> "_2264.MAAElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: "Self") -> "_2414.BatchOperations":
    ...
    @property
    def file_save_details_all(self: "Self") -> "_1629.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: "Self") -> "_1630.FileHistoryItem":
    ...
    @property
    def gear_set_design_group(self: "Self") -> "_338.GearSetDesignGroup":
    ...
    def selected_gear_set_selection_group(
        self: "Self",
    ) -> "_2568.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def settings(self: "Self") -> "_2258.DesignSettings":
    ...
    @property
    def system(self: "Self") -> "_2275.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: "Self") -> "_2293.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: "Self",
    ) -> "List[_2677.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: "Self",
    ) -> "List[_2674.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: "Self",
    ) -> "List[_2568.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: "Self",
    ) -> "List[_2029.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: "Self",
    ) -> "List[_2676.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: "Self") -> "_2317.Databases":
    ...
    @property
    def design_states(self: "Self") -> "List[_5793.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5794.DutyCycle]":
    ...
    @property
    def gear_set_config(self: "Self") -> "_2589.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: "Self", value: "_2589.GearSetConfiguration") -> None:
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: "Self") -> "_2265.MASTASettings":
    ...
    @property
    def root_assembly(self: "Self") -> "_2530.RootAssembly":
    ...
    @property
    def system_optimiser(self: "Self") -> "_2292.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5801.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3069.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3069.SynchroniserShift":
        """mastapy._private.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5793.DesignState":
        """mastapy._private.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5794.DutyCycle":
        """mastapy._private.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def load_results(self: "Self", file_name: "str") -> "Tuple[int, str]":
        ...
        method_result = self.wrapped.LoadResults(file_name if file_name else "")
    ...
    def new_hypoid_gear_set_creation_options(
        self: "Self",
    ) -> "_1186.HypoidGearSetCreationOptions":
    ...
    def remove_bearing_from_database(
        self: "Self", rolling_bearing: "_2218.RollingBearing"
    ) -> None:
        """Method does not return.
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3069.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: "Self", file_name: "str", save_results: "bool") -> "_1841.Status":
        """mastapy._private.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_6950.LoadCase]"
    ) -> None:
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2487.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1628.ExternalFullFEFileOption" = _1628.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy._private.system_model.Design
    ...
    def create_new_design(self: "Self") -> "Design":
        """mastapy._private.system_model.Design"""
        method_result = self.wrapped.CreateNewDesign()
        type_ = method_result.GetType()
        return (
            constructor.new(type_.Namespace, type_.Name)(method_result)
            if method_result is not None
    ...
    def load_new_design(
        ...
        method_result = self.wrapped.LoadNewDesign(
            file_path if file_path else "", load_full_fe_option
        )
        type_ = method_result.GetType()
        return (
    ...
    def create_from_example(self: "Self", example_string: "str") -> "Design":
        ...
        """
        example_string = str(example_string)
        method_result = self.wrapped.CreateFromExample(
            example_string if example_string else ""
        )
        type_ = method_result.GetType()
        return (
