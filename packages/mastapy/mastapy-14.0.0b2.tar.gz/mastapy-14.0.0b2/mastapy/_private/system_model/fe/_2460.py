...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2410, _2417
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: "Self") -> "_2410.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2410", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(
        self: "Self", value: "_2410.AlignmentMethodForRaceBearing"
    ) -> None:
    ...
    @property
    def links(self: "Self") -> "List[_2417.BearingRaceNodeLink]":
