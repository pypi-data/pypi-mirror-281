...
class IndependentMASTACreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self: "Self") -> "_213.RigidCouplingType":
    ...
    def rigid_coupling_type(self: "Self", value: "_213.RigidCouplingType") -> None:
    ...
    @property
    def fe_substructure_node(self: "Self") -> "_2439.FESubstructureNode":
