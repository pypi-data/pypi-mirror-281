...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _189, _199
    from mastapy._private.nodal_analysis import _64
    from mastapy._private.system_model.fe import _2441, _2413
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForModalAnalysis(_2444.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self: "Self") -> "_199.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: "Self",
    ) -> "List[_2441.FESubstructureNodeModeShapes]":
