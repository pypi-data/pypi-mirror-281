...
class _Cast_BaseFEWithSelection:
    ...
    def fe_substructure_with_selection_components(
        ...
        return self.__parent__._cast(_2445.FESubstructureWithSelectionComponents)
    ...
    def fe_substructure_with_selection_for_modal_analysis(
        ...
        return self.__parent__._cast(_2447.FESubstructureWithSelectionForModalAnalysis)
    ...
    def fe_substructure_with_selection_for_static_analysis(
        ...
        return self.__parent__._cast(_2448.FESubstructureWithSelectionForStaticAnalysis)

    @property
    def race_bearing_fe_with_selection(
        self: "CastSelf",
    ) -> "_2462.RaceBearingFEWithSelection":
        from mastapy._private.system_model.fe import _2462

        return self.__parent__._cast(_2462.RaceBearingFEWithSelection)
...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def component_draw_style(self: "Self") -> "_196.FEModelComponentDrawStyle":
    ...
    @property
    def draw_style(self: "Self") -> "_188.DrawStyleForFE":
    ...
    @property
    def node_selection(self: "Self") -> "_205.FENodeSelectionDrawStyle":
    ...
    @property
    def transparency_draw_style(self: "Self") -> "_204.FEModelTransparencyDrawStyle":
    ...
    def select_component(self: "Self", component: "_2498.Component") -> None:
