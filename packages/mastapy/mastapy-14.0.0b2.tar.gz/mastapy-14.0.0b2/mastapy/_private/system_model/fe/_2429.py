...
from mastapy._private.fe_tools.vis_tools_global import _1272
...
class _Cast_ElementFaceGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2431.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2431.FEEntityGroupWithSelection)
...
class ElementFaceGroupWithSelection(
    _2431.FEEntityGroupWithSelection[_235.CMSElementFaceGroup, _1272.ElementFace]
):
    """ElementFaceGroupWithSelection
