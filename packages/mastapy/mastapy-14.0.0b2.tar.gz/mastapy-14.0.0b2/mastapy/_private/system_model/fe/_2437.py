...
from mastapy._private.system_model.part_model import _2498, _2502
from mastapy._private._internal.overridable_constructor import _unpack_overridable
from mastapy._private.utility.units_and_measurements import _1657
from mastapy._private._internal.python_net import python_net_import
from mastapy._private.system_model.fe import _2465, _2442
...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _244, _237
    from mastapy._private.materials import _248, _294
    ...
    from mastapy._private.nodal_analysis.geometry_modeller_link import _162, _164
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self: "Self") -> "_2409.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2409", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2409.AlignmentMethod") -> None:
    ...
    @property
    def bearing_node_alignment(self: "Self") -> "_2415.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2415", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(
        self: "Self", value: "_2415.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def bearing_races_in_fe(self: "Self", value: "bool") -> None:
    ...
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2498.Component") -> None:
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: "Self", value: "_2502.Datum") -> None:
    ...
    @enforce_parameter_types
    def distance_display_unit(self: "Self", value: "_1657.Unit") -> None:
    ...
    @enforce_parameter_types
    def force_display_unit(self: "Self", value: "_1657.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def reduction_mode_type(self: "Self") -> "_244.ReductionModeType":
    ...
    @enforce_parameter_types
    def reduction_mode_type(self: "Self", value: "_244.ReductionModeType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2465.ThermalExpansionOption"
    ) -> None:
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2442.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def acoustic_radiation_efficiency(
        self: "Self",
    ) -> "_248.AcousticRadiationEfficiency":
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2411.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2273.RelativeComponentAlignment[_2498.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2498.Component](temp)

    @property
    def cms_model(self: "Self") -> "_237.CMSModel":
    ...
    @property
    def coordinate_system(self: "Self") -> "_1545.CoordinateSystem3D":
    ...
    @property
    def export(self: "Self") -> "_2438.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: "Self") -> "_2507.FEPart":
    ...
    @property
    def geometry_modeller_dimensions(self: "Self") -> "_164.GeometryModellerDimensions":
    ...
    @property
    def sound_pressure_enclosure(self: "Self") -> "_294.SoundPressureEnclosure":
    ...
    @property
    def gear_meshing_options(self: "Self") -> "List[_2449.GearMeshingOptions]":
    ...
    @property
    def geometries(self: "Self") -> "List[_2435.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2450.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: "Self") -> "List[_2472.FELink]":
    ...
    @property
    def replaced_shafts(self: "Self") -> "List[_2538.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2463.ReplacedShaftSelectionHelper]":
    ...
    def thermal_expansion_displacements(
        self: "Self",
    ) -> "List[_1610.VectorWithLinearAndAngularComponents]":
    ...
    def create_fe_substructure_with_selection_components(
        self: "Self",
    ) -> "_2445.FESubstructureWithSelectionComponents":
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        self: "Self",
    ) -> "_2446.FESubstructureWithSelectionForHarmonicAnalysis":
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        self: "Self",
    ) -> "_2447.FESubstructureWithSelectionForModalAnalysis":
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        self: "Self",
    ) -> "_2448.FESubstructureWithSelectionForStaticAnalysis":
    ...
    def import_fe_mesh(
        self: "Self",
        file_path: "str",
        format_: "_173.FEExportFormat",
        length_scale: "float" = 1.0,
        force_scale: "float" = 1.0,
        progress: Optional["_7724.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def import_node_positions(
        self: "Self", file_name: "str", distance_unit: "_1657.Unit"
    ) -> None:
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: "Self",
        file_name: "str",
        distance_unit: "_1657.Unit",
        force_unit: "_1657.Unit",
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2439.FESubstructureNode"
    ) -> "List[_2472.FELink]":
        """List[mastapy._private.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "str", progress: "_7724.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    def load_stl_geometry(
        self: "Self", length_unit: "_1657.Unit", file_name: "str"
    ) -> None:
        """Method does not return.
