...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2308.RotorDynamicsViewable":
        return self.__parent__._cast(_2308.RotorDynamicsViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SteadyStateSynchronousResponseViewable(_2308.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
