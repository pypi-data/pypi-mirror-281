...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self: "Self") -> "_1606.ForceAndDisplacementResults":
    ...
    @property
    def section_to_the_left_side(self: "Self") -> "_2888.ShaftSectionSystemDeflection":
    ...
    @property
    def section_to_the_right_side(self: "Self") -> "_2888.ShaftSectionSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
