...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2300, _2310, _2311
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2300.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2300

        return self.__parent__._cast(_2300.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2310.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2310

        return self.__parent__._cast(_2310.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2311.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2311

        return self.__parent__._cast(_2311.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4129.RotorDynamicsDrawStyle":
