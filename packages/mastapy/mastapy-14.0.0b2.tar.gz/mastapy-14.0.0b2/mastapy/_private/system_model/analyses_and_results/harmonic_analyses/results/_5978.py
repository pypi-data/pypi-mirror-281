...
class _Cast_ExcitationSourceSelectionBase:
    ...
    def excitation_source_selection(
        self: "CastSelf",
    ) -> "_5977.ExcitationSourceSelection":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5977,
        )

        return self.__parent__._cast(_5977.ExcitationSourceSelection)

    @property
    def excitation_source_selection_group(
        self: "CastSelf",
    ) -> "_5979.ExcitationSourceSelectionGroup":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5979,
        )

        return self.__parent__._cast(_5979.ExcitationSourceSelectionGroup)
