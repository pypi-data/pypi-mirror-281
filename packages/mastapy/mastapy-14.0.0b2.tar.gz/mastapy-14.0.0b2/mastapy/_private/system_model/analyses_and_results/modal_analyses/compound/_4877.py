...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectorCompoundModalAnalysis(_4920.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4719.ConnectorModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4719.ConnectorModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.ConnectorModalAnalysis]
