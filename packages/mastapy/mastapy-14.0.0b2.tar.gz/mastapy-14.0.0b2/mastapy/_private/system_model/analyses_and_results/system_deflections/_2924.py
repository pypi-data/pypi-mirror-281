...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearMeshSystemDeflection(_2789.BevelGearMeshSystemDeflection):
    """ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_380.ZerolBevelGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_380.ZerolBevelGearMeshRating":
        """mastapy._private.gears.rating.zerol_bevel.ZerolBevelGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4269.ZerolBevelGearMeshPowerFlow":
