...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetPowerFlow(_4153.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4270.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4270.ZerolBevelGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4269.ZerolBevelGearMeshPowerFlow]":
