...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchCompoundPowerFlow(_4309.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4158.ClutchPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4158.ClutchPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ClutchPowerFlow]
