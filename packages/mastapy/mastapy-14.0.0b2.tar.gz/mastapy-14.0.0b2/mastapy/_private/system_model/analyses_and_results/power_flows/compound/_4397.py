...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearCompoundPowerFlow(_4330.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_383.WormGearDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: "Self") -> "_383.WormGearDutyCycleRating":
        """mastapy._private.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4267.WormGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4267.WormGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
