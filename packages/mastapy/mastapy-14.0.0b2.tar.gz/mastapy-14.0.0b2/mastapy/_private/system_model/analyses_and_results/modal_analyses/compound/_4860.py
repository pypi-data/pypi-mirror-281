...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundModalAnalysis(_4866.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4703.BoltModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4703.BoltModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.BoltModalAnalysis]
