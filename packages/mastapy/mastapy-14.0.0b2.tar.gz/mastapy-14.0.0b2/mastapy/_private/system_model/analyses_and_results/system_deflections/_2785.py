...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetSystemDeflection(_2790.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_6971.BevelDifferentialGearSetLoadCase":
    ...
    @property
    def rating(self: "Self") -> "_567.BevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_567.BevelGearSetRating":
        """mastapy._private.gears.rating.bevel.BevelGearSetRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4148.BevelDifferentialGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2786.BevelDifferentialGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2784.BevelDifferentialGearMeshSystemDeflection]":
