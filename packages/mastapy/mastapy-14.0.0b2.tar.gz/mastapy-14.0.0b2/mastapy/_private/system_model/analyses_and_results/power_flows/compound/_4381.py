...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetCompoundPowerFlow(_4290.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4379.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4380.StraightBevelDiffGearMeshCompoundPowerFlow]":
