...
class _Cast_GearMeshExcitationDetail:
    ...
    def gear_mesh_misalignment_excitation_detail(
        self: "CastSelf",
    ) -> "_5886.GearMeshMisalignmentExcitationDetail":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5886,
        )

        return self.__parent__._cast(_5886.GearMeshMisalignmentExcitationDetail)

    @property
    def gear_mesh_te_excitation_detail(
        self: "CastSelf",
    ) -> "_5887.GearMeshTEExcitationDetail":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5887,
        )

        return self.__parent__._cast(_5887.GearMeshTEExcitationDetail)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshExcitationDetail(_5809.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def uncoupled_modal_analysis(self: "Self") -> "_4767.ModalAnalysis":
    ...
    @property
    def gear_mesh(self: "Self") -> "_2842.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: "Self") -> "_5834.ComplianceAndForceData":
    ...
    def get_uncoupled_modal_participation_factors_for(
        ...
        return conversion.pn_to_mp_objects_in_list(
            self.wrapped.GetUncoupledModalParticipationFactorsFor(
