...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetPowerFlow(_4141.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_451.HypoidGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_451.HypoidGearSetRating":
        """mastapy._private.gears.rating.hypoid.HypoidGearSetRating
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4201.HypoidGearPowerFlow]":
    ...
    @property
    def hypoid_gears_power_flow(self: "Self") -> "List[_4201.HypoidGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    @property
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4200.HypoidGearMeshPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
