...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1048, _1042
...
class CylindricalGearMeshAdvancedSystemDeflection(
    ...
    @property
    def inactive_flank(self: "Self") -> "_333.CylindricalFlanks":
        """mastapy._private.gears.CylindricalFlanks
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_469.CylindricalGearMeshRating":
    ...
    @property
    def gear_mesh_design(self: "Self") -> "_1048.CylindricalGearMeshDesign":
    ...
    @property
    def points_with_worst_results(self: "Self") -> "_1252.PointsWithWorstResults":
    ...
    def cylindrical_gear_advanced_analyses(
        self: "Self",
    ) -> "List[_7473.CylindricalGearAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_mesh_system_deflection_results(
        self: "Self",
    ) -> "List[_2823.CylindricalGearMeshSystemDeflectionTimestep]":
    ...
    @property
    def gear_designs(self: "Self") -> "List[_1042.CylindricalGearDesign]":
    ...
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(
        self: "Self",
    ) -> "List[_7462.ContactChartPerToothPass]":
