...
class _Cast_HarmonicAnalysisExportOptions:
    ...
    def harmonic_analysis_fe_export_options(
        self: "CastSelf",
    ) -> "_5894.HarmonicAnalysisFEExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5894,
        )

        return self.__parent__._cast(_5894.HarmonicAnalysisFEExportOptions)

    @property
    def harmonic_analysis_root_assembly_export_options(
        self: "CastSelf",
    ) -> "_5897.HarmonicAnalysisRootAssemblyExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5897,
        )

        return self.__parent__._cast(_5897.HarmonicAnalysisRootAssemblyExportOptions)

    @property
    def harmonic_analysis_shaft_export_options(
        self: "CastSelf",
    ) -> "_5898.HarmonicAnalysisShaftExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5898,
        )

        return self.__parent__._cast(_5898.HarmonicAnalysisShaftExportOptions)
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    def distance_units_for_export(self: "Self", value: "_1657.Unit") -> None:
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: "Self", value: "_5875.ExportOutputType") -> None:
    ...
    @enforce_parameter_types
    def type_of_result_to_export(
        self: "Self", value: "_4738.DynamicsResponseType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def analysis_options(self: "Self") -> "_5896.HarmonicAnalysisOptions":
