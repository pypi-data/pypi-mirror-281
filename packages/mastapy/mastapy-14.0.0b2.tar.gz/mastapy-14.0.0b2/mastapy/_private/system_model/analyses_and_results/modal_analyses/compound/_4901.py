...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetCompoundModalAnalysis(_4941.SpecialisedAssemblyCompoundModalAnalysis):
    """GearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4748.GearSetModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4748.GearSetModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.GearSetModalAnalysis]
