...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetModalAnalysis(_4748.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2922.WormGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4824.WormGearModalAnalysis]":
    ...
    @property
    def worm_gears_modal_analysis(self: "Self") -> "List[_4824.WormGearModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4823.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4823.WormGearMeshModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
