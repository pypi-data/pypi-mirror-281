...
class SpiralBevelGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5340.SpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5469.SpiralBevelGearCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5470.SpiralBevelGearMeshCompoundModalAnalysisAtASpeed]":
