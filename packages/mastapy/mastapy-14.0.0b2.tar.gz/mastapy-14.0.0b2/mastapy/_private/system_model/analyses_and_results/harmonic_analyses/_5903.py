...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetHarmonicAnalysis(_5815.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5901.HypoidGearHarmonicAnalysis]":
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5902.HypoidGearMeshHarmonicAnalysis]":
