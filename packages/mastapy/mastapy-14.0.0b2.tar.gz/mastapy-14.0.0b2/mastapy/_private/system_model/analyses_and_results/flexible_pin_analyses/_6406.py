...
class _Cast_CombinationAnalysis:
    ...
    @property
    def flexible_pin_analysis(self: "CastSelf") -> "_6407.FlexiblePinAnalysis":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6407,
        )

        return self.__parent__._cast(_6407.FlexiblePinAnalysis)
    ...
    def wind_turbine_certification_report(
        self: "CastSelf",
    ) -> "_6414.WindTurbineCertificationReport":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6414,
        )

        return self.__parent__._cast(_6414.WindTurbineCertificationReport)
