...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadCompoundModalAnalysis(_4965.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4783.PowerLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4783.PowerLoadModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.PowerLoadModalAnalysis]
