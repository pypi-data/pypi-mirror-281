...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2758, _2702
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCaseGroup(_5789.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_6952.TimeSeriesLoadCase]":
