...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetCompoundPowerFlow(_4290.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    def spiral_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4373.SpiralBevelGearCompoundPowerFlow]":
    ...
    def spiral_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4374.SpiralBevelGearMeshCompoundPowerFlow]":
