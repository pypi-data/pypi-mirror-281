...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassCompoundPowerFlow(_4396.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4264.UnbalancedMassPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4264.UnbalancedMassPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.UnbalancedMassPowerFlow]
