...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftCompoundSystemDeflection(_2937.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def shaft_duty_cycle_damage_results(
        self: "Self",
    ) -> "_3035.ShaftDutyCycleSystemDeflection":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2889.ShaftSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]
