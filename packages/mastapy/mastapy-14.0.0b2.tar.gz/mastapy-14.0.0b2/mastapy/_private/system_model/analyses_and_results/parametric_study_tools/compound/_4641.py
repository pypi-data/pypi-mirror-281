...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7088.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4510.PowerLoadParametricStudyTool]":
    ...
    @property
    def load_cases(self: "Self") -> "List[_7088.PowerLoadLoadCase]":
