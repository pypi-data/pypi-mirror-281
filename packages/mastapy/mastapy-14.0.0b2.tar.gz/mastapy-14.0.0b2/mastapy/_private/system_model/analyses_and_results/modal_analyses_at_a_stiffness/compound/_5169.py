...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5037.HypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5167.HypoidGearCompoundModalAnalysisAtAStiffness]":
    ...
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5168.HypoidGearMeshCompoundModalAnalysisAtAStiffness]":
