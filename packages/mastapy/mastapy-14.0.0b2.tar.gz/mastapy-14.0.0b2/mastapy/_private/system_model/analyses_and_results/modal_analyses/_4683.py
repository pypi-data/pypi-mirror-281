...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractAssemblyModalAnalysis(_4775.PartModalAnalysis):
    """AbstractAssemblyModalAnalysis
    ...
    @property
    def gear_meshes(self: "Self") -> "List[_4746.GearMeshModalAnalysis]":
    ...
    @property
    def rigidly_connected_groups(self: "Self") -> "List[_4708.ComponentModalAnalysis]":
