...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetSystemDeflection(_2843.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4185.CylindricalGearSetPowerFlow":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2822.CylindricalGearMeshSystemDeflection]":
