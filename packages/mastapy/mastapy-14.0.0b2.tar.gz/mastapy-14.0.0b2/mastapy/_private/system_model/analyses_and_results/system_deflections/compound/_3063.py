...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearCompoundSystemDeflection(_2995.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: "Self") -> "_383.WormGearDutyCycleRating":
    ...
    @property
    def worm_duty_cycle_rating(self: "Self") -> "_383.WormGearDutyCycleRating":
        """mastapy._private.gears.rating.worm.WormGearDutyCycleRating
