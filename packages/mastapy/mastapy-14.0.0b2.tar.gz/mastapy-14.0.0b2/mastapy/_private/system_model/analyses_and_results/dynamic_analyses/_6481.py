...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetDynamicAnalysis(_6421.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    def agma_gleason_conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6479.HypoidGearDynamicAnalysis]":
    ...
    def agma_gleason_conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6480.HypoidGearMeshDynamicAnalysis]":
