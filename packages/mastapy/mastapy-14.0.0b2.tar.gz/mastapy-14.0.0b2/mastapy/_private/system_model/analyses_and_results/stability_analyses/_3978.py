...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetStabilityAnalysis(_3879.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3979.StraightBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3977.StraightBevelGearMeshStabilityAnalysis]":
