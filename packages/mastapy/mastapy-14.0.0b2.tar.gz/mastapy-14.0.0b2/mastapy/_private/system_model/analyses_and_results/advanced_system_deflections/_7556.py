...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetAdvancedSystemDeflection(_7487.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7554.WormGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7555.WormGearMeshAdvancedSystemDeflection]":
