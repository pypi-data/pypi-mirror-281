...
class ShaftHarmonicAnalysis(
    _5810.AbstractShaftHarmonicAnalysis, _2739.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4792.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5898.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2889.ShaftSystemDeflection":
