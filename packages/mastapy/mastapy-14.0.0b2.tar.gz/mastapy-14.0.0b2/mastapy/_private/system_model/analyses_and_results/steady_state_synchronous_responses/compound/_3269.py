...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3134.HypoidGearSetSteadyStateSynchronousResponse]":
    ...
    def hypoid_gears_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3267.HypoidGearCompoundSteadyStateSynchronousResponse]":
    ...
    def hypoid_meshes_compound_steady_state_synchronous_response(
        self: "Self",
    ) -> "List[_3268.HypoidGearMeshCompoundSteadyStateSynchronousResponse]":
