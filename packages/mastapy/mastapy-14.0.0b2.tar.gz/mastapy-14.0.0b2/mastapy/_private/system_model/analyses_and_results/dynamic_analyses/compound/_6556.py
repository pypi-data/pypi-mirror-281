...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundDynamicAnalysis(_6584.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6423.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6423.BearingDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]
