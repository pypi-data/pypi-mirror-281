...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetHarmonicAnalysis(_5888.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5970.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5970.WormGearHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5971.WormGearMeshHarmonicAnalysis]":
