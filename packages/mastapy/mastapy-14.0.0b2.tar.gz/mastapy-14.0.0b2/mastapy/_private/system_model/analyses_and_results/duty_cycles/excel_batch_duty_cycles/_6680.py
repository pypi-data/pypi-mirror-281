...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6681.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6684.MASTAFileDetails":
    ...
    @property
    def working_folder(self: "Self") -> "_1646.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6683.ExcelSheetDesignStateSelector]":
