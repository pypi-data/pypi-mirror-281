...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetCompoundPowerFlow(_4332.GearSetCompoundPowerFlow):
    """ConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4169.ConicalGearSetPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4169.ConicalGearSetPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ConicalGearSetPowerFlow]
