...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartCompoundParametricStudyTool(_7711.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4502.PartParametricStudyTool]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4502.PartParametricStudyTool]":
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.PartParametricStudyTool]
