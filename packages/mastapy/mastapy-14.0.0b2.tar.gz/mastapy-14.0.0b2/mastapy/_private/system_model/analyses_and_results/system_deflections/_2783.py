...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDriveSystemDeflection(_2891.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4145.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: "Self") -> "List[_2782.BeltConnectionSystemDeflection]":
