...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearMeshSystemDeflection(_2772.AGMAGleasonConicalGearMeshSystemDeflection):
    """HypoidGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_449.HypoidGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_449.HypoidGearMeshRating":
        """mastapy._private.gears.rating.hypoid.HypoidGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4200.HypoidGearMeshPowerFlow":
