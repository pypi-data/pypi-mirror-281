...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundModalAnalysis(_4866.ComponentCompoundModalAnalysis):
    """MicrophoneCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4766.MicrophoneModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4766.MicrophoneModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.MicrophoneModalAnalysis]
