...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadCompoundPowerFlow(_4396.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4226.PointLoadPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.PointLoadPowerFlow]
