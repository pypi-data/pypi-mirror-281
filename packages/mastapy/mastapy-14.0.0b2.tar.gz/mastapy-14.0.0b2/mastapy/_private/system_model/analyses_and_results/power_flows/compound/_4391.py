...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterCompoundPowerFlow(_4309.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4261.TorqueConverterPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4261.TorqueConverterPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]
