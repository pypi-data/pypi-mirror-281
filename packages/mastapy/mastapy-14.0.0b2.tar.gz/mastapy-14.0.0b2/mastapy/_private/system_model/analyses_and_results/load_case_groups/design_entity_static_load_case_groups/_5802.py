...
TAssembly = TypeVar("TAssembly", bound="_2488.AbstractAssembly")
TAssemblyStaticLoad = TypeVar(
    "TAssemblyStaticLoad", bound="_6953.AbstractAssemblyLoadCase"
)
...
class AbstractAssemblyStaticLoadCaseGroup(
    _5807.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]
):
    """AbstractAssemblyStaticLoadCaseGroup
