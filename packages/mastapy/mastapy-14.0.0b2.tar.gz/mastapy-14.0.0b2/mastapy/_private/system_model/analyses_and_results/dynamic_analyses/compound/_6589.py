...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundDynamicAnalysis(_6558.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_6456.CVTDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6456.CVTDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.CVTDynamicAnalysis]
