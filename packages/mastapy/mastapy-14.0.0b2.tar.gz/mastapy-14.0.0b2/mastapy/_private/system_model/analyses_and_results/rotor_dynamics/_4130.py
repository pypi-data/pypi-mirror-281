...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1652.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1652.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4131.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4131,
        )

        return self.__parent__._cast(_4131.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4132.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4132,
        )

        return self.__parent__._cast(_4132.ShaftModalComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4133.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4133,
        )

        return self.__parent__._cast(_4133.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4134.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4134,
        )

        return self.__parent__._cast(_4134.ShaftModalComplexShapeAtStiffness)
