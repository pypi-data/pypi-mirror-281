...
class _Cast_ResultsForOrder:
    ...
    def results_for_order_including_groups(
        self: "CastSelf",
    ) -> "_6002.ResultsForOrderIncludingGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6002,
        )

        return self.__parent__._cast(_6002.ResultsForOrderIncludingGroups)

    @property
    def results_for_order_including_nodes(
        self: "CastSelf",
    ) -> "_6003.ResultsForOrderIncludingNodes":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6003,
        )

        return self.__parent__._cast(_6003.ResultsForOrderIncludingNodes)

    @property
    def results_for_order_including_surfaces(
        self: "CastSelf",
    ) -> "_6004.ResultsForOrderIncludingSurfaces":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6004,
        )

        return self.__parent__._cast(_6004.ResultsForOrderIncludingSurfaces)
...
class ResultsForOrder(_0.APIBase):
    ...
    def component(
        self: "Self",
    ) -> "_5992.HarmonicAnalysisResultsBrokenDownByComponentWithinAHarmonic":
