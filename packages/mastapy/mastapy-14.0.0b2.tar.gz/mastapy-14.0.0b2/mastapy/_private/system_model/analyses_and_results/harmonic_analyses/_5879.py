...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetHarmonicAnalysis(_5888.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5877.FaceGearHarmonicAnalysis]":
    ...
    def face_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5877.FaceGearHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.FaceGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5878.FaceGearMeshHarmonicAnalysis]":
