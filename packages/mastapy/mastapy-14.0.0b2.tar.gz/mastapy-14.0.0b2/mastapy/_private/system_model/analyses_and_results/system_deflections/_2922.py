...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetSystemDeflection(_2843.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4268.WormGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2923.WormGearSystemDeflection]":
    ...
    def worm_gears_system_deflection(
        self: "Self",
    ) -> "List[_2923.WormGearSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2921.WormGearMeshSystemDeflection]":
