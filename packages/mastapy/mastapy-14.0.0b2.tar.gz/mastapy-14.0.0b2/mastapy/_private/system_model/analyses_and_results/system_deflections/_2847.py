...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetSystemDeflection(_2773.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4202.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2848.HypoidGearSystemDeflection]":
    ...
    def agma_gleason_conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2846.HypoidGearMeshSystemDeflection]":
