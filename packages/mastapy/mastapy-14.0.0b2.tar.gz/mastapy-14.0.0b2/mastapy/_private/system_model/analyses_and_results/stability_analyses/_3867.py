...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetStabilityAnalysis(_3895.ConicalGearSetStabilityAnalysis):
    """AGMAGleasonConicalGearSetStabilityAnalysis
    ...
    def conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3868.AGMAGleasonConicalGearStabilityAnalysis]":
    ...
    def conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3866.AGMAGleasonConicalGearMeshStabilityAnalysis]":
