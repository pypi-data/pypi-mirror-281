...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6698.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6830.BevelDifferentialGearCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6831.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]":
