...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _189
...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_5893.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_5893.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _5893.HarmonicAnalysisExportOptions[
        _2737.IHaveFEPartHarmonicAnalysisResults, _2507.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    @enforce_parameter_types
    def distance_unit(self: "Self", value: "_1657.Unit") -> None:
    ...
    @enforce_parameter_types
    def element_face_group_to_export(
        self: "Self", value: "_235.CMSElementFaceGroup"
    ) -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def fe_export_format(self: "Self", value: "_173.FEExportFormat") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: "Self", value: "_1657.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def eigenvalue_options(self: "Self") -> "_189.EigenvalueOptions":
