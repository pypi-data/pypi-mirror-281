...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundDynamicAnalysis(_6584.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6497.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6497.OilSealDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
