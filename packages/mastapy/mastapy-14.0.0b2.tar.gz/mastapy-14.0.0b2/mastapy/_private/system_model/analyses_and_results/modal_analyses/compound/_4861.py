...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundModalAnalysis(_4941.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2497.BoltedJoint":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4702.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4702.BoltedJointModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
