...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSystemDeflection(_2844.GearSystemDeflection):
    """WormGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_385.WormGearRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4267.WormGearPowerFlow":
