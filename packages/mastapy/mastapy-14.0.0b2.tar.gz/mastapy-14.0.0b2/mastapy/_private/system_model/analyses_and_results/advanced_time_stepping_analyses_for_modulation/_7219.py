...
class GearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self: "Self") -> "List[_1554.Eigenmodes]":
    ...
    def gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7217.GearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def meshes_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7218.GearMeshAdvancedTimeSteppingAnalysisForModulation]":
