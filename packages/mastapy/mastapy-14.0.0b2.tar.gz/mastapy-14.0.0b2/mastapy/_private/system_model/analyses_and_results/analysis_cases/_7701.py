...
T = TypeVar("T", bound="_6950.LoadCase")
...
class _Cast_AbstractAnalysisOptions:
    ...
    @property
    def system_deflection_options(self: "CastSelf") -> "_2912.SystemDeflectionOptions":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _2912,
        )

        return self.__parent__._cast(_2912.SystemDeflectionOptions)
    ...
    def frequency_response_analysis_options(
        ...
        return self.__parent__._cast(_4745.FrequencyResponseAnalysisOptions)

    @property
    def mbd_run_up_analysis_options(
        self: "CastSelf",
    ) -> "_5586.MBDRunUpAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses import (
            _5586,
        )

        return self.__parent__._cast(_5586.MBDRunUpAnalysisOptions)
    ...
    def frequency_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5882.FrequencyOptionsForHarmonicAnalysisResults)
    ...
    def speed_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5943.SpeedOptionsForHarmonicAnalysisResults)

    @property
    def stiffness_options_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_5950.StiffnessOptionsForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5950,
        )

        return self.__parent__._cast(_5950.StiffnessOptionsForHarmonicAnalysis)
