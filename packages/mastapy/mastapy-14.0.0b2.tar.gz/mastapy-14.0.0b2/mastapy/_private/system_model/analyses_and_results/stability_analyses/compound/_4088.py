...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyCompoundStabilityAnalysis(_4037.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3954.PulleyStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3954.PulleyStabilityAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.PulleyStabilityAnalysis]
