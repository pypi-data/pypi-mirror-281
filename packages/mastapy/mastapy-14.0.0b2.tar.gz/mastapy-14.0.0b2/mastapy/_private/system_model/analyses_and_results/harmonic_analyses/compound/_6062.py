...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundHarmonicAnalysis(_6036.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5861.DatumHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5861.DatumHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.DatumHarmonicAnalysis]
