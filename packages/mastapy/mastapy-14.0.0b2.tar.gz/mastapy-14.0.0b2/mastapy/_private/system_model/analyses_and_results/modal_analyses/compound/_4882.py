...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundModalAnalysis(_4851.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4725.CVTModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4725.CVTModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.CVTModalAnalysis]
