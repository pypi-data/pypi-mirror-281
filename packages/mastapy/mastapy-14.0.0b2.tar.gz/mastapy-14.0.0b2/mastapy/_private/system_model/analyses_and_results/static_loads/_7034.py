...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2412
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartLoadCase(_6955.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: "Self") -> "_2412.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2412", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: "Self", value: "_2437.FESubstructure") -> None:
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_6982.CMSElementFaceGroupWithSelectionOption]":
