...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentCompoundModalAnalysis(_4922.PartCompoundModalAnalysis):
    """ComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4708.ComponentModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4708.ComponentModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.ComponentModalAnalysis]
