...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundModalAnalysisAtASpeed(_5378.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5277.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_5277.CVTModalAnalysisAtASpeed]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]
