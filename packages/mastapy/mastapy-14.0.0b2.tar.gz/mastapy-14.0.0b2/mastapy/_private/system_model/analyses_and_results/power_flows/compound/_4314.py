...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundPowerFlow(_4362.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4177.CVTPulleyPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.CVTPulleyPowerFlow]
