...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartCompoundPowerFlow(_7711.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4219.PartPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4219.PartPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.PartPowerFlow]
