...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1550, _1559
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadHarmonicLoadData(_1429.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: "Self") -> "_1550.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1550", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: "Self", value: "_1550.DegreeOfFreedom") -> None:
