...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundPowerFlow(_4279.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self: "Self") -> "_5790.AbstractStaticLoadCaseGroup":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4236.RootAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4236.RootAssemblyPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.RootAssemblyPowerFlow]
