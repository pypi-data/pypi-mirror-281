...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundPowerFlow(_4372.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4154.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4154.BoltedJointPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
