...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetCompoundPowerFlow(_4290.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4283.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4284.BevelDifferentialGearMeshCompoundPowerFlow]":
