...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshSystemDeflection(_2842.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_469.CylindricalGearMeshRating":
    ...
    @property
    def gear_a(self: "Self") -> "_2828.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2828.CylindricalGearSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4183.CylindricalGearMeshPowerFlow":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2930.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2825.CylindricalGearSetSystemDeflection":
