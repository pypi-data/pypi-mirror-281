...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetStabilityAnalysis(_3879.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3997.ZerolBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3995.ZerolBevelGearMeshStabilityAnalysis]":
