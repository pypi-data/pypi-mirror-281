...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundDynamicAnalysis(_6573.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6466.DatumDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6466.DatumDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.DatumDynamicAnalysis]
