...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundDynamicAnalysis(_6608.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6544.WormGearSetDynamicAnalysis]":
    ...
    def worm_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6673.WormGearCompoundDynamicAnalysis]":
    ...
    def worm_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6674.WormGearMeshCompoundDynamicAnalysis]":
