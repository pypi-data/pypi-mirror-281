...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSystemDeflection(_2791.BevelGearSystemDeflection):
    """ZerolBevelGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_381.ZerolBevelGearRating":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4270.ZerolBevelGearPowerFlow":
