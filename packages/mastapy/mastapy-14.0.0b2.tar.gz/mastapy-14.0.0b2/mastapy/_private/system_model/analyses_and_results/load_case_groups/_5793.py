...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignState(_5788.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5791.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: "Self", clutch_connection: "_2395.ClutchConnection"
    ) -> "_5791.ClutchEngagementStatus":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2581.CylindricalGear"
    ) -> "_5792.ConceptSynchroGearEngagementStatus":
