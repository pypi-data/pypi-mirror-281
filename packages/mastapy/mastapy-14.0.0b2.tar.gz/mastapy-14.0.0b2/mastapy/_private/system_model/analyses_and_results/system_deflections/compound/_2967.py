...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundSystemDeflection(_2997.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2965.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2966.ConceptGearMeshCompoundSystemDeflection]":
