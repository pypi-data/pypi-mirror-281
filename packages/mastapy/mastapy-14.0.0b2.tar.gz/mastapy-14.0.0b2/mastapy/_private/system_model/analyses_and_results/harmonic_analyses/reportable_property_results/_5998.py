...
class _Cast_ResultsForMultipleOrders:
    ...
    def results_for_multiple_orders_for_fe_surface(
        self: "CastSelf",
    ) -> "_5999.ResultsForMultipleOrdersForFESurface":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5999,
        )

        return self.__parent__._cast(_5999.ResultsForMultipleOrdersForFESurface)

    @property
    def results_for_multiple_orders_for_groups(
        self: "CastSelf",
    ) -> "_6000.ResultsForMultipleOrdersForGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6000,
        )

        return self.__parent__._cast(_6000.ResultsForMultipleOrdersForGroups)
