...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundSystemDeflection(_2961.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2834.DatumSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2834.DatumSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]
