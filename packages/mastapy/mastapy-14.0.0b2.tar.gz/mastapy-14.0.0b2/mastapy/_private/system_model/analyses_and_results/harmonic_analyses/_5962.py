...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5961
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSleeveHarmonicAnalysis(_5961.SynchroniserPartHarmonicAnalysis):
    """SynchroniserSleeveHarmonicAnalysis
