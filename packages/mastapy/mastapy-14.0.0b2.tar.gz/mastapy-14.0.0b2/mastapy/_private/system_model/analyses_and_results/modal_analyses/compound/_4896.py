...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundModalAnalysis(_4901.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4742.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4894.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4895.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4742.FaceGearSetModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]
