...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperCompoundPowerFlow(_4309.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4246.SpringDamperPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4246.SpringDamperPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
