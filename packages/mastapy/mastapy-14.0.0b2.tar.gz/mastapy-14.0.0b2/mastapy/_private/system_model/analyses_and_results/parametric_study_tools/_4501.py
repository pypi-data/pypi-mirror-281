...
class _Cast_ParametricStudyVariable:
    ...
    @property
    def analysis_case_variable(self: "CastSelf") -> "_2731.AnalysisCaseVariable":
        return self.__parent__._cast(_2731.AnalysisCaseVariable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParametricStudyVariable(_2731.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self: "Self") -> "_4492.ParametricStudyDimension":
    ...
    def dimension(self: "Self", value: "_4492.ParametricStudyDimension") -> None:
    ...
    @property
    def distribution(self: "Self") -> "_4489.MonteCarloDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4489",
            "MonteCarloDistribution",
        )(value)

    @distribution.setter
    @enforce_parameter_types
    def distribution(self: "Self", value: "_4489.MonteCarloDistribution") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: "Self") -> "_4455.DesignOfExperimentsVariableSetter":
