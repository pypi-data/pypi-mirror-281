...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5285.CylindricalGearSetModalAnalysisAtASpeed]":
    ...
    def cylindrical_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5415.CylindricalGearCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5416.CylindricalGearMeshCompoundModalAnalysisAtASpeed]":
