...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftSystemDeflection(_2770.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4238.ShaftPowerFlow":
    ...
    def shaft_section_end_with_worst_fatigue_safety_factor(
        self: "Self",
    ) -> "_2887.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    def mounted_components_applying_torque(self: "Self") -> "List[_1607.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: "Self",
    ) -> "List[_2887.ShaftSectionEndResultsSystemDeflection]":
    ...
    def shaft_section_results(
        self: "Self",
    ) -> "List[_2888.ShaftSectionSystemDeflection]":
