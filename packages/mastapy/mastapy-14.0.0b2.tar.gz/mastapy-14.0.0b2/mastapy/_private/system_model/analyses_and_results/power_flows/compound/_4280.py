...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundPowerFlow(_4308.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4143.BearingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4143.BearingPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.BearingPowerFlow]
