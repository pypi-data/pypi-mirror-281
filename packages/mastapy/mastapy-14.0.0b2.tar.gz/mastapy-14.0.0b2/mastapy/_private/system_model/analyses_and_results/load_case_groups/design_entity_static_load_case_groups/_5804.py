...
TConnection = TypeVar("TConnection", bound="_2325.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_6996.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5805.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
