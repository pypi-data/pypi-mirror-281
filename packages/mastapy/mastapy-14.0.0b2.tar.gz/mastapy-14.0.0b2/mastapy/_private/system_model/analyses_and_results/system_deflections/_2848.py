...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSystemDeflection(_2774.AGMAGleasonConicalGearSystemDeflection):
    """HypoidGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_450.HypoidGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_7052.HypoidGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4201.HypoidGearPowerFlow":
