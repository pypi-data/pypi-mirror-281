...
class SplinePitchErrorOptions(_0.APIBase):
    ...
    def pitch_error_input_type(
        self: "Self",
        value: "Union[_2660.SplinePitchErrorInputType, Tuple[_2660.SplinePitchErrorInputType, bool]]",
    ) -> None:
    ...
    @property
    def pitch_error_options_left_flank(self: "Self") -> "_2648.PitchErrorFlankOptions":
    ...
    @property
    def pitch_error_options_right_flank(self: "Self") -> "_2648.PitchErrorFlankOptions":
        """mastapy._private.system_model.part_model.couplings.PitchErrorFlankOptions
    ...
    @property
    def pitch_error_flank_options(self: "Self") -> "List[_2648.PitchErrorFlankOptions]":
