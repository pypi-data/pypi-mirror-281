...
from mastapy._private.system_model.part_model.configurations import _2679, _2675
...
class _Cast_ActiveShaftDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2679.PartDetailConfiguration":
        return self.__parent__._cast(_2679.PartDetailConfiguration)
...
class ActiveShaftDesignSelectionGroup(
    _2679.PartDetailConfiguration[
        _2675.ActiveShaftDesignSelection, _2538.Shaft, _43.SimpleShaftDefinition
    ]
):
    """ActiveShaftDesignSelectionGroup
