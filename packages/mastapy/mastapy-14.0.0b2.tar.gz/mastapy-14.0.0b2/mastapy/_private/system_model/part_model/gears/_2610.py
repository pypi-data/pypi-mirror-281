...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSet(_2576.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_978.ZerolBevelGearSetDesign":
    ...
    @property
    def zerol_bevel_gear_set_design(self: "Self") -> "_978.ZerolBevelGearSetDesign":
        """mastapy._private.gears.gear_designs.zerol_bevel.ZerolBevelGearSetDesign
    ...
    @property
    def zerol_bevel_gears(self: "Self") -> "List[_2609.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_2384.ZerolBevelGearMesh]":
