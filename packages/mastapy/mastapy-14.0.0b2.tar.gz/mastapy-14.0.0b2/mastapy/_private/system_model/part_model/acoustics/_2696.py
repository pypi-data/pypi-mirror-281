...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2699.ResultSurfaceOptions":
        return self.__parent__._cast(_2699.ResultSurfaceOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultPlaneOptions(_2699.ResultSurfaceOptions):
    """ResultPlaneOptions
    ...
    @property
    def axis_for_plane_normal(self: "Self") -> "_1538.Axis":
        """mastapy._private.math_utility.Axis"""
        temp = self.wrapped.AxisForPlaneNormal
    ...
    def axis_for_plane_normal(self: "Self", value: "_1538.Axis") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        self.wrapped.AxisForPlaneNormal = value
