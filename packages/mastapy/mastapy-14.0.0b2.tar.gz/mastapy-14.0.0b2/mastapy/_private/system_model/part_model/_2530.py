...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssembly(_2487.Assembly):
    """RootAssembly
    ...
    @property
    def packaging_limits(self: "Self") -> "_319.PackagingLimits":
    ...
    @property
    def parallel_part_groups(self: "Self") -> "List[_2546.ParallelPartGroup]":
    ...
    def parallel_part_groups_drawing_order(
        self: "Self",
    ) -> "List[_2541.SpecifiedParallelPartGroupDrawingOrder]":
