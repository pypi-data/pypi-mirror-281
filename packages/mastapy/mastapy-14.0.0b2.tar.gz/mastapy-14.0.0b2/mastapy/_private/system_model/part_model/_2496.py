...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2497, _2524
...
class Bolt(_2498.Component):
    ...
    @property
    def bolted_joint(self: "Self") -> "_2497.BoltedJoint":
    ...
    @property
    def loaded_bolt(self: "Self") -> "_1528.LoadedBolt":
