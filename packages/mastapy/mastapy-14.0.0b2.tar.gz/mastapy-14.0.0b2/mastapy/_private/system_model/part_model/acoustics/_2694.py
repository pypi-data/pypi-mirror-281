...
class MicrophoneArrayDesign(_0.APIBase):
    ...
    @property
    def envelope_type(self: "Self") -> "_2685.AcousticEnvelopeType":
        """mastapy._private.system_model.part_model.acoustics.AcousticEnvelopeType"""
        temp = self.wrapped.EnvelopeType
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.acoustics._2685",
            "AcousticEnvelopeType",
        )(value)

    @envelope_type.setter
    @enforce_parameter_types
    def envelope_type(self: "Self", value: "_2685.AcousticEnvelopeType") -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.SystemModel.PartModel.Acoustics.AcousticEnvelopeType"
        )
        self.wrapped.EnvelopeType = value

    @property
    def number_of_microphones(self: "Self") -> "int":
        """int"""
        temp = self.wrapped.NumberOfMicrophones
    ...
    @enforce_parameter_types
    def spherical_envelope_centre(
        self: "Self", value: "_2700.SphericalEnvelopeCentreDefinition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeCentreDefinition",
        )
        self.wrapped.SphericalEnvelopeCentre = value

    @property
    def spherical_envelope_type(self: "Self") -> "_2701.SphericalEnvelopeType":
        """mastapy._private.system_model.part_model.acoustics.SphericalEnvelopeType"""
        temp = self.wrapped.SphericalEnvelopeType
    ...
    def spherical_envelope_type(
        self: "Self", value: "_2701.SphericalEnvelopeType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeType"
        )
        self.wrapped.SphericalEnvelopeType = value

    @property
    def selected_part(self: "Self") -> "List[_2695.PartSelectionForAcousticEnvelope]":
        """List[mastapy._private.system_model.part_model.acoustics.PartSelectionForAcousticEnvelope]

        Note:
            This property is readonly.
        """
        temp = self.wrapped.SelectedPart
