...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2579, _2586
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGear(_2569.AGMAGleasonConicalGear):
    """HypoidGear
    ...
    @property
    def conical_gear_design(self: "Self") -> "_1009.HypoidGearDesign":
    ...
    @property
    def hypoid_gear_design(self: "Self") -> "_1009.HypoidGearDesign":
        """mastapy._private.gears.gear_designs.hypoid.HypoidGearDesign
