...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2634, _2649, _2644
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDrive(_2532.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: "Self") -> "_2634.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2634", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: "Self", value: "_2634.BeltDriveType") -> None:
    ...
    @property
    def belt_connections(self: "Self") -> "List[_2321.BeltConnection]":
    ...
    @property
    def pulleys(self: "Self") -> "List[_2649.Pulley]":
