...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1948, _1921
    ...
    from mastapy._private.gears.gear_designs.creation_options import _1184, _1187
    ...
    T_get_part_named = TypeVar("T_get_part_named", bound="_2524.Part")
    T_all_parts = TypeVar("T_all_parts", bound="_2524.Part")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Assembly(_2488.AbstractAssembly):
    """Assembly
    ...
    @property
    def oil_level_specification(self: "Self") -> "_2521.OilLevelSpecification":
    ...
    @property
    def bearings(self: "Self") -> "List[_2493.Bearing]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2497.BoltedJoint]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2498.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: "Self") -> "List[_2498.Component]":
        """List[mastapy._private.system_model.part_model.Component]
    ...
    @property
    def conical_gear_sets(self: "Self") -> "List[_2580.ConicalGearSet]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2507.FEPart]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2585.FaceGearSet]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2591.HypoidGearSet]":
    ...
    def klingelnberg_cyclo_palloid_gear_sets(
        self: "Self",
    ) -> "List[_2593.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    @property
    def microhone_arrays(self: "Self") -> "List[_2519.MicrophoneArray]":
        """List[mastapy._private.system_model.part_model.MicrophoneArray]

        Note:
            This property is readonly.
        """
        temp = self.wrapped.MicrohoneArrays
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2522.OilSeal]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2527.PointLoad]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2528.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_2657.ShaftHubConnection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2538.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: "Self") -> "List[_2600.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: "Self") -> "List[_2604.StraightBevelGearSet]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2608.WormGearSet]":
    ...
    def get_part_named(self: "Self", name: "str") -> "_2524.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: "Self", name: "str") -> "_2493.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: "Self", name: "str") -> "_2496.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: "Self", name: "str") -> "_2502.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: "Self", name: "str") -> "_2507.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: "Self", name: "str") -> "_2516.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: "Self", name: "str") -> "_2522.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: "Self", name: "str") -> "_2538.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: "Self", name: "str") -> "_2584.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: "Self", name: "str") -> "_2586.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: "Self", name: "str") -> "_2588.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: "Self", name: "str") -> "_2607.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: "Self", name: "str") -> "_2626.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: "Self", name: "str") -> "_2635.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: "Self", name: "str") -> "_2641.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: "Self", name: "str") -> "_2644.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: "Self", name: "str") -> "_2649.Pulley":
        """T_get_part_named
    ...
    def all_parts(self: "Self") -> "List[_2524.Part]":
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2489.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: "Self",
    ) -> "List[_2490.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2493.Bearing]":
        """List[mastapy._private.system_model.part_model.Bearing]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bearing")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_bolt(self: "Self") -> "List[_2496.Bolt]":
        """List[mastapy._private.system_model.part_model.Bolt]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bolt")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2497.BoltedJoint]":
        """List[mastapy._private.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "BoltedJoint"
        )
    ...
    def all_parts_of_type_component(self: "Self") -> "List[_2498.Component]":
        """List[mastapy._private.system_model.part_model.Component]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Component")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_connector(self: "Self") -> "List[_2501.Connector]":
        """List[mastapy._private.system_model.part_model.Connector]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Connector")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_datum(self: "Self") -> "List[_2502.Datum]":
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2507.FEPart]":
        """List[mastapy._private.system_model.part_model.FEPart]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "FEPart")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: "Self",
    ) -> "List[_2508.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2509.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2516.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: "Self",
    ) -> "List[_2517.MeasurementComponent]":
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2518.Microphone]":
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2522.OilSeal]":
        """List[mastapy._private.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2525.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2527.PointLoad]":
        """List[mastapy._private.system_model.part_model.PointLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PointLoad")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_power_load(self: "Self") -> "List[_2528.PowerLoad]":
        """List[mastapy._private.system_model.part_model.PowerLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PowerLoad")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2530.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: "Self",
    ) -> "List[_2532.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2533.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2538.Shaft]":
        """List[mastapy._private.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.ShaftModel", "Shaft"
        )
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: "Self",
    ) -> "List[_2569.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: "Self",
    ) -> "List[_2570.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: "Self",
    ) -> "List[_2571.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: "Self",
    ) -> "List[_2572.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: "Self",
    ) -> "List[_2573.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: "Self",
    ) -> "List[_2574.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2575.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2576.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: "Self") -> "List[_2577.ConceptGear]":
    ...
    def all_parts_of_type_conical_gear(self: "Self") -> "List[_2579.ConicalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: "Self",
    ) -> "List[_2583.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2584.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2585.FaceGearSet]":
        """List[mastapy._private.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "FaceGearSet"
        )
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2586.Gear]":
    ...
    def all_parts_of_type_gear_set(self: "Self") -> "List[_2588.GearSet]":
        """List[mastapy._private.system_model.part_model.gears.GearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "GearSet"
        )
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2590.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2591.HypoidGearSet]":
        """List[mastapy._private.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "HypoidGearSet"
        )
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: "Self",
    ) -> "List[_2592.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        self: "Self",
    ) -> "List[_2594.KlingelnbergCycloPalloidHypoidGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: "Self",
    ) -> "List[_2595.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(
        self: "Self",
    ) -> "List[_2596.KlingelnbergCycloPalloidSpiralBevelGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: "Self",
    ) -> "List[_2597.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: "Self",
    ) -> "List[_2601.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: "Self",
    ) -> "List[_2602.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: "Self",
    ) -> "List[_2604.StraightBevelGearSet]":
        """List[mastapy._private.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "StraightBevelGearSet"
        )
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: "Self",
    ) -> "List[_2605.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: "Self",
    ) -> "List[_2606.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2607.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2608.WormGearSet]":
        """List[mastapy._private.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "WormGearSet"
        )
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2625.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2626.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2633.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2635.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2636.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: "Self",
    ) -> "List[_2639.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2641.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: "Self") -> "List[_2642.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2644.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2645.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: "Self",
    ) -> "List[_2646.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: "Self",
    ) -> "List[_2647.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2649.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2655.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: "Self",
    ) -> "List[_2656.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2662.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2664.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: "Self",
    ) -> "List[_2670.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: "Self",
    ) -> "List[_2672.TorqueConverterTurbine]":
    ...
    @enforce_parameter_types
    def add_bearing(self: "Self", name: "str") -> "_2493.Bearing":
        """mastapy._private.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: "Self", name: "str", type_: "_1948.RollingBearingType"
    ) -> "_2493.Bearing":
        """mastapy._private.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: "Self", name: "str", type_: "_1948.RollingBearingType", designation: "str"
    ) -> "_2493.Bearing":
        """mastapy._private.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: "Self",
        belt_creation_options: Optional["_2627.BeltCreationOptions"] = None,
    ) -> "_2633.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: "Self", name: "str" = "CVT") -> "_2644.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: "Self", name: "str" = "Clutch") -> "_2635.Clutch":
    ...
    def add_cycloidal_assembly_with_options(
        ...
        cycloidal_assembly_creation_options: Optional[
            "_2628.CycloidalAssemblyCreationOptions"
        ] = None,
    ) -> "_2624.CycloidalAssembly":
    ...
    def add_cylindrical_gear_pair_with_options(
        ...
        cylindrical_gear_pair_creation_options: Optional[
            "_1184.CylindricalGearPairCreationOptions"
        ] = None,
    ) -> "_2582.CylindricalGearSet":
    ...
    def add_cylindrical_gear_set_with_options(
        ...
        cylindrical_gear_linear_train_creation_options: Optional[
            "_2629.CylindricalGearLinearTrainCreationOptions"
        ] = None,
    ) -> "_2582.CylindricalGearSet":
        """mastapy._private.system_model.part_model.gears.CylindricalGearSet
    ...
    @enforce_parameter_types
    def add_datum(self: "Self", name: "str" = "Datum") -> "_2502.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: "Self", name: "str" = "FE Part") -> "_2507.FEPart":
    ...
    def add_hypoid_gear_set_detailed(
        ...
        design_method: "_1217.AGMAGleasonConicalGearGeometryMethods" = _1217.AGMAGleasonConicalGearGeometryMethods.GLEASON,
    ) -> "_2591.HypoidGearSet":
        """mastapy._private.system_model.part_model.gears.HypoidGearSet
    ...
    @enforce_parameter_types
    def add_mass_disc(self: "Self", name: "str" = "Mass Disc") -> "_2516.MassDisc":
    ...
    def add_microphone_array(
        ...
        """
        name = str(name)
        method_result = self.wrapped.AddMicrophoneArray(name if name else "")
        type_ = method_result.GetType()
        return (
            constructor.new(type_.Namespace, type_.Name)(method_result)
            if method_result is not None
    ...
    @enforce_parameter_types
    def add_oil_seal(self: "Self", name: "str" = "Oil Seal") -> "_2522.OilSeal":
    ...
    def add_planet_carrier_with_options(
        ...
        planet_carrier_creation_options: Optional[
            "_2631.PlanetCarrierCreationOptions"
        ] = None,
    ) -> "_2525.PlanetCarrier":
    ...
    @enforce_parameter_types
    def add_point_load(self: "Self", name: "str" = "Point Load") -> "_2527.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: "Self", name: "str" = "Power Load") -> "_2528.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: "Self", catalogue: "_1921.BearingCatalog", designation: "str", name: "str"
    ) -> "_2493.Bearing":
        """mastapy._private.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: "Self", shaft_creation_options: "_2632.ShaftCreationOptions"
    ) -> "_2538.Shaft":
    ...
    def add_spiral_bevel_gear_set_with_options(
        ...
        spiral_bevel_gear_set_creation_options: Optional[
            "_1187.SpiralBevelGearSetCreationOptions"
        ] = None,
    ) -> "_2600.SpiralBevelGearSet":
