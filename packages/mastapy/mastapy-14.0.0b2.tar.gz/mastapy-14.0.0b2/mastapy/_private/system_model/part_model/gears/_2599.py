...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGear(_2575.BevelGear):
    """SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_993.SpiralBevelGearDesign":
    ...
    @property
    def spiral_bevel_gear_design(self: "Self") -> "_993.SpiralBevelGearDesign":
        """mastapy._private.gears.gear_designs.spiral_bevel.SpiralBevelGearDesign
