...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2515, _2498, _2524
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrier(_2520.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2341.PlanetarySocket]":
