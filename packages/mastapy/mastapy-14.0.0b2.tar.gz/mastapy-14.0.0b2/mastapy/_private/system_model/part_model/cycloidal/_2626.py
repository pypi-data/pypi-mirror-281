...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1508, _1509
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPins(_2520.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: "Self") -> "_1508.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: "Self") -> "_1509.RingPinsMaterial":
