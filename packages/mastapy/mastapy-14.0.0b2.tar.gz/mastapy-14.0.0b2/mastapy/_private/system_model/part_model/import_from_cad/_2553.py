...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectorFromCAD(_2560.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self: "Self") -> "_2559.HousedOrMounted":
    ...
    def mounting(self: "Self", value: "_2559.HousedOrMounted") -> None:
