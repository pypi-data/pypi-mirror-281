...
from mastapy._private.system_model.part_model import _2509, _2489
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Shaft(_2489.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2509.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2510.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2437.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2520.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
    ...
    def read_rxf(self: "Self", file_name: "str") -> None:
        ...
        self.wrapped.ReadRXF(file_name if file_name else "")
