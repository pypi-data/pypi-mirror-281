...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2543, _2547, _2548
...
class _Cast_ParallelPartGroup:
    ...
    def parallel_part_group_selection(
        self: "CastSelf",
    ) -> "_2547.ParallelPartGroupSelection":
        from mastapy._private.system_model.part_model.part_groups import _2547

        return self.__parent__._cast(_2547.ParallelPartGroupSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroup(_2542.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: "Self") -> "List[_2543.ConcentricPartGroup]":
