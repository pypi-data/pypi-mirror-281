...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2544, _2548
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConcentricPartGroup(_2542.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2544.ConcentricPartGroupParallelToThis]":
