...
from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import _2619
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SuperchargerRotorSetDatabase(_1878.NamedDatabase[_2619.SuperchargerRotorSet]):
    """SuperchargerRotorSetDatabase
