...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCoupling(_2641.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self: "Self") -> "_1581.Vector2DListAccessor":
    ...
    @property
    def half_positioning(self: "Self") -> "_2640.ConceptCouplingHalfPositioning":
    ...
    def half_positioning(
        self: "Self", value: "_2640.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
