...
class _Cast_ComponentFromCAD:
    ...
    @property
    def abstract_shaft_from_cad(self: "CastSelf") -> "_2549.AbstractShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2549

        return self.__parent__._cast(_2549.AbstractShaftFromCAD)
    ...
    @property
    def planet_shaft_from_cad(self: "CastSelf") -> "_2561.PlanetShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2561

        return self.__parent__._cast(_2561.PlanetShaftFromCAD)
    ...
    @property
    def shaft_from_cad(self: "CastSelf") -> "_2565.ShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2565

        return self.__parent__._cast(_2565.ShaftFromCAD)
