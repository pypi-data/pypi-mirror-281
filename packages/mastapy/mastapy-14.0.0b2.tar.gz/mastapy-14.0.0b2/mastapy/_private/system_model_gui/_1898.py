...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2253, _2256
    from mastapy._private.utility.operation_modes import _1838
    from mastapy._private.geometry.two_d import _321
    from mastapy._private.nodal_analysis.geometry_modeller_link import _162, _169, _170
    from mastapy._private.math_utility import _1557, _1539
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2253.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2253.Design") -> None:
    ...
    @property
    def open_designs(self: "Self") -> "List[_2253.Design]":
    ...
    @property
    def operation_mode(self: "Self") -> "_1838.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.operation_modes._1838", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: "Self", value: "_1838.OperationMode") -> None:
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2256.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2256.DesignEntity") -> None:
    ...
    def add_electric_machine_from_cad_face_group(
        self: "Self",
        cad_face_group: "_321.CADFaceGroup",
        geometry_modeller_design_information: "_162.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _163.GeometryModellerDimension]",
    ) -> None:
        """Method does not return.
    ...
    def add_fe_substructure_from_data(
        self: "Self",
        vertices_and_facets: "_1557.FacetedBody",
        geometry_modeller_design_information: "_162.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _163.GeometryModellerDimension]",
        body_moniker: "str",
    ) -> None:
    ...
    def add_line_from_geometry_modeller(
        self: "Self", circles_on_axis: "_1539.CirclesOnAxis"
    ) -> None:
        """Method does not return.
    ...
    def are_new_input_available(self: "Self") -> "_169.MeshRequest":
    ...
    def circle_pairs_from_geometry_modeller(
        self: "Self",
        preselection_circles: "_1539.CirclesOnAxis",
        selected_circles: "List[_1539.CirclesOnAxis]",
    ) -> None:
        """Method does not return.
    ...
    def create_mesh_request_result(self: "Self") -> "_170.MeshRequestResult":
    ...
    def create_new_cad_face_group(self: "Self") -> "_321.CADFaceGroup":
    ...
    def create_new_circles_on_axis(self: "Self") -> "_1539.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: "Self") -> "_1557.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2253.Design") -> None:
        """Method does not return.
    ...
    def set_mesh_request_result(
        self: "Self", mesh_request_result: "_170.MeshRequestResult"
    ) -> None:
        """Method does not return.
