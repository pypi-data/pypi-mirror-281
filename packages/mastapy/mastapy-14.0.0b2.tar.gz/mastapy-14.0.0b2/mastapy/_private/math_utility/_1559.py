...
class FourierSeries(_0.APIBase):
    ...
    @enforce_parameter_types
    def harmonic(self: "Self", index: "int") -> "_1562.HarmonicValue":
    ...
    def harmonics_above_cut_off(self: "Self") -> "List[_1562.HarmonicValue]":
    ...
    def harmonics_with_zeros_truncated(self: "Self") -> "List[_1562.HarmonicValue]":
        """List[mastapy._private.math_utility.HarmonicValue]"""
