...
class _Cast_OptimizationVariable:
    ...
    @property
    def optimization_input(self: "CastSelf") -> "_1590.OptimizationInput":
        from mastapy._private.math_utility.optimisation import _1590

        return self.__parent__._cast(_1590.OptimizationInput)

    @property
    def reporting_optimization_input(
        self: "CastSelf",
    ) -> "_1602.ReportingOptimizationInput":
        from mastapy._private.math_utility.optimisation import _1602

        return self.__parent__._cast(_1602.ReportingOptimizationInput)
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: "Self") -> "_1652.MeasurementBase":
    ...
    def measurement(self: "Self", value: "_1652.MeasurementBase") -> None:
