...
from mastapy._private.math_utility.optimisation import _1585
...
class _Cast_Optimisable:
    ...
    @property
    def abstract_optimisable(self: "CastSelf") -> "_1585.AbstractOptimisable":
        return self.__parent__._cast(_1585.AbstractOptimisable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Optimisable(_1585.AbstractOptimisable):
    """Optimisable
