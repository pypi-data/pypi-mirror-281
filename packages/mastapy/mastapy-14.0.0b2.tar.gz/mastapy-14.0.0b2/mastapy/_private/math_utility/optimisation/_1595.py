...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1597, _1593, _1594
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParetoOptimisationStrategy(_1879.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    def charts(
        self: "Self",
    ) -> "List[_1597.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: "Self") -> "List[_1593.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: "Self") -> "List[_1594.ParetoOptimisationOutput]":
