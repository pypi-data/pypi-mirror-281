...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_data import _1613, _1614
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LookupTableBase(_1633.IndependentReportablePropertiesBase[T]):
    """LookupTableBase
    ...
    def extrapolation_option(self: "Self", value: "_1556.ExtrapolationOptions") -> None:
