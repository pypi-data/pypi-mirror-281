...
class OnedimensionalFunctionLookupTable(
    _1612.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1581.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1581.Vector2DListAccessor") -> None:
