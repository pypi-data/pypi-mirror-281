...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1610, _1606, _1607
...
class _Cast_AbstractForceAndDisplacementResults:
    ...
    def force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1606.ForceAndDisplacementResults":
        from mastapy._private.math_utility.measured_vectors import _1606

        return self.__parent__._cast(_1606.ForceAndDisplacementResults)

    @property
    def force_results(self: "CastSelf") -> "_1607.ForceResults":
        from mastapy._private.math_utility.measured_vectors import _1607

        return self.__parent__._cast(_1607.ForceResults)
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self: "Self") -> "_1610.VectorWithLinearAndAngularComponents":
