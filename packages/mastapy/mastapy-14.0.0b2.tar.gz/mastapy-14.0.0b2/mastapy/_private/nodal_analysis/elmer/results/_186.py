...
from mastapy._private.nodal_analysis.elmer.results import _185
...
class _Cast_Data1D:
    ...
    @property
    def data(self: "CastSelf") -> "_185.Data":
        return self.__parent__._cast(_185.Data)
