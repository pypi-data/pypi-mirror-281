...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer.results import _186, _187
...
class _Cast_Data:
    ...
    @property
    def data_1d(self: "CastSelf") -> "_186.Data1D":
        from mastapy._private.nodal_analysis.elmer.results import _186

        return self.__parent__._cast(_186.Data1D)

    @property
    def data_3d(self: "CastSelf") -> "_187.Data3D":
        from mastapy._private.nodal_analysis.elmer.results import _187

        return self.__parent__._cast(_187.Data3D)
