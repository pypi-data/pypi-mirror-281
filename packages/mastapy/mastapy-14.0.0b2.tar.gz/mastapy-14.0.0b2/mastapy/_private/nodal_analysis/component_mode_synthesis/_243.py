...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _242, _246
...
class _Cast_RealCMSResults:
    ...
    @property
    def cms_results(self: "CastSelf") -> "_240.CMSResults":
        return self.__parent__._cast(_240.CMSResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RealCMSResults(_240.CMSResults):
    """RealCMSResults
