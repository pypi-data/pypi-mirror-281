...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    def cad_face_group(self: "Self") -> "_321.CADFaceGroup":
    ...
    @enforce_parameter_types
    def cad_face_group(self: "Self", value: "_321.CADFaceGroup") -> None:
    ...
    @property
    def faceted_body(self: "Self") -> "_1557.FacetedBody":
    ...
    @faceted_body.setter
    @enforce_parameter_types
    def faceted_body(self: "Self", value: "_1557.FacetedBody") -> None:
    ...
    @enforce_parameter_types
    def geometry_modeller_design_information(
        self: "Self", value: "_162.GeometryModellerDesignInformation"
    ) -> None:
        self.wrapped.GeometryModellerDesignInformation = value.wrapped

    @enforce_parameter_types
    def set_geometry_modeller_dimensions(
        self: "Self", dimensions: "Dict[str, _163.GeometryModellerDimension]"
    ) -> None:
