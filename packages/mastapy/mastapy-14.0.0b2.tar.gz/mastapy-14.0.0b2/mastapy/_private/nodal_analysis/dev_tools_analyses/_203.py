...
class _Cast_FEModelTabDrawStyle:
    ...
    def fe_model_harmonic_analysis_draw_style(
        self: "CastSelf",
    ) -> "_197.FEModelHarmonicAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _197

        return self.__parent__._cast(_197.FEModelHarmonicAnalysisDrawStyle)

    @property
    def fe_model_modal_analysis_draw_style(
        self: "CastSelf",
    ) -> "_199.FEModelModalAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _199

        return self.__parent__._cast(_199.FEModelModalAnalysisDrawStyle)

    @property
    def fe_model_static_analysis_draw_style(
        self: "CastSelf",
    ) -> "_202.FEModelStaticAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _202

        return self.__parent__._cast(_202.FEModelStaticAnalysisDrawStyle)
