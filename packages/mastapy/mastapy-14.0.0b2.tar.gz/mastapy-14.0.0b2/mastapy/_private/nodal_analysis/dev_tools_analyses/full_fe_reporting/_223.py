...
from mastapy._private.nodal_analysis.dev_tools_analyses.full_fe_reporting import _219
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementPropertiesRigid(_219.ElementPropertiesBase):
    """ElementPropertiesRigid
    ...
    def degrees_of_freedom_list(
        self: "Self",
    ) -> "List[_231.RigidElementNodeDegreesOfFreedom]":
