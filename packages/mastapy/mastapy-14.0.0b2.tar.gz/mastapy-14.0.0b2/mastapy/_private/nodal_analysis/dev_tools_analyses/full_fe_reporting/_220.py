...
if TYPE_CHECKING:
    ...
    from mastapy._private.fe_tools.vis_tools_global.vis_tools_global_enums import _1273
...
class _Cast_ElementPropertiesBeam:
    ...
    @property
    def element_properties_base(self: "CastSelf") -> "_219.ElementPropertiesBase":
        from mastapy._private.nodal_analysis.dev_tools_analyses.full_fe_reporting import (
            _219,
        )

        return self.__parent__._cast(_219.ElementPropertiesBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementPropertiesBeam(_227.ElementPropertiesWithMaterial):
    """ElementPropertiesBeam
    ...
    @property
    def section_type(self: "Self") -> "_1273.BeamSectionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.fe_tools.vis_tools_global.vis_tools_global_enums._1273",
            "BeamSectionType",
        )(value)
