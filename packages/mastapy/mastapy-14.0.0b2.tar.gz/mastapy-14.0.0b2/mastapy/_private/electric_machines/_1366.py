...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1335, _1338
...
class WoundFieldSynchronousRotor(
    ...
    def pole_tip_depth(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.PoleTipDepth
    ...
    def pole_tip_radius(self: "Self") -> "overridable.Overridable_float":
        """Overridable[float]"""
        temp = self.wrapped.PoleTipRadius
    ...
    def pole_tip_radius(
        ...
        self.wrapped.PoleTipRadius = value

    @property
    def pole_tip_width(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.PoleTipWidth
