...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1322, _1314
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class VShapedMagnetLayerSpecification(_1339.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def magnet_clearance(self: "Self") -> "_1322.MagnetClearance":
    ...
    @enforce_parameter_types
    def magnet_clearance(self: "Self", value: "_1322.MagnetClearance") -> None:
    ...
    @property
    def upper_flux_barrier_web_specification(self: "Self") -> "_1314.FluxBarrierOrWeb":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1314", "FluxBarrierOrWeb"
        )(value)

    @upper_flux_barrier_web_specification.setter
    @enforce_parameter_types
    def upper_flux_barrier_web_specification(
        self: "Self", value: "_1314.FluxBarrierOrWeb"
    ) -> None:
        value = conversion.mp_to_pn_enum(
