...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1286, _1310
...
class _Cast_FieldWindingSpecificationBase:
    ...
    def cad_field_winding_specification(
        self: "CastSelf",
    ) -> "_1286.CADFieldWindingSpecification":
        from mastapy._private.electric_machines import _1286

        return self.__parent__._cast(_1286.CADFieldWindingSpecification)

    @property
    def field_winding_specification(
        self: "CastSelf",
    ) -> "_1310.FieldWindingSpecification":
        from mastapy._private.electric_machines import _1310

        return self.__parent__._cast(_1310.FieldWindingSpecification)
...
class FieldWindingSpecificationBase(_0.APIBase):
    ...
    def fill_factor_windings(self: "Self", value: "float") -> None:
        self.wrapped.FillFactorWindings = float(value) if value is not None else 0.0
    ...
    def total_length_of_conductors_in_pole(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.TotalLengthOfConductorsInPole
