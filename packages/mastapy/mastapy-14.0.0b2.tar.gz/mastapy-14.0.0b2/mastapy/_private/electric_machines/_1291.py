...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1318, _1357
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CADToothAndSlot(_1283.AbstractToothAndSlot):
    """CADToothAndSlot
    ...
    def individual_conductor_specification_source(
        self: "Self",
    ) -> "_1318.IndividualConductorSpecificationSource":
    ...
    def individual_conductor_specification_source(
        self: "Self", value: "_1318.IndividualConductorSpecificationSource"
    ) -> None:
