...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: "Self") -> "List[_1394.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1392.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: "Self") -> "List[_1397.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1422.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1404.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: "Self",
    ) -> "List[_1421.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: "Self", load_case_type: "_1410.LoadCaseType"
    ...
    def add_load_case_named(
        self: "Self", load_case_type: "_1410.LoadCaseType", name: "str"
    ) -> "_1405.ElectricMachineLoadCaseBase":
        """mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: "Self",
        setup: "_1308.ElectricMachineSetup",
        load_case_type: "_1410.LoadCaseType",
    ) -> "_1637.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1308.ElectricMachineSetup",
        load_case_type: "_1410.LoadCaseType",
        task_progress: "_7724.TaskProgress",
    ) -> "_1637.MethodOutcome":
        """mastapy._private.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: "Self", load_case: "_1405.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
