...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleOperatingPointAnalysis(_1398.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    def electric_machine_results(
        self: "Self",
    ) -> "_1376.ElectricMachineResultsForOpenCircuitAndOnLoad":
    ...
    @property
    def load_case(self: "Self") -> "_1404.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: "Self",
    ) -> "List[_1417.SlotDetailForAnalysis]":
