...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1284, _1316
...
class _Cast_WindingConductor:
    ...
    @property
    def cad_conductor(self: "CastSelf") -> "_1284.CADConductor":
        from mastapy._private.electric_machines import _1284

        return self.__parent__._cast(_1284.CADConductor)

    @property
    def hairpin_conductor(self: "CastSelf") -> "_1316.HairpinConductor":
        from mastapy._private.electric_machines import _1316

        return self.__parent__._cast(_1316.HairpinConductor)
