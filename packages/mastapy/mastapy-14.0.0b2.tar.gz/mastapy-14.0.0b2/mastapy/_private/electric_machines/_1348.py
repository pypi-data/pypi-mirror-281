...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1349, _1302
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SurfacePermanentMagnetMachine(_1331.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    def rotor(self: "Self") -> "_1349.SurfacePermanentMagnetRotor":
