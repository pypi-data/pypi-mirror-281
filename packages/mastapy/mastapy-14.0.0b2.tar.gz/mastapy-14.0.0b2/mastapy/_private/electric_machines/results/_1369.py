...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1386, _1388
...
class _Cast_ElectricMachineDQModel:
    ...
    @property
    def linear_dq_model(self: "CastSelf") -> "_1386.LinearDQModel":
        from mastapy._private.electric_machines.results import _1386

        return self.__parent__._cast(_1386.LinearDQModel)

    @property
    def non_linear_dq_model(self: "CastSelf") -> "_1388.NonLinearDQModel":
        from mastapy._private.electric_machines.results import _1388

        return self.__parent__._cast(_1388.NonLinearDQModel)
