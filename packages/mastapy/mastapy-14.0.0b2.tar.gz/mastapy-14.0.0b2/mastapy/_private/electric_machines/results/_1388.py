...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1917, _1919
...
class _Cast_NonLinearDQModel:
    ...
    @property
    def electric_machine_dq_model(self: "CastSelf") -> "_1369.ElectricMachineDQModel":
        return self.__parent__._cast(_1369.ElectricMachineDQModel)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NonLinearDQModel(_1369.ElectricMachineDQModel):
    """NonLinearDQModel
    ...
    @property
    def d_axis_armature_flux_linkage_map(self: "Self") -> "_1917.ThreeDChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDChartDefinition
    ...
    @property
    def d_axis_flux_linkage_map(self: "Self") -> "_1917.ThreeDChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDChartDefinition

        Note:
            This property is readonly.
        """
        temp = self.wrapped.DAxisFluxLinkageMap
    ...
    @property
    def magnet_loss_per_frequency_2_map(self: "Self") -> "_1917.ThreeDChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDChartDefinition

        Note:
            This property is readonly.
        """
        temp = self.wrapped.MagnetLossPerFrequency2Map
    ...
    @property
    def q_axis_armature_flux_linkage_map(self: "Self") -> "_1917.ThreeDChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDChartDefinition
    ...
    @property
    def q_axis_flux_linkage_map(self: "Self") -> "_1917.ThreeDChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDChartDefinition

        Note:
            This property is readonly.
        """
        temp = self.wrapped.QAxisFluxLinkageMap
