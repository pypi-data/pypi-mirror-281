...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1379, _1382, _1380, _1378
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: "Self") -> "_1919.TwoDChartDefinition":
        """mastapy._private.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: "Self",
    ) -> "List[_1379.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: "Self",
    ) -> "List[_1382.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1380.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1378.ElectricMachineResultsForPhaseAtTimeStep]":
