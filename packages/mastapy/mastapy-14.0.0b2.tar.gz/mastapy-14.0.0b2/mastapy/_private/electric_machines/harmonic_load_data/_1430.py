...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1431, _1432
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        return self.__parent__._cast(_1431.StatorToothLoadInterpolator)
    ...
    def stator_tooth_moment_interpolator(
        ...
        return self.__parent__._cast(_1432.StatorToothMomentInterpolator)
