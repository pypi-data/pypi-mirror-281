...
class _Cast_StatorToothMomentInterpolator:
    ...
    @property
    def stator_tooth_interpolator(self: "CastSelf") -> "_1430.StatorToothInterpolator":
        return self.__parent__._cast(_1430.StatorToothInterpolator)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorToothMomentInterpolator(_1430.StatorToothInterpolator):
    """StatorToothMomentInterpolator
