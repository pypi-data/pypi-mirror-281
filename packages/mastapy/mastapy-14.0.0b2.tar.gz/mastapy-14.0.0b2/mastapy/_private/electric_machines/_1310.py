...
class _Cast_FieldWindingSpecification:
    ...
    def field_winding_specification_base(
        self: "CastSelf",
    ) -> "_1311.FieldWindingSpecificationBase":
        return self.__parent__._cast(_1311.FieldWindingSpecificationBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FieldWindingSpecification(_1311.FieldWindingSpecificationBase):
    """FieldWindingSpecification
    ...
    def coil_radial_offset(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.CoilRadialOffset
    ...
    def field_winding_edge_is_radial_line(self: "Self") -> "bool":
        """bool"""
        temp = self.wrapped.FieldWindingEdgeIsRadialLine
    ...
    def field_winding_edge_is_radial_line(self: "Self", value: "bool") -> None:
        self.wrapped.FieldWindingEdgeIsRadialLine = (
