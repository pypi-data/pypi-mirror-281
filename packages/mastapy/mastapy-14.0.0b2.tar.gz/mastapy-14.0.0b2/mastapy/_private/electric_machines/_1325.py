...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1288, _1326
...
class _Cast_MagnetDesign:
    ...
    @property
    def cad_magnets_for_layer(self: "CastSelf") -> "_1288.CADMagnetsForLayer":
        from mastapy._private.electric_machines import _1288

        return self.__parent__._cast(_1288.CADMagnetsForLayer)

    @property
    def magnet_for_layer(self: "CastSelf") -> "_1326.MagnetForLayer":
        from mastapy._private.electric_machines import _1326

        return self.__parent__._cast(_1326.MagnetForLayer)
