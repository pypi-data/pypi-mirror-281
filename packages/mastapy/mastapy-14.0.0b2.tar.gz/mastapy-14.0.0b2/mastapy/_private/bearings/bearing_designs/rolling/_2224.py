...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2215, _2218
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TaperRollerBearing(_2214.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: "Self") -> "_1928.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1928", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(
        self: "Self", value: "_1928.BearingMeasurementType"
    ) -> None:
