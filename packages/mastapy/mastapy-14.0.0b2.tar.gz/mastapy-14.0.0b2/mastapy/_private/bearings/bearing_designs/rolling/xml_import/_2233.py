...
from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2229
...
class _Cast_XMLVariableAssignment:
    ...
    def abstract_xml_variable_assignment(
        self: "CastSelf",
    ) -> "_2229.AbstractXmlVariableAssignment":
        return self.__parent__._cast(_2229.AbstractXmlVariableAssignment)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class XMLVariableAssignment(_2229.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
