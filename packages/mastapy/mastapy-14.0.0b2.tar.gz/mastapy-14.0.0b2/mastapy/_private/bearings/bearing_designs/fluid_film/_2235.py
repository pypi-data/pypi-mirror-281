...
from mastapy._private.bearings.bearing_designs.fluid_film import _2234
...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2234.AxialFeedJournalBearing":
        return self.__parent__._cast(_2234.AxialFeedJournalBearing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialGrooveJournalBearing(_2234.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
