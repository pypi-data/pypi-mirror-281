...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2238, _2239, _2241
...
class _Cast_PlainJournalHousing:
    ...
    def cylindrical_housing_journal_bearing(
        self: "CastSelf",
    ) -> "_2238.CylindricalHousingJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2238

        return self.__parent__._cast(_2238.CylindricalHousingJournalBearing)

    @property
    def machinery_encased_journal_bearing(
        self: "CastSelf",
    ) -> "_2239.MachineryEncasedJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2239

        return self.__parent__._cast(_2239.MachineryEncasedJournalBearing)

    @property
    def pedestal_journal_bearing(self: "CastSelf") -> "_2241.PedestalJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2241

        return self.__parent__._cast(_2241.PedestalJournalBearing)
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self: "Self") -> "_1996.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results._1996", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(
        self: "Self", value: "_1996.DefaultOrUserInput"
    ) -> None:
