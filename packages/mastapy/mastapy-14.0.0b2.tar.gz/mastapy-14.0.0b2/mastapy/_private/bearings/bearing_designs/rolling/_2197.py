...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self: "Self") -> "_2198.BearingProtectionLevel":
    ...
    @property
    def new_protection_level(self: "Self") -> "_2198.BearingProtectionLevel":
        """mastapy._private.bearings.bearing_designs.rolling.BearingProtectionLevel"""
    ...
    def new_protection_level(
        self: "Self", value: "_2198.BearingProtectionLevel"
    ) -> None:
