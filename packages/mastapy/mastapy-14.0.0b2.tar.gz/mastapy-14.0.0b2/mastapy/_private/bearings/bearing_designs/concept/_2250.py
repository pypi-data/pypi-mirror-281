...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.concept import _2249
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptAxialClearanceBearing(_2251.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: "Self") -> "_2249.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.concept._2249",
            "BearingNodePosition",
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2249.BearingNodePosition") -> None:
