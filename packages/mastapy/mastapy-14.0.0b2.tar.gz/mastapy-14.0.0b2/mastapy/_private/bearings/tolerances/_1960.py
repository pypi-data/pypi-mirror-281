...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1963, _1966, _1972
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InterferenceDetail(_1953.BearingConnectionComponent):
    """InterferenceDetail
    ...
    @property
    def material(self: "Self") -> "_280.Material":
