...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2031, _2033
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2031.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2031

        return self.__parent__._cast(_2031.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2033.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2033

        return self.__parent__._cast(_2033.ISOTR1417922001Results)
