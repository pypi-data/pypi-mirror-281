...
class _Cast_GreaseLifeAndRelubricationInterval:
    ...
    @property
    def skf_calculation_result(self: "CastSelf") -> "_2149.SKFCalculationResult":
        return self.__parent__._cast(_2149.SKFCalculationResult)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GreaseLifeAndRelubricationInterval(_2149.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: "Self") -> "_2139.Grease":
    ...
    @property
    def grease_quantity(self: "Self") -> "_2141.GreaseQuantity":
    ...
    @property
    def initial_fill(self: "Self") -> "_2142.InitialFill":
