...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2180, _2181
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedPadFluidFilmBearingResults(_2172.LoadedFluidFilmBearingResults):
    """LoadedPadFluidFilmBearingResults
