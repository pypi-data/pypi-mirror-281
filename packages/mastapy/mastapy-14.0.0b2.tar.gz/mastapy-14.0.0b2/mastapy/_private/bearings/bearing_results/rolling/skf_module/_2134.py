...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Frequencies(_2149.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: "Self") -> "_2135.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: "Self") -> "_2147.RotationalFrequency":
