...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2026.InternalClearance":
        return self.__parent__._cast(_2026.InternalClearance)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ThreePointContactInternalClearance(_2026.InternalClearance):
    """ThreePointContactInternalClearance
