...
class _Cast_OuterRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2166.RingFittingThermalResults":
        return self.__parent__._cast(_2166.RingFittingThermalResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OuterRingFittingThermalResults(_2166.RingFittingThermalResults):
    """OuterRingFittingThermalResults
