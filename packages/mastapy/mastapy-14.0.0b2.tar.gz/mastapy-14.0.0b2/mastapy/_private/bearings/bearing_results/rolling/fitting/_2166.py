...
class _Cast_RingFittingThermalResults:
    ...
    def inner_ring_fitting_thermal_results(
        ...
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2163

        return self.__parent__._cast(_2163.InnerRingFittingThermalResults)

    @property
    def outer_ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2165.OuterRingFittingThermalResults":
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2165

        return self.__parent__._cast(_2165.OuterRingFittingThermalResults)
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self: "Self") -> "List[_2164.InterferenceComponents]":
