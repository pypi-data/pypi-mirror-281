...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2080, _2081, _2067
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNeedleRollerBearingElement(_2061.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
