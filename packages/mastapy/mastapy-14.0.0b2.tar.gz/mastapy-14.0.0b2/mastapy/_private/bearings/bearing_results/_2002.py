...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedBearingResults(_1927.BearingLoadCaseResultsLightweight):
    """LoadedBearingResults
    ...
    @property
    def bearing(self: "Self") -> "_2183.BearingDesign":
    ...
    @property
    def ring_results(self: "Self") -> "List[_2121.RingForceAndDisplacement]":
