...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2091, _2098, _2067
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedSphericalRollerBearingElement(_2081.LoadedRollerBearingElement):
    """LoadedSphericalRollerBearingElement
