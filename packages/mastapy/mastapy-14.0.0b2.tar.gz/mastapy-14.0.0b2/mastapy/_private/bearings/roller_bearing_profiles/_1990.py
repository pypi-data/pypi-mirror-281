...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _1979, _1981, _1992
...
class _Cast_RollerBearingUserSpecifiedProfile:
    ...
    @property
    def roller_bearing_profile(self: "CastSelf") -> "_1988.RollerBearingProfile":
        return self.__parent__._cast(_1988.RollerBearingProfile)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollerBearingUserSpecifiedProfile(_1988.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: "Self") -> "_1979.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._1979",
            "ProfileDataToUse",
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: "Self", value: "_1979.ProfileDataToUse") -> None:
    ...
    @property
    def profile_to_fit(self: "Self") -> "_1981.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._1981", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_1981.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: "Self") -> "List[_1992.UserSpecifiedProfilePoint]":
