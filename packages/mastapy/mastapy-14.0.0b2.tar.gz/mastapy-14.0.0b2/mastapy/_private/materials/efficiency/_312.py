...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _305, _307
...
class _Cast_PowerLoss:
    ...
    @property
    def independent_power_loss(self: "CastSelf") -> "_305.IndependentPowerLoss":
        from mastapy._private.materials.efficiency import _305

        return self.__parent__._cast(_305.IndependentPowerLoss)

    @property
    def load_and_speed_combined_power_loss(
        self: "CastSelf",
    ) -> "_307.LoadAndSpeedCombinedPowerLoss":
        from mastapy._private.materials.efficiency import _307

        return self.__parent__._cast(_307.LoadAndSpeedCombinedPowerLoss)
