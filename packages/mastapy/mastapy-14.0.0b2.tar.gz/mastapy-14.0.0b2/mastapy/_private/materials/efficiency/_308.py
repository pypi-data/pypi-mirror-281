...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilPumpDetail(_1633.IndependentReportablePropertiesBase["OilPumpDetail"]):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self: "Self") -> "_1581.Vector2DListAccessor":
    ...
    @property
    def oil_flow_rate_vs_speed(self: "Self") -> "_1581.Vector2DListAccessor":
        """mastapy._private.math_utility.Vector2DListAccessor"""
    ...
    @property
    def oil_pump_drive_type(self: "Self") -> "_309.OilPumpDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials.efficiency._309", "OilPumpDriveType"
        )(value)

    @oil_pump_drive_type.setter
    @enforce_parameter_types
    def oil_pump_drive_type(self: "Self", value: "_309.OilPumpDriveType") -> None:
    ...
    @property
    def operating_oil_pressure_vs_speed(self: "Self") -> "_1581.Vector2DListAccessor":
        """mastapy._private.math_utility.Vector2DListAccessor"""
