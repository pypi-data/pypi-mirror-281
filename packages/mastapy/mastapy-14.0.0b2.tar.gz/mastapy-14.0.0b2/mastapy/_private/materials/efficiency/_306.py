...
class _Cast_IndependentResistiveTorque:
    ...
    @property
    def resistive_torque(self: "CastSelf") -> "_313.ResistiveTorque":
        return self.__parent__._cast(_313.ResistiveTorque)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class IndependentResistiveTorque(_313.ResistiveTorque):
    """IndependentResistiveTorque
