...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self: "Self") -> "_249.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._249", "AcousticRadiationEfficiencyInputType"
        )(value)

    @input_type.setter
    @enforce_parameter_types
    def input_type(
        self: "Self", value: "_249.AcousticRadiationEfficiencyInputType"
    ) -> None:
    ...
    @property
    def radiation_efficiency_curve(self: "Self") -> "_1581.Vector2DListAccessor":
