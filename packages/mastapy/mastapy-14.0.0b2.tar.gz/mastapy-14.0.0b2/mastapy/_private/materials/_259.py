...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: "Self") -> "_1581.Vector2DListAccessor":
    ...
    def bh_curve(self: "Self", value: "_1581.Vector2DListAccessor") -> None:
        self.wrapped.BHCurve = value.wrapped

    @property
    def bh_curve_plot(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    def bh_curve_extrapolation_method(
        self: "Self",
    ) -> "_258.BHCurveExtrapolationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._258", "BHCurveExtrapolationMethod"
        )(value)

    @bh_curve_extrapolation_method.setter
    @enforce_parameter_types
    def bh_curve_extrapolation_method(
        self: "Self", value: "_258.BHCurveExtrapolationMethod"
    ) -> None:
