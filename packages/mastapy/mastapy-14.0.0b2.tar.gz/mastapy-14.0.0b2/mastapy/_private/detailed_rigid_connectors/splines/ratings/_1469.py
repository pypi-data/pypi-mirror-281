...
class _Cast_AGMA6123SplineHalfRating:
    ...
    @property
    def spline_half_rating(self: "CastSelf") -> "_1477.SplineHalfRating":
        return self.__parent__._cast(_1477.SplineHalfRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMA6123SplineHalfRating(_1477.SplineHalfRating):
    """AGMA6123SplineHalfRating
