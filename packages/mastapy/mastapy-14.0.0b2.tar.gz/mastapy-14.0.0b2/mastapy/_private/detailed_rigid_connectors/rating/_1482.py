...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints.rating import _1488
...
class _Cast_ShaftHubConnectionRating:
    ...
    def agma6123_spline_joint_rating(
        self: "CastSelf",
    ) -> "_1470.AGMA6123SplineJointRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1470

        return self.__parent__._cast(_1470.AGMA6123SplineJointRating)

    @property
    def din5466_spline_rating(self: "CastSelf") -> "_1472.DIN5466SplineRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1472

        return self.__parent__._cast(_1472.DIN5466SplineRating)

    @property
    def gbt17855_spline_joint_rating(
        self: "CastSelf",
    ) -> "_1474.GBT17855SplineJointRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1474

        return self.__parent__._cast(_1474.GBT17855SplineJointRating)

    @property
    def sae_spline_joint_rating(self: "CastSelf") -> "_1476.SAESplineJointRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1476

        return self.__parent__._cast(_1476.SAESplineJointRating)

    @property
    def spline_joint_rating(self: "CastSelf") -> "_1478.SplineJointRating":
        from mastapy._private.detailed_rigid_connectors.splines.ratings import _1478

        return self.__parent__._cast(_1478.SplineJointRating)

    @property
    def keyway_rating(self: "CastSelf") -> "_1488.KeywayRating":
        from mastapy._private.detailed_rigid_connectors.keyed_joints.rating import _1488

        return self.__parent__._cast(_1488.KeywayRating)

    @property
    def interference_fit_rating(self: "CastSelf") -> "_1495.InterferenceFitRating":
        from mastapy._private.detailed_rigid_connectors.interference_fits.rating import (
            _1495,
        )

        return self.__parent__._cast(_1495.InterferenceFitRating)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self: "Self") -> "_1433.DetailedRigidConnectorDesign":
