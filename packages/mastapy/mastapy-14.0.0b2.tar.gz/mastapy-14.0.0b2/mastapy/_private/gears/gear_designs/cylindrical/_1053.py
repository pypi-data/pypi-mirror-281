...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearPinionTypeCutter(_1036.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: "Self") -> "_1054.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1054.CylindricalGearPinionTypeCutterFlank":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank
