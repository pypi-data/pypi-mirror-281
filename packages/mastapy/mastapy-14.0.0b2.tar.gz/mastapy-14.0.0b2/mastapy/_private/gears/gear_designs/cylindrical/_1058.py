...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _521
    ...
    from mastapy._private.gears.rating.cylindrical import _465, _474
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetDesign(_974.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    def coefficient_of_friction_calculation_method(
        self: "Self",
        value: "Union[_329.CoefficientOfFrictionCalculationMethod, Tuple[_329.CoefficientOfFrictionCalculationMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def efficiency_rating_method(
        self: "Self", value: "_370.GearMeshEfficiencyRatingMethod"
    ) -> None:
    ...
    @property
    def gear_fit_system(self: "Self") -> "_1077.GearFitSystems":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1077", "GearFitSystems"
        )(value)

    @gear_fit_system.setter
    @enforce_parameter_types
    def gear_fit_system(self: "Self", value: "_1077.GearFitSystems") -> None:
    ...
    def helical_gear_micro_geometry_option(
        self: "Self",
    ) -> "_521.HelicalGearMicroGeometryOption":
    ...
    @enforce_parameter_types
    def helical_gear_micro_geometry_option(
        self: "Self", value: "_521.HelicalGearMicroGeometryOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption",
    ...
    def normal_diametral_pitch_per_inch(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.NormalDiametralPitchPerInch
    ...
    def normal_diametral_pitch_per_inch(self: "Self", value: "float") -> None:
        self.wrapped.NormalDiametralPitchPerInch = (
            float(value) if value is not None else 0.0
        )
    ...
    def normal_diametral_pitch_per_inch_with_centre_distance_adjustment(
        ...
        """float"""
        temp = self.wrapped.NormalDiametralPitchPerInchWithCentreDistanceAdjustment
    ...
    def profile_shift_distribution_rule(
        self: "Self",
    ) -> "_1022.AddendumModificationDistributionRule":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1022",
    ...
    @enforce_parameter_types
    def profile_shift_distribution_rule(
        self: "Self", value: "_1022.AddendumModificationDistributionRule"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule",
    ...
    def transverse_diametral_pitch_per_inch(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.TransverseDiametralPitchPerInch
    ...
    def transverse_diametral_pitch_per_inch(self: "Self", value: "float") -> None:
        self.wrapped.TransverseDiametralPitchPerInch = (
            float(value) if value is not None else 0.0
        )
    ...
    @property
    def ltca_settings(self: "Self") -> "_1090.LTCASettings":
    ...
    @property
    def left_flank(self: "Self") -> "_1059.CylindricalGearSetFlankDesign":
    ...
    @property
    def micropitting(self: "Self") -> "_1093.Micropitting":
    ...
    @property
    def right_flank(self: "Self") -> "_1059.CylindricalGearSetFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def scuffing(self: "Self") -> "_1102.Scuffing":
    ...
    @property
    def usage(self: "Self") -> "_1120.Usage":
    ...
    @property
    def gears(self: "Self") -> "List[_1042.CylindricalGearDesign]":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_1042.CylindricalGearDesign]":
        """List[mastapy._private.gears.gear_designs.cylindrical.CylindricalGearDesign]
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_1048.CylindricalGearMeshDesign]":
    ...
    @property
    def flanks(self: "Self") -> "List[_1059.CylindricalGearSetFlankDesign]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1059.CylindricalGearSetFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def micro_geometries(self: "Self") -> "List[_1139.CylindricalGearSetMicroGeometry]":
    ...
    def add_new_micro_geometry(self: "Self") -> "_1139.CylindricalGearSetMicroGeometry":
        """mastapy._private.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry"""
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(
        self: "Self", gears: "List[_1042.CylindricalGearDesign]"
    ) -> "_1139.CylindricalGearSetMicroGeometry":
        """mastapy._private.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def create_optimiser(
        self: "Self", duty_cycle: "_474.CylindricalGearSetDutyCycleRating"
    ) -> "_1060.CylindricalGearSetMacroGeometryOptimiser":
    ...
    def delete_manufacturing_configuration(
        self: "Self", config: "_648.CylindricalSetManufacturingConfig"
    ) -> None:
        """Method does not return.
    ...
    def delete_micro_geometry(
        self: "Self", micro_geometry: "_1139.CylindricalGearSetMicroGeometry"
    ) -> None:
        """Method does not return.
    ...
    def set_active_manufacturing_configuration(
        self: "Self", value: "_648.CylindricalSetManufacturingConfig"
    ) -> None:
        """Method does not return.
    ...
    def set_active_micro_geometry(
        self: "Self", value: "_1139.CylindricalGearSetMicroGeometry"
    ) -> None:
        """Method does not return.
