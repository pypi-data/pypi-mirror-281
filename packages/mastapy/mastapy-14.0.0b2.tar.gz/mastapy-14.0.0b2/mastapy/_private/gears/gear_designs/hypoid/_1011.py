...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.hypoid import _1009, _1010
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetDesign(_1233.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1009.HypoidGearDesign]":
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_1009.HypoidGearDesign]":
        """List[mastapy._private.gears.gear_designs.hypoid.HypoidGearDesign]
    ...
    @property
    def meshes(self: "Self") -> "List[_1010.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_1010.HypoidGearMeshDesign]":
        """List[mastapy._private.gears.gear_designs.hypoid.HypoidGearMeshDesign]
