...
class _Cast_CylindricalAccuracyGrader:
    ...
    def agma2000a88_accuracy_grader(
        self: "CastSelf",
    ) -> "_1169.AGMA2000A88AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1169,
        )

        return self.__parent__._cast(_1169.AGMA2000A88AccuracyGrader)

    @property
    def agma20151a01_accuracy_grader(
        self: "CastSelf",
    ) -> "_1170.AGMA20151A01AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1170,
        )

        return self.__parent__._cast(_1170.AGMA20151A01AccuracyGrader)
    ...
    def customer_102agma2000_accuracy_grader(
        self: "CastSelf",
    ) -> "_1173.Customer102AGMA2000AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1173,
        )

        return self.__parent__._cast(_1173.Customer102AGMA2000AccuracyGrader)
    ...
    def iso132811995_accuracy_grader(
        self: "CastSelf",
    ) -> "_1179.ISO132811995AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1179,
        )

        return self.__parent__._cast(_1179.ISO132811995AccuracyGrader)

    @property
    def iso132812013_accuracy_grader(
        self: "CastSelf",
    ) -> "_1180.ISO132812013AccuracyGrader":
        from mastapy._private.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
            _1180,
        )

        return self.__parent__._cast(_1180.ISO132812013AccuracyGrader)
...
class CylindricalAccuracyGrader(_0.APIBase):
    ...
    @property
    def accuracy_grades(self: "Self") -> "_1176.CylindricalAccuracyGrades":
