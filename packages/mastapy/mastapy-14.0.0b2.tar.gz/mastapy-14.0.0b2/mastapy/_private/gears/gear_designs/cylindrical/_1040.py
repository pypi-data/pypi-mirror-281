...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1036, _1061
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: "Self", value: "_1080.GeometrySpecificationType"
    ) -> None:
    ...
    @property
    def cylindrical_gear_cutter(self: "Self") -> "_1036.CylindricalGearAbstractRack":
    ...
    def manufacturing_configuration_selection(
        self: "Self",
    ) -> "_1061.CylindricalGearSetManufacturingConfigurationSelection":
