...
class _Cast_CylindricalGearBasicRackFlank:
    ...
    def cylindrical_gear_abstract_rack_flank(
        self: "CastSelf",
    ) -> "_1037.CylindricalGearAbstractRackFlank":
        return self.__parent__._cast(_1037.CylindricalGearAbstractRackFlank)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearBasicRackFlank(_1037.CylindricalGearAbstractRackFlank):
    """CylindricalGearBasicRackFlank
