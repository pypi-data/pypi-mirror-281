...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1019, _1017, _1016
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetMicroGeometry(_1269.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    @property
    def face_gear_set_design(self: "Self") -> "_1019.FaceGearSetDesign":
    ...
    def face_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1016.FaceGearMeshMicroGeometry]":
