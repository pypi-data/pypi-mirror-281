...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self: "Self") -> "_1152.MeasuredMapDataTypes":
    ...
    def measured_map_data_type(
        self: "Self", value: "_1152.MeasuredMapDataTypes"
    ) -> None:
    ...
    @property
    def zero_bias_relief(self: "Self") -> "_1055.CylindricalGearProfileMeasurement":
