...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _328
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshDesign(_973.GearMeshDesign):
    """CylindricalGearMeshDesign
    ...
    def centre_distance_change_method(
        self: "Self",
    ) -> "_328.CentreDistanceChangeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._328", "CentreDistanceChangeMethod"
        )(value)

    @centre_distance_change_method.setter
    @enforce_parameter_types
    def centre_distance_change_method(
        self: "Self", value: "_328.CentreDistanceChangeMethod"
    ) -> None:
    ...
    def friction_loss_multiplier(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.FrictionLossMultiplier
    ...
    def friction_loss_multiplier(self: "Self", value: "float") -> None:
        self.wrapped.FrictionLossMultiplier = float(value) if value is not None else 0.0
    ...
    @enforce_parameter_types
    def lubrication_method(self: "Self", value: "_345.LubricationMethods") -> None:
    ...
    def profile_modification(
        self: "Self",
    ) -> "_1057.CylindricalGearProfileModifications":
    ...
    @enforce_parameter_types
    def profile_modification(
        self: "Self", value: "_1057.CylindricalGearProfileModifications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications",
    ...
    @property
    def type_of_mechanism_housing(self: "Self") -> "_1119.TypeOfMechanismHousing":
    ...
    def type_of_mechanism_housing(
        self: "Self", value: "_1119.TypeOfMechanismHousing"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def user_specified_tooth_loss_factor(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.UserSpecifiedToothLossFactor
    ...
    def user_specified_tooth_loss_factor(self: "Self", value: "float") -> None:
        self.wrapped.UserSpecifiedToothLossFactor = (
            float(value) if value is not None else 0.0
        )

    @property
    def valid_normal_module_range(self: "Self") -> "_1535.Range":
    ...
    @property
    def backlash_specification(self: "Self") -> "_1023.BacklashSpecification":
    ...
    @property
    def left_flank(self: "Self") -> "_1049.CylindricalGearMeshFlankDesign":
    ...
    @property
    def right_flank(self: "Self") -> "_1049.CylindricalGearMeshFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def cylindrical_meshed_gear(self: "Self") -> "List[_1068.CylindricalMeshedGear]":
    ...
    @property
    def flanks(self: "Self") -> "List[_1049.CylindricalGearMeshFlankDesign]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1049.CylindricalGearMeshFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def gear_a(self: "Self") -> "_1042.CylindricalGearDesign":
    ...
    @property
    def gear_b(self: "Self") -> "_1042.CylindricalGearDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearDesign
