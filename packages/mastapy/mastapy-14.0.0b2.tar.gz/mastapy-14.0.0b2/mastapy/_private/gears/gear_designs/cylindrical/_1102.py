...
from mastapy._private.gears.gear_designs.cylindrical import _1103
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Scuffing(_1633.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: "Self", value: "_1103.ScuffingCoefficientOfFrictionMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: "Self", value: "_1104.ScuffingTemperatureMethodsAGMA"
    ) -> None:
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: "Self", value: "_1105.ScuffingTemperatureMethodsISO"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
