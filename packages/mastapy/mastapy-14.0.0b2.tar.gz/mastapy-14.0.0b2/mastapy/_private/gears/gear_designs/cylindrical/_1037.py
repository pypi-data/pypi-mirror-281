...
class _Cast_CylindricalGearAbstractRackFlank:
    ...
    def cylindrical_gear_basic_rack_flank(
        self: "CastSelf",
    ) -> "_1039.CylindricalGearBasicRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1039

        return self.__parent__._cast(_1039.CylindricalGearBasicRackFlank)

    @property
    def cylindrical_gear_pinion_type_cutter_flank(
        self: "CastSelf",
    ) -> "_1054.CylindricalGearPinionTypeCutterFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1054

        return self.__parent__._cast(_1054.CylindricalGearPinionTypeCutterFlank)

    @property
    def standard_rack_flank(self: "CastSelf") -> "_1109.StandardRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1109

        return self.__parent__._cast(_1109.StandardRackFlank)
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self: "Self") -> "_1036.CylindricalGearAbstractRack":
