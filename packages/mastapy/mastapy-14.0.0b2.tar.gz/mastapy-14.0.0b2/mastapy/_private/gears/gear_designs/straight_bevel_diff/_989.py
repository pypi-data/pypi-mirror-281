...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearDesign(_1218.BevelGearDesign):
    """StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self: "Self") -> "_1223.EdgeRadiusType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.bevel._1223", "EdgeRadiusType"
        )(value)

    @edge_radius_from.setter
    @enforce_parameter_types
    def edge_radius_from(self: "Self", value: "_1223.EdgeRadiusType") -> None:
