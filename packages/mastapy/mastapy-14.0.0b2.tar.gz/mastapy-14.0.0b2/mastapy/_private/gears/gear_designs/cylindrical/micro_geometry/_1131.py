...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshMicroGeometryDutyCycle(_1260.GearMeshDesignAnalysis):
    """CylindricalGearMeshMicroGeometryDutyCycle
    ...
    def peak_to_peak_te(
        self: "Self",
    ) -> "_1894.DutyCyclePropertySummaryVeryShortLength[_880.CylindricalGearMeshLoadDistributionAnalysis]":
