...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1026, _1078
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: "Self",
    ) -> "_1026.CreateNewSuitableCutterOption":
    ...
    def create_new_suitable_cutters(
        self: "Self", value: "_1026.CreateNewSuitableCutterOption"
    ) -> None:
    ...
    @property
    def gears(self: "Self") -> "List[_1078.GearManufacturingConfigSetupViewModel]":
