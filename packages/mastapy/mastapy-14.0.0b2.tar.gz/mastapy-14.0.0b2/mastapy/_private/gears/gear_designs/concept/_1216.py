...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.concept import _1214, _1215
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetDesign(_974.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1214.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: "Self") -> "List[_1214.ConceptGearDesign]":
        """List[mastapy._private.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: "Self") -> "List[_1215.ConceptGearMeshDesign]":
