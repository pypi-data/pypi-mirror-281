...
from mastapy._private.gears.gear_designs.creation_options import _1185
...
class _Cast_CylindricalGearPairCreationOptions:
    ...
    @property
    def gear_set_creation_options(self: "CastSelf") -> "_1185.GearSetCreationOptions":
        return self.__parent__._cast(_1185.GearSetCreationOptions)
...
class CylindricalGearPairCreationOptions(
    _1185.GearSetCreationOptions[_1058.CylindricalGearSetDesign]
):
    """CylindricalGearPairCreationOptions
    ...
    def normal_diametral_pitch_target(self: "Self") -> "float":
        """float"""
        temp = self.wrapped.NormalDiametralPitchTarget
    ...
    def normal_diametral_pitch_target(self: "Self", value: "float") -> None:
        self.wrapped.NormalDiametralPitchTarget = (
            float(value) if value is not None else 0.0
        )
