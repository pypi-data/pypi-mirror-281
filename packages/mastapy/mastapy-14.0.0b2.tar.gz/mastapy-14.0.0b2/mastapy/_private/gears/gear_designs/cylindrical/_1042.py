...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDesign(_971.GearDesign):
    """CylindricalGearDesign
    ...
    @property
    def internal_external(self: "Self") -> "_322.InternalExternalType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.geometry.two_d._322", "InternalExternalType"
        )(value)

    @internal_external.setter
    @enforce_parameter_types
    def internal_external(self: "Self", value: "_322.InternalExternalType") -> None:
    ...
    @property
    def agma_accuracy_grade(self: "Self") -> "_1171.AGMA20151AccuracyGrades":
    ...
    def accuracy_grades_specified_accuracy(
        self: "Self",
    ) -> "_1176.CylindricalAccuracyGrades":
    ...
    @property
    def case_hardening_properties(self: "Self") -> "_1025.CaseHardeningProperties":
    ...
    def cylindrical_gear_cutting_options(
        self: "Self",
    ) -> "_1040.CylindricalGearCuttingOptions":
    ...
    def customer_102_data_sheet_change_log(
        self: "Self",
    ) -> "_1030.Customer102DataSheetChangeLog":
    ...
    def customer_102_data_sheet_notes(
        self: "Self",
    ) -> "_1033.Customer102DataSheetNotes":
    ...
    def customer_102_data_sheet_tolerance_settings(
        self: "Self",
    ) -> "_1034.Customer102DataSheetTolerances":
    ...
    @property
    def finish_stock_specification(self: "Self") -> "_1121.FinishStockSpecification":
    ...
    def gear_accuracy_tolerances(
        self: "Self",
    ) -> "_1177.CylindricalGearAccuracyTolerances":
    ...
    @property
    def iso6336_geometry(self: "Self") -> "_1085.ISO6336GeometryBase":
    ...
    @property
    def iso_accuracy_grade(self: "Self") -> "_1182.ISO1328AccuracyGrades":
    ...
    @property
    def left_flank(self: "Self") -> "_1047.CylindricalGearFlankDesign":
    ...
    @property
    def material(self: "Self") -> "_608.GearMaterial":
    ...
    @property
    def right_flank(self: "Self") -> "_1047.CylindricalGearFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    @property
    def system_of_gear_fits(self: "Self") -> "_1178.DIN3967SystemOfGearFits":
    ...
    @property
    def tiff_analysis_settings(self: "Self") -> "_1112.TiffAnalysisSettings":
    ...
    @property
    def flanks(self: "Self") -> "List[_1047.CylindricalGearFlankDesign]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1047.CylindricalGearFlankDesign":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    def manufacturing_configurations(
        self: "Self",
    ) -> "List[_635.CylindricalGearManufacturingConfig]":
    ...
    def micro_geometries(
        self: "Self",
    ) -> "List[_1133.CylindricalGearMicroGeometryBase]":
