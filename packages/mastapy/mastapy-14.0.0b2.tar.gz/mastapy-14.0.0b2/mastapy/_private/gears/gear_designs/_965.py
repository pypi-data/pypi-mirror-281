...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelHypoidGearDesignSettingsItem(_1879.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self: "Self") -> "_354.QualityGradeTypes":
    ...
    @enforce_parameter_types
    def quality_grade_type(self: "Self", value: "_354.QualityGradeTypes") -> None:
