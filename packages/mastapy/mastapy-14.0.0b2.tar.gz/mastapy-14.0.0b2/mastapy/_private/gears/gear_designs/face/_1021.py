...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1014
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearWheelDesign(_1013.FaceGearDesign):
    """FaceGearWheelDesign
    ...
    def face_width_and_diameters_specification_method(
        self: "Self",
    ) -> "_1014.FaceGearDiameterFaceWidthSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.face._1014",
    ...
    @enforce_parameter_types
    def face_width_and_diameters_specification_method(
        self: "Self", value: "_1014.FaceGearDiameterFaceWidthSpecificationMethod"
    ) -> None:
