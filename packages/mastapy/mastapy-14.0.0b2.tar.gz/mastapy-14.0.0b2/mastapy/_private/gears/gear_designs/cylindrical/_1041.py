...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _765
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDefaults(_1641.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self: "Self") -> "_1122.FinishStockType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash._1122",
            "FinishStockType",
        )(value)

    @finish_stock_type.setter
    @enforce_parameter_types
    def finish_stock_type(self: "Self", value: "_1122.FinishStockType") -> None:
    ...
    def rough_cutter_creation_settings(
        self: "Self",
    ) -> "_745.RoughCutterCreationSettings":
    ...
    @property
    def system_of_fits_defaults(self: "Self") -> "_1178.DIN3967SystemOfGearFits":
