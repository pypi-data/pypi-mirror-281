...
class _Cast_CylindricalAccuracyGrades:
    ...
    @property
    def accuracy_grades(self: "CastSelf") -> "_324.AccuracyGrades":
        return self.__parent__._cast(_324.AccuracyGrades)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalAccuracyGrades(_324.AccuracyGrades):
    """CylindricalAccuracyGrades
