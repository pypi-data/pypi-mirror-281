...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1115, _1098
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalMeshAngularBacklash(_1070.CylindricalMeshLinearBacklashSpecification):
    """CylindricalMeshAngularBacklash
