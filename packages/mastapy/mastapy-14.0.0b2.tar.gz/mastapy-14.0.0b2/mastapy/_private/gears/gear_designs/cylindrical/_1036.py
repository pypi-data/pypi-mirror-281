...
class _Cast_CylindricalGearAbstractRack:
    ...
    def cylindrical_gear_basic_rack(
        self: "CastSelf",
    ) -> "_1038.CylindricalGearBasicRack":
        from mastapy._private.gears.gear_designs.cylindrical import _1038

        return self.__parent__._cast(_1038.CylindricalGearBasicRack)

    @property
    def cylindrical_gear_pinion_type_cutter(
        self: "CastSelf",
    ) -> "_1053.CylindricalGearPinionTypeCutter":
        from mastapy._private.gears.gear_designs.cylindrical import _1053

        return self.__parent__._cast(_1053.CylindricalGearPinionTypeCutter)

    @property
    def standard_rack(self: "CastSelf") -> "_1108.StandardRack":
        from mastapy._private.gears.gear_designs.cylindrical import _1108

        return self.__parent__._cast(_1108.StandardRack)
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_1042.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: "Self") -> "_1037.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1037.CylindricalGearAbstractRackFlank":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def shaper_for_agma_rating(self: "Self") -> "_737.CylindricalGearShaper":
    ...
    @property
    def flanks(self: "Self") -> "List[_1037.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1037.CylindricalGearAbstractRackFlank":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
