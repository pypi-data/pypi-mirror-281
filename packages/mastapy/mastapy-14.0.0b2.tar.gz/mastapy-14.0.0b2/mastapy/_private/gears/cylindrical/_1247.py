...
from mastapy._private.gears.cylindrical import _1251
...
class _Cast_CylindricalGearLTCAContactCharts:
    ...
    @property
    def gear_ltca_contact_charts(self: "CastSelf") -> "_1251.GearLTCAContactCharts":
        return self.__parent__._cast(_1251.GearLTCAContactCharts)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearLTCAContactCharts(_1251.GearLTCAContactCharts):
    """CylindricalGearLTCAContactCharts
