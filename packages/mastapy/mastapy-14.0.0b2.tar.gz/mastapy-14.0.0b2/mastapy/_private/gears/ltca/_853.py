...
class _Cast_CylindricalGearFilletNodeStressResultsRow:
    ...
    def gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_862.GearFilletNodeStressResultsRow":
        return self.__parent__._cast(_862.GearFilletNodeStressResultsRow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFilletNodeStressResultsRow(_862.GearFilletNodeStressResultsRow):
    """CylindricalGearFilletNodeStressResultsRow
