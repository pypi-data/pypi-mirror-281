...
class _Cast_CylindricalGearMeshLoadedContactPoint:
    ...
    def gear_mesh_loaded_contact_point(
        self: "CastSelf",
    ) -> "_867.GearMeshLoadedContactPoint":
        return self.__parent__._cast(_867.GearMeshLoadedContactPoint)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshLoadedContactPoint(_867.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
