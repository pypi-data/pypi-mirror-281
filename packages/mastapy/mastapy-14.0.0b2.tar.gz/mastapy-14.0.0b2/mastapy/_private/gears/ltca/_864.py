...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _865, _863
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshLoadDistributionAnalysis(_1261.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: "Self") -> "_1559.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: "Self") -> "_1559.FourierSeries":
        """mastapy._private.math_utility.FourierSeries
    ...
    def load_distribution_analyses_at_single_rotation(
        self: "Self",
    ) -> "List[_865.GearMeshLoadDistributionAtRotation]":
    ...
    def maximum_root_stress_with_flanks(
        self: "Self",
        gear: "_863.GearLoadDistributionAnalysis",
        flank: "_336.GearFlanks",
