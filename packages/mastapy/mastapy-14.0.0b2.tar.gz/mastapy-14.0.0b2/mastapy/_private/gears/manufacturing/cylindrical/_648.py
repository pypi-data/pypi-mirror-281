...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _635, _645
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalSetManufacturingConfig(_1269.GearSetImplementationDetail):
    """CylindricalSetManufacturingConfig
    ...
    def cylindrical_mesh_manufacturing_configurations(
        self: "Self",
    ) -> "List[_645.CylindricalMeshManufacturingConfig]":
