...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _668, _669
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @enforce_parameter_types
    def micro_geometry_source(
        self: "Self", value: "_669.MicroGeometryDefinitionType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def points_of_interest_left_flank(self: "Self") -> "List[_676.PointOfInterest]":
    ...
    @property
    def points_of_interest_right_flank(self: "Self") -> "List[_676.PointOfInterest]":
        """List[mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
