...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _747
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FormWheelGrindingSimulationCalculator(_754.CutterSimulationCalc):
    """FormWheelGrindingSimulationCalculator
