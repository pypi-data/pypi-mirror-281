...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _665
...
class _Cast_ShaverPointCalculationError:
    ...
    @property
    def calculation_error(self: "CastSelf") -> "_665.CalculationError":
        return self.__parent__._cast(_665.CalculationError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaverPointCalculationError(_665.CalculationError):
    """ShaverPointCalculationError
