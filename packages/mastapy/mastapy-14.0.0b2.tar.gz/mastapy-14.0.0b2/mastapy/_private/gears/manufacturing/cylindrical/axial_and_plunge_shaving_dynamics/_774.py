...
class _Cast_ConventionalShavingDynamics:
    ...
    @property
    def shaving_dynamics(self: "CastSelf") -> "_788.ShavingDynamics":
        return self.__parent__._cast(_788.ShavingDynamics)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConventionalShavingDynamics(_788.ShavingDynamics):
    """ConventionalShavingDynamics
