...
class _Cast_RealPlungeShaverOutputs:
    ...
    @property
    def plunge_shaver_outputs(self: "CastSelf") -> "_674.PlungeShaverOutputs":
        return self.__parent__._cast(_674.PlungeShaverOutputs)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RealPlungeShaverOutputs(_674.PlungeShaverOutputs):
    """RealPlungeShaverOutputs
    ...
    @property
    def shaver(self: "Self") -> "_733.CylindricalGearPlungeShaver":
