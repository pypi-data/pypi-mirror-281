...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: "Self",
    ) -> "_789.ShavingDynamicsCalculation[_774.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: "Self",
    ) -> "_789.ShavingDynamicsCalculation[_778.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_778.PlungeShaverDynamics](
            temp
        )
