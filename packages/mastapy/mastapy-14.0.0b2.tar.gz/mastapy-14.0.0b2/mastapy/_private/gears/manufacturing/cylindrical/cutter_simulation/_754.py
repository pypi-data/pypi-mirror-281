...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _752
...
class _Cast_CutterSimulationCalc:
    ...
    def form_wheel_grinding_simulation_calculator(
        self: "CastSelf",
    ) -> "_761.FormWheelGrindingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _761,
        )

        return self.__parent__._cast(_761.FormWheelGrindingSimulationCalculator)

    @property
    def hob_simulation_calculator(self: "CastSelf") -> "_763.HobSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _763,
        )

        return self.__parent__._cast(_763.HobSimulationCalculator)

    @property
    def rack_simulation_calculator(self: "CastSelf") -> "_766.RackSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _766,
        )

        return self.__parent__._cast(_766.RackSimulationCalculator)

    @property
    def shaper_simulation_calculator(
        self: "CastSelf",
    ) -> "_768.ShaperSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _768,
        )

        return self.__parent__._cast(_768.ShaperSimulationCalculator)

    @property
    def shaving_simulation_calculator(
        self: "CastSelf",
    ) -> "_769.ShavingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _769,
        )

        return self.__parent__._cast(_769.ShavingSimulationCalculator)

    @property
    def virtual_simulation_calculator(
        self: "CastSelf",
    ) -> "_770.VirtualSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _770,
        )

        return self.__parent__._cast(_770.VirtualSimulationCalculator)

    @property
    def worm_grinder_simulation_calculator(
        self: "CastSelf",
    ) -> "_771.WormGrinderSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _771,
        )

        return self.__parent__._cast(_771.WormGrinderSimulationCalculator)
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_755.CylindricalCutterSimulatableGear":
    ...
    @property
    def stock_removed_at_designed_sap(self: "Self") -> "_760.FinishStockPoint":
    ...
    @property
    def stock_removed_at_reference_diameter(self: "Self") -> "_760.FinishStockPoint":
        """mastapy._private.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def stock_removed_at_rough_tip_form(self: "Self") -> "_760.FinishStockPoint":
        """mastapy._private.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def finish_stock_indexed_arcs(self: "Self") -> "List[_760.FinishStockPoint]":
    ...
    @property
    def gear_fillet_points(self: "Self") -> "List[_752.NamedPoint]":
    ...
    @property
    def main_profile_finish_stock(self: "Self") -> "List[_760.FinishStockPoint]":
        """List[mastapy._private.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint]
