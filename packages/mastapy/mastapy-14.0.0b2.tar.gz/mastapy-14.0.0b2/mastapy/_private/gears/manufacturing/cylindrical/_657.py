...
from mastapy._private.gears.manufacturing.cylindrical import _656, _655
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicroGeometryInputsLead(_656.MicroGeometryInputs[_655.LeadModificationSegment]):
    """MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self: "Self") -> "_1535.Range":
