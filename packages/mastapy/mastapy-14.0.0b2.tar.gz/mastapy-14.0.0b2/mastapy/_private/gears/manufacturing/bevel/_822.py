...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _821, _835
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ManufacturingMachine(_1879.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self: "Self") -> "_821.MachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.bevel._821", "MachineTypes"
        )(value)

    @machine_type.setter
    @enforce_parameter_types
    def machine_type(self: "Self", value: "_821.MachineTypes") -> None:
    ...
    @property
    def wheel_formate_machine_type(self: "Self") -> "_835.WheelFormatMachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.bevel._835", "WheelFormatMachineTypes"
        )(value)

    @wheel_formate_machine_type.setter
    @enforce_parameter_types
    def wheel_formate_machine_type(
        self: "Self", value: "_835.WheelFormatMachineTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
