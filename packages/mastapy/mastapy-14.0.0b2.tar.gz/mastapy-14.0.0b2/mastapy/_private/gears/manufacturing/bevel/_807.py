...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _818, _802
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalMeshManufacturingAnalysis(_1261.GearMeshImplementationAnalysis):
    """ConicalMeshManufacturingAnalysis
    ...
    @property
    def conical_mesh_load_case(self: "Self") -> "_910.ConicalMeshLoadCase":
    ...
    @property
    def tca(self: "Self") -> "_818.EaseOffBasedTCA":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_802.ConicalMeshedGearManufacturingAnalysis]":
