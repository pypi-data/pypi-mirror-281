...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrindingProcessPitchCalculation(_717.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self: "Self") -> "_1919.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: "Self") -> "_684.CalculatePitchDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_684.CalculatePitchDeviationAccuracy":
        """mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculatePitchDeviationAccuracy
