...
class _Cast_FinishCutterSimulation:
    ...
    @property
    def gear_cutter_simulation(self: "CastSelf") -> "_762.GearCutterSimulation":
        return self.__parent__._cast(_762.GearCutterSimulation)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FinishCutterSimulation(_762.GearCutterSimulation):
    """FinishCutterSimulation
