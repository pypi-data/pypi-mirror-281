...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalMeshManufacturingConfig(_1263.GearMeshImplementationDetail):
    """CylindricalMeshManufacturingConfig
    ...
    @property
    def gear_a_as_manufactured(self: "Self") -> "List[_754.CutterSimulationCalc]":
    ...
    @property
    def gear_b_as_manufactured(self: "Self") -> "List[_754.CutterSimulationCalc]":
        """List[mastapy._private.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc]
