...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalSetFEModel(_1238.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self: "Self") -> "_1245.FlankDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.fe_model.conical._1245", "FlankDataSource"
        )(value)

    @flank_data_source.setter
    @enforce_parameter_types
    def flank_data_source(self: "Self", value: "_1245.FlankDataSource") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def selected_design(
        self: "Self", value: "_814.ConicalSetManufacturingConfig"
    ) -> None:
        wrapper_type = (
