...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _599, _598
...
T = TypeVar("T", bound="_599.BevelGearMaterial")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearAbstractMaterialDatabase(_281.MaterialDatabase[T]):
    """BevelGearAbstractMaterialDatabase
