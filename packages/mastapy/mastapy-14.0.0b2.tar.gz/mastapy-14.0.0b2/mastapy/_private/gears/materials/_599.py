...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _631, _597
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearMaterial(_608.GearMaterial):
    """BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self: "Self") -> "_631.SNCurveDefinition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._631", "SNCurveDefinition"
        )(value)

    @sn_curve_definition.setter
    @enforce_parameter_types
    def sn_curve_definition(self: "Self", value: "_631.SNCurveDefinition") -> None:
