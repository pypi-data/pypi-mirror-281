...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _253, _251, _252, _280
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMACylindricalGearMaterial(_604.CylindricalGearMaterial):
    """AGMACylindricalGearMaterial
    ...
    @property
    def grade(self: "Self") -> "_253.AGMAMaterialGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._253", "AGMAMaterialGrade"
        )(value)

    @grade.setter
    @enforce_parameter_types
    def grade(self: "Self", value: "_253.AGMAMaterialGrade") -> None:
    ...
    @property
    def material_application(self: "Self") -> "_251.AGMAMaterialApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._251", "AGMAMaterialApplications"
        )(value)

    @material_application.setter
    @enforce_parameter_types
    def material_application(
        self: "Self", value: "_251.AGMAMaterialApplications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def material_class(self: "Self") -> "_252.AGMAMaterialClasses":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._252", "AGMAMaterialClasses"
        )(value)

    @material_class.setter
    @enforce_parameter_types
    def material_class(self: "Self", value: "_252.AGMAMaterialClasses") -> None:
        value = conversion.mp_to_pn_enum(
