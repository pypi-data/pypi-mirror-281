...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _299, _296, _297
...
class _Cast_PlasticSNCurve:
    ...
    def plastic_sn_curve_for_the_specified_operating_conditions(
        self: "CastSelf",
    ) -> "_506.PlasticSNCurveForTheSpecifiedOperatingConditions":
        from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _506
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self: "Self") -> "_299.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._299", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @enforce_parameter_types
    def lubricant(self: "Self", value: "_299.VDI2736LubricantType") -> None:
    ...
    @property
    def material(self: "Self") -> "_625.PlasticCylindricalGearMaterial":
    ...
    def bending_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_296.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]":
    ...
    def contact_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_297.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]":
