...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.face import _461, _459
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshRating(_371.GearMeshRating):
    """FaceGearMeshRating
    ...
    @property
    def active_flank(self: "Self") -> "_336.GearFlanks":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._336", "GearFlanks"
        )(value)

    @property
    def face_gear_mesh(self: "Self") -> "_1015.FaceGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: "Self") -> "_461.FaceGearSetRating":
    ...
    @property
    def mesh_load_case(self: "Self") -> "_904.FaceMeshLoadCase":
    ...
    @property
    def face_gear_ratings(self: "Self") -> "List[_459.FaceGearRating]":
