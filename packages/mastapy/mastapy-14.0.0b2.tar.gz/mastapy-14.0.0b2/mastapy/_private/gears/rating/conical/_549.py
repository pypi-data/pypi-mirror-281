...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.conical import _552, _551
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearDutyCycleRating(_368.GearDutyCycleRating):
    """ConicalGearDutyCycleRating
    ...
    @property
    def concave_flank_rating(self: "Self") -> "_369.GearFlankRating":
        """mastapy._private.gears.rating.GearFlankRating
    ...
    @property
    def convex_flank_rating(self: "Self") -> "_369.GearFlankRating":
        """mastapy._private.gears.rating.GearFlankRating
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_551.ConicalGearRating]":
    ...
    @property
    def conical_gear_ratings(self: "Self") -> "List[_551.ConicalGearRating]":
        """List[mastapy._private.gears.rating.conical.ConicalGearRating]
