...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _373, _369, _372
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearDutyCycleRating(_364.AbstractGearRating):
    """GearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self: "Self") -> "_373.GearSetDutyCycleRating":
