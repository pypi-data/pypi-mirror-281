...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _513, _514
...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    def helix_angle_optimisation_results(
        self: "Self",
    ) -> "_513.OptimisationResultsPair[_516.SafetyFactorOptimisationStepResultAngle]":
    ...
    def maximum_transverse_contact_ratio_optimisation_results(
        self: "Self",
    ) -> "_513.OptimisationResultsPair[_517.SafetyFactorOptimisationStepResultNumber]":
    ...
    def normal_module_optimisation_results(
        self: "Self",
    ) -> "_513.OptimisationResultsPair[_518.SafetyFactorOptimisationStepResultShortLength]":
    ...
    def all_helix_angle_optimisation_results(
        self: "Self",
    ) -> "List[_514.SafetyFactorOptimisationResults[_516.SafetyFactorOptimisationStepResultAngle]]":
    ...
    def all_normal_module_optimisation_results(
        self: "Self",
    ) -> "List[_514.SafetyFactorOptimisationResults[_518.SafetyFactorOptimisationStepResultShortLength]]":
    ...
    def all_profile_shift_optimisation_results(
        self: "Self",
    ) -> "List[_514.SafetyFactorOptimisationResults[_517.SafetyFactorOptimisationStepResultNumber]]":
