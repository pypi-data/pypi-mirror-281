...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1103, _1102
    from mastapy._private.gears import _331
    from mastapy._private.materials import _278
    from mastapy._private.gears.rating.cylindrical import _465, _473, _476
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalMeshSingleFlankRating(_377.MeshSingleFlankRating):
    """CylindricalMeshSingleFlankRating
    ...
    def coefficient_of_friction_method_flash_temperature_method(
        self: "Self",
    ) -> "_1103.ScuffingCoefficientOfFrictionMethods":
    ...
    @property
    def contact_ratio_source(self: "Self") -> "_331.ContactRatioDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._331", "ContactRatioDataSource"
        )(value)
    ...
    @property
    def lubrication_detail(self: "Self") -> "_278.LubricationDetail":
    ...
    @property
    def sorted_scuffing_results(self: "Self") -> "_473.CylindricalGearScuffingResults":
    ...
    def sorted_scuffing_results_without_special_values(
        self: "Self",
    ) -> "_473.CylindricalGearScuffingResults":
        """mastapy._private.gears.rating.cylindrical.CylindricalGearScuffingResults
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_476.CylindricalGearSingleFlankRating]":
