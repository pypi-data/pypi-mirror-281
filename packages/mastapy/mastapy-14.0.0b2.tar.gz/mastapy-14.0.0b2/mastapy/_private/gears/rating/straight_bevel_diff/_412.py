...
class _Cast_StraightBevelDiffMeshedGearRating:
    ...
    @property
    def conical_meshed_gear_rating(self: "CastSelf") -> "_556.ConicalMeshedGearRating":
        return self.__parent__._cast(_556.ConicalMeshedGearRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffMeshedGearRating(_556.ConicalMeshedGearRating):
    """StraightBevelDiffMeshedGearRating
