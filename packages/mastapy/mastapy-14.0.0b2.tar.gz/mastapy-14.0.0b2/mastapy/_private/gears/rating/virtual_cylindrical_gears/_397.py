...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _395, _396, _400
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergVirtualCylindricalGear(_399.VirtualCylindricalGear):
    """KlingelnbergVirtualCylindricalGear
