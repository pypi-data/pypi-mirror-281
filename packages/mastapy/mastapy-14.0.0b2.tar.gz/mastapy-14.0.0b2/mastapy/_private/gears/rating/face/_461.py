...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.face import _459, _458
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetRating(_374.GearSetRating):
    """FaceGearSetRating
    ...
    @property
    def face_gear_set(self: "Self") -> "_1019.FaceGearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_459.FaceGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_458.FaceGearMeshRating]":
    ...
    @property
    def face_mesh_ratings(self: "Self") -> "List[_458.FaceGearMeshRating]":
        """List[mastapy._private.gears.rating.face.FaceGearMeshRating]
