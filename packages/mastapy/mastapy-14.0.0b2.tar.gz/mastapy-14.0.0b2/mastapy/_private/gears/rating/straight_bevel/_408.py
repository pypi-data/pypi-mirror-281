...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel import _407, _406
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetRating(_567.BevelGearSetRating):
    """StraightBevelGearSetRating
    ...
    def straight_bevel_gear_ratings(
        self: "Self",
    ) -> "List[_407.StraightBevelGearRating]":
    ...
    def straight_bevel_mesh_ratings(
        self: "Self",
    ) -> "List[_406.StraightBevelGearMeshRating]":
