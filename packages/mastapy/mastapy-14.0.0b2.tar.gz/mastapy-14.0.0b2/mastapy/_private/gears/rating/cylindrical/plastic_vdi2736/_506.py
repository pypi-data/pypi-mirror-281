...
class _Cast_PlasticSNCurveForTheSpecifiedOperatingConditions:
    ...
    @property
    def plastic_sn_curve(self: "CastSelf") -> "_626.PlasticSNCurve":
        return self.__parent__._cast(_626.PlasticSNCurve)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlasticSNCurveForTheSpecifiedOperatingConditions(_626.PlasticSNCurve):
    """PlasticSNCurveForTheSpecifiedOperatingConditions
