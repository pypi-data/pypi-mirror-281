...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _491, _477
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetDutyCycleRating(_373.GearSetDutyCycleRating):
    """CylindricalGearSetDutyCycleRating
    ...
    def gear_mesh_duty_cycle_ratings(
        self: "Self",
    ) -> "List[_477.CylindricalMeshDutyCycleRating]":
