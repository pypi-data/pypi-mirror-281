...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.iso_10300 import _434, _435, _436, _437
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO10300MeshSingleFlankRating(_557.ConicalMeshSingleFlankRating, Generic[T]):
    """ISO10300MeshSingleFlankRating
