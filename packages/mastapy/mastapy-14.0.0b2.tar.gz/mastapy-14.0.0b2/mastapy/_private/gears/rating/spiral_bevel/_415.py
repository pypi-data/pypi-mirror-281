...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.spiral_bevel import _414, _413
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetRating(_567.BevelGearSetRating):
    """SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_set(self: "Self") -> "_995.SpiralBevelGearSetDesign":
    ...
    @property
    def spiral_bevel_gear_ratings(self: "Self") -> "List[_414.SpiralBevelGearRating]":
    ...
    def spiral_bevel_mesh_ratings(
        self: "Self",
    ) -> "List[_413.SpiralBevelGearMeshRating]":
