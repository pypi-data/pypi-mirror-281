...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO6336AbstractMeshSingleFlankRating(_478.CylindricalMeshSingleFlankRating):
    """ISO6336AbstractMeshSingleFlankRating
    ...
    def misalignment_contact_pattern_enhancement(
        self: "Self",
    ) -> "_489.MisalignmentContactPatternEnhancements":
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_528.ISO6336AbstractGearSingleFlankRating]":
