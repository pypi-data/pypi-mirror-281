...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _522, _524, _526, _530
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO6336AbstractGearSingleFlankRating(_476.CylindricalGearSingleFlankRating):
    """ISO6336AbstractGearSingleFlankRating
