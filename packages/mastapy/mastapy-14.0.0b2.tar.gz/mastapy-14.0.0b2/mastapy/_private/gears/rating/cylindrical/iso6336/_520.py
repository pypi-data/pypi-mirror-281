...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _541, _538
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    def fatigue_damage_chart(self: "Self") -> "_1917.ThreeDChartDefinition":
    ...
    @property
    def critical_section(self: "Self") -> "_541.ToothFlankFractureAnalysisRowN1457":
    ...
    def mesh_contact_point_a_section(
        self: "Self",
    ) -> "_541.ToothFlankFractureAnalysisRowN1457":
        """mastapy._private.gears.rating.cylindrical.iso6336.ToothFlankFractureAnalysisRowN1457
    ...
    def mesh_contact_point_ab_section(
        self: "Self",
    ) -> "_538.ToothFlankFractureAnalysisContactPointN1457":
    ...
    @property
    def analysis_rows(self: "Self") -> "List[_541.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: "Self",
    ) -> "List[_538.ToothFlankFractureAnalysisContactPointN1457]":
