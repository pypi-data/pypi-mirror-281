...
class _Cast_ToothFlankFractureAnalysisRowN1457:
    ...
    def tooth_flank_fracture_analysis_contact_point_n1457(
        ...
        return self.__parent__._cast(_538.ToothFlankFractureAnalysisContactPointN1457)
...
class ToothFlankFractureAnalysisRowN1457(
    ...
    def analysis_point_with_maximum_fatigue_damage(
        self: "Self",
    ) -> "_540.ToothFlankFractureAnalysisPointN1457":
    ...
    @property
    def watch_points(self: "Self") -> "List[_540.ToothFlankFractureAnalysisPointN1457]":
