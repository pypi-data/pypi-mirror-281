...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.bevel.standards import _569, _571
    from mastapy._private.gears.rating.iso_10300 import _436, _434
    from mastapy._private.gears.rating.conical import _556, _550
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearMeshRating(_576.AGMAGleasonConicalGearMeshRating):
    """BevelGearMeshRating
    ...
    @property
    def meshed_gears(self: "Self") -> "List[_556.ConicalMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: "Self") -> "List[_556.ConicalMeshedGearRating]":
        """List[mastapy._private.gears.rating.conical.ConicalMeshedGearRating]
