...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.klingelnberg_hypoid import _420, _419
...
class KlingelnbergCycloPalloidHypoidGearSetRating(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_ratings(
        self: "Self",
    ) -> "List[_420.KlingelnbergCycloPalloidHypoidGearRating]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(
        self: "Self",
    ) -> "List[_419.KlingelnbergCycloPalloidHypoidGearMeshRating]":
