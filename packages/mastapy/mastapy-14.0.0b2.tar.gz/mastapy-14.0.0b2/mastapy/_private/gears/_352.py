...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PocketingPowerLossCoefficients(_1879.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    def extrapolation_options(
        self: "Self", value: "_1556.ExtrapolationOptions"
    ) -> None:
    ...
    def specifications_for_the_effect_of_oil_kinematic_viscosity(
        self: "Self",
    ) -> "List[_356.SpecificationForTheEffectOfOilKinematicViscosity]":
