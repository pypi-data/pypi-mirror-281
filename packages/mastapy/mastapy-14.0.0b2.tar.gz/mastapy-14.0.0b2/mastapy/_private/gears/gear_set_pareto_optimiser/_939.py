...
from mastapy._private.gears.ltca.cylindrical import _879, _880, _883
from mastapy._private.gears.gear_set_pareto_optimiser import _929, _940
...
class MicroGeometryDesignSpaceSearch(
    _929.DesignSpaceSearchBase[
        ...
        _940.MicroGeometryDesignSpaceSearchCandidate,
    ]
):
    """MicroGeometryDesignSpaceSearch
    ...
    @enforce_parameter_types
    def select_gear(
        self: "Self", value: "_879.CylindricalGearLoadDistributionAnalysis"
    ) -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def select_mesh(
        self: "Self", value: "_880.CylindricalGearMeshLoadDistributionAnalysis"
    ) -> None:
        wrapper_type = (
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_1139.CylindricalGearSetMicroGeometry]":
