...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _929
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetParetoOptimiser(_935.GearSetParetoOptimiser):
    """CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1058.CylindricalGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_1058.CylindricalGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1058.CylindricalGearSetDesign]":
        """List[mastapy._private.gears.gear_designs.cylindrical.CylindricalGearSetDesign]
