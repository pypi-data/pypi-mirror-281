...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetParetoOptimiser(_935.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_987.StraightBevelGearSetDesign":
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_987.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_987.StraightBevelGearSetDesign]":
        """List[mastapy._private.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
