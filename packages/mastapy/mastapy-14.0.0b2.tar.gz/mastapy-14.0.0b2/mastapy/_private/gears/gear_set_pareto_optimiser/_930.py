...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _934, _940
...
class _Cast_DesignSpaceSearchCandidateBase:
    ...
    def gear_set_optimiser_candidate(
        self: "CastSelf",
    ) -> "_934.GearSetOptimiserCandidate":
        from mastapy._private.gears.gear_set_pareto_optimiser import _934

        return self.__parent__._cast(_934.GearSetOptimiserCandidate)

    @property
    def micro_geometry_design_space_search_candidate(
        self: "CastSelf",
    ) -> "_940.MicroGeometryDesignSpaceSearchCandidate":
        from mastapy._private.gears.gear_set_pareto_optimiser import _940

        return self.__parent__._cast(_940.MicroGeometryDesignSpaceSearchCandidate)
