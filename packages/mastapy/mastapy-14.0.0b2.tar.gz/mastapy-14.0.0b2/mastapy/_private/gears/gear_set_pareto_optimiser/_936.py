...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetParetoOptimiser(_935.GearSetParetoOptimiser):
    """HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1011.HypoidGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_1011.HypoidGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1011.HypoidGearSetDesign]":
        """List[mastapy._private.gears.gear_designs.hypoid.HypoidGearSetDesign]
