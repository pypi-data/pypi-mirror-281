...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetParetoOptimiser(_935.GearSetParetoOptimiser):
    """FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_1019.FaceGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: "Self") -> "List[_1019.FaceGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_1019.FaceGearSetDesign]":
        """List[mastapy._private.gears.gear_designs.face.FaceGearSetDesign]
