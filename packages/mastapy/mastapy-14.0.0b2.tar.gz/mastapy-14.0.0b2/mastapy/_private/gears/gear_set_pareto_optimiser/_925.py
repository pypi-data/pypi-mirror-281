...
class _Cast_BarForPareto:
    ...
    def pareto_optimisation_strategy_bars(
        self: "CastSelf",
    ) -> "_1596.ParetoOptimisationStrategyBars":
        return self.__parent__._cast(_1596.ParetoOptimisationStrategyBars)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BarForPareto(
    _1596.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
