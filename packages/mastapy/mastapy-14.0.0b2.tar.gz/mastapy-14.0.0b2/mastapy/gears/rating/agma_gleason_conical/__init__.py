...
if __tc:
    from mastapy._private.gears.rating.agma_gleason_conical._576 import (
        AGMAGleasonConicalGearMeshRating,
    )
    from mastapy._private.gears.rating.agma_gleason_conical._577 import (
    ...
    __import_structure = {
        "_private.gears.rating.agma_gleason_conical._576": [
            "AGMAGleasonConicalGearMeshRating"
        ],
        "_private.gears.rating.agma_gleason_conical._577": [
            "AGMAGleasonConicalGearRating"
        ],
