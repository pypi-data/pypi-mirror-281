...
if __tc:
    from mastapy._private.gears.gear_designs.creation_options._1184 import (
        CylindricalGearPairCreationOptions,
    )
    from mastapy._private.gears.gear_designs.creation_options._1185 import (
    ...
    __import_structure = {
        "_private.gears.gear_designs.creation_options._1184": [
            "CylindricalGearPairCreationOptions"
        ],
        "_private.gears.gear_designs.creation_options._1185": [
            "GearSetCreationOptions"
        ],
