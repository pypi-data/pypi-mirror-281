...
if __tc:
    from mastapy._private.gears.gear_designs.klingelnberg_spiral_bevel._997 import (
        KlingelnbergCycloPalloidSpiralBevelGearDesign,
    )
    from mastapy._private.gears.gear_designs.klingelnberg_spiral_bevel._998 import (
    ...
    __import_structure = {
        "_private.gears.gear_designs.klingelnberg_spiral_bevel._997": [
            "KlingelnbergCycloPalloidSpiralBevelGearDesign"
        ],
        "_private.gears.gear_designs.klingelnberg_spiral_bevel._998": [
            "KlingelnbergCycloPalloidSpiralBevelGearMeshDesign"
        ],
