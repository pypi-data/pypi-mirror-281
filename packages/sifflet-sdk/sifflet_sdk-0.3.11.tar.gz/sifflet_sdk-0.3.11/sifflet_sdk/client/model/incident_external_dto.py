...
class IncidentExternalDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, compromised_assets, criticality, datasets, id, issue_no, name, owners, rules, sifflet_url, status, trigger_time, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, compromised_assets, criticality, datasets, id, issue_no, name, owners, rules, sifflet_url, status, trigger_time, *args, **kwargs):  # noqa: E501
        """IncidentExternalDto - a model defined in OpenAPI
