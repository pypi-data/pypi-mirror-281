...
from techgram.errors.exceptions.bad_request_400 import PeerIdInvalid
...
class Story(Object, Update):
    ...
    Parameters:
        ...
        views (:obj:`~techgram.types.StoryViews`, *optional*):
            Stories views.

        forward_from (:obj:`~techgram.types.StoryForwardHeader`, *optional*):
            Story is a forwarded story.
            Information about the original story.

        privacy (:obj:`~techgram.enums.StoryPrivacy`, *optional*):
            Story privacy.
        ...
        media_areas (List of :obj:`~techgram.types.MediaArea`, *optional*):
            List of :obj:`~techgram.types.MediaArea` object in story.
    ...
    async def edit_animation(self, animation: Union[str, BinaryIO]) -> "types.Story":
        """Bound method *edit_animation* of :obj:`~techgram.types.Story`.
    ...
    async def edit(
        ...
        Parameters:
            ...
            media_areas (List of :obj:`~techgram.types.InputMediaArea`):
    ...
    async def edit_photo(self, photo: Union[str, BinaryIO]) -> "types.Story":
        """Bound method *edit_photo* of :obj:`~techgram.types.Story`.
    ...
    async def edit_video(self, video: Union[str, BinaryIO]) -> "types.Story":
        """Bound method *edit_video* of :obj:`~techgram.types.Story`.
    ...
    async def export_link(self) -> "types.ExportedStoryLink":
        """Bound method *export_link* of :obj:`~techgram.types.Story`.
        ...
        Returns:
            :obj:`~techgram.types.ExportedStoryLink`: a single story link is returned.
