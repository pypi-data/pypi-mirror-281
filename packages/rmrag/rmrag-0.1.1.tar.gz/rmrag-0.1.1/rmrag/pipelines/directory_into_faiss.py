...
def directory_into_faiss(directory_path:str, chunk_size:int, chunk_overlap:int, embedding_model:Type, specific_model:str) -> None:
    """
    ...
    create_embeddings_and_faiss_vectorstore(chunks, embedding_model, specific_model)
