...
class RsCmwNrFr1Meas:
	...
	_driver_options = "SupportedInstrModels = CMW500/CMW100/CMP, SupportedIdnPatterns = CMW, SimulationIdnString = 'Rohde&Schwarz,CMW100,100001,3.8.42.0003'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '3.8.42.0003'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '3.8.42.0003'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCmwNrFr1Meas version failed. Current version: '3.8.42.0003', minimum required version: '{min_version}'")
