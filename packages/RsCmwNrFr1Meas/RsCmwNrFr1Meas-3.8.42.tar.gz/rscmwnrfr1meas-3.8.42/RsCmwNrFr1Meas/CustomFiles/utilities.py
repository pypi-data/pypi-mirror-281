...
class Utilities:
	...
	Access snippet: ``utils = RsCmwNrFr1Meas.utilities``"""
	...
	def logger(self) -> ScpiLogger:
		...
		Access snippet: ``logger = RsCmwNrFr1Meas.utilities.logger``"""
	...
	def get_lock(self) -> threading.RLock:
		...
		By default:
			- If you create standard new RsCmwNrFr1Meas instance with new VISA session, the session gets a new thread lock. You can assign it to other RsCmwNrFr1Meas sessions in order to share one physical instrument with a multi-thread access.
			- If you create new RsCmwNrFr1Meas from an existing session, the thread lock is shared automatically making both instances multi-thread safe.
