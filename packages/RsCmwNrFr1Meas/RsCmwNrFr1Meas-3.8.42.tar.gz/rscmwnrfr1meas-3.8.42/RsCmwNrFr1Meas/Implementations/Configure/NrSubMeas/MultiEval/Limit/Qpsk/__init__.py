...
class QpskCls:
	...
	def get_freq_error(self) -> float or bool:
		...
		Snippet: value: float or bool = driver.configure.nrSubMeas.multiEval.limit.qpsk.get_freq_error() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:FERRor?')
	...
	def set_freq_error(self, frequency_error: float or bool) -> None:
		...
		self._core.io.write(f'CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:FERRor {param}')
	...
	def get_es_flatness(self) -> EsFlatnessStruct:
		...
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness?', self.__class__.EsFlatnessStruct())
	...
	def set_es_flatness(self, value: EsFlatnessStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness', value)
