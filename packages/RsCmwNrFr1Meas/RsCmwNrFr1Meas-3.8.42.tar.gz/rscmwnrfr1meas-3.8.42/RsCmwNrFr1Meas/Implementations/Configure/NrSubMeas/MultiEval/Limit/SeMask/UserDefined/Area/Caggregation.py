...
class CaggregationCls:
	...
	def set(self, enable: bool, frequency_start: float, frequency_end: float, level: float, rbw: enums.RbwC, area=repcap.Area.Default) -> None:
		...
		The activation state, the area borders, an upper limit and the resolution bandwidth must be specified. \n
			...
			:param frequency_start: numeric Start frequency of the area, relative to the edges of the aggregated channel bandwidth. Range: 0 MHz to 200 MHz, Unit: Hz
			:param frequency_end: numeric Stop frequency of the area, relative to the edges of the aggregated channel bandwidth. Range: 0 MHz to 205 MHz, Unit: Hz
			:param level: numeric Upper limit for the area Range: -256 dBm to 256 dBm, Unit: dBm
			:param rbw: K030 | K400 | M1 Resolution bandwidth to be used for the area K030: 30 kHz K400: 400 kHz M1: 1 MHz
