...
class CurrentCls:
	...
	def fetch(self, utraChannel=repcap.UtraChannel.Default) -> List[float]:
		"""SCPI: FETCh:NRSub:MEASurement<Instance>:MEValuation:LIST:ACLR:UTRA<nr>:POSitiv:CURRent \n
	...
	def calculate(self, utraChannel=repcap.UtraChannel.Default) -> List[enums.ResultStatus2]:
		"""SCPI: CALCulate:NRSub:MEASurement<Instance>:MEValuation:LIST:ACLR:UTRA<nr>:POSitiv:CURRent \n
