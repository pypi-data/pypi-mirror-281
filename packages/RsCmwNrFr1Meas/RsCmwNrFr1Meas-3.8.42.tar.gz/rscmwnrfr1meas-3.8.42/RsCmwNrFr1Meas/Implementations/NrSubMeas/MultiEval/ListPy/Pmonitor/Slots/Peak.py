...
class PeakCls:
	...
	def fetch(self) -> List[float]:
		...
		Use RsCmwNrFr1Meas.reliability.last_value to read the updated reliability indicator. \n
			:return: step_peak_power: float Comma-separated list of power values, one value per slot, from first slot of first measured segment to last slot of last measured segment For an inactive segment, only one INV is returned, independent of the number of slots. Unit: dBm"""
