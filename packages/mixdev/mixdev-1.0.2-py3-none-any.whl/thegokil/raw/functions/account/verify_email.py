...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <thegokil.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <thegokil.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <thegokil.raw.base.account.EmailVerified>`
    """
