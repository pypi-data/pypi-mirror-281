...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <thegokil.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <thegokil.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <thegokil.raw.base.DataJSON>`):
            N/A
