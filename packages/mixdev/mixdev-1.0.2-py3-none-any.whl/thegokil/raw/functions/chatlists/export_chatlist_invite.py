...
class ExportChatlistInvite(TLObject):  # type: ignore
    ...
    Parameters:
        chatlist (:obj:`InputChatlist <thegokil.raw.base.InputChatlist>`):
            N/A

        title (``str``):
            N/A

        peers (List of :obj:`InputPeer <thegokil.raw.base.InputPeer>`):
            N/A

    Returns:
        :obj:`chatlists.ExportedChatlistInvite <thegokil.raw.base.chatlists.ExportedChatlistInvite>`
    """
