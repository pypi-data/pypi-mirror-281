...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~thegokil.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <thegokil.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <thegokil.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~thegokil.raw.types`
    """
