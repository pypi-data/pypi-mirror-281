...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <thegokil.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <thegokil.raw.base.PageRelatedArticle>`):
            N/A
