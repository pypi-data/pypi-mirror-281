...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <thegokil.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <thegokil.raw.base.Reaction>`, *optional*):
            N/A
