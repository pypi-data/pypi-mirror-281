...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <thegokil.raw.base.SearchResultsPosition>`):
            N/A
