...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <thegokil.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <thegokil.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <thegokil.raw.base.SecureValueError>`):
            N/A
