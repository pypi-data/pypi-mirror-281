...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <thegokil.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <thegokil.raw.base.auth.CodeType>`, *optional*):
            N/A
