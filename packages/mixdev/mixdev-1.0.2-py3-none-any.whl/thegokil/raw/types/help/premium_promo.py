...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <thegokil.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <thegokil.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <thegokil.raw.base.PremiumSubscriptionOption>`):
            N/A
