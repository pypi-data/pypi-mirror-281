...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <thegokil.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <thegokil.raw.base.MessagePeerReaction>`, *optional*):
            N/A
