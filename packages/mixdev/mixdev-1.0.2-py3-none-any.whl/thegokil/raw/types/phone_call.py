...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~thegokil.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <thegokil.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <thegokil.raw.base.PhoneConnection>`):
            N/A
