...
`IMMUNITY
_NOTIFICATIONS_CACHE_TIMEOUT setting <#IMMUNITY
_NOTIFICATIONS_CACHE_TIMEOUT>`_.
...
`"IMMUNITY
_NOTIFICATIONS_IGNORE_ENABLED_ADMIN" <#immunity_notifications_ignore_enabled_admin>`_
...
.. code-block:: python
    ...
    IMMUNITY
_NOTIFICATIONS_HOST = 'https://api.example.com'
...
.. code-block:: python
    ...
    IMMUNITY
_NOTIFICATIONS_SOUND = 'your-appname/audio/notification.mp3'
...
``IMMUNITY
_NOTIFICATIONS_POPULATE_PREFERENCES_ON_MIGRATE``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. code-block:: python
    ...
    IMMUNITY
_NOTIFICATIONS_NOTIFICATION_MODEL = 'mynotifications.Notification'
    IMMUNITY
_NOTIFICATIONS_NOTIFICATIONSETTING_MODEL = 'mynotifications.NotificationSetting'
    IMMUNITY
_NOTIFICATIONS_IGNOREOBJECTNOTIFICATION_MODEL = 'mynotifications.IgnoreObjectNotification'
