...
def test_xnat_expand_url_search_single(xnat_url_fixture):
    ...
    expected_url = URL("xnat+https://xnat.bmia.nl/data/archive/projects/sandbox/subjects/BMIAXNAT_S17618"
...
def test_xnat_fetch_url(xnat_urlsample_fixture, tmp_path):
    ...
    assert response.filename == 'files'
...
def test_xnat_expand_project():
    xnat_project_url = URL(
        "xnat+http://xnat.bmia.nl/projects/sandbox?scans=*T1*"
    )
    ...
    assert [x[0] for x in result] == ['BMIAXNAT12_E02329_6_DICOM', 'BMIAXNAT15_E02599_6_DICOM',
                                      'BMIAXNAT36_E01628_6_DICOM', 'BMIAXNAT_E69813_6_DICOM',
                                      'BMIAXNAT_E82572_6_DICOM']

    assert result[0] == ('BMIAXNAT12_E02329_6_DICOM',
                         URLSample(
                             data_url=URL('xnat+http://xnat.bmia.nl/data/archive/projects/sandbox/subjects/BMIAXNAT12_S00261/experiments/BMIAXNAT12_E02329/scans/6/resources/1097057'),
