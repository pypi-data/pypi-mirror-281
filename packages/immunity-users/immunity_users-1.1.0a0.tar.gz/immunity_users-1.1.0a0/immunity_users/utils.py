...
def usermodel_add_form(model, additional_fields):
    """
    Read:
    https://github.com/edge-servers/immunity-users/blob/master/README.rst#usermodel_add_form
    """
...
def usermodel_change_form(model, additional_fields):
    """
    Read:
    https://github.com/edge-servers/immunity-users/blob/master/README.rst#usermodel_change_form
    """
...
def usermodel_list_and_search(model, additional_fields):
    """
    Read:
    https://github.com/edge-servers/immunity-users/blob/master/README.rst#usermodel_list_and_search
    """
