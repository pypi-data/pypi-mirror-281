...
class LLM__Ollama(LLM__Chat_Completion):
    ...
    def __init__(self, **kwargs) -> None:
        #self.api_key  = getenv("OLLAMA__API_KEY")
        self.base_url = LLM_BASE_URL__OLLAMA
        super().__init__(**kwargs)

    def api_generate(self, prompt, stream=False, format=None):
        path      = 'api/generate'
        ...
        return self.post_request(path, json_data)
