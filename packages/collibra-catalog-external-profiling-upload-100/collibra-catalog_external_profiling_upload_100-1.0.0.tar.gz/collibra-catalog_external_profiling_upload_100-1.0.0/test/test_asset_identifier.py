...
from collibra_catalog_external_profiling_upload.models.asset_identifier import AssetIdentifier  # noqa: E501
...
class TestAssetIdentifier(unittest.TestCase):
    ...
    def testAssetIdentifier(self):
        ...
        # model = collibra_catalog_external_profiling_upload.models.asset_identifier.AssetIdentifier()  # noqa: E501
        pass
