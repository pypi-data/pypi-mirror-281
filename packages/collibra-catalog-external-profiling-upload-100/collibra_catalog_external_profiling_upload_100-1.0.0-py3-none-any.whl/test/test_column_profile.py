...
from collibra_catalog_external_profiling_upload.models.column_profile import ColumnProfile  # noqa: E501
...
class TestColumnProfile(unittest.TestCase):
    ...
    def testColumnProfile(self):
        ...
        # model = collibra_catalog_external_profiling_upload.models.column_profile.ColumnProfile()  # noqa: E501
        pass
