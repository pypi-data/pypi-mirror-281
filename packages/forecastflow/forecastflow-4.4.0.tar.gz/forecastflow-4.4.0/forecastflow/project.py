...
class Project:
    ...
    def delete_data_sources_unused_for_training(self, data_source_ids: List[str], with_prediction: bool=False) -> None:
        """
        ...
        if response['status'] != 0:
            raise OperationFailed(f"Data source deletion is failed: {response['message']}")
