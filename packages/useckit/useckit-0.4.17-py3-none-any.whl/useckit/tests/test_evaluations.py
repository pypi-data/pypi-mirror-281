...
class TestUseckit(unittest.TestCase):
    ...
    def test_binary_verification_shapeerror_ovr_ovo_eatg(self):
        ...
        x1 = np.load("resources/x1eatg.npy")
        y1 = np.load("resources/y1eatg.npy")
        x2 = np.load("resources/x2eatg.npy")
        y2 = np.load("resources/y2eatg.npy")
