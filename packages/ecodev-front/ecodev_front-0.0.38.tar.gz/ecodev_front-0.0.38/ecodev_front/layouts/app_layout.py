...
def dash_base_layout(stores: list[tuple[str, str]],
    ...
    Parameters:
      - stores: A list of tuple (store_name/id, and dcc.Store memory type
                (https://dash.plotly.com/dash-core-components/store)).
                The dcc.Store are placed in the root of the app, to ensure that they are accessible.
      - colors: A dictionary of color pallet name (key) and list of color values from
                https://www.dash-mantine-components.com/components/mantineprovider#custom-colors
    """
        ...
        children=dmc.AppShell(
            [
                ...
                *[dcc.Store(id=store_id, storage_type=storage_type)
                ...
                dmc.AppShellHeader(id=NAVBAR_ID, children=[], style={
                                   'background-color': '#0066A1'}, zIndex=100),
