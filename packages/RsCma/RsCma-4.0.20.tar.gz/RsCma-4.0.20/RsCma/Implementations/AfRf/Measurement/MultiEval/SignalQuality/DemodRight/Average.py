...
class AverageCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Query the signal quality results measured for the right demodulator channel. The commands are only relevant for FM stereo.
		The results are related to the right audio channel. CALCulate commands return error indicators instead of measurement
		values. \n
