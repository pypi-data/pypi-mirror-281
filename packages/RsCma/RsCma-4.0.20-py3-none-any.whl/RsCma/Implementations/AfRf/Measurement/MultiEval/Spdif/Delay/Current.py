...
class CurrentCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Delay_Left: float: No parameter help available
			- Delay_Right: float: No parameter help available"""
		__meta_args_list = [
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:AFRF:MEASurement<Instance>:MEValuation:SIN:DELay:CURRent \n
