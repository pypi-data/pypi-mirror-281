import random
class LootItem:
    def __init__(self, name, description, rarity, quantity=1, item_type="generic", attributes=None):
        self.name = name
...
common_loot = [
    ...
    LootItem("木盾", "普通的木盾。", "common", item_type="armor", attributes={"defense": 2}),
    LootItem("皮甲", "普通的皮甲。", "common", item_type="armor", attributes={"defense": 4}),
    LootItem("布帽", "普通的布帽。", "common", item_type="armor", attributes={"defense": 1}),
...
rare_loot = [
    ...
    LootItem("铁盔", "提供额外防护的铁盔。", "rare", item_type="armor", attributes={"defense": 5}),
    LootItem("锁子甲", "提供额外防护的锁子甲。", "rare", item_type="armor", attributes={"defense": 8}),
...
epic_loot = [
    ...
    LootItem("龙鳞甲", "提供极高防护的龙鳞甲。", "epic", item_type="armor", attributes={"defense": 15}),
    ...
    LootItem("神圣头盔", "提供极高防护的神圣头盔。", "epic", item_type="armor", attributes={"defense": 12}),
