...
class SapGui(SapGuiLibrary):
    def __init__(self, screenshots_on_error , screenshot_directory) -> None:
        super().__init__(screenshots_on_error=screenshots_on_error, screenshot_directory=screenshot_directory)
