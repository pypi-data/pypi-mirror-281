...
class Ingest(APIBase):
    ...
    def ingest_sharepoint_scan(self, host, site, token, client_id, oauth_secret, tenant_id, environment, folder_id=None, drive=None, current_next_link=None, initial_run_id=None, cosmos_guid=None):
        ...
        if cosmos_guid:
            payload["cosmos_guid"] = cosmos_guid
