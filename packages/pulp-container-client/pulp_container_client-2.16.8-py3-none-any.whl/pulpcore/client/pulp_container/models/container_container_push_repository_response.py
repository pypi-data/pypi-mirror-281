...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, manifest_signing_service=None, pulp_href=None, latest_version_href=None, pulp_created=None, retain_repo_versions=None, name=None, description=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
