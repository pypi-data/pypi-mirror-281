...
class SayPolicy(EnvPolicy):
    ...
    def parse(self, last_utter):
        """ Checks whether a sentence is in the format <player_send> says to <player_receive>: <inner_sentence>
        ...
        player_send = describer.get_arg('Arg-PAG')
        if player_send != last_utter.speaker:
            return None
