...
def add_prop_seen(kn_state, ent, pkey, pval):
    ...
    kn_state.undo_changes.append(undo)


def remove_prop_seen(kn_state, ent, pkey):
...
def add_prop_seen_neg(kn_state, ent, pkey, pval):
    ...
    if pkey not in ent.prop_seen_neg:
        ...
        kn_state.undo_changes.append(undo_set)
    ...
    if pval not in ent.prop_seen_neg[pkey]:
        ...
        kn_state.undo_changes.append(undo_neg_val)


def remove_prop_seen_neg(kn_state, ent, pkey, pval):
...
def add_attr_seen(kn_state, ent, attr, neg):
...
def remove_attr_seen(kn_state, ent, attr, neg):
