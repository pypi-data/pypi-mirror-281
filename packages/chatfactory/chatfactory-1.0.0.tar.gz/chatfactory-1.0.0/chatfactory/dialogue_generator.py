...
class DialogueGenerator:
    ...
    knowledge_state: KnowledgeState
        The knowledge state stores additional information, and it is used in rule-based policies to quickly
    ...
    def __init__(self,
        ...
        self.knowledge_state = kb.KnowledgeState(self.meta_context, self.world)
    ...
    def init_param_generators(self):
        ...
        self.prim_param_generators += [("world", partial(getattr, self, "world")),
                                       ...
                                       ("player_send", partial(pg.random_player_send, self.curr_prim_params)),
                                       ("player_receive", partial(pg.random_world_list, self.curr_prim_params,
                                                                  "players")),
        ...
        self.complex_param_generators += [("world", partial(getattr, self, "world")),
                                          ("player_send", partial(pg.random_player_send, self.curr_complex_params)),
                                          ("dia_generator", lambda ent=self: ent)
                                          ]
    ...
    def execute_utters(self, utterances, random_gen=None, fake=False, skip_env=False):
        ...
        it updates the knowledge state. Moreover, the env_policy is executed
        ...
        for utter in utterances:
            ...
            if utter is not None and utter_str.strip():
                ...
                self.knowledge_state.context_update()
    ...
    def flush(self):
        ...
        self.knowledge_state.flush_undo_changes()
