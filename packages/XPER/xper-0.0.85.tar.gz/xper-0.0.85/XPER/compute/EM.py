...
def XPER_choice(y, X, model, Eval_Metric, var_interet=None, N_coalition_sampled=1000,
                ...
                execution_type="ThreadPoolExecutor", max_workers=4): # Add the kernel parameter and max_workers
    ...
    max_workers: Maximum number of workers for ProcessPoolExecutor (default=4)
    '''
