...
from ..fs.log_all import log_all


def try_error(level="error", path=r"C:\log_all.txt", is_print=False):
    def decorator(func):
        ...
        if is_await == False:
            ...
            def wrapper(*args, **kwargs):
                try:
                    ...
                    log_all(level=level,info=str(traceback.format_exc()),path=path, is_print=is_print)
