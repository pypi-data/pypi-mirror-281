...
class reservoir_pressure(Model):
    """ Class of reservoir_pressure

        Class to estimate reservoir pressure from the slop plot
        Ref. Akin, 2019, Geothermal re-injection performance evaluation
        using surveillance analysis methods
    """
