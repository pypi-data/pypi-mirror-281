...
class Client(ResourceClient, ServingClient):
    ...
    **Using the Client:**
    ...
    def _iceberg_dataframe(
        ...
        # parse something like: glue://featureform/Transformation_iceberg_trx132_2024_06_04t20_39_55'
        def parse_glue_location(ff_glue_path):
            if ff_glue_path.startswith("glue://"):
                return ff_glue_path.split("glue://")[1].split("/")

        database, table = parse_glue_location(location)
