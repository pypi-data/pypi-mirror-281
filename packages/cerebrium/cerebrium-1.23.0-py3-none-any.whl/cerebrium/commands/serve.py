...
import cerebrium
from cerebrium.serve import local_api_server
from cerebrium.types import JSON
from cerebrium.files import SERVE_SESSION_CACHE_FILE
...
def start(
    ...
    cerebrium_log("Serve functionality is temporarily disabled", level="ERROR")
    return
...
#     config_obj = merge_config_with_params("cerebrium.toml", params)
#
...
#         http_method="POST", url="setupApp", payload=backend_params
#     )
#
#     if response is None:
#         cerebrium_log(
...
#
#     serve_id = setup_response["serveId"]
#     assert isinstance(serve_id, str)
#     serve_session = {
#         serve_id: {
