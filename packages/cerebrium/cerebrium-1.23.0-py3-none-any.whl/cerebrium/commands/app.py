...
def list_apps():
    ...
    """
    app_response = cerebrium_request("GET", "get-models", {})
...
def get(
    ...
    """
    app_response = cerebrium_request("GET", f"get-model-details?modelId={app_id}", {})
...
def delete(
    ...
    delete_response = cerebrium_request("DELETE", "delete-model", {"name": name})
...
@app.command("scale")
def model_scaling(
    name: Annotated[str, typer.Argument(..., help="The name of your deployment.")],
    cooldown: Annotated[
        int,
        typer.Option(
            ...,
    ...
    body["name"] = name
    update_response = cerebrium_request("POST", "update-model-scaling", body)
    ...
    if update_response.status_code == 200:
        ...
        cerebrium_log(level="ERROR", message=f"There was an error scaling {name}", prefix="")
