        ...
        try:
            async with self.client:
                try:
                    ...
                    print(
                        f"{Style.BRIGHT}{Fore.RED}WARNING{Fore.WHITE}: Bot is unable to run. This may be due to your application token being invalid or there is a problem with your code, Please try again later.{Style.NORMAL}"
                    )
                finally:
                    await self.shutdown_bot()
        except:
            print(
                f"{Style.BRIGHT}{Fore.RED}WARNING{Fore.WHITE}: Bot is unable to run. Please check your code again.{Style.NORMAL}"
            )
            return
        finally:
            await self.shutdown_bot()
