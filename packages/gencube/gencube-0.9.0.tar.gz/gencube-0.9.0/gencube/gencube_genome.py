...
def genome (
    ...
    if ls_search:
        ...
        if download:
            dic_download = download_genome(df_genome_plus, database, masking, dic_genark_meta, dic_ensembl_meta, recursive)
            # Change chromosome label style
            convert_chr_label_genome(df_genome_plus, dic_download, chr_style, masking, compresslevel)
