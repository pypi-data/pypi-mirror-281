...
class ScaleJwtAuth(httpx.Auth):
    ...
    def __init__(self, scale_url: URL, endpoint_url: URL, token: str):
        """
        ...
        """
        self.url = format(endpoint_url)

        # Client to ikomia scale
        self.client = httpx.Client(
            base_url=format(scale_url),
    ...
    def jwt(self, force: bool = False) -> str:
        ...
        response = self.client.get("/v1/projects/jwt/", params={"endpoint": self.url})
