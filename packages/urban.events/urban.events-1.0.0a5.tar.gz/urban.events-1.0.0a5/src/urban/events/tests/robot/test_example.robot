...
#
#  $ bin/test -s urban.events -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src urban.events.testing.URBAN_EVENTS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/urban/events/tests/robot/test_example.robot
#
