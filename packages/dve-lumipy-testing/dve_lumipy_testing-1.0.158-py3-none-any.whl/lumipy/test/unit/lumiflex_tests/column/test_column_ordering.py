...
class TestColumnOrdering(SqlTestCase):
    ...
    def test_ordering_ctor_label_validation(self):
        ...
        self.assertErrorsWithMessage(
            ...
            "(type=value_error.const; given=invalid; permitted=('asc', 'desc'))"
        )
    ...
    def test_ordering_ctor_parents_validation(self):
        ...
        self.assertErrorsWithMessage(
            ...
            '1 validation error for Ordering\n'
            'parents\n'
            '  Ordering must have exactly one parent, received 2. (type=value_error)'
        )
        ...
        self.assertErrorsWithMessage(
            ...
            "1 validation error for Ordering\n"
            "parents\n"
            "  Parent must be Column type but was Ordering. (type=type_error)"
        )
