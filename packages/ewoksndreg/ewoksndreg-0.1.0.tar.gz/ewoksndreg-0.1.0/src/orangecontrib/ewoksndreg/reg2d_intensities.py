...
class OWReg2DIntensities(
    ...
    _METHOD_OPTIONS = {
        ...
        "SimpleITK": {
            "metric": {
                "value_for_type": list(SitkMetricType),
                "serialize": str,
            },
            "optimizer": {
                "value_for_type": list(SitkOptimizerType),
                "serialize": str,
            },
        ...
        "Kornia": {
            "metric": {
                "value_for_type": list(KorniaMetricType),
                "serialize": str,
            },
            "optimizer": {
                "value_for_type": list(KorniaOptimizerType),
                "serialize": str,
            },
            "pyramid_levels": {"value_for_type": 0},
        },
    ...
    _PREPROC_OPTIONS = {
        "apply_filter": {
            "value_for_type": list(FilterType),
            "serialize": str,
        },
        ...
        "apply_window": {
            "value_for_type": list(WindowType),
            "serialize": str,
        },
    }
    ...
    def _init_control_area(self):
        ...
        proper_transformations = list(TransformationType)
        try:
