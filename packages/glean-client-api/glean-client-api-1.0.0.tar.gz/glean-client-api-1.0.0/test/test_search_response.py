    ...
    def make_instance(self, include_optional) -> SearchResponse:
        ...
        if include_optional:
            return SearchResponse(
                ...
                generated_qna_result = glean_client_api.models.generated_qna.GeneratedQna(
                    question = '', 
                    answer = '', 
                    follow_up_prompts = [
                        ''
                    ...
                    cursor = '', 
                    tracking_token = '', ),
                error_info = glean_client_api.models.error_info.ErrorInfo(
                    bad_gmail_token = True, 
                    bad_outlook_token = True, 
                    invalid_operators = [
                        glean_client_api.models.invalid_operator_value_error.InvalidOperatorValueError(
                            key = '', 
                            value = '', )
                        ], 
                    error_messages = [
                        glean_client_api.models.error_message.ErrorMessage(
                            source = '', 
                            error_message = '', )
                        ], ),
                request_id = '',
                ...
                metadata = glean_client_api.models.search_response_metadata.SearchResponseMetadata(
                    rewritten_query = '', 
                    searched_query = '', 
                    ...
                    original_query = '', 
                    query_suggestion = {"query":"app:github type:pull author:mortimer","label":"Mortimer's PRs","datasource":"github"}, 
                    additional_query_suggestions = glean_client_api.models.query_suggestion_list.QuerySuggestionList(
                        suggestions = [
                            {"query":"app:github type:pull author:mortimer","label":"Mortimer's PRs","datasource":"github"}
                            ], 
                        person = {"name":"George Clooney","obfuscatedId":"abc123"}, ), 
                    ...
                    search_warning = glean_client_api.models.search_warning.SearchWarning(
                ...
                result_tabs = [
                    glean_client_api.models.result_tab.ResultTab(
                        id = '', 
                        count = 56, 
                        datasource = '', 
                        datasource_instance = '', )
                ...
                results_description = glean_client_api.models.results_description.ResultsDescription(
                    text = '', 
                    icon_config = {"color":"#343CED","key":"person_icon","iconType":"GLYPH","name":"user"}, ),
