...
class TestTeam(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Team:
        ...
        if include_optional:
            return Team(
                related_objects = {
                    'key' : glean_client_api.models.related_object_edge.RelatedObjectEdge(
                        objects = [
                            glean_client_api.models.related_object.RelatedObject(
                                id = '', 
                                metadata = glean_client_api.models.related_object_metadata.RelatedObject_metadata(
                                    name = '', ), )
                            ], )
                    },
                ...
                external_link = '',
                members = [
                    glean_client_api.models.person_to_team_relationship.PersonToTeamRelationship(
                ...
                member_count = 56,
                emails = [
                    glean_client_api.models.team_email.TeamEmail(
                        email = '', 
                        type = 'OTHER', 
