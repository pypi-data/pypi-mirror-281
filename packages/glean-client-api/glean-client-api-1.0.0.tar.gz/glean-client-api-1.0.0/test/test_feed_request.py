    ...
    def make_instance(self, include_optional) -> FeedRequest:
        ...
        if include_optional:
            return FeedRequest(
                ...
                request_options = glean_client_api.models.feed_request_options.FeedRequestOptions(
                    result_size = 56, 
                    timezone_offset = 56, 
                    category_to_result_size = {
                        'key' : glean_client_api.models.feed_request_options_category_to_result_size_value.FeedRequestOptions_categoryToResultSize_value(
                            result_size = 56, )
                        }, 
                    datasource_filter = [
                        ''
                ...
                client_data = glean_client_api.models.client_data.ClientData(
