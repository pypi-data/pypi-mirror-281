    ...
    def make_instance(self, include_optional) -> InsightsResponse:
        ...
        if include_optional:
            return InsightsResponse(
                timeseries = [
                    glean_client_api.models.labeled_count_info.LabeledCountInfo(
                        label = '', 
                        count_info = [
                ...
                users = glean_client_api.models.user_insights_response.UserInsightsResponse(
                ...
                content = glean_client_api.models.content_insights_response.ContentInsightsResponse(
                    last_log_timestamp = 56, 
                    document_insights = [
                ...
                queries = glean_client_api.models.query_insights_response.QueryInsightsResponse(
                    last_log_timestamp = 56, 
                    query_insights = [
                        glean_client_api.models.query_insight.QueryInsight(
                            query = '', 
                            search_count = glean_client_api.models.count_info.CountInfo(
                                count = 56, 
                                period = glean_client_api.models.period.Period(
                                    min_days_from_now = 56, 
                                    max_days_from_now = 56, 
                                    start = glean_client_api.models.time_point.TimePoint(
                                        ...
                                        days_from_now = 56, ), ), 
                                org = '', ), 
                            searchor_count = glean_client_api.models.count_info.CountInfo(
                                count = 56, 
                                org = '', ), 
                    ...
                    min_visitor_threshold = 56, ),
                collections = glean_client_api.models.content_insights_response.ContentInsightsResponse(
                    last_log_timestamp = 56, 
                    document_insights = [
                        glean_client_api.models.document_insight.DocumentInsight(
                            document = glean_client_api.models.document.Document(
                    ...
                    min_department_size_threshold = 56, 
                    min_visitor_threshold = 56, ),
                collections_v2 = glean_client_api.models.content_insights_response.ContentInsightsResponse(
                    last_log_timestamp = 56, 
                    document_insights = [
                        glean_client_api.models.document_insight.DocumentInsight(
                            document = glean_client_api.models.document.Document(
                    ...
                    min_department_size_threshold = 56, 
                    min_visitor_threshold = 56, ),
                shortcuts = glean_client_api.models.shortcut_insights_response.ShortcutInsightsResponse(
                    last_log_timestamp = 56, 
                    shortcut_insights = [
                        glean_client_api.models.shortcut_insight.ShortcutInsight(
                            shortcut = null, 
                    ...
                    min_visitor_threshold = 56, ),
                announcements = glean_client_api.models.content_insights_response.ContentInsightsResponse(
                    last_log_timestamp = 56, 
                    document_insights = [
                        glean_client_api.models.document_insight.DocumentInsight(
                            document = glean_client_api.models.document.Document(
                    ...
                    min_department_size_threshold = 56, 
                    min_visitor_threshold = 56, ),
                answers = glean_client_api.models.content_insights_response.ContentInsightsResponse(
                    last_log_timestamp = 56, 
                    document_insights = [
                        glean_client_api.models.document_insight.DocumentInsight(
                            document = glean_client_api.models.document.Document(
                    ...
                    min_department_size_threshold = 56, 
                    min_visitor_threshold = 56, ),
                ai = glean_client_api.models.ai_insights_response.AiInsightsResponse(
                    last_log_timestamp = 56, 
                    assistant_insights = [
                        glean_client_api.models.user_activity_insight.UserActivityInsight(
                            user = {"name":"George Clooney","obfuscatedId":"abc123"}, 
                ...
                ai_apps = glean_client_api.models.ai_apps_insights_response.AiAppsInsightsResponse(
                    last_log_timestamp = 56, 
                    ai_app_insights = [
                        glean_client_api.models.user_activity_insight.UserActivityInsight(
                            user = {"name":"George Clooney","obfuscatedId":"abc123"}, 
