...
class ToolConfig(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Human understandable name of the tool. Max 50 characters.", alias="displayName")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Valid only for ACTION tools. Represents the type of action tool REDIRECT - The client renders the URL which contains information for carrying out the action. EXECUTION - Send a request to an external server and execute the action.")
    __properties: ClassVar[List[str]] = ["displayName", "objectName", "logoUrl", "type"]
