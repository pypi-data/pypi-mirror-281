...
class CollectionItemDescriptor(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The URL of the item being added.")
    document_id: Optional[StrictStr] = Field(default=None, description="The Glean Document ID of the item being added if it's an indexed document.", alias="documentId")
    new_next_item_id: Optional[StrictStr] = Field(default=None, description="The (optional) ItemId of the next CollectionItem in sequence. If omitted, will be added to the end of the Collection", alias="newNextItemId")
    ...
    def item_type_validate_enum(cls, value):
        ...
        if value not in set(['DOCUMENT', 'TEXT', 'URL']):
            raise ValueError("must be one of enum values ('DOCUMENT', 'TEXT', 'URL')")
        return value
