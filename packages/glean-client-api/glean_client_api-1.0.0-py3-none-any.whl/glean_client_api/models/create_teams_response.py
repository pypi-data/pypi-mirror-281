...
class CreateTeamsResponse(BaseModel):
    """
    CreateTeamsResponse
    """ # noqa: E501
    num_errors: Optional[StrictInt] = Field(default=None, description="Number of teams that failed to be created", alias="numErrors")
