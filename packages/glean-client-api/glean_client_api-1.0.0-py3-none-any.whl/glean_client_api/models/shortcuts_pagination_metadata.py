...
class ShortcutsPaginationMetadata(BaseModel):
    ...
    """ # noqa: E501
    cursor: Optional[StrictStr] = Field(default=None, description="Cursor indicates the start of the next page of results")
    has_next_page: Optional[StrictBool] = Field(default=None, alias="hasNextPage")
    total_item_count: Optional[StrictInt] = Field(default=None, alias="totalItemCount")
    __properties: ClassVar[List[str]] = ["cursor", "hasNextPage", "totalItemCount"]
