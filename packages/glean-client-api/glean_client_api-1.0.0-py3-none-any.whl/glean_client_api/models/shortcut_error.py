...
class ShortcutError(BaseModel):
    ...
    def error_type_validate_enum(cls, value):
        ...
        if value not in set(['NO_PERMISSION', 'INVALID_ID', 'EXISTING_SHORTCUT', 'INVALID_CHARS']):
            raise ValueError("must be one of enum values ('NO_PERMISSION', 'INVALID_ID', 'EXISTING_SHORTCUT', 'INVALID_CHARS')")
        return value
