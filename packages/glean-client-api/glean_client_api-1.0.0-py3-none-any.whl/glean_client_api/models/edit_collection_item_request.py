...
class EditCollectionItemRequest(BaseModel):
    ...
    """ # noqa: E501
    collection_id: StrictInt = Field(description="The ID of the Collection to edit CollectionItems in.", alias="collectionId")
    item_id: StrictStr = Field(description="The ID of the CollectionItem to edit.", alias="itemId")
