...
class FlareEncoder:
    def __init__(self):
        ...
        self.number_mode_code = "3313"  # Updated code for first third group, third character
        self.special_mode_code = "3323"  # Updated code for second third group, third character
