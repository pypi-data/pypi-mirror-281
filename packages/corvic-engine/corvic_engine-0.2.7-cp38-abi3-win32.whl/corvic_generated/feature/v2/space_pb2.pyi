...
class Parameters(_message.Message):
    __slots__ = ("space_id", "feature_view_id", "column_embedding_parameters", "node2vec_parameters", "concat_string_and_embed")
    ...
    def __init__(self, space_id: _Optional[str] = ..., feature_view_id: _Optional[str] = ..., column_embedding_parameters: _Optional[_Union[_models_pb2.ColumnEmbeddingParameters, _Mapping]] = ..., node2vec_parameters: _Optional[_Union[_graph_pb2.Node2VecParameters, _Mapping]] = ..., concat_string_and_embed: _Optional[_Union[_models_pb2.ConcatStringAndEmbedParameters, _Mapping]] = ...) -> None: ...
