...
class FeatureViewEntry(_message.Message):
    __slots__ = ("id", "room_id", "source_entries", "name", "description", "output_entities", "output_sources")
    ...
    def __init__(self, id: _Optional[str] = ..., room_id: _Optional[str] = ..., source_entries: _Optional[_Iterable[_Union[_source_pb2.SourceEntry, _Mapping]]] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., output_entities: _Optional[_Union[OutputEntities, _Mapping]] = ..., output_sources: _Optional[_Iterable[_Union[OutputSource, _Mapping]]] = ...) -> None: ...
...
class CreateFeatureViewRequest(_message.Message):
    __slots__ = ("room_id", "name", "description", "source_ids", "output_entities", "output_sources")
    ROOM_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    output_entities: OutputEntities
    output_sources: _containers.RepeatedCompositeFieldContainer[OutputSource]
    def __init__(self, room_id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., source_ids: _Optional[_Iterable[str]] = ..., output_entities: _Optional[_Union[OutputEntities, _Mapping]] = ..., output_sources: _Optional[_Iterable[_Union[OutputSource, _Mapping]]] = ...) -> None: ...
...
class GetFeatureViewRelationshipsRequest(_message.Message):
    __slots__ = ("source_ids", "output_entites", "output_sources")
    SOURCE_IDS_FIELD_NUMBER: _ClassVar[int]
    ...
    output_sources: _containers.RepeatedCompositeFieldContainer[OutputSource]
    def __init__(self, source_ids: _Optional[_Iterable[str]] = ..., output_entites: _Optional[_Union[OutputEntities, _Mapping]] = ..., output_sources: _Optional[_Iterable[_Union[OutputSource, _Mapping]]] = ...) -> None: ...
