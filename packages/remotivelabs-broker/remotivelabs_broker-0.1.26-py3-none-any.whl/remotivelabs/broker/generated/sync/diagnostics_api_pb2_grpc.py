...
class DiagnosticsService(object):
    ...
    def PublishMultiFrame(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/diagnostics.DiagnosticsService/PublishMultiFrame',
    ...
    def SubscribeMultiFrame(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/diagnostics.DiagnosticsService/SubscribeMultiFrame',
