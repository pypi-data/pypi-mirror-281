...
class LimitsOverride(BaseModel):
    ...
    joint_acceleration_limit: Optional[Joints] = Field(default=None, description="Maximum joint acceleration in [rad/s^2] for each joint. Either leave this field empty or set a value for each joint. ")
    ...
    __properties: ClassVar[List[str]] = ["joint_velocity_limits", "joint_acceleration_limit", "tcp_velocity_limit", "tcp_acceleration_limit", "tcp_orientation_velocity_limit", "tcp_orientation_acceleration_limit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of joint_acceleration_limit
        if self.joint_acceleration_limit:
            _dict['joint_acceleration_limit'] = self.joint_acceleration_limit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "joint_acceleration_limit": Joints.from_dict(obj["joint_acceleration_limit"]) if obj.get("joint_acceleration_limit") is not None else None,
