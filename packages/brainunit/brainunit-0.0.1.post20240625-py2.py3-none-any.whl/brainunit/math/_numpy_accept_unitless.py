...
def _func_accept_unitless_unary(
  ...
  if isinstance(x, Quantity):
    if unit is None:
      assert x.is_unitless, f'Input should be unitless for the function "{func}" when scaling "unit" is not provided.'
      x = x.value
      return func(x, *args, **kwargs)
    else:
      fail_for_dimension_mismatch(x, unit, error_message="Unit mismatch: {value} != {unit}", value=x, unit=unit)
      return Quantity(func(x / unit, *args, **kwargs), unit=unit)
  else:
    assert unit is None, f'Unit should be None for the function "{func}" when "x" is not a Quantity.'
    return func(x, *args, **kwargs)
...
def exp(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.exp, x, unit=unit)
...
def exp2(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.exp2, x, unit=unit)
...
def expm1(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.expm1, x, unit=unit)
...
def log(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.log, x, unit=unit)
...
def log10(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.log10, x, unit=unit)
...
def log1p(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.log1p, x, unit=unit)
...
def log2(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.log2, x, unit=unit)
...
def arccos(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arccos, x, unit=unit)
...
def arccosh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arccosh, x, unit=unit)
...
def arcsin(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arcsin, x, unit=unit)
...
def arcsinh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arcsinh, x, unit=unit)
...
def arctan(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arctan, x, unit=unit)
...
def arctanh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.arctanh, x, unit=unit)
...
def cos(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.cos, x, unit=unit)
...
def cosh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.cosh, x, unit=unit)
...
def sin(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.sin, x, unit=unit)
...
def sinc(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.sinc, x, unit=unit)
...
def sinh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.sinh, x, unit=unit)
...
def tan(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.tan, x, unit=unit)
...
def tanh(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.tanh, x, unit=unit)
...
def deg2rad(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.deg2rad, x, unit=unit)
...
def rad2deg(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.rad2deg, x, unit=unit)
...
def degrees(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.degrees, x, unit=unit)
...
def radians(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.radians, x, unit=unit)
...
def angle(
  ...
  out : jax.Array
    Output array.
  """
  return _func_accept_unitless_unary(jnp.angle, x, unit=unit)
...
def round_(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.round_, x, unit=unit)
...
def around(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.around, x, unit=unit, decimals=decimals)
...
def round(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.round, x, unit=unit, decimals=decimals)
...
def rint(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.rint, x, unit=unit)
...
def floor(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.floor, x, unit=unit)
...
def ceil(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.ceil, x, unit=unit)
...
def trunc(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.trunc, x, unit=unit)
...
def fix(
  ...
  out : jax.Array
  """
  return _func_accept_unitless_unary(jnp.fix, x, unit=unit)
...
@set_module_as('brainunit.math')
def hypot(x: Union[Array, Quantity], y: Union[Array, Quantity]) -> Array | Quantity:
  """
...
@set_module_as('brainunit.math')
def arctan2(x: Union[Array, Quantity], y: Union[Array, Quantity]) -> Array | Quantity:
  """
...
@set_module_as('brainunit.math')
def logaddexp(x: Union[Array, Quantity], y: Union[Array, Quantity]) -> Array | Quantity:
  """
