...
from collibra_catalog_classification.models.classify_request import ClassifyRequest  # noqa: E501
...
class TestClassifyRequest(unittest.TestCase):
    ...
    def testClassifyRequest(self):
        ...
        # model = collibra_catalog_classification.models.classify_request.ClassifyRequest()  # noqa: E501
        pass
