...
from ...Core.data_context import (DataContext__ctor_Z2FD70A12, DataContext)
from ...Core.Table.data_map import (DataMap__ctor_4E3220A7, DataMap, DataMap__get_DataContexts)
...
def compose_columns(columns: IEnumerable_1[FsColumn]) -> Array[DataContext]:
    ...
    def _arrow1054(__unit: None=None, columns: Any=columns) -> IEnumerable_1[DataContext]:
        def _arrow1053(i: int) -> DataContext:
            return DataContext__ctor_Z2FD70A12()

        return map(_arrow1053, range_big_int(0, 1, l - 1))

    dc: Array[DataContext] = list(to_array(delay(_arrow1054)))
