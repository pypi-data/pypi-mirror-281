...
def get_templates(url: str | None=None) -> Async[Array[Template]]:
    ...
    def _arrow2065(__unit: None=None, url: Any=url) -> Async[Array[Template]]:
        def _arrow2064(_arg: str) -> Async[Array[Template]]:
            map_result: Array[Template] = Templates_fromJsonString(_arg)
            return singleton.Return(map_result)

        return singleton.Bind(download_file(url_1), _arrow2064)

    return singleton.Delay(_arrow2065)
