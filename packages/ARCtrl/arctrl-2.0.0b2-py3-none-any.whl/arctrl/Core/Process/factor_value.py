...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow381(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow382(__unit: None=None) -> str:
        ...
        return ("" if (value is None) else _arrow381()) if (category is None) else (_arrow382() if (value is None) else _arrow383())
...
FactorValue_reflection = _expr384
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow385(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow385(), this.Value, this.Unit)
