...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr493()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr494()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow495(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow497(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow496(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow496, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow497))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr498()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow499(table: ArcTable) -> CompositeCell | None:
    ...
    def iter_columns(action: Callable[[CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow500(table: ArcTable) -> ArcTable:
    ...
    def update_header(index: int, header: CompositeHeader) -> Callable[[ArcTable], ArcTable]:
        def _arrow503(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow509(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_column(column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow514(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_column(index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow515(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow516(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_columns(columns: Array[CompositeColumn], index: int | None=None, skip_fill_missing: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow517(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_column(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow518(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow519(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow519, index_arr)
        def _arrow520(index_1: int) -> None:
        ...
        iterate_1(_arrow520, sort_descending(index_arr, ObjectExpr521()))

    @staticmethod
    def remove_columns(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow523(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow525(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow524(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow524, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow525))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow527(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow529(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow530(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow531(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow533(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow535(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow536(table: ArcTable) -> CompositeColumn:
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow540(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow539(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow539, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow540)) if (cells is None) else value_3(cells)
    ...
    def add_row(cells: Array[CompositeCell] | None=None, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow541(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_row(row_index: int, cells: Array[CompositeCell]) -> Callable[[ArcTable], ArcTable]:
        def _arrow543(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow547(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_row(index: int, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow549(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.AddRow(cells, index)
            return new_table
    ...
    def add_rows(rows: Array[Array[CompositeCell]], index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow550(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow552(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow551(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow551, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow552))
        def _arrow553(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow553, None)
        this.AddRows(rows, index)

    @staticmethod
    def add_rows_empty(row_count: int, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow555(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow558(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_1(_arrow558, index_arr)
        def _arrow559(index_1: int) -> None:
        ...
        iterate_1(_arrow559, sort_descending(index_arr, ObjectExpr560()))

    @staticmethod
    def remove_rows(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow561(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.RemoveColumns(index_arr)
            return new_table
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow563(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow562(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow562, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow563))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow564(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow565(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow567(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr566()), None), None)

        return _arrow567

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow568(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow569(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow573(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow572(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow571(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow570(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow570, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow571))

                return map(_arrow572, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow573))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow582(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow581(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow580(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow579(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow574(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow577(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow576(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow575(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow575, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow576))

                        def _arrow578(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow574, range_big_int(0, 1, 19)), delay(_arrow577)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow578, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow579))

                return append_1(singleton("-------------"), delay(_arrow580))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow581))

        return join("\n", to_list(delay(_arrow582)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr583())

        def _arrow586(__unit: None=None) -> bool:
            ...
            def _arrow585(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow584(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow584, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow585))) if (length(a) == length(b)) else False

        if _arrow586() if (this.Name == other.Name) else False:
            ...
            def _arrow588(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow587(i_1: int) -> bool:
                    return equals(item(i_1, a_1), item(i_1, b_1))

                return map(_arrow587, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow588))) if (length(a_1) == length(b_1)) else False
