...
def ArcTablesAux_SanityChecks_validateSheetIndex(index: int, allow_append: bool, sheets: Array[ArcTable]) -> None:
    ...
    def _arrow504(__unit: None=None, index: Any=index, allow_append: Any=allow_append, sheets: Any=sheets) -> bool:
        x: int = index or 0
...
def ArcTablesAux_SanityChecks_validateNamesUnique(names: IEnumerable_1[str]) -> None:
    class ObjectExpr506:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow505(x: str, y: str) -> bool:
                return x == y
    ...
    if not (length(names) == length(distinct(names, ObjectExpr506()))):
...
def ArcTablesAux_SanityChecks_validateNewNameUnique(new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow507(x: str, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name
...
def ArcTablesAux_SanityChecks_validateNewNameAtUnique(index: int, new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow508(x: str, index: Any=index, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow508, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNamesUnique(new_names: IEnumerable_1[str], existing_names: IEnumerable_1[str]) -> None:
    ...
    same: Any = intersect(of_seq(new_names, ObjectExpr510()), of_seq(existing_names, ObjectExpr511()))
...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr554()
    ...
    def TableNames(self, __unit: None=None) -> FSharpList[str]:
        ...
        def _arrow513(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow512(s: ArcTable) -> str:
                return s.Name

            return map_1(_arrow512, this.Tables)
    ...
    def RemoveColumnAt(self, table_index: int, column_index: int) -> None:
        this: ArcTables = self
        def _arrow526(table: ArcTable) -> None:
            table.RemoveColumn(column_index)

        this.MapTableAt(table_index, _arrow526)
    ...
    def UpdateColumnAt(self, table_index: int, column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> None:
        this: ArcTables = self
        def _arrow528(table: ArcTable) -> None:
            table.UpdateColumn(column_index, header, cells)

        this.MapTableAt(table_index, _arrow528)
    ...
    def AddRowAt(self, table_index: int, cells: Array[CompositeCell] | None=None, row_index: int | None=None) -> None:
        this: ArcTables = self
        def _arrow532(table: ArcTable) -> None:
            table.AddRow(cells, row_index)

        this.MapTableAt(table_index, _arrow532)
    ...
    def UpdateRowAt(self, table_index: int, row_index: int, cells: Array[CompositeCell]) -> None:
        this: ArcTables = self
        def _arrow537(table: ArcTable) -> None:
            table.UpdateRow(row_index, cells)

        this.MapTableAt(table_index, _arrow537)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr542())
        def _arrow548(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow544(__unit: None=None) -> Array[ArcTable]:
            ...
            class ObjectExpr546:
                @property
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow545(x_2: str, y_1: str) -> bool:
                        return x_2 == y_1
            ...
            s: Array[ArcTable] = map_3(mapping_4, map_3(mapping_3, Array_groupBy(projection, map_3(mapping_2, _arrow544(), None), ObjectExpr546()), None), None)
        ...
        return ArcTables(list(_arrow548()))
