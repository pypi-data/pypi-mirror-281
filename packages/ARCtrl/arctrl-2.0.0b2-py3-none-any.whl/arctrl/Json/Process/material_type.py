...
class ObjectExpr1389(Decoder_1[MaterialType]):
...
MaterialType_ROCrate_decoder: Decoder_1[MaterialType] = ObjectExpr1389()
...
def ARCtrl_Process_MaterialType__MaterialType_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[MaterialType], str]:
    def _arrow1390(f: MaterialType, spaces: Any=spaces) -> str:
