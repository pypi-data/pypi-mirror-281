...
def FsCellsCollection__Add_2E78CE33(this: FsCellsCollection, row: int, column: int, cell: FsCell) -> None:
    ...
    def _arrow119(__unit: None=None, this: Any=this, row: Any=row, column: Any=column, cell: Any=cell) -> Any:
    ...
    add_to_dict(_arrow119(), column, cell)
...
def FsCellsCollection__GetCells_6611854F(this: FsCellsCollection, row_start: int, column_start: int, row_end: int, column_end: int, predicate: Callable[[FsCell], bool]) -> IEnumerable_1[FsCell]:
    ...
    def _arrow126(__unit: None=None, this: Any=this, row_start: Any=row_start, column_start: Any=column_start, row_end: Any=row_end, column_end: Any=column_end, predicate: Any=predicate) -> IEnumerable_1[FsCell]:
        def _arrow125(ro: int) -> IEnumerable_1[FsCell]:
            ...
            if match_value is None:
                ...
                def _arrow124(co: int) -> IEnumerable_1[FsCell]:
                ...
                return collect(_arrow124, range_big_int(column_start, 1, final_column))


        return collect(_arrow125, range_big_int(row_start, 1, final_row))
...
def FsCellsCollection__GetCells_Z6C21C500(this: FsCellsCollection, row_start: int, column_start: int, row_end: int, column_end: int) -> IEnumerable_1[FsCell]:
    final_row: int = (this._maxRowUsed if (row_end > this._maxRowUsed) else row_end) or 0
    final_column: int = (this._maxColumnUsed if (column_end > this._maxColumnUsed) else column_end) or 0
    def _arrow129(__unit: None=None, this: Any=this, row_start: Any=row_start, column_start: Any=column_start, row_end: Any=row_end, column_end: Any=column_end) -> IEnumerable_1[FsCell]:
        def _arrow128(ro: int) -> IEnumerable_1[FsCell]:
            match_value: Any | None = Dictionary_tryGet(ro, this._rowsCollection)
            if match_value is None:
                return empty()
                ...
                columns_collection: Any = match_value
                def _arrow127(co: int) -> IEnumerable_1[FsCell]:
                    match_value_1: FsCell | None = Dictionary_tryGet(co, columns_collection)
                    if match_value_1 is not None:
                ...
                return collect(_arrow127, range_big_int(column_start, 1, final_column))


        return collect(_arrow128, range_big_int(row_start, 1, final_row))
