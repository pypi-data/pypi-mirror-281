...
def Study_encoder(study: ArcStudy) -> Json:
    ...
    def _arrow1815(value_1: str, study: Any=study) -> Json:
        return Json(0, value_1)

    def _arrow1816(value_3: str, study: Any=study) -> Json:
        return Json(0, value_3)

    def _arrow1817(value_5: str, study: Any=study) -> Json:
        return Json(0, value_5)

    def _arrow1818(value_7: str, study: Any=study) -> Json:
        return Json(0, value_7)

    def _arrow1819(oa: Publication, study: Any=study) -> Json:
        return Publication_encoder(oa)

    def _arrow1820(person: Person, study: Any=study) -> Json:
        return Person_encoder(person)

    def _arrow1821(oa_1: OntologyAnnotation, study: Any=study) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1822(table: ArcTable, study: Any=study) -> Json:
        return ArcTable_encoder(table)

    def _arrow1823(value_9: str, study: Any=study) -> Json:
        return Json(0, value_9)

    def _arrow1824(comment: Comment, study: Any=study) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([("Identifier", Json(0, study.Identifier)), try_include("Title", _arrow1815, study.Title), try_include("Description", _arrow1816, study.Description), try_include("SubmissionDate", _arrow1817, study.SubmissionDate), try_include("PublicReleaseDate", _arrow1818, study.PublicReleaseDate), try_include_seq("Publications", _arrow1819, study.Publications), try_include_seq("Contacts", _arrow1820, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow1821, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow1822, study.Tables), try_include_seq("RegisteredAssayIdentifiers", _arrow1823, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow1824, study.Comments)])))


def _arrow1836(get: IGetters) -> ArcStudy:
    def _arrow1825(__unit: None=None) -> str:
    ...
    def _arrow1832(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow1833(__unit: None=None) -> Array[ArcTable] | None:
    ...
    return ArcStudy(_arrow1825(), _arrow1826(), _arrow1827(), _arrow1828(), _arrow1829(), _arrow1830(), _arrow1831(), _arrow1832(), _arrow1833(), None, _arrow1834(), _arrow1835())


Study_decoder: Decoder_1[ArcStudy] = object(_arrow1836)
...
def Study_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> Json:
    ...
    def _arrow1837(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_1)

    def _arrow1838(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_3)

    def _arrow1839(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_5)

    def _arrow1840(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_7)

    def _arrow1841(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Publication_encoder(oa)

    def _arrow1842(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Person_encoder(person)

    def _arrow1843(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1844(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return ArcTable_encoderCompressed(string_table, oa_table, cell_table, table)

    def _arrow1845(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_9)

    def _arrow1846(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([("Identifier", Json(0, study.Identifier)), try_include("Title", _arrow1837, study.Title), try_include("Description", _arrow1838, study.Description), try_include("SubmissionDate", _arrow1839, study.SubmissionDate), try_include("PublicReleaseDate", _arrow1840, study.PublicReleaseDate), try_include_seq("Publications", _arrow1841, study.Publications), try_include_seq("Contacts", _arrow1842, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow1843, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow1844, study.Tables), try_include_seq("RegisteredAssayIdentifiers", _arrow1845, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow1846, study.Comments)])))
...
def Study_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow1858(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow1847(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow1852(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = Decode_resizeArray(Publication_decoder)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow1853(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = Decode_resizeArray(Person_decoder)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow1854(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = Decode_resizeArray(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow1855(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = Decode_resizeArray(ArcTable_decoderCompressed(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow1856(__unit: None=None) -> Array[str] | None:
            arg_19: Decoder_1[Array[str]] = Decode_resizeArray(string)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("RegisteredAssayIdentifiers", arg_19)

        def _arrow1857(__unit: None=None) -> Array[Comment] | None:
            arg_21: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("Comments", arg_21)

        return ArcStudy(_arrow1847(), _arrow1848(), _arrow1849(), _arrow1850(), _arrow1851(), _arrow1852(), _arrow1853(), _arrow1854(), _arrow1855(), None, _arrow1856(), _arrow1857())

    return object(_arrow1858)
...
def Study_ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> Json:
    ...
    def _arrow1859(value_4: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_4)

    def _arrow1860(value_6: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_6)

    def _arrow1861(value_8: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_8)

    def _arrow1862(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow1863(value_10: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_10)

    def _arrow1864(value_12: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_12)

    def _arrow1865(oa_1: Publication, assays: Any=assays, s: Any=s) -> Json:
        return Publication_ROCrate_encoder(oa_1)

    def _arrow1866(oa_2: Person, assays: Any=assays, s: Any=s) -> Json:
        return Person_ROCrate_encoder(oa_2)

    def _arrow1868(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], Json]:
        study_name: str | None = s.Identifier
        def _arrow1867(oa_3: Process) -> Json:
            return Process_ROCrate_encoder(study_name, None, oa_3)

        return _arrow1867

    def _arrow1870(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], Json]:
        study_name_1: str | None = s.Identifier
        def _arrow1869(a_1: ArcAssay) -> Json:
            return Assay_ROCrate_encoder(study_name_1, a_1)

        return _arrow1869

    def _arrow1871(comment: Comment, assays: Any=assays, s: Any=s) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Study_ROCrate_genID(s))), ("@type", list_1_1(singleton(Json(0, "Study")))), ("additionalType", Json(0, "Study")), ("identifier", Json(0, s.Identifier)), try_include("filename", _arrow1859, file_name), try_include("title", _arrow1860, s.Title), try_include("description", _arrow1861, s.Description), try_include_seq("studyDesignDescriptors", _arrow1862, s.StudyDesignDescriptors), try_include("submissionDate", _arrow1863, s.SubmissionDate), try_include("publicReleaseDate", _arrow1864, s.PublicReleaseDate), try_include_seq("publications", _arrow1865, s.Publications), try_include_seq("people", _arrow1866, s.Contacts), try_include_list("processSequence", _arrow1868(), processes), try_include_seq("assays", _arrow1870(), assays_1), try_include_seq("comments", _arrow1871, s.Comments), ("@context", context_jsonvalue)])))


def _arrow1886(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow1872(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow1872()), create_missing_identifier())
    ...
    def _arrow1881(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow1882(__unit: None=None) -> Array[Person] | None:
        arg_18: Decoder_1[Array[Person]] = Decode_resizeArray(Person_ROCrate_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_18)

    def _arrow1883(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow1877(), _arrow1878(), _arrow1879(), _arrow1880(), _arrow1881(), _arrow1882(), _arrow1883(), tables, None, assay_identifiers, _arrow1885()), default_arg(assays, empty()))


Study_ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow1886)
...
def Study_ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> Json:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> Json:
        ...
        def _arrow1887(ps: FSharpList[Process], s_1: Any=s_1) -> Json:
            return encoder_4(id_map, ps)

        encoded_materials: tuple[str, Json] = try_include("materials", _arrow1887, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, Json]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow1889(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], Json]:
            study_name: str | None = s_1.Identifier
            def _arrow1888(oa_1: Protocol) -> Json:
                return Protocol_ISAJson_encoder(study_name, None, None, id_map, oa_1)

            return _arrow1888

        encoded_protocols = try_include_list("protocols", _arrow1889(), value_5)
        ...
        def _arrow1890(value_9: str, s_1: Any=s_1) -> Json:
            return Json(0, value_9)

        def _arrow1891(value_11: str, s_1: Any=s_1) -> Json:
            return Json(0, value_11)

        def _arrow1892(value_13: str, s_1: Any=s_1) -> Json:
            return Json(0, value_13)

        def _arrow1893(value_15: str, s_1: Any=s_1) -> Json:
            return Json(0, value_15)

        def _arrow1894(oa_2: Publication, s_1: Any=s_1) -> Json:
            return Publication_ISAJson_encoder(id_map, oa_2)

        def _arrow1895(person_2: Person, s_1: Any=s_1) -> Json:
            return Person_ISAJson_encoder(id_map, person_2)

        def _arrow1896(oa_3: OntologyAnnotation, s_1: Any=s_1) -> Json:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow1898(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], Json]:
            study_name_1: str | None = s_1.Identifier
            def _arrow1897(oa_4: Process) -> Json:
                return Process_ISAJson_encoder(study_name_1, None, id_map, oa_4)

            return _arrow1897

        def _arrow1900(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], Json]:
            study_name_2: str | None = s_1.Identifier
            def _arrow1899(a_2: ArcAssay) -> Json:
                return Assay_ISAJson_encoder(study_name_2, id_map, a_2)

            return _arrow1899

        def _arrow1901(comment: Comment, s_1: Any=s_1) -> Json:
            return Comment_ISAJson_encoder(id_map, comment)

        return Json(5, choose(chooser, of_array([("@id", Json(0, Study_ROCrate_genID(study))), ("filename", Json(0, file_name)), ("identifier", Json(0, study.Identifier)), try_include("title", _arrow1890, study.Title), try_include("description", _arrow1891, study.Description), try_include("submissionDate", _arrow1892, study.SubmissionDate), try_include("publicReleaseDate", _arrow1893, study.PublicReleaseDate), try_include_seq("publications", _arrow1894, study.Publications), try_include_seq("people", _arrow1895, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow1896, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow1898(), processes), try_include_seq("assays", _arrow1900(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow1901, study.Comments)])))

    if id_map is not None:
        def _arrow1902(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return Study_ROCrate_genID(s_2)

        return encode(_arrow1902, f, s, id_map)
...
def _arrow1913(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow1904()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow1903(), def_thunk)
    ...
    def _arrow1907(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
    ...
    def _arrow1910(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow1911(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow1906(), _arrow1907(), _arrow1908(), _arrow1909(), _arrow1910(), None if (len(persons) == 0) else persons, _arrow1911(), tables, None, assay_identifiers, _arrow1912()), default_arg(assays, empty()))


Study_ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(Study_ISAJson_allowedFields, _arrow1913)
...
def ARCtrl_ArcStudy__ArcStudy_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1914(obj: ArcStudy, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcStudy__ArcStudy_toCompressedJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1915(obj: ArcStudy, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcStudy__ArcStudy_toROCrateJsonString_Static_3BA23086(assays: FSharpList[ArcAssay] | None=None, spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1916(obj: ArcStudy, assays: Any=assays, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcStudy__ArcStudy_toISAJsonString_Static_Z3FD920F1(assays: FSharpList[ArcAssay] | None=None, spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[ArcStudy], str]:
    ...
    def _arrow1917(obj: ArcStudy, assays: Any=assays, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
