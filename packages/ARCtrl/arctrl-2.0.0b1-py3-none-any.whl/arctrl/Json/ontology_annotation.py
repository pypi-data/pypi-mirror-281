...
def OntologyAnnotation_encoder(oa: OntologyAnnotation) -> Json:
    ...
    def _arrow1129(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1130(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1131(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1132(comment: Comment, oa: Any=oa) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("annotationValue", _arrow1129, oa.Name), try_include("termSource", _arrow1130, oa.TermSourceREF), try_include("termAccession", _arrow1131, oa.TermAccessionNumber), try_include_seq("comments", _arrow1132, oa.Comments)])))


def _arrow1137(get: IGetters) -> OntologyAnnotation:
    ...
    return OntologyAnnotation.create(_arrow1133(), _arrow1134(), _arrow1135(), _arrow1136())


OntologyAnnotation_decoder: Decoder_1[OntologyAnnotation] = object(_arrow1137)
...
def OntologyAnnotation_compressedEncoder(string_table: Any, oa: OntologyAnnotation) -> Json:
    ...
    def _arrow1139(s: str, string_table: Any=string_table, oa: Any=oa) -> Json:
        return encode_string(string_table, s)

    def _arrow1140(s_1: str, string_table: Any=string_table, oa: Any=oa) -> Json:
        return encode_string(string_table, s_1)

    def _arrow1141(s_2: str, string_table: Any=string_table, oa: Any=oa) -> Json:
        return encode_string(string_table, s_2)

    def _arrow1142(comment: Comment, string_table: Any=string_table, oa: Any=oa) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("a", _arrow1139, oa.Name), try_include("ts", _arrow1140, oa.TermSourceREF), try_include("ta", _arrow1141, oa.TermAccessionNumber), try_include_seq("comments", _arrow1142, oa.Comments)])))


def OntologyAnnotation_compressedDecoder(string_table: Array[str]) -> Decoder_1[OntologyAnnotation]:
    def _arrow1147(get: IGetters, string_table: Any=string_table) -> OntologyAnnotation:
        ...
        def _arrow1146(__unit: None=None) -> Array[Comment] | None:
            arg_7: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("comments", arg_7)

        return OntologyAnnotation(_arrow1143(), _arrow1144(), _arrow1145(), _arrow1146())

    return object(_arrow1147)
...
def OntologyAnnotation_ROCrate_encoderDefinedTerm(oa: OntologyAnnotation) -> Json:
    ...
    def _arrow1148(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1149(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1150(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1151(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoderDisambiguatingDescription(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, OntologyAnnotation_ROCrate_genID(oa))), ("@type", Json(0, "OntologyAnnotation")), try_include("annotationValue", _arrow1148, oa.Name), try_include("termSource", _arrow1149, oa.TermSourceREF), try_include("termAccession", _arrow1150, oa.TermAccessionNumber), try_include_seq("comments", _arrow1151, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1156(get: IGetters) -> OntologyAnnotation:
    ...
    return OntologyAnnotation.create(_arrow1152(), _arrow1153(), _arrow1154(), _arrow1155())


OntologyAnnotation_ROCrate_decoderDefinedTerm: Decoder_1[OntologyAnnotation] = object(_arrow1156)
...
def OntologyAnnotation_ROCrate_encoderPropertyValue(oa: OntologyAnnotation) -> Json:
    ...
    def _arrow1157(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1158(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1159(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoderDisambiguatingDescription(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, OntologyAnnotation_ROCrate_genID(oa))), ("@type", Json(0, "PropertyValue")), try_include("category", _arrow1157, oa.Name), try_include("categoryCode", _arrow1158, oa.TermAccessionNumber), try_include_seq("comments", _arrow1159, oa.Comments), ("@context", context_jsonvalue_1)])))


def _arrow1163(get: IGetters) -> OntologyAnnotation:
    def _arrow1160(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("category", string)

    def _arrow1161(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("categoryCode", string)

    def _arrow1162(__unit: None=None) -> Array[Comment] | None:
    ...
    return OntologyAnnotation.create(_arrow1160(), None, _arrow1161(), _arrow1162())


OntologyAnnotation_ROCrate_decoderPropertyValue: Decoder_1[OntologyAnnotation] = object(_arrow1163)
...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> Json:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1165(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1166(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1167(value_4: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_4)

        def _arrow1168(value_6: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_6)

        def _arrow1169(comment: Comment, oa_1: Any=oa_1) -> Json:
            return Comment_encoder(comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1165, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1166, oa_1.Name), try_include("termSource", _arrow1167, oa_1.TermSourceREF), try_include("termAccession", _arrow1168, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1169, comments)])))

    if id_map is not None:
        def _arrow1170(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1170, f, oa, id_map)
...
def ARCtrl_OntologyAnnotation__OntologyAnnotation_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[OntologyAnnotation], str]:
    def _arrow1171(obj: OntologyAnnotation, spaces: Any=spaces) -> str:
...
def ARCtrl_OntologyAnnotation__OntologyAnnotation_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[OntologyAnnotation], str]:
    def _arrow1172(obj: OntologyAnnotation, spaces: Any=spaces) -> str:
...
def ARCtrl_OntologyAnnotation__OntologyAnnotation_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[OntologyAnnotation], str]:
    def _arrow1173(obj: OntologyAnnotation, spaces: Any=spaces) -> str:
