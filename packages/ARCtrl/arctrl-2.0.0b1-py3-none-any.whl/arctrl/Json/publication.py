...
def Publication_encoder(oa: Publication) -> Json:
    ...
    def _arrow1213(value: str, oa: Any=oa) -> Json:
        return Json(0, value)
    ...
    def _arrow1216(value_6: str, oa: Any=oa) -> Json:
    ...
    return Json(5, choose(chooser, of_array([try_include("pubMedID", _arrow1213, oa.PubMedID), try_include("doi", _arrow1214, oa.DOI), try_include("authorList", _arrow1215, oa.Authors), try_include("title", _arrow1216, oa.Title), try_include("status", _arrow1217, oa.Status), try_include_seq("comments", _arrow1218, oa.Comments)])))


def _arrow1225(get: IGetters) -> Publication:
    ...
    def _arrow1223(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_decoder)

    def _arrow1224(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1219(), _arrow1220(), _arrow1221(), _arrow1222(), _arrow1223(), _arrow1224())


Publication_decoder: Decoder_1[Publication] = object(_arrow1225)
...
def Publication_ROCrate_encoder(oa: Publication) -> Json:
    ...
    def _arrow1226(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1227(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1228(author_list: str, oa: Any=oa) -> Json:
        return Person_ROCrate_encodeAuthorListString(author_list)

    def _arrow1229(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1230(oa_1: OntologyAnnotation, oa: Any=oa) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1231(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoderDisambiguatingDescription(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Publication_ROCrate_genID(oa))), ("@type", Json(0, "Publication")), try_include("pubMedID", _arrow1226, oa.PubMedID), try_include("doi", _arrow1227, oa.DOI), try_include("authorList", _arrow1228, oa.Authors), try_include("title", _arrow1229, oa.Title), try_include("status", _arrow1230, oa.Status), try_include_seq("comments", _arrow1231, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1238(get: IGetters) -> Publication:
    ...
    def _arrow1236(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow1237(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ROCrate_decoderDisambiguatingDescription)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1232(), _arrow1233(), _arrow1234(), _arrow1235(), _arrow1236(), _arrow1237())


Publication_ROCrate_decoder: Decoder_1[Publication] = object(_arrow1238)
...
def Publication_ISAJson_encoder(id_map: Any | None, oa: Publication) -> Json:
    ...
    def _arrow1240(value: str, id_map: Any=id_map, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1241(value_2: str, id_map: Any=id_map, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1242(value_4: str, id_map: Any=id_map, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1243(value_6: str, id_map: Any=id_map, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1244(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1245(comment: Comment, id_map: Any=id_map, oa: Any=oa) -> Json:
        return Comment_ISAJson_encoder(id_map, comment)

    return Json(5, choose(chooser, of_array([try_include("pubMedID", _arrow1240, oa.PubMedID), try_include("doi", _arrow1241, oa.DOI), try_include("authorList", _arrow1242, oa.Authors), try_include("title", _arrow1243, oa.Title), try_include("status", _arrow1244, oa.Status), try_include_seq("comments", _arrow1245, oa.Comments)])))
...
def ARCtrl_Publication__Publication_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Publication], str]:
    def _arrow1246(obj: Publication, spaces: Any=spaces) -> str:
...
def ARCtrl_Publication__Publication_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Publication], str]:
    def _arrow1247(obj: Publication, spaces: Any=spaces) -> str:
...
def ARCtrl_Publication__Publication_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Publication], str]:
    ...
    def _arrow1248(obj: Publication, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
