...
def Protocol_ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> Json:
    ...
    def _arrow1396(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1397(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1398(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1399(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1400(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_8)

    def _arrow1401(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Protocol_ROCrate_genID(study_name, assay_name, process_name, oa))), ("@type", list_1_1(singleton(Json(0, "Protocol")))), try_include("name", _arrow1396, oa.Name), try_include("protocolType", _arrow1397, oa.ProtocolType), try_include("description", _arrow1398, oa.Description), try_include("uri", _arrow1399, oa.Uri), try_include("version", _arrow1400, oa.Version), try_include_list_opt("components", Component_ROCrate_encoder, oa.Components), try_include_list_opt("comments", _arrow1401, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1413(get: IGetters) -> Protocol:
    def _arrow1405(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow1402(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(Component_ROCrate_decoder)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow1402(), empty())
        def _arrow1403(__unit: None=None) -> FSharpList[Component] | None:
            arg_3: Decoder_1[FSharpList[Component]] = list_1_2(Component_ROCrate_decoder)
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("reagents", arg_3)

        list_4 = append(default_arg(_arrow1403(), empty()), list_2)
        def _arrow1404(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow1404(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow1405())
    ...
    def _arrow1409(__unit: None=None) -> str | None:
    ...
    def _arrow1412(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ROCrate_decoder)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow1406(), _arrow1407(), _arrow1408(), _arrow1409(), _arrow1410(), _arrow1411(), None, components, _arrow1412())


Protocol_ROCrate_decoder: Decoder_1[Protocol] = object(_arrow1413)
...
def Protocol_ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> Json:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1415(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1416(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1417(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> Json:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow1418(value_4: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_4)

        def _arrow1419(value_6: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_6)

        def _arrow1420(value_8: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_8)

        def _arrow1421(value_10: ProtocolParameter, oa_1: Any=oa_1) -> Json:
            return ProtocolParameter_ISAJson_encoder(id_map, value_10)

        def _arrow1422(c: Component, oa_1: Any=oa_1) -> Json:
            return Component_ISAJson_encoder(id_map, c)

        def _arrow1423(comment: Comment, oa_1: Any=oa_1) -> Json:
            return Comment_ISAJson_encoder(id_map, comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1415, Protocol_ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow1416, oa_1.Name), try_include("protocolType", _arrow1417, oa_1.ProtocolType), try_include("description", _arrow1418, oa_1.Description), try_include("uri", _arrow1419, oa_1.Uri), try_include("version", _arrow1420, oa_1.Version), try_include_list_opt("parameters", _arrow1421, oa_1.Parameters), try_include_list_opt("components", _arrow1422, oa_1.Components), try_include_list_opt("comments", _arrow1423, oa_1.Comments)])))

    if id_map is not None:
        def _arrow1424(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return Protocol_ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow1424, f, oa, id_map)
...
def _arrow1434(get: IGetters) -> Protocol:
    ...
    def _arrow1427(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1430(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("version", string)

    def _arrow1431(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
    ...
    def _arrow1432(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(Component_ISAJson_decoder)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow1433(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ISAJson_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow1425(), _arrow1426(), _arrow1427(), _arrow1428(), _arrow1429(), _arrow1430(), _arrow1431(), _arrow1432(), _arrow1433())


Protocol_ISAJson_decoder: Decoder_1[Protocol] = object(_arrow1434)
...
def ARCtrl_Process_Protocol__Protocol_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Protocol], str]:
    ...
    def _arrow1435(f: Protocol, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Protocol__Protocol_toROCrateString_Static_Z482224B9(study_name: str | None=None, assay_name: str | None=None, process_name: str | None=None, spaces: int | None=None) -> Callable[[Protocol], str]:
    def _arrow1436(f: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, spaces: Any=spaces) -> str:
