...
def ProtocolParameter_ISAJson_encoder(id_map: Any | None, value: ProtocolParameter) -> Json:
    def f(value_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> Json:
        ...
        def _arrow1361(value_2: str, value_1: Any=value_1) -> Json:
            return Json(0, value_2)

        def _arrow1362(oa: OntologyAnnotation, value_1: Any=value_1) -> Json:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1361, ProtocolParameter_ISAJson_genID(value_1)), try_include("parameterName", _arrow1362, value_1.ParameterName)])))

    if id_map is not None:
        def _arrow1363(p_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> str:
            return ProtocolParameter_ISAJson_genID(p_1)

        return encode(_arrow1363, f, value, id_map)
...
def _arrow1365(get: IGetters) -> ProtocolParameter:
    def _arrow1364(__unit: None=None) -> OntologyAnnotation | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("parameterName", OntologyAnnotation_ISAJson_decoder)

    return ProtocolParameter(None, _arrow1364())


ProtocolParameter_ISAJson_decoder: Decoder_1[ProtocolParameter] = object(_arrow1365)
...
def ARCtrl_Process_ProtocolParameter__ProtocolParameter_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ProtocolParameter], str]:
    def _arrow1366(v: ProtocolParameter, spaces: Any=spaces) -> str:
