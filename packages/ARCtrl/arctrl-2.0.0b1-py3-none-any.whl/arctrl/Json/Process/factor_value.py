...
def FactorValue_ISAJson_encoder(id_map: Any | None, fv: FactorValue) -> Json:
    def f(fv_1: FactorValue, id_map: Any=id_map, fv: Any=fv) -> Json:
        ...
        def _arrow1349(value: str, fv_1: Any=fv_1) -> Json:
            return Json(0, value)

        def _arrow1350(value_2: Factor, fv_1: Any=fv_1) -> Json:
            return Factor_ISAJson_encoder(id_map, value_2)

        def _arrow1351(value_3: Value_1, fv_1: Any=fv_1) -> Json:
            return Value_ISAJson_encoder(id_map, value_3)

        def _arrow1352(oa: OntologyAnnotation, fv_1: Any=fv_1) -> Json:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1349, FactorValue_ISAJson_genID(fv_1)), try_include("category", _arrow1350, fv_1.Category), try_include("value", _arrow1351, fv_1.Value), try_include("unit", _arrow1352, fv_1.Unit)])))

    if id_map is not None:
        def _arrow1353(fv_3: FactorValue, id_map: Any=id_map, fv: Any=fv) -> str:
            return FactorValue_ISAJson_genID(fv_3)

        return encode(_arrow1353, f, fv, id_map)
...
def _arrow1358(get: IGetters) -> FactorValue:
    def _arrow1354(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1355(__unit: None=None) -> Factor | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("category", Factor_ISAJson_decoder)

    def _arrow1356(__unit: None=None) -> Value_1 | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("value", Value_ISAJson_decoder)

    def _arrow1357(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("unit", OntologyAnnotation_ISAJson_decoder)

    return FactorValue(_arrow1354(), _arrow1355(), _arrow1356(), _arrow1357())


FactorValue_ISAJson_decoder: Decoder_1[FactorValue] = object(_arrow1358)
...
def ARCtrl_Process_FactorValue__FactorValue_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[FactorValue], str]:
    ...
    def _arrow1359(f: FactorValue, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
