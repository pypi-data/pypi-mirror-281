...
def Material_ROCrate_encoder(oa: Material) -> Json:
    ...
    def _arrow1439(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1440(value_4: MaterialType, oa: Any=oa) -> Json:
        return MaterialType_ROCrate_encoder(value_4)

    def _arrow1441(oa_1: Material, oa: Any=oa) -> Json:
        return Material_ROCrate_encoder(oa_1)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Material_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Material")))), try_include("name", _arrow1439, oa.Name), try_include("type", _arrow1440, oa.MaterialType), try_include_list_opt("characteristics", MaterialAttributeValue_ROCrate_encoder, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow1441, oa.DerivesFrom), ("@context", context_jsonvalue)])))


def _arrow1449(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow1448(get: IGetters) -> Material:
            ...
            def _arrow1445(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", MaterialType_ROCrate_decoder)

            def _arrow1446(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow1447(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow1443(), _arrow1444(), _arrow1445(), _arrow1446(), _arrow1447())

        return object(_arrow1448)

    return decode(None)


Material_ROCrate_decoder: Decoder_1[Material] = _arrow1449()
...
def Material_ISAJson_encoder(id_map: Any | None, c: Material) -> Json:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> Json:
        ...
        def _arrow1451(value: str, oa: Any=oa) -> Json:
            return Json(0, value)

        def _arrow1452(value_2: str, oa: Any=oa) -> Json:
            return Json(0, value_2)

        def _arrow1453(oa_1: MaterialAttributeValue, oa: Any=oa) -> Json:
            return MaterialAttributeValue_ISAJson_encoder(id_map, oa_1)

        def _arrow1454(c_1: Material, oa: Any=oa) -> Json:
            return Material_ISAJson_encoder(id_map, c_1)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1451, Material_ROCrate_genID(oa)), try_include("name", _arrow1452, oa.Name), try_include("type", MaterialType_ISAJson_encoder, oa.MaterialType), try_include_list_opt("characteristics", _arrow1453, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow1454, oa.DerivesFrom)])))

    if id_map is not None:
        def _arrow1455(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return Material_ROCrate_genID(m_1)

        return encode(_arrow1455, f, c, id_map)
...
def _arrow1462(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow1461(get: IGetters) -> Material:
            def _arrow1456(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)
            ...
            def _arrow1458(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", MaterialType_ISAJson_decoder)

            def _arrow1459(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
                arg_7: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(MaterialAttributeValue_ISAJson_decoder)
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("characteristics", arg_7)

            def _arrow1460(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow1456(), _arrow1457(), _arrow1458(), _arrow1459(), _arrow1460())

        return Decode_objectNoAdditionalProperties(Material_ISAJson_allowedFields, _arrow1461)

    return decode(None)


Material_ISAJson_decoder: Decoder_1[Material] = _arrow1462()
...
def ARCtrl_Process_Material__Material_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Material], str]:
    ...
    def _arrow1463(f: Material, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Material__Material_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Material], str]:
    def _arrow1464(f: Material, spaces: Any=spaces) -> str:
