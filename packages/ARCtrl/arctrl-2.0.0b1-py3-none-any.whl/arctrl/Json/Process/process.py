...
def Process_ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> Json:
    ...
    def _arrow1596(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1597(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Protocol_ROCrate_encoder(study_name, assay_name, oa.Name, oa_1)

    def _arrow1598(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Person_ROCrate_encodeAuthorListString(author_list)

    def _arrow1599(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1600(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessInput_ROCrate_encoder(value_6)

    def _arrow1601(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessOutput_ROCrate_encoder(value_7)

    def _arrow1602(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Process_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Process")))), try_include("name", _arrow1596, oa.Name), try_include("executesProtocol", _arrow1597, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ProcessParameterValue_ROCrate_encoder, oa.ParameterValues), try_include("performer", _arrow1598, oa.Performer), try_include("date", _arrow1599, oa.Date), try_include_list_opt("inputs", _arrow1600, oa.Inputs), try_include_list_opt("outputs", _arrow1601, oa.Outputs), try_include_list_opt("comments", _arrow1602, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1612(get: IGetters) -> Process:
    def _arrow1603(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1604(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow1605(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", Protocol_ROCrate_decoder)

    def _arrow1606(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow1607(__unit: None=None) -> str | None:
    ...
    def _arrow1609(__unit: None=None) -> FSharpList[ProcessInput] | None:
    ...
    def _arrow1610(__unit: None=None) -> FSharpList[ProcessOutput] | None:
    ...
    def _arrow1611(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ROCrate_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow1603(), _arrow1604(), _arrow1605(), _arrow1606(), _arrow1607(), _arrow1608(), None, None, _arrow1609(), _arrow1610(), _arrow1611())


Process_ROCrate_decoder: Decoder_1[Process] = object(_arrow1612)
...
def Process_ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> Json:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1614(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1615(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1616(oa_2: Protocol, oa_1: Any=oa_1) -> Json:
            return Protocol_ISAJson_encoder(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow1617(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> Json:
            return ProcessParameterValue_ISAJson_encoder(id_map, oa_3)

        def _arrow1618(value_4: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_4)

        def _arrow1619(value_6: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_6)

        def _arrow1620(oa_4: Process, oa_1: Any=oa_1) -> Json:
            return Process_ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow1621(oa_5: Process, oa_1: Any=oa_1) -> Json:
            return Process_ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow1622(value_8: ProcessInput, oa_1: Any=oa_1) -> Json:
            return ProcessInput_ISAJson_encoder(id_map, value_8)

        def _arrow1623(value_9: ProcessOutput, oa_1: Any=oa_1) -> Json:
            return ProcessOutput_ISAJson_encoder(id_map, value_9)

        def _arrow1624(comment: Comment, oa_1: Any=oa_1) -> Json:
            return Comment_ISAJson_encoder(id_map, comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1614, Process_ROCrate_genID(oa_1)), try_include("name", _arrow1615, oa_1.Name), try_include("executesProtocol", _arrow1616, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow1617, oa_1.ParameterValues), try_include("performer", _arrow1618, oa_1.Performer), try_include("date", _arrow1619, oa_1.Date), try_include("previousProcess", _arrow1620, oa_1.PreviousProcess), try_include("nextProcess", _arrow1621, oa_1.NextProcess), try_include_list_opt("inputs", _arrow1622, oa_1.Inputs), try_include_list_opt("outputs", _arrow1623, oa_1.Outputs), try_include_list_opt("comments", _arrow1624, oa_1.Comments)])))

    if id_map is not None:
        def _arrow1625(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return Process_ROCrate_genID(p)

        return encode(_arrow1625, f, oa, id_map)
...
def _arrow1638(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow1637(get: IGetters) -> Process:
            def _arrow1626(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow1627(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow1628(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", Protocol_ISAJson_decoder)

            def _arrow1629(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
            ...
            def _arrow1636(__unit: None=None) -> FSharpList[Comment] | None:
                arg_21: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ISAJson_decoder)
                object_arg_10: IOptionalGetter = get.Optional
                return object_arg_10.Field("comments", arg_21)

            return Process(_arrow1626(), _arrow1627(), _arrow1628(), _arrow1629(), _arrow1630(), _arrow1631(), _arrow1632(), _arrow1633(), _arrow1634(), _arrow1635(), _arrow1636())

        return object(_arrow1637)

    return decode(None)


Process_ISAJson_decoder: Decoder_1[Process] = _arrow1638()
...
def ARCtrl_Process_Process__Process_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Process], str]:
    ...
    def _arrow1639(f: Process, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Process__Process_toROCrateString_Static_39E0BC3F(study_name: str | None=None, assay_name: str | None=None, spaces: int | None=None) -> Callable[[Process], str]:
    def _arrow1640(f: Process, study_name: Any=study_name, assay_name: Any=assay_name, spaces: Any=spaces) -> str:
