...
def StudyInfo_ToSparseTable_1680536E(study: ArcStudy) -> SparseTable:
    ...
    class ObjectExpr893:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow892(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr893())), matrix.ColumnCount)
...
def to_rows(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    ...
    def _arrow906(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
        def _arrow905(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        ...
                                        def _arrow897(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow896(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                def _arrow895(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                    ...
                                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY CONTACTS"]))), delay(_arrow894))

                                                return append_1(to_rows_5("Study Protocol", protocols), delay(_arrow895))

                                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PROTOCOLS"]))), delay(_arrow896))

                                        return append_1(to_rows_4("Study Assay", assays_1), delay(_arrow897))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY ASSAYS"]))), delay(_arrow898))

                                return append_1(to_rows_3("Study Factor", factors), delay(_arrow899))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY FACTORS"]))), delay(_arrow900))

                        return append_1(to_rows_2("Study Publication", of_seq(study.Publications)), delay(_arrow901))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PUBLICATIONS"]))), delay(_arrow902))

                return append_1(to_rows_1("Study Design", of_seq(study.StudyDesignDescriptors)), delay(_arrow903))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY DESIGN DESCRIPTORS"]))), delay(_arrow904))

        return append_1(StudyInfo_toRows_1680536E(study), delay(_arrow905))

    return delay(_arrow906)
