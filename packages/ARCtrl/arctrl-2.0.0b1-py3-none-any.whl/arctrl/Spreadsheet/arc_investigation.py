...
InvestigationInfo_reflection = _expr1041
...
def InvestigationInfo_ToSparseTable_Z720BD3FF(investigation: ArcInvestigation) -> SparseTable:
    ...
    class ObjectExpr1043:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1042(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr1043())), matrix.ColumnCount)
    ...
    def loop(last_line_mut: str | None, ontology_source_references_mut: FSharpList[OntologySourceReference], investigation_info_mut: InvestigationInfo, publications_mut: FSharpList[Publication], contacts_mut: FSharpList[Person], studies_mut: FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]], remarks_mut: FSharpList[Remark], line_number_mut: int, rows: Any=rows) -> ArcInvestigation:
        while True:
            ...
            if pattern_matching_result == 0:
                ...
                pattern_input_5 = (reverse(tupled_arg[0]), List_distinctBy(projection, concat(tupled_arg[1]), ObjectExpr1045()))
...
def to_rows(investigation: ArcInvestigation) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    def _arrow1058(__unit: None=None, investigation: Any=investigation) -> FSharpList[IEnumerable_1[tuple[int, str]]]:
        ...
        def _arrow1056(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
            def _arrow1055(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                def _arrow1054(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                    def _arrow1053(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                        def _arrow1052(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                            def _arrow1051(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                def _arrow1050(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                    def _arrow1049(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        def _arrow1048(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow1047(study_identifier: str) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                study: ArcStudy = default_arg(investigation.TryGetStudy(study_identifier), ArcStudy(study_identifier))
                                                def _arrow1046(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                    return to_rows_4(study, None)

                                                return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY"]))), delay(_arrow1046))

                                            return collect(_arrow1047, investigation.RegisteredStudyIdentifiers)

                                        return append_1(to_rows_3("Investigation Person", of_seq(investigation.Contacts)), delay(_arrow1048))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION CONTACTS"]))), delay(_arrow1049))

                                return append_1(to_rows_2("Investigation Publication", of_seq(investigation.Publications)), delay(_arrow1050))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION PUBLICATIONS"]))), delay(_arrow1051))

                        return append_1(InvestigationInfo_toRows_Z720BD3FF(investigation), delay(_arrow1052))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION"]))), delay(_arrow1053))

                return append_1(to_rows_1(of_seq(investigation.OntologySourceReferences)), delay(_arrow1054))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["ONTOLOGY SOURCE REFERENCE"]))), delay(_arrow1055))

        rows: IEnumerable_1[IEnumerable_1[tuple[int, str]]] = delay(_arrow1056)
        try: 
            ...
            rm: Any = of_list(map(mapping, remarks), ObjectExpr1057())
...
def from_fs_workbook(doc: FsWorkbook) -> ArcInvestigation:
    try: 
        def _arrow1059(__unit: None=None) -> Array[FsRow]:
            sheet_2: FsWorksheet
        ...
        return from_rows(map_1(SparseRowModule_fromFsRow, _arrow1059()))
