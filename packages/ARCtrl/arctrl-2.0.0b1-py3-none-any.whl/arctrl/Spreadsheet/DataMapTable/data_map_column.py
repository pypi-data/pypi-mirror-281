...
def to_fs_columns(dc: Array[DataContext]) -> FSharpList[FSharpList[FsCell]]:
    ...
    class ObjectExpr997:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow996(x: str, y: str) -> bool:
                return x == y
    ...
    comment_keys: FSharpList[str] = to_list(distinct(collect(mapping_1, dc), ObjectExpr997()))
    ...
    def _arrow1012(__unit: None=None, dc: Any=dc) -> IEnumerable_1[FSharpList[FsCell]]:
        def _arrow1011(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow1010(dc_4: DataContext) -> FSharpList[FsCell]:
                dc_3: DataContext = dc_4
                def _arrow1009(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1000(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow1008(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1007(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1006(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow1005(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow1004(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        def _arrow1003(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow1003))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow1004))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow1005))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow1006))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow1007))

                    return append(_arrow1000(), delay(_arrow1008))

                return to_list(delay(_arrow1009))

            return map_1(_arrow1010, dc)

        return append(singleton_1(headers), delay(_arrow1011))

    return transpose(to_list(delay(_arrow1012)))
