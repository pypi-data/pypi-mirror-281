...
def compose_columns(columns: IEnumerable_1[FsColumn]) -> Array[DataContext]:
    ...
    def _arrow1032(__unit: None=None, columns: Any=columns) -> IEnumerable_1[DataContext]:
        def _arrow1031(i: int) -> DataContext:
            return DataContext__ctor_Z2FD70A12()

        return map(_arrow1031, range_big_int(0, 1, l - 1))

    dc: Array[DataContext] = list(to_array(delay(_arrow1032)))
