...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow359(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow360(__unit: None=None) -> str:
            category_2: str = category
            return (category_2 + ":") + "No Value"

        def _arrow361(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow359()) if (category is None) else (_arrow360() if (value is None) else _arrow361())
...
FactorValue_reflection = _expr362
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow363(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow363(), this.Value, this.Unit)
