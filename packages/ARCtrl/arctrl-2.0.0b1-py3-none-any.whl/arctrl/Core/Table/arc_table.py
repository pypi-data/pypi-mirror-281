...
class ArcTable:
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow497(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow497, index_arr)
        def _arrow498(index_1: int) -> None:
        ...
        iterate_1(_arrow498, sort_descending(index_arr, ObjectExpr500()))
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow503(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow502(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow502, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow503))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow505(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow507(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow508(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow509(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow511(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow513(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow514(table: ArcTable) -> CompositeColumn:
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow518(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow517(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow517, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow518)) if (cells is None) else value_3(cells)
    ...
    def add_row(cells: Array[CompositeCell] | None=None, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow519(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow531(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow530(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow530, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow531))
        def _arrow532(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow532, None)
