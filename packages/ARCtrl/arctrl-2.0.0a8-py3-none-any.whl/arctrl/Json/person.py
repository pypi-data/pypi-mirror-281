...
def Person_encoder(person: Person) -> Json:
    ...
    def _arrow1238(value: str, person: Any=person) -> Json:
        return Json(0, value)

    def _arrow1239(value_2: str, person: Any=person) -> Json:
        return Json(0, value_2)

    def _arrow1240(value_4: str, person: Any=person) -> Json:
        return Json(0, value_4)

    def _arrow1241(value_6: str, person: Any=person) -> Json:
        return Json(0, value_6)

    def _arrow1242(value_8: str, person: Any=person) -> Json:
        return Json(0, value_8)

    def _arrow1243(value_10: str, person: Any=person) -> Json:
        return Json(0, value_10)

    def _arrow1244(value_12: str, person: Any=person) -> Json:
        return Json(0, value_12)

    def _arrow1245(value_14: str, person: Any=person) -> Json:
        return Json(0, value_14)

    def _arrow1246(value_16: str, person: Any=person) -> Json:
        return Json(0, value_16)

    def _arrow1247(oa: OntologyAnnotation, person: Any=person) -> Json:
        return OntologyAnnotation_encoder(oa)

    def _arrow1248(comment: Comment, person: Any=person) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("firstName", _arrow1238, person.FirstName), try_include("lastName", _arrow1239, person.LastName), try_include("midInitials", _arrow1240, person.MidInitials), try_include("orcid", _arrow1241, person.ORCID), try_include("email", _arrow1242, person.EMail), try_include("phone", _arrow1243, person.Phone), try_include("fax", _arrow1244, person.Fax), try_include("address", _arrow1245, person.Address), try_include("affiliation", _arrow1246, person.Affiliation), try_include_seq("roles", _arrow1247, person.Roles), try_include_seq("comments", _arrow1248, person.Comments)])))


def _arrow1260(get: IGetters) -> Person:
    ...
    def _arrow1258(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person(_arrow1249(), _arrow1250(), _arrow1251(), _arrow1252(), _arrow1253(), _arrow1254(), _arrow1255(), _arrow1256(), _arrow1257(), _arrow1258(), _arrow1259())


Person_decoder: Decoder_1[Person] = object(_arrow1260)
...
def _arrow1261(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


Person_ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow1261)
...
def Person_ROCrate_encoder(oa: Person) -> Json:
    ...
    def _arrow1263(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1264(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1265(value_8: str, oa: Any=oa) -> Json:
        return Json(0, value_8)

    def _arrow1266(value_10: str, oa: Any=oa) -> Json:
        return Json(0, value_10)

    def _arrow1267(value_12: str, oa: Any=oa) -> Json:
        return Json(0, value_12)

    def _arrow1268(value_14: str, oa: Any=oa) -> Json:
        return Json(0, value_14)

    def _arrow1269(value_16: str, oa: Any=oa) -> Json:
        return Json(0, value_16)

    def _arrow1270(affiliation: str, oa: Any=oa) -> Json:
        return Person_ROCrate_Affiliation_encoder(affiliation)

    def _arrow1271(oa_1: OntologyAnnotation, oa: Any=oa) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1272(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoderDisambiguatingDescription(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Person_ROCrate_genID(oa))), ("@type", Json(0, "Person")), try_include("orcid", _arrow1262, oa.ORCID), try_include("firstName", _arrow1263, oa.FirstName), try_include("lastName", _arrow1264, oa.LastName), try_include("midInitials", _arrow1265, oa.MidInitials), try_include("email", _arrow1266, oa.EMail), try_include("phone", _arrow1267, oa.Phone), try_include("fax", _arrow1268, oa.Fax), try_include("address", _arrow1269, oa.Address), try_include("affiliation", _arrow1270, oa.Affiliation), try_include_seq("roles", _arrow1271, oa.Roles), try_include_seq("comments", _arrow1272, oa.Comments), ("@context", context_jsonvalue_1)])))


def _arrow1284(get: IGetters) -> Person:
    def _arrow1273(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("orcid", string)

    def _arrow1274(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("lastName", string)
    ...
    def _arrow1282(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = Decode_resizeArray(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow1283(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow1273(), _arrow1274(), _arrow1275(), _arrow1276(), _arrow1277(), _arrow1278(), _arrow1279(), _arrow1280(), _arrow1281(), _arrow1282(), _arrow1283())


Person_ROCrate_decoder: Decoder_1[Person] = object(_arrow1284)
...
def Person_ROCrate_encodeAuthorListString(author_list: str) -> Json:
    def encode_single(name: str, author_list: Any=author_list) -> Json:
        ...
        def _arrow1285(value_1: str, name: Any=name) -> Json:
            return Json(0, value_1)

        return Json(5, choose(chooser, of_array([("@type", Json(0, "Person")), try_include("name", _arrow1285, name), ("@context", context_minimal_json_value)])))
...
def _arrow1287(get: IGetters) -> str:
    def _arrow1286(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow1286(), "")


Person_ROCrate_decodeAuthorListString: Decoder_1[str] = map_1(ctor, array_2(object(_arrow1287)))
...
def Person_ISAJson_encoder(id_map: Any | None, person: Person) -> Json:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> Json:
        ...
        def _arrow1289(value: str, person_1: Any=person_1) -> Json:
            return Json(0, value)

        def _arrow1290(value_2: str, person_1: Any=person_1) -> Json:
            return Json(0, value_2)

        def _arrow1291(value_4: str, person_1: Any=person_1) -> Json:
            return Json(0, value_4)

        def _arrow1292(value_6: str, person_1: Any=person_1) -> Json:
            return Json(0, value_6)

        def _arrow1293(value_8: str, person_1: Any=person_1) -> Json:
            return Json(0, value_8)

        def _arrow1294(value_10: str, person_1: Any=person_1) -> Json:
            return Json(0, value_10)

        def _arrow1295(value_12: str, person_1: Any=person_1) -> Json:
            return Json(0, value_12)

        def _arrow1296(value_14: str, person_1: Any=person_1) -> Json:
            return Json(0, value_14)

        def _arrow1297(value_16: str, person_1: Any=person_1) -> Json:
            return Json(0, value_16)

        def _arrow1298(oa: OntologyAnnotation, person_1: Any=person_1) -> Json:
            return OntologyAnnotation_encoder(oa)

        def _arrow1299(comment: Comment, person_1: Any=person_1) -> Json:
            return Comment_encoder(comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1289, Person_ROCrate_genID(person_2)), try_include("firstName", _arrow1290, person_2.FirstName), try_include("lastName", _arrow1291, person_2.LastName), try_include("midInitials", _arrow1292, person_2.MidInitials), try_include("email", _arrow1293, person_2.EMail), try_include("phone", _arrow1294, person_2.Phone), try_include("fax", _arrow1295, person_2.Fax), try_include("address", _arrow1296, person_2.Address), try_include("affiliation", _arrow1297, person_2.Affiliation), try_include_seq("roles", _arrow1298, person_2.Roles), try_include_seq("comments", _arrow1299, person_2.Comments)])))

    if id_map is not None:
        def _arrow1300(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return Person_ROCrate_genID(p_1)

        return encode(_arrow1300, f, person, id_map)
...
def _arrow1311(get: IGetters) -> Person:
    def _arrow1301(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("lastName", string)

    def _arrow1302(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("firstName", string)

    def _arrow1303(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1305(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("phone", string)

    def _arrow1306(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow1309(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow1310(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Person_setOrcidFromComments(Person(None, _arrow1301(), _arrow1302(), _arrow1303(), _arrow1304(), _arrow1305(), _arrow1306(), _arrow1307(), _arrow1308(), _arrow1309(), _arrow1310()))


Person_ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(Person_ISAJson_allowedFields, _arrow1311)
...
def ARCtrl_Person__Person_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Person], str]:
    def _arrow1312(obj: Person, spaces: Any=spaces) -> str:
...
def ARCtrl_Person__Person_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Person], str]:
    def _arrow1313(obj: Person, spaces: Any=spaces) -> str:
...
def ARCtrl_Person__Person_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Person], str]:
    ...
    def _arrow1314(obj: Person, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
