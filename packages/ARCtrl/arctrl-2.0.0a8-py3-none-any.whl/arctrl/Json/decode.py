...
class ObjectExpr1088(Decoder_1[str]):
...
Decode_uri: Decoder_1[str] = ObjectExpr1088()
...
def Decode_objectNoAdditionalProperties(allowed_properties: IEnumerable_1[str], builder: Callable[[IGetters], _VALUE]) -> Decoder_1[_VALUE]:
    ...
    allowed_properties_1: Any = of_seq(allowed_properties, ObjectExpr1089())
    class ObjectExpr1090(Decoder_1[_VALUE_]):
...
def Decode_noAdditionalProperties(allowed_properties: IEnumerable_1[str], decoder: Decoder_1[_VALUE]) -> Decoder_1[_VALUE]:
    ...
    allowed_properties_1: Any = of_seq(allowed_properties, ObjectExpr1091())
    class ObjectExpr1092(Decoder_1[_VALUE_]):
                ...
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_1: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow1093(__unit: None=None, acc: Any=acc, value_1: Any=value_1) -> tuple[str, ErrorReason_1[__A_]]:
                            ...
                            return FSharpResult_2(1, _arrow1093())
