...
class ObjectExpr1355(Decoder_1[MaterialType]):
...
MaterialType_ROCrate_decoder: Decoder_1[MaterialType] = ObjectExpr1355()
...
def ARCtrl_Process_MaterialType__MaterialType_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[MaterialType], str]:
    def _arrow1356(f: MaterialType, spaces: Any=spaces) -> str:
