...
def MaterialAttributeValue_ISAJson_encoder(id_map: Any | None, oa: MaterialAttributeValue) -> Json:
    def f(oa_1: MaterialAttributeValue, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1372(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1373(value_2: MaterialAttribute, oa_1: Any=oa_1) -> Json:
            return MaterialAttribute_ISAJson_encoder(id_map, value_2)

        def _arrow1374(value_3: Value_1, oa_1: Any=oa_1) -> Json:
            return Value_ISAJson_encoder(id_map, value_3)

        def _arrow1375(oa_3: OntologyAnnotation, oa_1: Any=oa_1) -> Json:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1372, MaterialAttributeValue_ISAJson_genID(oa_1)), try_include("category", _arrow1373, oa_1.Category), try_include("value", _arrow1374, oa_1.Value), try_include("unit", _arrow1375, oa_1.Unit)])))

    if id_map is not None:
        def _arrow1376(oa_4: MaterialAttributeValue, id_map: Any=id_map, oa: Any=oa) -> str:
            return MaterialAttributeValue_ISAJson_genID(oa_4)

        return encode(_arrow1376, f, oa, id_map)
...
def _arrow1381(get: IGetters) -> MaterialAttributeValue:
    def _arrow1377(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1378(__unit: None=None) -> MaterialAttribute | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("category", MaterialAttribute_ISAJson_decoder)

    def _arrow1379(__unit: None=None) -> Value_1 | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("value", Value_ISAJson_decoder)

    def _arrow1380(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("unit", OntologyAnnotation_ISAJson_decoder)

    return MaterialAttributeValue(_arrow1377(), _arrow1378(), _arrow1379(), _arrow1380())


MaterialAttributeValue_ISAJson_decoder: Decoder_1[MaterialAttributeValue] = object(_arrow1381)
...
def ARCtrl_Process_MaterialAttributeValue__MaterialAttributeValue_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[MaterialAttributeValue], str]:
    ...
    def _arrow1382(f: MaterialAttributeValue, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_MaterialAttributeValue__MaterialAttributeValue_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[MaterialAttributeValue], str]:
    def _arrow1383(f: MaterialAttributeValue, spaces: Any=spaces) -> str:
