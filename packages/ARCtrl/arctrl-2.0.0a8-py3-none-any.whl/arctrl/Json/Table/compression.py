...
def encode(encoder: Callable[[Any, Any, Any, _A], Json], obj: _A) -> Json:
    ...
    oa_table: Any = Dictionary([], ObjectExpr1650())
    class ObjectExpr1651:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr1651())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow1653(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow1652(__unit: None=None) -> Array[CompositeCell]:
