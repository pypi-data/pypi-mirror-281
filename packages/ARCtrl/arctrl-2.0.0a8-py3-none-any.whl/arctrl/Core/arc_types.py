...
class ArcStudy(ArcTables):
    ...
    def register_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow651(study: ArcStudy) -> ArcStudy:
            copy: ArcStudy = study.Copy()
    ...
    def DeregisterAssay(self, assay_identifier: str) -> None:
        ...
        ignore(remove_in_place(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr653()))

    @staticmethod
    def deregister_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow654(study: ArcStudy) -> ArcStudy:
            copy: ArcStudy = study.Copy()
    ...
    def GetRegisteredAssay(self, assay_identifier: str) -> ArcAssay:
        ...
        if not contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr657()):
    ...
    def get_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcAssay]:
        def _arrow658(study: ArcStudy) -> ArcAssay:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow659(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays_or_identifier(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow662(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcStudy], tuple[ArcStudy, ArcTable]]:
        def _arrow670(study: ArcStudy) -> tuple[ArcStudy, ArcTable]:
            c: ArcStudy = study.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table_at(index: int) -> Callable[[ArcStudy], ArcTable]:
        def _arrow672(study: ArcStudy) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcStudy], ArcTable]:
        def _arrow673(study: ArcStudy) -> ArcTable:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetTable(name)
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow690(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumnAt(table_index, column_index)
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow691(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumn(table_name, column_index)
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow698(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRowAt(table_index, row_index)
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow699(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRow(table_name, row_index)
    ...
    def StructurallyEquals(self, other: ArcStudy) -> bool:
        ...
        def _arrow702(__unit: None=None) -> bool:
            ...
            def _arrow701(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow700(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow700, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow701))) if (length(a) == length(b)) else False
        ...
        def _arrow705(__unit: None=None) -> bool:
            ...
            def _arrow704(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow703(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow703, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow704))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow708(__unit: None=None) -> bool:
            ...
            def _arrow707(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow706(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow706, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow707))) if (length(a_2) == length(b_2)) else False

        def _arrow711(__unit: None=None) -> bool:
            ...
            def _arrow710(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow709(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow709, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow710))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow714(__unit: None=None) -> bool:
            ...
            def _arrow713(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow712(i_5: int) -> bool:
                    return item(i_5, a_4) == item(i_5, b_4)

                return map_1(_arrow712, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow713))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow717(__unit: None=None) -> bool:
            ...
            def _arrow716(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow715(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow715, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow716))) if (length(a_5) == length(b_5)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), equals(this.DataMap, other.DataMap), _arrow702(), _arrow705(), _arrow708(), _arrow711(), _arrow714(), _arrow717()]))
...
class ArcInvestigation:
    ...
    def UnregisteredAssays(self, __unit: None=None) -> Array[ArcAssay]:
        ...
        def f(a: ArcAssay) -> bool:
            def predicate(s: ArcStudy, a: Any=a) -> bool:
                def _arrow738(i: str, s: Any=s) -> bool:
                    return i == a.Identifier

                return exists(_arrow738, s.RegisteredAssayIdentifiers)
    ...
    def init_assay(assay_identifier: str, register_in: Array[ArcStudy] | None=None) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow741(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def remove_assay_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow746(inv: ArcInvestigation) -> ArcInvestigation:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def remove_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow747(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def rename_assay(old_identifier: str, new_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow748(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def set_assay_at(index: int, assay: ArcAssay) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow749(inv: ArcInvestigation) -> ArcInvestigation:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def GetAssayIndex(self, assay_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow751(a: ArcAssay) -> bool:
            return a.Identifier == assay_identifier

        index: int = find_index(_arrow751, this.Assays) or 0
        if index == -1:
    ...
    def get_assay_index(assay_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow752(inv: ArcInvestigation) -> int:
    ...
    def get_assay_at(index: int) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow753(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow754(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def TryGetAssay(self, assay_identifier: str) -> ArcAssay | None:
        this: ArcInvestigation = self
        def _arrow755(a: ArcAssay) -> bool:
            return a.Identifier == assay_identifier

        return try_find(_arrow755, this.Assays)

    @staticmethod
    def try_get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay | None]:
        def _arrow756(inv: ArcInvestigation) -> ArcAssay | None:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def contains_assay(assay_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow757(inv: ArcInvestigation) -> bool:
    ...
    def UnregisteredStudies(self, __unit: None=None) -> Array[ArcStudy]:
        ...
        def f(s: ArcStudy) -> bool:
            def _arrow760(__unit: None=None, s: Any=s) -> bool:
                source: Array[str] = this.RegisteredStudyIdentifiers
                def _arrow759(__unit: None=None) -> Callable[[str], bool]:
                    x: str = s.Identifier
                    def _arrow758(y: str) -> bool:
                        return x == y

                    return _arrow758

                return exists(_arrow759(), source)

            return not _arrow760()
    ...
    def init_study(study_identifier: str) -> Callable[[ArcInvestigation], tuple[ArcInvestigation, ArcStudy]]:
        def _arrow762(inv: ArcInvestigation) -> tuple[ArcInvestigation, ArcStudy]:
            copy: ArcInvestigation = inv.Copy()
    ...
    def RegisterStudy(self, study_identifier: str) -> None:
        ...
        class ObjectExpr764:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow763(x_1: str, y: str) -> bool:
                    return x_1 == y
        ...
        if contains(study_ident_1, this.RegisteredStudyIdentifiers, ObjectExpr764()):
    ...
    def add_registered_study(study: ArcStudy) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow767(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def delete_study_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow768(i: ArcInvestigation) -> ArcInvestigation:
    ...
    def remove_study_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow771(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def GetStudyIndex(self, study_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow776(s: ArcStudy) -> bool:
            return s.Identifier == study_identifier

        index: int = find_index(_arrow776, this.Studies) or 0
        if index == -1:
    ...
    def get_study_index(study_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow777(inv: ArcInvestigation) -> int:
    ...
    def get_study_at(index: int) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow778(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow779(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def try_get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy | None]:
        def _arrow780(inv: ArcInvestigation) -> ArcStudy | None:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def contains_study(study_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow781(inv: ArcInvestigation) -> bool:
    ...
    def deregister_assay_at(study_index: int, assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow784(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def deregister_assay(study_identifier: str, assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow785(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def DeregisterStudy(self, study_identifier: str) -> None:
        ...
        ignore(remove_in_place(study_identifier, this.RegisteredStudyIdentifiers, ObjectExpr788()))

    @staticmethod
    def deregister_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow790(i: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = i.Copy()
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr793())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr797())
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr801:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow800(x: str, y: str) -> bool:
                                    return x == y
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr801()):
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow809(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow806(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow808(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow807(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                return collect(_arrow807, this.Assays)

            return append_3(collect(_arrow806, this.Studies), delay(_arrow808))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow809))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow814(__unit: None=None) -> bool:
            ...
            def _arrow813(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow812(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow812, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow813))) if (length(a) == length(b)) else False

        def _arrow817(__unit: None=None) -> bool:
            a_1: IEnumerable_1[Person] = this.Contacts
            b_1: IEnumerable_1[Person] = other.Contacts
            def folder_1(acc_1: bool, e_1: bool) -> bool:
                if acc_1:
            ...
            def _arrow816(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow815(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow815, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow816))) if (length(a_1) == length(b_1)) else False

        def _arrow822(__unit: None=None) -> bool:
            ...
            def _arrow821(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow820(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow820, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow821))) if (length(a_2) == length(b_2)) else False

        def _arrow825(__unit: None=None) -> bool:
            ...
            def _arrow824(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow823(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow823, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow824))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow828(__unit: None=None) -> bool:
            ...
            def _arrow827(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow826(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow826, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow827))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow831(__unit: None=None) -> bool:
            ...
            def _arrow830(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow829(i_6: int) -> bool:
                    return item(i_6, a_5) == item(i_6, b_5)

                return map_1(_arrow829, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow830))) if (length(a_5) == length(b_5)) else False
        ...
        def _arrow834(__unit: None=None) -> bool:
            ...
            def _arrow833(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow832(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow832, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow833))) if (length(a_6) == length(b_6)) else False

        def _arrow839(__unit: None=None) -> bool:
            ...
            def _arrow838(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow836(i_8: int) -> bool:
                    return equals(item(i_8, a_7), item(i_8, b_7))

                return map_1(_arrow836, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow838))) if (length(a_7) == length(b_7)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow814(), _arrow817(), _arrow822(), _arrow825(), _arrow828(), _arrow831(), _arrow834(), _arrow839()]))
...
ArcInvestigation_reflection = _expr846
