...
def Process_getInputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr388())
...
def Process_getOutputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr389())
...
def Process_getCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    return List_distinct(append(Process_getInputCharacteristicValues_763471FF(p), Process_getOutputCharacteristicValues_763471FF(p)), ObjectExpr390())
...
def Process_getCharacteristics_763471FF(p: Process) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(choose(chooser, Process_getCharacteristicValues_763471FF(p)), ObjectExpr391())
...
def Process_getFactorValues_763471FF(p: Process) -> FSharpList[FactorValue]:
    ...
    return List_distinct(collect(mapping, default_arg(p.Outputs, empty())), ObjectExpr392())
...
def Process_getFactors_763471FF(p: Process) -> FSharpList[Factor]:
    ...
    return List_distinct(choose(chooser, Process_getFactorValues_763471FF(p)), ObjectExpr393())
...
def Process_getSources_763471FF(p: Process) -> FSharpList[Source]:
    ...
    return List_distinct(choose(chooser, default_arg(p.Inputs, empty())), ObjectExpr394())
...
def Process_getData_763471FF(p: Process) -> FSharpList[Data]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr395())
...
def Process_getSamples_763471FF(p: Process) -> FSharpList[Sample]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr396())
...
def Process_getMaterials_763471FF(p: Process) -> FSharpList[Material]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr397())
