...
MaterialAttributeValue_reflection = _expr370
...
def MaterialAttributeValue__SetCategory_ZDED3A0F(this: MaterialAttributeValue, c: OntologyAnnotation) -> MaterialAttributeValue:
    def _arrow371(__unit: None=None, this: Any=this, c: Any=c) -> MaterialAttribute | None:
    ...
    return MaterialAttributeValue(this.ID, _arrow371(), this.Value, this.Unit)
