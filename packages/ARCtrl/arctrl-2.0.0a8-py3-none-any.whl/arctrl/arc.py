...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2057(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2056:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2055(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr2056())
        ...
        def _arrow2060(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2059(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2058(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract_6FCE9E49(isa)), delay(_arrow2058))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow2059))

        return list(to_list(delay(_arrow2060)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2063(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2062:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2061(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr2062())
        ...
        def _arrow2065(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2064(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow2064))

        return list(to_list(delay(_arrow2065)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2068(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2067:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2066(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr2067())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow2070(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2069(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow2069))

        return list(to_list(delay(_arrow2070)))
                        ...
                        def _arrow2076(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow2075(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                ...
                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow2073))

                            elif pattern_matching_result == 1:
                                def _arrow2074(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow2074))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow2076))

                    def _arrow2083(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow2082(a: ArcAssay) -> IEnumerable_1[Contract]:
                            ...
                            def _arrow2081(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow2080(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    ...
                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow2078))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow2079(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow2079))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow2081))

                        return collect(_arrow2082, inv_2.Assays)

                    return append(collect(_arrow2077, inv_2.Studies), delay(_arrow2083))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract_6FCE9E49(inv_2, is_light_1)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow2084))

            return to_array(delay(_arrow2085))

        return (_arrow2072() if _arrow2071() else _arrow2086()) if (match_value is not None) else this.GetWriteContracts(is_light_1)
        ...
        def _arrow2090(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2089(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2088(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow2087))

                return append(singleton(gitattributes_contract), delay(_arrow2088))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow2089))

        return to_array(delay(_arrow2090))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow2098(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow2097(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2096(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2095(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2094(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow2093(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2092(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow2092))

                                return append(singleton(text_value), delay(_arrow2093))

                            return collect(_arrow2094, table.Values)

                        return collect(_arrow2095, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow2096))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow2097))
            ...
            return of_seq(to_list(delay(_arrow2098)), ObjectExpr2099())

        class ObjectExpr2100:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow2107(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow2106(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2105(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2104(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2103(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow2102(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2101(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow2101))

                                return append(singleton(text_value_1), delay(_arrow2102))

                            return collect(_arrow2103, table_1.Values)

                        return collect(_arrow2104, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow2105))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow2106))
            ...
            return of_seq(to_list(delay(_arrow2107)), ObjectExpr2108())

        class ObjectExpr2109:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr2110:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr2091()), union_many(map(mapping_3, registered_studies, None), ObjectExpr2100()), union_many(map(mapping_4, registered_assays, None), ObjectExpr2109())]), ObjectExpr2110())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2111(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2111)(tree_1)

            else: 
                return tree_1


        def _arrow2113(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow2112(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2112)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2113()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr2114:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr2114())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2115(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2115)(tree_1)

            else: 
                return tree_1


        def _arrow2117(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow2116(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2116)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2117()), FileSystemTree.from_file_paths([]))
    ...
    def DefaultContracts() -> Any:
        ...
        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr2118())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow2119(__unit: None=None) -> ArcInvestigation | None:
