...
def to_rows(is_light: bool, investigation: ArcInvestigation) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    def _arrow1047(__unit: None=None, is_light: Any=is_light, investigation: Any=investigation) -> FSharpList[IEnumerable_1[tuple[int, str]]]:
        remarks: FSharpList[Remark] = of_seq(investigation.Remarks)
        def _arrow1045(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                ...
                                def _arrow1039(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                    def _arrow1038(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        def _arrow1037(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow1036(study_identifier: str) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                ...
                                                return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY"]))), delay(_arrow1035))

                                            return collect(_arrow1036, investigation.RegisteredStudyIdentifiers) if (not is_light) else empty_1()

                                        return append_1(to_rows_3("Investigation Person", of_seq(investigation.Contacts)), delay(_arrow1037))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION CONTACTS"]))), delay(_arrow1038))

                                return append_1(to_rows_2("Investigation Publication", of_seq(investigation.Publications)), delay(_arrow1039))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION PUBLICATIONS"]))), delay(_arrow1040))

                        return append_1(InvestigationInfo_toRows_Z720BD3FF(investigation), delay(_arrow1041))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION"]))), delay(_arrow1042))

                return append_1(to_rows_1(of_seq(investigation.OntologySourceReferences)), delay(_arrow1043))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["ONTOLOGY SOURCE REFERENCE"]))), delay(_arrow1044))

        rows: IEnumerable_1[IEnumerable_1[tuple[int, str]]] = delay(_arrow1045)
        try: 
            ...
            rm: Any = of_list(map(mapping, remarks), ObjectExpr1046())
...
def from_fs_workbook(doc: FsWorkbook) -> ArcInvestigation:
    try: 
        def _arrow1048(__unit: None=None) -> Array[FsRow]:
            sheet_2: FsWorksheet
        ...
        return from_rows(map_1(SparseRowModule_fromFsRow, _arrow1048()))
