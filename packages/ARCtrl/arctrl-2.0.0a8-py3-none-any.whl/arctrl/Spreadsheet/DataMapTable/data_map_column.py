...
def to_fs_columns(dc: Array[DataContext]) -> FSharpList[FSharpList[FsCell]]:
    ...
    class ObjectExpr985:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow984(x: str, y: str) -> bool:
                return x == y
    ...
    comment_keys: FSharpList[str] = to_list(distinct(collect(mapping_1, dc), ObjectExpr985()))
    ...
    def _arrow996(__unit: None=None, dc: Any=dc) -> IEnumerable_1[FSharpList[FsCell]]:
        def _arrow995(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow994(dc_4: DataContext) -> FSharpList[FsCell]:
                dc_3: DataContext = dc_4
                def _arrow993(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow986(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow992(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow991(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow990(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow989(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow988(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        def _arrow987(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow987))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow988))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow989))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow990))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow991))

                    return append(_arrow986(), delay(_arrow992))

                return to_list(delay(_arrow993))

            return map_1(_arrow994, dc)

        return append(singleton_1(headers), delay(_arrow995))

    return transpose(to_list(delay(_arrow996)))
