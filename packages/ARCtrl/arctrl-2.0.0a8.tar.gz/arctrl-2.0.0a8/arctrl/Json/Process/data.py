...
def Data_encoder(d: Data) -> Json:
    ...
    def _arrow1462(value: str, d: Any=d) -> Json:
        return Json(0, value)

    def _arrow1463(value_2: str, d: Any=d) -> Json:
        return Json(0, value_2)

    def _arrow1465(value_4: str, d: Any=d) -> Json:
        return Json(0, value_4)

    def _arrow1466(value_6: str, d: Any=d) -> Json:
        return Json(0, value_6)

    def _arrow1468(comment: Comment, d: Any=d) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1462, d.ID), try_include("name", _arrow1463, d.Name), try_include("dataType", DataFile_ISAJson_encoder, d.DataType), try_include("format", _arrow1465, d.Format), try_include("selectorFormat", _arrow1466, d.SelectorFormat), try_include_seq("comments", _arrow1468, d.Comments)])))


def _arrow1480(get: IGetters) -> Data:
    ...
    def _arrow1475(__unit: None=None) -> DataFile | None:
    ...
    def _arrow1479(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1472(), _arrow1474(), _arrow1475(), _arrow1476(), _arrow1477(), _arrow1479())


Data_decoder: Decoder_1[Data] = object(_arrow1480)
...
def Data_compressedEncoder(string_table: Any, d: Data) -> Json:
    ...
    def _arrow1482(s: str, string_table: Any=string_table, d: Any=d) -> Json:
        return encode_string(string_table, s)

    def _arrow1484(s_1: str, string_table: Any=string_table, d: Any=d) -> Json:
        return encode_string(string_table, s_1)

    def _arrow1485(s_2: str, string_table: Any=string_table, d: Any=d) -> Json:
        return encode_string(string_table, s_2)

    def _arrow1486(s_3: str, string_table: Any=string_table, d: Any=d) -> Json:
        return encode_string(string_table, s_3)

    def _arrow1487(comment: Comment, string_table: Any=string_table, d: Any=d) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("i", _arrow1482, d.ID), try_include("n", _arrow1484, d.Name), try_include("d", DataFile_ISAJson_encoder, d.DataType), try_include("f", _arrow1485, d.Format), try_include("s", _arrow1486, d.SelectorFormat), try_include_seq("c", _arrow1487, d.Comments)])))


def Data_compressedDecoder(string_table: Array[str]) -> Decoder_1[Data]:
    def _arrow1494(get: IGetters, string_table: Any=string_table) -> Data:
        ...
        def _arrow1490(__unit: None=None) -> DataFile | None:
            object_arg_2: IOptionalGetter = get.Optional
        ...
        def _arrow1492(__unit: None=None) -> str | None:
            arg_9: Decoder_1[str] = decode_string(string_table)
            object_arg_4: IOptionalGetter = get.Optional
            return object_arg_4.Field("s", arg_9)

        def _arrow1493(__unit: None=None) -> Array[Comment] | None:
            arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("c", arg_11)

        return Data(_arrow1488(), _arrow1489(), _arrow1490(), _arrow1491(), _arrow1492(), _arrow1493())

    return object(_arrow1494)
...
def Data_ROCrate_encoder(oa: Data) -> Json:
    ...
    def _arrow1495(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1496(value_4: DataFile, oa: Any=oa) -> Json:
        return DataFile_ROCrate_encoder(value_4)

    def _arrow1497(value_5: str, oa: Any=oa) -> Json:
        return Json(0, value_5)

    def _arrow1498(value_7: str, oa: Any=oa) -> Json:
        return Json(0, value_7)

    def _arrow1499(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Data_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Data")))), try_include("name", _arrow1495, oa.Name), try_include("type", _arrow1496, oa.DataType), try_include("encodingFormat", _arrow1497, oa.Format), try_include("usageInfo", _arrow1498, oa.SelectorFormat), try_include_seq("comments", _arrow1499, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1506(get: IGetters) -> Data:
    ...
    def _arrow1502(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1505(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ROCrate_decoder)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1500(), _arrow1501(), _arrow1502(), _arrow1503(), _arrow1504(), _arrow1505())


Data_ROCrate_decoder: Decoder_1[Data] = object(_arrow1506)
...
def Data_ISAJson_encoder(id_map: Any | None, oa: Data) -> Json:
    def f(oa_1: Data, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1508(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1509(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1510(comment: Comment, oa_1: Any=oa_1) -> Json:
            return Comment_ISAJson_encoder(id_map, comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1508, Data_ROCrate_genID(oa_1)), try_include("name", _arrow1509, oa_1.Name), try_include("type", DataFile_ISAJson_encoder, oa_1.DataType), try_include_seq("comments", _arrow1510, oa_1.Comments)])))

    if id_map is not None:
        def _arrow1511(d_1: Data, id_map: Any=id_map, oa: Any=oa) -> str:
            return Data_ROCrate_genID(d_1)

        return encode(_arrow1511, f, oa, id_map)
...
def _arrow1516(get: IGetters) -> Data:
    ...
    def _arrow1515(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ISAJson_decoder)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return Data(_arrow1512(), _arrow1513(), _arrow1514(), None, None, _arrow1515())


Data_ISAJson_decoder: Decoder_1[Data] = Decode_objectNoAdditionalProperties(Data_ISAJson_allowedFields, _arrow1516)
...
def ARCtrl_Data__Data_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Data], str]:
    ...
    def _arrow1517(f: Data, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Data__Data_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Data], str]:
    def _arrow1518(f: Data, spaces: Any=spaces) -> str:
