...
def Process_ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> Json:
    ...
    def _arrow1577(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1578(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Protocol_ROCrate_encoder(study_name, assay_name, oa.Name, oa_1)

    def _arrow1579(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Person_ROCrate_encodeAuthorListString(author_list)

    def _arrow1580(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1581(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessInput_ROCrate_encoder(value_6)

    def _arrow1582(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessOutput_ROCrate_encoder(value_7)

    def _arrow1584(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Process_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Process")))), try_include("name", _arrow1577, oa.Name), try_include("executesProtocol", _arrow1578, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ProcessParameterValue_ROCrate_encoder, oa.ParameterValues), try_include("performer", _arrow1579, oa.Performer), try_include("date", _arrow1580, oa.Date), try_include_list_opt("inputs", _arrow1581, oa.Inputs), try_include_list_opt("outputs", _arrow1582, oa.Outputs), try_include_list_opt("comments", _arrow1584, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1597(get: IGetters) -> Process:
    ...
    def _arrow1590(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", Protocol_ROCrate_decoder)

    def _arrow1591(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow1594(__unit: None=None) -> FSharpList[ProcessInput] | None:
    ...
    def _arrow1595(__unit: None=None) -> FSharpList[ProcessOutput] | None:
    ...
    def _arrow1596(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ROCrate_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow1588(), _arrow1589(), _arrow1590(), _arrow1591(), _arrow1592(), _arrow1593(), None, None, _arrow1594(), _arrow1595(), _arrow1596())


Process_ROCrate_decoder: Decoder_1[Process] = object(_arrow1597)
...
def Process_ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> Json:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1599(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1600(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1602(oa_2: Protocol, oa_1: Any=oa_1) -> Json:
            return Protocol_ISAJson_encoder(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow1604(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> Json:
            return ProcessParameterValue_ISAJson_encoder(id_map, oa_3)

        def _arrow1606(value_4: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_4)

        def _arrow1607(value_6: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_6)

        def _arrow1608(oa_4: Process, oa_1: Any=oa_1) -> Json:
            return Process_ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow1609(oa_5: Process, oa_1: Any=oa_1) -> Json:
            return Process_ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow1610(value_8: ProcessInput, oa_1: Any=oa_1) -> Json:
            return ProcessInput_ISAJson_encoder(id_map, value_8)

        def _arrow1611(value_9: ProcessOutput, oa_1: Any=oa_1) -> Json:
            return ProcessOutput_ISAJson_encoder(id_map, value_9)

        def _arrow1612(comment: Comment, oa_1: Any=oa_1) -> Json:
            return Comment_ISAJson_encoder(id_map, comment)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1599, Process_ROCrate_genID(oa_1)), try_include("name", _arrow1600, oa_1.Name), try_include("executesProtocol", _arrow1602, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow1604, oa_1.ParameterValues), try_include("performer", _arrow1606, oa_1.Performer), try_include("date", _arrow1607, oa_1.Date), try_include("previousProcess", _arrow1608, oa_1.PreviousProcess), try_include("nextProcess", _arrow1609, oa_1.NextProcess), try_include_list_opt("inputs", _arrow1610, oa_1.Inputs), try_include_list_opt("outputs", _arrow1611, oa_1.Outputs), try_include_list_opt("comments", _arrow1612, oa_1.Comments)])))

    if id_map is not None:
        def _arrow1613(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return Process_ROCrate_genID(p)

        return encode(_arrow1613, f, oa, id_map)
...
def _arrow1626(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow1625(get: IGetters) -> Process:
            ...
            def _arrow1616(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", Protocol_ISAJson_decoder)

            def _arrow1617(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
            ...
            def _arrow1624(__unit: None=None) -> FSharpList[Comment] | None:
                arg_21: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ISAJson_decoder)
                object_arg_10: IOptionalGetter = get.Optional
                return object_arg_10.Field("comments", arg_21)

            return Process(_arrow1614(), _arrow1615(), _arrow1616(), _arrow1617(), _arrow1618(), _arrow1619(), _arrow1620(), _arrow1621(), _arrow1622(), _arrow1623(), _arrow1624())

        return object(_arrow1625)

    return decode(None)


Process_ISAJson_decoder: Decoder_1[Process] = _arrow1626()
...
def ARCtrl_Process_Process__Process_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Process], str]:
    ...
    def _arrow1627(f: Process, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Process__Process_toROCrateString_Static_39E0BC3F(study_name: str | None=None, assay_name: str | None=None, spaces: int | None=None) -> Callable[[Process], str]:
    def _arrow1628(f: Process, study_name: Any=study_name, assay_name: Any=assay_name, spaces: Any=spaces) -> str:
