...
class ArcTable:
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr472()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow473(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow475(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow474(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow474, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow475))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr476()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow477(table: ArcTable) -> CompositeCell | None:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow479(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow485(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow488(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow488, index_arr)
        def _arrow489(index_1: int) -> None:
        ...
        iterate_1(_arrow489, sort_descending(index_arr, ObjectExpr490()))

    @staticmethod
    def remove_columns(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow491(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow493(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow492(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow492, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow493))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow494(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow495(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow496(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow497(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow498(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow499(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow500(table: ArcTable) -> CompositeColumn:
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow503(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow502(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow502, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow503)) if (cells is None) else value_3(cells)
    ...
    def add_row(cells: Array[CompositeCell] | None=None, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow504(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_row(row_index: int, cells: Array[CompositeCell]) -> Callable[[ArcTable], ArcTable]:
        def _arrow505(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow512(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow519(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow518(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow518, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow519))
        def _arrow520(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow520, None)
        this.AddRows(rows, index)

    @staticmethod
    def add_rows_empty(row_count: int, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow521(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow523(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_1(_arrow523, index_arr)
        def _arrow524(index_1: int) -> None:
        ...
        iterate_1(_arrow524, sort_descending(index_arr, ObjectExpr525()))
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow528(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow527(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow527, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow528))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow529(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow532(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow538(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr537()), None), None)

        return _arrow538

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow540(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow541(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow549(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow548(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow547(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow546(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow546, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow547))

                return map(_arrow548, range_big_int(0, 1, t.RowCount - 1))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow558(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow557(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow556(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow555(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow550(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow553(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow552(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow551(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow551, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow552))

                        def _arrow554(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow550, range_big_int(0, 1, 19)), delay(_arrow553)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow554, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow555))

                return append_1(singleton("-------------"), delay(_arrow556))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow557))

        return join("\n", to_list(delay(_arrow558)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr560())
