...
class IOType(Union):
    ...
    def as_input(self, __unit: None=None) -> str:
        ...
        def string_create(x: Any | None=None) -> str:
            def _arrow430(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Input [" + _arrow430()) + "]"
    ...
    def as_output(self, __unit: None=None) -> str:
        this: IOType = self
        def string_create(x: Any | None=None) -> str:
            def _arrow431(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Output [" + _arrow431()) + "]"
...
CompositeHeader_reflection = _expr433
