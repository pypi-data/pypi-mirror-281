...
def TemplatesAux_getComparer(match_all: bool | None=None) -> Callable[[bool, bool], bool]:
    if default_arg(match_all, False):
        def _arrow594(e: bool, match_all: Any=match_all) -> Callable[[bool], bool]:
            def _arrow593(e_1: bool) -> bool:
                return e and e_1
        ...
        def _arrow596(e_2: bool, match_all: Any=match_all) -> Callable[[bool], bool]:
            def _arrow595(e_3: bool) -> bool:
                return e_2 or e_3
    ...
    def f(t: Template, tag_getter: Any=tag_getter, query_tags: Any=query_tags, comparer: Any=comparer, templates: Any=templates) -> bool:
        ...
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                contains: bool = contains_1(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), template_tags, ObjectExpr597())
...
class Templates:
    ...
    def get_distinct_ontology_annotations(templates: Array[Template]) -> Array[OntologyAnnotation]:
        ...
        return Array_distinct(list(oas), ObjectExpr598())

    @staticmethod
    def filter_by_tags(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow600(templates: Array[Template]) -> Array[Template]:
            def _arrow599(t: Template) -> Array[OntologyAnnotation]:
                return t.Tags

            return TemplatesAux_filterOnTags(_arrow599, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
    ...
    def filter_by_endpoint_repositories(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow602(templates: Array[Template]) -> Array[Template]:
            def _arrow601(t: Template) -> Array[OntologyAnnotation]:
                return t.EndpointRepositories

            return TemplatesAux_filterOnTags(_arrow601, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
    ...
    def filter_by_ontology_annotation(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow604(templates: Array[Template]) -> Array[Template]:
            def _arrow603(t: Template) -> Array[OntologyAnnotation]:
                return ResizeArray_append(t.Tags, t.EndpointRepositories)

            return TemplatesAux_filterOnTags(_arrow603, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
