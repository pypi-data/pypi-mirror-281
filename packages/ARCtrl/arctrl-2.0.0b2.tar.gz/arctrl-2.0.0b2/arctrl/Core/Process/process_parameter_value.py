...
class ProcessParameterValue(Record):
    ...
    def SetCategory(self, c: OntologyAnnotation) -> ProcessParameterValue:
        this: ProcessParameterValue = self
        def _arrow404(__unit: None=None) -> ProtocolParameter | None:
        ...
        return ProcessParameterValue(_arrow404(), this.Value, this.Unit)
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow406(__unit: None=None) -> str:
        ...
        return ("" if (value is None) else _arrow405()) if (category is None) else (_arrow406() if (value is None) else _arrow407())
...
ProcessParameterValue_reflection = _expr408
