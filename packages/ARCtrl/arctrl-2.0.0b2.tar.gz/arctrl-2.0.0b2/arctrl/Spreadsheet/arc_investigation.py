...
from ..fable_modules.fable_library.seq import (delay, append as append_1, singleton, collect, to_list, map as map_1, iterate_indexed)
...
InvestigationInfo_reflection = _expr1063
    ...
    def loop(last_line_mut: str | None, ontology_source_references_mut: FSharpList[OntologySourceReference], investigation_info_mut: InvestigationInfo, publications_mut: FSharpList[Publication], contacts_mut: FSharpList[Person], studies_mut: FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]], remarks_mut: FSharpList[Remark], line_number_mut: int, rows: Any=rows) -> ArcInvestigation:
        while True:
            ...
            if pattern_matching_result == 0:
                ...
                class ObjectExpr1067:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow1066(x: str, y: str) -> bool:
                            return x == y
                ...
                pattern_input_5 = (reverse(tupled_arg[0]), List_distinctBy(projection, concat(tupled_arg[1]), ObjectExpr1067()))
...
def to_rows(investigation: ArcInvestigation) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    def _arrow1080(__unit: None=None, investigation: Any=investigation) -> FSharpList[IEnumerable_1[tuple[int, str]]]:
        ...
        def _arrow1078(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
            def _arrow1077(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                def _arrow1076(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                    def _arrow1075(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                        def _arrow1074(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                            def _arrow1073(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                def _arrow1072(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                    def _arrow1071(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        def _arrow1070(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow1069(study_identifier: str) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                ...
                                                return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY"]))), delay(_arrow1068))

                                            return collect(_arrow1069, investigation.RegisteredStudyIdentifiers)

                                        return append_1(to_rows_3("Investigation Person", of_seq(investigation.Contacts)), delay(_arrow1070))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION CONTACTS"]))), delay(_arrow1071))

                                return append_1(to_rows_2("Investigation Publication", of_seq(investigation.Publications)), delay(_arrow1072))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION PUBLICATIONS"]))), delay(_arrow1073))

                        return append_1(InvestigationInfo_toRows_Z720BD3FF(investigation), delay(_arrow1074))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["INVESTIGATION"]))), delay(_arrow1075))

                return append_1(to_rows_1(of_seq(investigation.OntologySourceReferences)), delay(_arrow1076))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["ONTOLOGY SOURCE REFERENCE"]))), delay(_arrow1077))

        rows: IEnumerable_1[IEnumerable_1[tuple[int, str]]] = delay(_arrow1078)
        try: 
            ...
            rm: Any = of_list(map(mapping, remarks), ObjectExpr1079())
...
def from_fs_workbook(doc: FsWorkbook) -> ArcInvestigation:
    try: 
        def _arrow1081(__unit: None=None) -> Array[FsRow]:
            sheet_2: FsWorksheet
        ...
        return from_rows(map_1(SparseRowModule_fromFsRow, _arrow1081()))
...
def to_fs_workbook(investigation: ArcInvestigation) -> FsWorkbook:
    try: 
        ...
        iterate_indexed(action, to_rows(investigation))
...
__all__ = ["InvestigationInfo_reflection", "InvestigationInfo_create", "InvestigationInfo_get_Labels", "InvestigationInfo_FromSparseTable_3ECCA699", "InvestigationInfo_ToSparseTable_Z720BD3FF", "InvestigationInfo_fromRows", "InvestigationInfo_toRows_Z720BD3FF", "from_parts", "from_rows", "to_rows", "from_fs_workbook", "to_fs_workbook"]
