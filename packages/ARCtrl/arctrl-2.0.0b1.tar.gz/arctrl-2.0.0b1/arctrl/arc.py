...
from .Spreadsheet.arc_investigation import to_fs_workbook
...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2065(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2064:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2063(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr2064())
        ...
        def _arrow2068(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2067(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2066(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow2066))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow2067))

        return list(to_list(delay(_arrow2068)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2071(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2070:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2069(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr2070())
        ...
        def _arrow2073(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2072(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow2072))

        return list(to_list(delay(_arrow2073)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2076(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2075:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2074(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr2075())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow2078(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2077(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow2077))

        return list(to_list(delay(_arrow2078)))
    ...
    def GetWriteContracts(self, __unit: None=None) -> Array[Contract]:
        ...
        match_value: ArcInvestigation | None = this.ISA
        if match_value is None:
            add_to_dict(workbooks, "isa.investigation.xlsx", (DTOType(2), to_fs_workbook(ArcInvestigation.create("MISSING_IDENTIFIER_"))))

        else: 
            inv: ArcInvestigation = match_value
            add_to_dict(workbooks, "isa.investigation.xlsx", (DTOType(2), to_fs_workbook(inv)))
    ...
    def GetUpdateContracts(self, __unit: None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow2079(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow2080(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow2094(__unit: None=None) -> Array[Contract]:
            inv_2: ArcInvestigation = match_value
            def _arrow2093(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = inv_2.GetLightHashCode() or 0
                def _arrow2092(__unit: None=None) -> IEnumerable_1[Contract]:
                    inv_2.StaticHash = hash_1 or 0
                    def _arrow2085(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow2084(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow2083(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                def _arrow2081(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_2, safe_hash(dm_2))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow2081))

                            elif pattern_matching_result == 1:
                                def _arrow2082(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow2082))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow2084))

                    def _arrow2091(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow2090(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow2089(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow2088(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow2086(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow2086))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow2087(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow2087))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow2089))

                        return collect(_arrow2090, inv_2.Assays)

                    return append(collect(_arrow2085, inv_2.Studies), delay(_arrow2091))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow2092))

            return to_array(delay(_arrow2093))

        return (_arrow2080() if _arrow2079() else _arrow2094()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow2098(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2097(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2096(__unit: None=None) -> IEnumerable_1[Contract]:
                    def _arrow2095(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow2095))

                return append(singleton(gitattributes_contract), delay(_arrow2096))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow2097))

        return to_array(delay(_arrow2098))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow2106(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow2105(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2104(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2103(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2102(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow2101(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2100(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow2100))

                                return append(singleton(text_value), delay(_arrow2101))

                            return collect(_arrow2102, table.Values)

                        return collect(_arrow2103, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow2104))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow2105))

            class ObjectExpr2107:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow2106)), ObjectExpr2107())

        class ObjectExpr2108:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow2115(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow2114(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2113(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2112(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2111(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow2110(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2109(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow2109))

                                return append(singleton(text_value_1), delay(_arrow2110))

                            return collect(_arrow2111, table_1.Values)

                        return collect(_arrow2112, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow2113))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow2114))

            class ObjectExpr2116:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow2115)), ObjectExpr2116())

        class ObjectExpr2117:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr2118:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr2099()), union_many(map(mapping_3, registered_studies, None), ObjectExpr2108()), union_many(map(mapping_4, registered_assays, None), ObjectExpr2117())]), ObjectExpr2118())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2119(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2119)(tree_1)

            else: 
                return tree_1


        def _arrow2121(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow2120(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2120)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2121()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr2122:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr2122())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2123(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2123)(tree_1)

            else: 
                return tree_1


        def _arrow2125(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow2124(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2124)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2125()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr2126:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr2126())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow2127(__unit: None=None) -> ArcInvestigation | None:
