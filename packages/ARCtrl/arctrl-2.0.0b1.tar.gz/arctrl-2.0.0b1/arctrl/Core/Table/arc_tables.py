...
def ArcTablesAux_SanityChecks_validateSheetIndex(index: int, allow_append: bool, sheets: Array[ArcTable]) -> None:
    ...
    def _arrow482(__unit: None=None, index: Any=index, allow_append: Any=allow_append, sheets: Any=sheets) -> bool:
        x: int = index or 0
...
def ArcTablesAux_SanityChecks_validateNamesUnique(names: IEnumerable_1[str]) -> None:
    class ObjectExpr484:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow483(x: str, y: str) -> bool:
                return x == y
    ...
    if not (length(names) == length(distinct(names, ObjectExpr484()))):
...
def ArcTablesAux_SanityChecks_validateNewNameUnique(new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow485(x: str, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow485, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNameAtUnique(index: int, new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow486(x: str, index: Any=index, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow486, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNamesUnique(new_names: IEnumerable_1[str], existing_names: IEnumerable_1[str]) -> None:
    ...
    same: Any = intersect(of_seq(new_names, ObjectExpr487()), of_seq(existing_names, ObjectExpr488()))
...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr529()
    ...
    def TableNames(self, __unit: None=None) -> FSharpList[str]:
        ...
        def _arrow491(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow490(s: ArcTable) -> str:
                return s.Name

            return map_1(_arrow490, this.Tables)

        return to_list(delay(_arrow491))
    ...
    def RemoveColumnAt(self, table_index: int, column_index: int) -> None:
        this: ArcTables = self
        def _arrow504(table: ArcTable) -> None:
            table.RemoveColumn(column_index)

        this.MapTableAt(table_index, _arrow504)
    ...
    def UpdateColumnAt(self, table_index: int, column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> None:
        this: ArcTables = self
        def _arrow506(table: ArcTable) -> None:
            table.UpdateColumn(column_index, header, cells)

        this.MapTableAt(table_index, _arrow506)
    ...
    def AddRowAt(self, table_index: int, cells: Array[CompositeCell] | None=None, row_index: int | None=None) -> None:
        this: ArcTables = self
        def _arrow510(table: ArcTable) -> None:
            table.AddRow(cells, row_index)

        this.MapTableAt(table_index, _arrow510)
    ...
    def UpdateRowAt(self, table_index: int, row_index: int, cells: Array[CompositeCell]) -> None:
        this: ArcTables = self
        def _arrow515(table: ArcTable) -> None:
            table.UpdateRow(row_index, cells)

        this.MapTableAt(table_index, _arrow515)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr520())
        def _arrow525(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow522(__unit: None=None) -> Array[ArcTable]:
            ...
            class ObjectExpr524:
                @property
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow523(x_2: str, y_1: str) -> bool:
                        return x_2 == y_1
            ...
            s: Array[ArcTable] = map_3(mapping_4, map_3(mapping_3, Array_groupBy(projection, map_3(mapping_2, _arrow522(), None), ObjectExpr524()), None), None)
        ...
        return ArcTables(list(_arrow525()))
