...
class ProcessParameterValue(Record):
    ...
    def SetCategory(self, c: OntologyAnnotation) -> ProcessParameterValue:
        this: ProcessParameterValue = self
        def _arrow382(__unit: None=None) -> ProtocolParameter | None:
        ...
        return ProcessParameterValue(_arrow382(), this.Value, this.Unit)
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow383(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow384(__unit: None=None) -> str:
            category_2: str = category
            return (category_2 + ":") + "No Value"

        def _arrow385(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow383()) if (category is None) else (_arrow384() if (value is None) else _arrow385())
...
ProcessParameterValue_reflection = _expr386
