...
class Data:
    ...
    def Name(self, __unit: None=None) -> str | None:
        ...
        def _arrow335(__unit: None=None) -> str | None:
            p_1: str = matchValue
            return p_1

        def _arrow336(__unit: None=None) -> str | None:
            p: str = matchValue
            s: str = matchValue_1
            return DataAux_nameFromPathAndSelector(p, s)

        return None if (matchValue is None) else (_arrow335() if (matchValue_1 is None) else _arrow336())
