...
def Component_ISAJson_encoder(id_map: Any | None, c: Component) -> Json:
    ...
    def _arrow1377(value: str, id_map: Any=id_map, c: Any=c) -> Json:
        return Json(0, value)

    def _arrow1378(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> Json:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    return Json(5, choose(chooser, of_array([try_include("componentName", _arrow1377, Component__get_ComponentName(c)), try_include("componentType", _arrow1378, c.ComponentType)])))


def _arrow1380(get: IGetters) -> Component:
    name: str | None
    ...
    return Component(pattern_input_1[0], pattern_input_1[1], _arrow1379())


Component_ISAJson_decoder: Decoder_1[Component] = object(_arrow1380)
...
def ARCtrl_Process_Component__Component_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Component], str]:
    ...
    def _arrow1381(f: Component, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Component__Component_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Component], str]:
    def _arrow1382(f: Component, spaces: Any=spaces) -> str:
