...
def Source_ROCrate_encoder(oa: Source) -> Json:
    ...
    def _arrow1478(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Source_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Source")))), try_include("name", _arrow1478, oa.Name), try_include_list_opt("characteristics", MaterialAttributeValue_ROCrate_encoder, oa.Characteristics), ("@context", context_jsonvalue)])))


def _arrow1488(get: IGetters) -> Source:
    def _arrow1484(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1486(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow1487(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow1484(), _arrow1486(), _arrow1487())


Source_ROCrate_decoder: Decoder_1[Source] = object(_arrow1488)
...
def Source_ISAJson_encoder(id_map: Any | None, oa: Source) -> Json:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> Json:
        ...
        def _arrow1490(value: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value)

        def _arrow1492(value_2: str, oa_1: Any=oa_1) -> Json:
            return Json(0, value_2)

        def _arrow1493(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> Json:
            return MaterialAttributeValue_ISAJson_encoder(id_map, oa_2)

        return Json(5, choose(chooser, of_array([try_include("@id", _arrow1490, Source_ROCrate_genID(oa_1)), try_include("name", _arrow1492, oa_1.Name), try_include_list_opt("characteristics", _arrow1493, oa_1.Characteristics)])))

    if id_map is not None:
        def _arrow1496(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return Source_ROCrate_genID(s_1)

        return encode(_arrow1496, f, oa, id_map)
...
def _arrow1504(get: IGetters) -> Source:
    ...
    def _arrow1503(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
        arg_5: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(MaterialAttributeValue_ISAJson_decoder)
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("characteristics", arg_5)

    return Source(_arrow1499(), _arrow1501(), _arrow1503())


Source_ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(Source_ISAJson_allowedFields, _arrow1504)
...
def ARCtrl_Process_Source__Source_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[Source], str]:
    ...
    def _arrow1506(f: Source, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
...
def ARCtrl_Process_Source__Source_toROCrateString_Static_71136F3F(spaces: int | None=None) -> Callable[[Source], str]:
    def _arrow1511(f: Source, spaces: Any=spaces) -> str:
