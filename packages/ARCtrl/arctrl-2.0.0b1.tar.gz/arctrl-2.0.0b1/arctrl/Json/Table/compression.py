...
def encode(encoder: Callable[[Any, Any, Any, _A], Json], obj: _A) -> Json:
    ...
    oa_table: Any = Dictionary([], ObjectExpr1662())
    class ObjectExpr1663:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr1663())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow1665(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow1664(__unit: None=None) -> Array[CompositeCell]:
