  ...
  def initMeasurementProtocol(self) -> None:
    ...
    if self.meastype.lower() == PBHC:  
      info_dict_sample = {"sample_thickness": (self.sample_thickness, "m"), 
                          ...
                          "Bx_air_area": ((0.035*0.00001016+0.002*0.00014168)*2+self.sample_thickness*(self.drill_diameter-1e-3), "m^2"),
                          "By_air_area": ((0.035*0.00001016)*2+self.sample_thickness*(self.drill_diameter-1e-3), "m^2")}
