...
def mk_exec_logs(file_path, file_name, process_name, output_content):
    """
...
def mk_texec_logs(file_path, file_name, time_var, time_val, obs=None):
    """
...
def mk_err_logs(file_path, file_name, err_var, err_desc, mode="summary"):
    """
