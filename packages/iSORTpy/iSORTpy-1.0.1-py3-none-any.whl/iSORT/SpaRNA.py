...
class SpaRNAVelocity:
    ...
    def compute_velocity(self, model, velocity, space):
        ...
        - space (torch.Tensor): Normalized spatial data, torch.Tensor type.
        
        Returns:
        - predictions_velocity (torch.Tensor): Computed velocity, torch.Tensor type.
        """
        with torch.no_grad():
    ...
    def plot_velocity(self, adata, velocity_data):
        ...
        - velocity_data (torch.Tensor): Computed velocity, torch.Tensor type.
        """
