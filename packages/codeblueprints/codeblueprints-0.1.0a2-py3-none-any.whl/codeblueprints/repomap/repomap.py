...
from codeblueprints.repomap.dump import dump
from codeblueprints.repomap.io import read_text
from codeblueprints.repomap.tokencounter import TokenCounter, LLMTokenCounter
...
class RepoMap:
    CACHE_VERSION = 3
    TAGS_CACHE_DIR = f".tags.cache.v{CACHE_VERSION}"
    ...
    def __init__(
        ...
        self.token_count = token_counter.tokencount
    ...
    def get_tags_raw(self, fname, rel_fname):
        ...
        try:
            scm_fname = resources.files("codeblueprints.repomap").joinpath(
...
if __name__ == "__main__":
    ...
    token_counter: TokenCounter = LLMTokenCounter(model_name="gpt-3.5")
    rm = RepoMap(root=".", token_counter=token_counter)
