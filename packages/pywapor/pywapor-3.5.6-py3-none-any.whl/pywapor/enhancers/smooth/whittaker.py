...
if __name__ == "__main__":
    ...
    ds = xr.open_dataset(r"/Users/hmcoerver/Desktop/pywapor_delft/exercise_data/data_fixed.nc")
    # ds["sensor"].attrs = {str(v):k for k,v in ds.attrs.items()}
