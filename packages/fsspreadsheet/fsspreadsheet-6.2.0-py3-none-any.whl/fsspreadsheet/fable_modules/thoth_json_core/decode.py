...
class ObjectExpr22(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[__A_], value_2: __A_) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow20(__unit: None=None) -> uint8:
                return out_arg

            def _arrow21(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow20, _arrow21)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr22()

class ObjectExpr25(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[__A_], value_2: __A_) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow23(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow24(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow23, _arrow24)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr25()

class ObjectExpr28(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[__A_], value_2: __A_) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow26(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow27(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow26, _arrow27)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr28()
