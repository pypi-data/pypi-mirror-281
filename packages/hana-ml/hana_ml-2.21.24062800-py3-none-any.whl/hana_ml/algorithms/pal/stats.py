...
def benford_analysis(data,
    ...
    DataFrame
        ...
        Benford analysis result for input data, structured as follows:
    ...
    DataFrame
        ...
        Mantissa statistics, structured as follows:
    ...
    Examples
    --------
    Input data for benford analysis
