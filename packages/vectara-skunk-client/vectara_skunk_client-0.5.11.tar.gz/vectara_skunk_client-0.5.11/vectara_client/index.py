...
class IndexerService:
    ...
    def upload(self, corpus_id: int, path: Union[str, Path] = None, input_contents: bytes = None, filename_override: str = None,
               return_extracted: bool = None, metadata: dict = None,
               ocr = False, timeout = 600) -> UploadDocumentResponse:
        ...
        return self.request_util.multipart_post("upload", path_str=path, input_contents=input_contents, filename_override=filename_override, params=params, headers=headers, timeout=timeout)
