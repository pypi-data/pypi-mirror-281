...
class AwsS3Storage(StorageInterface, GenericCRUD, metaclass=MetaLogger, object=LOGGER_CODE_OBJECT):
    ...
    def __init__(self, bucket_name: str, region: str, is_test_data=False) -> None:
        GenericCRUD.__init__(self, default_schema_name=SCHEMA_NAME,
    ...
    def download_file_by_storage_id(self, storage_id: int, local_file_path: str):
        remote_path_dict = super().select_one_dict_by_column_and_value(schema_name=SCHEMA_NAME, 
