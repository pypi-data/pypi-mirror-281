...
templates = (  ('FourierStripeArtifactImageFilter', 'itk::FourierStripeArtifactImageFilter', 'itkFourierStripeArtifactImageFilterIF2', True, 'itk::Image< float,2 >'),
  ...
  ('FourierStripeArtifactImageFilter', 'itk::FourierStripeArtifactImageFilter', 'itkFourierStripeArtifactImageFilterIF4', True, 'itk::Image< float,4 >'),
  ('FourierStripeArtifactImageFilter', 'itk::FourierStripeArtifactImageFilter', 'itkFourierStripeArtifactImageFilterID4', True, 'itk::Image< double,4 >'),
)
factories = ()
