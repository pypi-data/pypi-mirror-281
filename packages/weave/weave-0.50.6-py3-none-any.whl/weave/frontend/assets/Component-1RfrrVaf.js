import{l as p,b as E,R as t,C as u,s as f,W as y,r as $,L as S,_ as I,u as L,o as w,P as N}from"./index-eIlRbXG6.js";function k(e){return p.pick(e,["className","id"])}const P="text__single-line",v=e=>{const a=k(e),n=E(e.className,P),s={maxWidth:e.maxWidth?e.maxWidth:"",alignSelf:e.alignSelf?e.alignSelf:""},r=Array.isArray(e.children)?e.children.join(""):e.children,i={className:n,style:s,title:r},l=e.as||"span";return t.createElement(l,{...a,...i},e.children)},W={small:u`
    font-size: 12px;
  `,medium:u`
    font-size: 14px;
  `,large:u`
...
//# sourceMappingURL=Component-1RfrrVaf.js.map
