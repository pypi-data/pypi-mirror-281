...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        ...
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=5, side="buy", price=2.1)
    ...
    if "create_market_order" in params and params["create_market_order"]:
        ...
        try:
            resp = ttxtExchange.create_market_order(symbol=tickerToTest, side="buy", amount=3)
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id='5db2328a-3463-11ef-b058-9377d478ccfa', symbol=tickerToTest)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, 
                     ...
                     "myTrades": True,
                     "accountInfo": False}
    test(params=testingParams, exchangeName="coindcx")
