...
class Workflow:
    ...
    def __init__(self, task,checkpoint=None,download_path=None,**kwargs):
        ...
        if self.task == 'nlp_qa':
            ...
            self.contexts = []
            self.doc = None
        default_task = ['depth_anything','det_body','det_body_l','det_coco','det_coco_l','pose_body17','pose_body17_l','pose_body26','pose_wholebody133','pose_face106','pose_hand21','det_hand','cls_imagenet','gen_style','nlp_qa','drive_perception','embedding_image','embedding_text','gen_color']
