...
def generate_plot(path:str, source:str=None, forces_tag:str=None, energy_tag:str=None, subfolders:bool=False, output_path:str=None, 
                    plot:str=None, verbose:bool=False, index:int=None,
...
def generate_AbInitioThermodynamics(path: str, source: str = None, forces_tag:str=None, energy_tag:str=None, subfolders: bool = False, output_path: str = None, 
    ...
    elif plot.upper() == 'LOCAL_LINEAR':
        PT.handleABITAnalysis( values=value  )

    elif plot.upper() == 'GLOBAL_LINEAR':
        PT.handleABITAnalysis( values=value  )
...
def main():
    ...
    parser_AbIT.add_argument('--plot', type=str, choices=['phase_diagram', 'local_linear', 'global_linear', 'F'], help='')
    ...
    if args.command == 'defect':
        ...
        generate_supercell_embedding(path=args.path,     source=args.source,     forces_tag=args.forces_tag,     energy_tag=args.energy_tag,      subfolders=args.subfolders, 
                                    index=args.index,   verbose=args.verbose,   output_path=args.output_path,   output_source=args.output_source, 
        ...
        generate_extract(path=args.path,     source=args.source,     forces_tag=args.forces_tag,     energy_tag=args.energy_tag,      subfolders=args.subfolders, 
                        index=args.index,   verbose=args.verbose,   output_path=args.output_path,   output_source=args.output_source,  
