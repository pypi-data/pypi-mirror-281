...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_secret: The client secret for the connection. Environment variable: `SCM_CLIENT_SECRET`. JSON config file variable:
               `client_secret`.
        :param pulumi.Input[str] host: The hostname of Strata Cloud Manager API. Default: `pa-us01.api.prismaaccess.com`. Environment variable: `SCM_HOST`.
        ...
        :param pulumi.Input[int] port: The port number for API operations, if non-standard for the given protocol. Environment variable: `SCM_PORT`. JSON
               config file variable: `port`.
        :param pulumi.Input[str] protocol: The protocol (https or http). Default: `https`. Environment variable: `SCM_PROTOCOL`. JSON config file variable:
               `protocol`.
