...
from collibra_import.models.mapping_identifier import MappingIdentifier  # noqa: E501
...
class TestMappingIdentifier(unittest.TestCase):
    ...
    def testMappingIdentifier(self):
        ...
        # model = collibra_import.models.mapping_identifier.MappingIdentifier()  # noqa: E501
        pass
