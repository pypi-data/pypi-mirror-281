...
from collibra_import.models.external_identifier import ExternalIdentifier  # noqa: E501
...
class TestExternalIdentifier(unittest.TestCase):
    ...
    def testExternalIdentifier(self):
        ...
        # model = collibra_import.models.external_identifier.ExternalIdentifier()  # noqa: E501
        pass
