...
from collibra_import.models.asset_type_identifier import AssetTypeIdentifier  # noqa: E501
...
class TestAssetTypeIdentifier(unittest.TestCase):
    ...
    def testAssetTypeIdentifier(self):
        ...
        # model = collibra_import.models.asset_type_identifier.AssetTypeIdentifier()  # noqa: E501
        pass
