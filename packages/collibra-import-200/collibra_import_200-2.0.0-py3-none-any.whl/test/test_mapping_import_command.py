...
from collibra_import.models.mapping_import_command import MappingImportCommand  # noqa: E501
...
class TestMappingImportCommand(unittest.TestCase):
    ...
    def testMappingImportCommand(self):
        ...
        # model = collibra_import.models.mapping_import_command.MappingImportCommand()  # noqa: E501
        pass
