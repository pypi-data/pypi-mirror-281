...
class ImportJsonInJobRequest(object):
    ...
    def __init__(self, send_notification=None, batch_size=1000, simulation=None, save_result=None, file_id=None, file=None, file_name=None, delete_file=None, continue_on_error=None, relations_action=None):  # noqa: E501
        """ImportJsonInJobRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImportJsonInJobRequest, dict):
