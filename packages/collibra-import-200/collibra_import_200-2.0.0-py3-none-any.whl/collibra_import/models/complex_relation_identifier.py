...
class ComplexRelationIdentifier(object):
    ...
    def __init__(self, id=None, external_system_id=None, external_entity_id=None, relations=None):  # noqa: E501
        """ComplexRelationIdentifier - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ComplexRelationIdentifier, dict):
