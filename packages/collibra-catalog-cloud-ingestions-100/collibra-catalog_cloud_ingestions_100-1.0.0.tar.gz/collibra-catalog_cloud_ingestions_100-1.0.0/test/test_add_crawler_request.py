...
from collibra_catalog_cloud_ingestions.models.add_crawler_request import AddCrawlerRequest  # noqa: E501
...
class TestAddCrawlerRequest(unittest.TestCase):
    ...
    def testAddCrawlerRequest(self):
        ...
        # model = collibra_catalog_cloud_ingestions.models.add_crawler_request.AddCrawlerRequest()  # noqa: E501
        pass
