...
import collibra_catalog_cloud_ingestions.models
from collibra_catalog_cloud_ingestions import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(collibra_catalog_cloud_ingestions.models, klass)
