...
import collibra_catalog_classification.models
from collibra_catalog_classification import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(collibra_catalog_classification.models, klass)
