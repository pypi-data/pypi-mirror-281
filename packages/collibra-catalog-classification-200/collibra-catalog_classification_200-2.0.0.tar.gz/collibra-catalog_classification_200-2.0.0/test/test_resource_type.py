...
from collibra_catalog_classification.models.resource_type import ResourceType  # noqa: E501
...
class TestResourceType(unittest.TestCase):
    ...
    def testResourceType(self):
        ...
        # model = collibra_catalog_classification.models.resource_type.ResourceType()  # noqa: E501
        pass
