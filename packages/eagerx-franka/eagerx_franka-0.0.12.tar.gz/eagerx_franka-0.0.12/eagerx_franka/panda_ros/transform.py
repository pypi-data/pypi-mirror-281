import numpy as np
from eagerx_franka.panda_ros.pose_transform_functions import pose_st_2_transformation, array_quat_2_pose, transform_pos_ori
...
class Transform:
    def __init__(self):
        ...
        quat_home_pose = np.quaternion(
            -0.0013368381495548441, 0.9999906149190223, -0.003484754266474329, 0.00016145904239296165
        )
