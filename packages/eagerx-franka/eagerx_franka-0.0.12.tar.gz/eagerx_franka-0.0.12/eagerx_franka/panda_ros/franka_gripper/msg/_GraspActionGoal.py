...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_5d().pack(
                    _x.goal.width, _x.goal.epsilon.inner, _x.goal.epsilon.outer, _x.goal.speed, _x.goal.force
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                _x.goal.width,
                _x.goal.epsilon.inner,
                _x.goal.epsilon.outer,
                _x.goal.speed,
                _x.goal.force,
            ) = _get_struct_5d().unpack(str[start:end])
            return self
