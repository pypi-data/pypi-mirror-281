...
"""
    ...
    def __init__(self, *args, **kwds):
        ...
        if args or kwds:
            ...
            if self.action_goal is None:
                self.action_goal = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionGoal()
            if self.action_result is None:
                self.action_result = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionResult()
            if self.action_feedback is None:
                self.action_feedback = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionFeedback()
        else:
            self.action_goal = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionGoal()
            self.action_result = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionResult()
            self.action_feedback = eagerx_franka.panda_ros.franka_gripper.msg.HomingActionFeedback()
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_3I().pack(
                    _x.action_goal.header.seq, _x.action_goal.header.stamp.secs, _x.action_goal.header.stamp.nsecs
                )
            )
            ...
            _x = self
            buff.write(
                _get_struct_2I().pack(_x.action_result.status.goal_id.stamp.secs, _x.action_result.status.goal_id.stamp.nsecs)
            )
            ...
            buff.write(
                _get_struct_2I().pack(
                    _x.action_feedback.status.goal_id.stamp.secs, _x.action_feedback.status.goal_id.stamp.nsecs
                )
            )
