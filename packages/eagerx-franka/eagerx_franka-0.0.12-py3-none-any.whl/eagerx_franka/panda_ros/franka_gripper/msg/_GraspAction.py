...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            _x = self
            buff.write(
                _get_struct_5d3I().pack(
                    _x.action_goal.goal.width,
                    _x.action_goal.goal.epsilon.inner,
                    _x.action_goal.goal.epsilon.outer,
                    _x.action_goal.goal.speed,
                    _x.action_goal.goal.force,
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.action_result.header.stamp.secs,
                _x.action_result.header.stamp.nsecs,
            ) = _get_struct_5d3I().unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            start = end
