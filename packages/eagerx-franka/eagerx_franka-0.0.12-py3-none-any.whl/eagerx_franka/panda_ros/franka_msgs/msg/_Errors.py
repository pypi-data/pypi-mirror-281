...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            _x = self
            buff.write(
                _get_struct_41B().pack(
                    _x.joint_position_limits_violation,
                    _x.cartesian_position_limits_violation,
                    _x.self_collision_avoidance_violation,
                    _x.joint_velocity_violation,
                    _x.cartesian_velocity_violation,
                    _x.force_control_safety_violation,
                    _x.joint_reflex,
                    _x.cartesian_reflex,
                    _x.max_goal_pose_deviation_violation,
                    _x.max_path_pose_deviation_violation,
                    _x.cartesian_velocity_profile_safety_violation,
                    _x.joint_position_motion_generator_start_pose_invalid,
                    _x.joint_motion_generator_position_limits_violation,
                    _x.joint_motion_generator_velocity_limits_violation,
                    _x.joint_motion_generator_velocity_discontinuity,
                    _x.joint_motion_generator_acceleration_discontinuity,
                    _x.cartesian_position_motion_generator_start_pose_invalid,
                    _x.cartesian_motion_generator_elbow_limit_violation,
                    _x.cartesian_motion_generator_velocity_limits_violation,
                    _x.cartesian_motion_generator_velocity_discontinuity,
                    _x.cartesian_motion_generator_acceleration_discontinuity,
                    _x.cartesian_motion_generator_elbow_sign_inconsistent,
                    _x.cartesian_motion_generator_start_elbow_invalid,
                    _x.cartesian_motion_generator_joint_position_limits_violation,
                    _x.cartesian_motion_generator_joint_velocity_limits_violation,
                    _x.cartesian_motion_generator_joint_velocity_discontinuity,
                    _x.cartesian_motion_generator_joint_acceleration_discontinuity,
                    _x.cartesian_position_motion_generator_invalid_frame,
                    _x.force_controller_desired_force_tolerance_violation,
                    _x.controller_torque_discontinuity,
                    _x.start_elbow_sign_inconsistent,
                    _x.communication_constraints_violation,
                    _x.power_limit_violation,
                    _x.joint_p2p_insufficient_torque_for_planning,
                    _x.tau_j_range_violation,
                    _x.instability_detected,
                    _x.joint_move_in_wrong_direction,
                    _x.cartesian_spline_motion_generator_violation,
                    _x.joint_via_motion_generator_planning_joint_limit_violation,
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.base_acceleration_initialization_timeout,
                _x.base_acceleration_invalid_reading,
            ) = _get_struct_41B().unpack(str[start:end])
            ...
            self.joint_position_motion_generator_start_pose_invalid = bool(
                self.joint_position_motion_generator_start_pose_invalid
            )
            ...
            self.joint_motion_generator_acceleration_discontinuity = bool(
                self.joint_motion_generator_acceleration_discontinuity
            )
            self.cartesian_position_motion_generator_start_pose_invalid = bool(
                self.cartesian_position_motion_generator_start_pose_invalid
            )
            self.cartesian_motion_generator_elbow_limit_violation = bool(self.cartesian_motion_generator_elbow_limit_violation)
            self.cartesian_motion_generator_velocity_limits_violation = bool(
                self.cartesian_motion_generator_velocity_limits_violation
            )
            self.cartesian_motion_generator_velocity_discontinuity = bool(
                self.cartesian_motion_generator_velocity_discontinuity
            )
            self.cartesian_motion_generator_acceleration_discontinuity = bool(
                self.cartesian_motion_generator_acceleration_discontinuity
            )
            self.cartesian_motion_generator_elbow_sign_inconsistent = bool(
                self.cartesian_motion_generator_elbow_sign_inconsistent
            )
            self.cartesian_motion_generator_start_elbow_invalid = bool(self.cartesian_motion_generator_start_elbow_invalid)
            self.cartesian_motion_generator_joint_position_limits_violation = bool(
                self.cartesian_motion_generator_joint_position_limits_violation
            )
            self.cartesian_motion_generator_joint_velocity_limits_violation = bool(
                self.cartesian_motion_generator_joint_velocity_limits_violation
            )
            self.cartesian_motion_generator_joint_velocity_discontinuity = bool(
                self.cartesian_motion_generator_joint_velocity_discontinuity
            )
            self.cartesian_motion_generator_joint_acceleration_discontinuity = bool(
                self.cartesian_motion_generator_joint_acceleration_discontinuity
            )
            self.cartesian_position_motion_generator_invalid_frame = bool(
                self.cartesian_position_motion_generator_invalid_frame
            )
            self.force_controller_desired_force_tolerance_violation = bool(
                self.force_controller_desired_force_tolerance_violation
            )
            ...
            self.joint_via_motion_generator_planning_joint_limit_violation = bool(
                self.joint_via_motion_generator_planning_joint_limit_violation
            )
