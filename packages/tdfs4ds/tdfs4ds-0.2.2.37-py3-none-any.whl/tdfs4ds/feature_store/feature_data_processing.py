...
def _store_feature_update_insert(entity_id, prepared_features, entity_null_substitute={},  **kwargs):
    """
...
def _store_feature_merge(entity_id, prepared_features, entity_null_substitute= {}, **kwargs):
    """
    Stores prepared feature data in specific feature tables within a Teradata database. This function performs updates and inserts
    on the feature tables based on the provided entity IDs and prepared feature data.
    ...
    return
def store_feature(entity_id, prepared_features, entity_null_substitute = {}, **kwargs):
    """
    ...
    if tdfs4ds.STORE_FEATURE == 'UPDATE_INSERT':
        _store_feature_update_insert(entity_id, prepared_features, entity_null_substitute=entity_null_substitute, **kwargs)
    elif tdfs4ds.STORE_FEATURE == 'MERGE':
        _store_feature_merge(entity_id, prepared_features, entity_null_substitute=entity_null_substitute, **kwargs)
    else:
