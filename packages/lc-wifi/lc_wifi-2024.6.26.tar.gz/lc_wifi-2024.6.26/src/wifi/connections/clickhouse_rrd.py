...
class Attrs:
    ...
    pme_5_quality_drop          = ['5.pme.detail.pme_5_quality_drop'   , bool ]
    ...
    pme_2_total                 = ['2.pme.total', int]
    pme_5_total                 = ['5.pme.total', int]
    pme_cpe_total               = ['cpe.pme.total', int]
    ...
    # radio statistics
    wifi_2_transmit_power      = ['2.Radio.TransmitPower'           , short            ]
    ...
    wifi_5_transmit_power      = ['5.Radio.TransmitPower'           , short           ]
    ...
    wifi_allow_collection       = ['metadata.allow_collection'   , bool     ]
    ssid_1_enabled = ['WiFi.SSID.1.Enable'   , bool            ]
    ssid_1_advertisement_enabled = ['WiFi.SSID.1.SSIDAdvertisementEnabled'   , bool ]
    ssid_2_enabled = ['WiFi.SSID.2.Enable'   , bool            ]
    ssid_2_advertisement_enabled = ['WiFi.SSID.2.SSIDAdvertisementEnabled'   , bool ]
    ssid_5_enabled = ['WiFi.SSID.5.Enable'   , bool            ]
    ssid_5_advertisement_enabled = ['WiFi.SSID.5.SSIDAdvertisementEnabled'   , bool ]
    ssid_6_enabled = ['WiFi.SSID.6.Enable'   , bool            ]
    ssid_6_advertisement_enabled = ['WiFi.SSID.6.SSIDAdvertisementEnabled'   , bool ]
    ssid_1_security_modeenabled = ['WiFi.SSID.1.Security.ModeEnabled', str ]
    ssid_1_security_encryptionmode= ['WiFi.SSID.1.Security.EncryptionMode', str]
    ssid_2_security_modeenabled = ['WiFi.SSID.2.Security.ModeEnabled', str ]
    ssid_2_security_encryptionmode= ['WiFi.SSID.2.Security.EncryptionMode', str]
    ssid_5_security_modeenabled = ['WiFi.SSID.5.Security.ModeEnabled', str ]
    ssid_5_security_encryptionmode= ['WiFi.SSID.5.Security.EncryptionMode', str]
    ssid_6_security_modeenabled = ['WiFi.SSID.6.Security.ModeEnabled', str ]
    ssid_6_security_encryptionmode= ['WiFi.SSID.6.Security.EncryptionMode', str]

    full_scan = ['collector.full_scan', bool]
    light_scan = ['collector.light_scan', bool]

    wifi_2_extender_count = ['2.clients.extender_count', int]
    wifi_2_mesh_count = ['2.clients.mesh_count', int]
    wifi_5_extender_count = ['5.clients.extender_count', int]
    wifi_5_mesh_count = ['5.clients.mesh_count', int]
