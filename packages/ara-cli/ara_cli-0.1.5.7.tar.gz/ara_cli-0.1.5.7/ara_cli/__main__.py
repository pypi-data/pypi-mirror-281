...
def prompt_action(args):
    ...
    from ara_cli.prompt_handler import create_and_send_custom_prompt, extract_and_save_prompt_results
    from ara_cli.prompt_handler import update_artefact_config_prompt_files
