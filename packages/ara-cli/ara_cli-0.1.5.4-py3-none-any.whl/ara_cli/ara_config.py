    ...
    def get_config(cls, filepath='./ara/.araconfig/ara_config.json'):
        ...
        if cls._config_instance is None:
            if not exists(os.path.dirname(filepath)):
                ...
                makedirs(join(os.path.dirname(filepath), "custom-prompt-modules"))
                makedirs(join(os.path.dirname(filepath), "custom-prompt-modules", "commands"))
                makedirs(join(os.path.dirname(filepath), "custom-prompt-modules", "rule"))
                makedirs(join(os.path.dirname(filepath), "custom-prompt-modules", "intentions"))
                makedirs(join(os.path.dirname(filepath), "custom-prompt-modules", "recipies"))
