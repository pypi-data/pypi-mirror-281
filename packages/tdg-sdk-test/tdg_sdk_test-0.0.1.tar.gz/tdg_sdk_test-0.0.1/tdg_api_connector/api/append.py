...
class AppendAPI:
    ...
    Methods:
        - get_phone_number_details_by_names_and_addresses(first_name: str, 
                                                    last_name: str, address: str, 
                                                    zip_number: int, max_score: str=None) -> dict

        - get_email_details_by_names_and_addresses(first_name: str, 
                                last_name: str, address: str, 
                                zip_number: int, suppression: bool = True, 
                                includemonths: int=None, max_score: str=None) -> dict

        - get_demographic_details_by_names_and_addresses(first_name: str=None, 
        ...
        - get_auto_details_by_names_and_addresses(full_name: str=None, address: str=None, 
    ...
    def get_auto(self, full_name: str, address: str,
                                zip_number: int, first_name: str=None,
                                last_name: str=None, email: str=None, phone: str=None) -> dict:
        """
