...
class VerifyAPI:
    ...
    Methods:
        - get_verification_score(first_name: str=None, last_name: str=None, 
                    address: int=None, zip_number: int=None, 
                    phone: str=None, email: str=None) -> dict

        - verify_tcpa_info(self, phone: int=None, last_name: str=None) -> dict
    ...
    def get_id_verification(self, first_name: str=None, last_name: str=None,
                    address: int=None, zip_number: int=None,
                    phone: str=None, email: str=None) -> dict:
        """
