...
class Query(sgqlc.types.Type):
    ...
    tdm = sgqlc.types.Field(sgqlc.types.non_null(JSON), graphql_name='tdmInternal', args=sgqlc.types.ArgDict((
        ('id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='id', default=None)),
        ('hide_new', sgqlc.types.Arg(sgqlc.types.non_null(Boolean), graphql_name='hideNew', default=False)),
))
    )
    tdm_new = sgqlc.types.Field(sgqlc.types.non_null(JSON), graphql_name='tdmNewInternal', args=sgqlc.types.ArgDict((
        ('id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='id', default=None)),
))
    )
