...
def get_business_payment_deadline_edit_schema():
    schema = SQLAlchemySchemaNode(
        BusinessPaymentDeadline, includes=("description", "date", "amount_ttc")
    )
    ...
    schema["date"].widget = deferred_date_modify_widget
    schema.after_bind = drop_date_if_not_set
    return schema
