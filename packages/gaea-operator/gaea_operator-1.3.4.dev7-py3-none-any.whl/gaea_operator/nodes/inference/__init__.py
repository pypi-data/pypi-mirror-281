...
inference_inputs: List[Variable] = \
    [
        Variable(type="model", name="input_model_uri", value=""),
        Variable(type="dataset", name="input_dataset_uri", value="")
    ]
...
class Inference(BaseNode):
    ...
    def __init__(self,
                 inputs: List[Variable] = inference_inputs,
    ...
    def __call__(self,
                 ...
                 dataset_name: str = ""):
        inference_params = {"inference_skip": self.inference_skip,
        ...
        set_node_parameters(skip=self.inference_skip,
