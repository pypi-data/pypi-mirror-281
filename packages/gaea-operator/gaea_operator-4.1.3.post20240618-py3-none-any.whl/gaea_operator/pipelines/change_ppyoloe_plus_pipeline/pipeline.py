...
def pipeline(accelerator: str = "T4",
    ...
    train = ContainerStep(name="train",
                          docker_env=
                          "iregistry.baidu-int.com/windmill-public/train/paddlepaddle:v1.3.3-hotfix-20240618",
    ...
    eval = ContainerStep(name="eval",
                         docker_env="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:v1.3.3-hotfix-20240618",
