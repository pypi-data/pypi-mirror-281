...
class ModifyPackageFiles(object):
    ...
    def __init__(self,
        ...
        self.eval_width = int(algo_param_dict['evalWidth']) if 'evalWidth' in algo_param_dict else None
        self.eval_height = int(algo_param_dict['evalHeight']) if 'evalHeight' in algo_param_dict else None
