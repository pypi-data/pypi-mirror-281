...
# {
    ...
    int seed:           Seed for numpy random generator / default=None
    ...
    def setup(self, X, y, varnames=None, alts=None, isvars=None, num_classes=2,
              ...
              maxiter=2000, seed=None, correlation=None, n_draws=1000, halton=True,
    ...
    # {
        ...
        # {
            ...
            # {
                ...
                mxl = misc.setup_logit(i, mxl, X, y, varnames, self.class_params_spec, avail, alts, transvars, gtol,
                        mixed=True, seed=seed, panels=panels, randvars=randvars,
        ...
        super(LatentClassMixedModel, self).setup(X, y, varnames, alts, isvars,
                ...
                self.fit_intercept, init_coeff, maxiter, seed, correlation,
