...
class SparkConnector(google.protobuf.message.Message):
    ...
    class PermanentCluster(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["folder_id", b"folder_id", "id", b"id", "master_node_host", b"master_node_host", "name", b"name", "status", b"status", "version", b"version"]) -> None: ...
