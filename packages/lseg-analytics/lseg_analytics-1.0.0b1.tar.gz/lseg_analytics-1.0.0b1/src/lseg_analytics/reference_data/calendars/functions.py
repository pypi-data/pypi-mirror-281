...
def load(
    *,
    ...
    <lseg_analytics.reference_data.calendars.calendar.Calendar at 0x7f9ff268ce10>

    Load by name and space.

    >>> load(name="EMU", space="LSEG")
    <lseg_analytics.reference_data.calendars.calendar.Calendar at 0x7f9ff2673550>
