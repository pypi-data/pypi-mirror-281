...
def load(
    *,
    ...
    <lseg_analytics.instruments.fx_forwards.fx_forward.FxForward at 0x7fa17aebe090>

    Load by name and space.

    >>> load(name="EURCHF", space="MYSPACE")
    <lseg_analytics.instruments.fx_forwards.fx_forward.FxForward at 0x7fa17aebd450>
