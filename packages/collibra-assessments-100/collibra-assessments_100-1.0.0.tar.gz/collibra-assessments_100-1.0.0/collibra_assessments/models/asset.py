...
import six
from collibra_assessments.models.base_asset import BaseAsset  # noqa: F401,E501
...
class Asset(BaseAsset):
    ...
    if hasattr(BaseAsset, "swagger_types"):
        swagger_types.update(BaseAsset.swagger_types)

    attribute_map = {
        'name': 'name'
    }
    if hasattr(BaseAsset, "attribute_map"):
        attribute_map.update(BaseAsset.attribute_map)
    ...
    def name(self):
        ...
        The name of the Collibra asset.  # noqa: E501
