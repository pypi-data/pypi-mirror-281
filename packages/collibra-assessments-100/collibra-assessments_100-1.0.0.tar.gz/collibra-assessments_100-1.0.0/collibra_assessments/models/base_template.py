...
class BaseTemplate(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """BaseTemplate - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this BaseTemplate.  # noqa: E501

        The ID of the template.  # noqa: E501

        :return: The id of this BaseTemplate.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this BaseTemplate.

        The ID of the template.  # noqa: E501

        :param id: The id of this BaseTemplate.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseTemplate, dict):
