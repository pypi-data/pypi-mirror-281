...
from collibra_assessments.models.assessment_status import AssessmentStatus  # noqa: E501
...
class TestAssessmentStatus(unittest.TestCase):
    ...
    def testAssessmentStatus(self):
        ...
        # model = collibra_assessments.models.assessment_status.AssessmentStatus()  # noqa: E501
        pass
