...
from collibra_assessments.models.question_and_answer import QuestionAndAnswer  # noqa: E501
...
class TestQuestionAndAnswer(unittest.TestCase):
    ...
    def testQuestionAndAnswer(self):
        ...
        # model = collibra_assessments.models.question_and_answer.QuestionAndAnswer()  # noqa: E501
        pass
