...
class TableExtraction:
    ...
    def extract_table(
        ...
        Args:
            ...
            output_formats (List[OutputFormat], optional): Include "html", "latex", "csv" to specify the output formats for the reconstructed tables. Defaults to output all formats.
            border_format (BorderFormat, optional): Include "full_border", "no_border", "hor_border", "ver_border", "inner_border", "outer_border" to specify the border format for the reconstructed tables. Defaults to BorderFormat.FULL_LINE.
            vertical_align (VerticalAlign, optional): Include "top", "middle", "bottom" to specify the vertical align for the reconstructed tables. Defaults to VerticalAlign.MIDDLE.
            horizontal_align (HorizontalAlign, optional): Include "left", "center", "right" to specify the horizontal align for the reconstructed tables. Defaults to HorizontalAlign.LEFT.

        Returns:
            List[Dict]: List of detected tables with the reconstructed table outputs.
        """
