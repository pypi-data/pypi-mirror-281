...
def llinput(*prompt, sep=" ", end='\n', wend='', max_length=None, min_lenght=None, forceint=False, forceinput=False, forcemininputlen=0, forceinputlen=0, otodt=False, inputcolor=None, promptcolor=None, endcolor=None, wendcolor=None):
