...
class ModelUsecaseUtilities:
    ...
    # def _display_results(self, workspace_data_list: list) -> None:
    #     """
    #     Display the results as DataFrames to the user.
    #     """
    #     if workspace_data_list:
    #         associated_workspaces_df = pd.DataFrame(workspace_data_list)
    #         print("Associated Workspaces:")
    #         print(associated_workspaces_df.to_string(index=False))
    #     else:
    #         _logger.error("No Associated Workspaces found!!")
    ...
    def list_associated_workspaces_by_phase(self, phase_name: Phases = None) -> None:
        ...
        if phase_name:
            ...
            filtered_workspaces = [phase for phase in associated_workspaces if
                                   phase.get('phase_name') == phase_name]
