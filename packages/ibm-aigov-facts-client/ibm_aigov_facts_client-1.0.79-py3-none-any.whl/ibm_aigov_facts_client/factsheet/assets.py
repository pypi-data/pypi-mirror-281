...
#=====================================  PROMPT ASSET  ======================================================================================
    ...
    def get_prompt(self, asset_id: str, container_type: str=None , container_id: str=None ) -> AIGovAssetUtilities:
        """
            ...
            Parameters:
                prompt_id (str): The ID of the prompt asset to retrieve (default is None).
                container_type (str optional): The type of container where the prompt is stored, e.g., 'folder', 'project' (default is None).
                container_id (str optional): The ID of the container where the prompt is stored (default is None).
    ...
    def get_workspace_association_info(self: object, workspace_info:List[dict[str,str]]) -> None:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                for workspace in data.get('associated_workspaces', []):
                    print("\n\t\t====Workspace Details:====")
                    ...
                    for usecase in workspace.get('associated_usecases', []):
                    ...
                    print("\n\t\t====Tracked AI Assets:====")
                    for asset in workspace.get('tracked_assets', []):
