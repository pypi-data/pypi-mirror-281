...
class Platform:
    ...
    @staticmethod
    def to_format_locations(locations: List[List[str] | List[Tuple[float, float, float]]], format: LocationFormats = LocationFormats.h3) -> List[Any]:
    ...
    @staticmethod
    def from_format_locations(locations: List[Any], format: LocationFormats = LocationFormats.h3) -> List[List[str] | List[Tuple[float, float, float]]]:
        ...
        Returns:
        -------
            List[List[str] | List[Tuple[float, float, float]]]: locations in requested format.
