...
class TestTimeTrackingSourceEnum(unittest.TestCase):
    """TimeTrackingSourceEnum unit test stubs"""
    ...
    def testTimeTrackingSourceEnum(self):
        """Test TimeTrackingSourceEnum"""
        # inst = TimeTrackingSourceEnum()
