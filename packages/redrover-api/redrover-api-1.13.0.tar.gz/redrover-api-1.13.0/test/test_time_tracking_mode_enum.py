...
class TestTimeTrackingModeEnum(unittest.TestCase):
    """TimeTrackingModeEnum unit test stubs"""
    ...
    def testTimeTrackingModeEnum(self):
        """Test TimeTrackingModeEnum"""
        # inst = TimeTrackingModeEnum()
