...
class VacancyDetailSearchResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["notesToAdmin", "adminOnlyNotes", "absenceDetail", "vacancyId", "isDeleted", "position", "createdUtc", "id", "assignmentId", "substitute", "externalAssignmentNumber", "assignmentIsLongTerm", "assignmentNotes", "location", "start", "end", "actualDurationMinutes", "accountingCodes", "payDuration", "payUnit", "payCode", "vacancyReason", "verified", "verifiedAtUtc", "verifyComment", "verifiedBy", "approvalStatus", "approvalStatusId"]
