...
class SubstituteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributes", "relatedOrgIds", "payCode", "id", "orgId", "createdUtc", "changedUtc", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted"]
